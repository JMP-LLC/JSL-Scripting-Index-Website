...
**Syntaxe :** obj = Ternary Plot(...<By( column(s) )>...)
...
**Syntaxe :** obj = Ternary Plot(...Contour Formula( formula column )...)
...
**Syntaxe :** obj = Ternary Plot(...Plotting( column(s) )...)
...
**Syntaxe :** obj = Ternary Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Syntaxe :** obj = Ternary Plot(...X( column(s) )...)
