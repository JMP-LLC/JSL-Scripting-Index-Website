...
**Syntaxe :** obj = MaxDiff(...Convergence Criterion( number )...)
...
**Syntaxe :** obj = MaxDiff(...Firth Bias-Adjusted Estimates( state=0|1 )...)
...
**Syntaxe :** obj = MaxDiff(...Hierarchical Bayes( state=0|1 )...)
...
**Syntaxe :** obj = MaxDiff(...Number of Bayesian Iterations( number )...)
...
**Syntaxe :** obj = MaxDiff(...<Profile Effects( column )>...)
...
**Syntaxe :** obj = MaxDiff(...Remove Subject Effects...)
...
**Syntaxe :** MaxDiff( Response Best Option( column ), ... )
...
**Syntaxe :** MaxDiff( Response Value Indicates Best( value ), ... )
...
**Syntaxe :** MaxDiff( Response Value Indicates Worst( value ), ... )
...
**Syntaxe :** MaxDiff( Response Worst Option( column ), ... )
...
**Syntaxe :** obj = MaxDiff(...<Subject Effects( column )>...)
...
**Syntaxe :** obj = MaxDiff(...Window View( "Visible"|"Invisible"|"Private" )...)
