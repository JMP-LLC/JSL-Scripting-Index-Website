...
**Syntaxe :** obj << Heading Underline Color( color );
...
**Syntaxe :** obj << Row Border Color( color );
...
**Syntaxe :** obj << Row Height Scale( number );
...
**Syntaxe :** obj << Row Vertical Alignment( "Haut"|"Centre"|"Référence de base"|"Bas" );

"Haut"|"Centre"|"Référence de base"|"Bas" = obj << Get Row Vertical Alignment
