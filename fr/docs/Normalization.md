...
**Syntaxe :** Mean Expression Threshold ( number = 0.05 )
...
**Syntaxe :** Create New Tables for Results ( state =0|1 )
...
**Syntaxe :** Interpolated Quantiles( state =0|1 )
...
**Syntaxe :** Log Transformation( state =0|1 )
...
**Syntaxe :** Logratio Threshold ( number = 0.3 )
...
**Syntaxe :** Method( "Row Standardize" | "Wrench" )
...
**Syntaxe :** Total Prior Count ( number = 0.25 )
...
**Syntaxe :** Replace Y Data( state =0|1 )
...
**Syntaxe :** obj = Normalization(...Window View( "Visible"|"Invisible"|"Private" )...)
