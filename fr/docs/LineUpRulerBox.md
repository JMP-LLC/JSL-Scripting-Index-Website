...
**Syntaxe :** list = obj << Get Widths

**Description :** Renvoie les largeurs des colonnes pour les boîtes d&apos;alignement contenues.
...
**Syntaxe :** obj << Widths( list )

**Description :** Définit les largeurs des colonnes pour les boîtes d&apos;alignement contenues.
