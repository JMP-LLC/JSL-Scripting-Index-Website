...
**Syntaxe :** obj << Set Row States( dt, rs )

**Description :** Définit les états de ligne de la table de données spécifiée dans le filtre. Les sélections issues de cet état de ligne ne seront pas liées à la table de données, elles seront incluses dans les rapports liés au filtre de sélection.
