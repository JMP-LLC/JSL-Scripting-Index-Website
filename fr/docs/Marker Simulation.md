...
**Syntaxe :** obj = Marker Simulation(...Estimate Diversity( state=0|1 )...)
...
**Syntaxe :** obj = Marker Simulation(...Imputation Value( number=0 )...)
...
**Syntaxe :** obj = Marker Simulation(...Missing Marker Imputation Method( "HWE désactivé"|"HWE activé"|"Aléatoire"|"Spécifiée"="HWE désactivé" )...)
...
**Syntaxe :** obj = Marker Simulation(...Number of Generations( number=1 )...)
...
**Syntaxe :** obj = Marker Simulation(...Number of Individuals per Cross( number=5 )...)
...
**Syntaxe :** obj = Marker Simulation(...Number of Selected Crosses( number=0 )...)
...
**Syntaxe :** obj = Marker Simulation(...Number of Selected Individuals( number=0 )...)
...
**Syntaxe :** obj = Marker Simulation(...Ploidy( number=2 )...)
...
**Syntaxe :** obj = Marker Simulation(...Select Best Individuals( state=0|1 )...)
...
**Syntaxe :** obj = Marker Simulation(...Set Random Seed( number=0 )...)
...
**Syntaxe :** obj = Marker Simulation(...Threshold to Make Line Plots( number=500 )...)
...
**Syntaxe :** obj = Marker Simulation(...Unthreaded( state=0|1 )...)
...
**Syntaxe :** obj = Marker Simulation(...Use Annotation Table( state=0|1 )...)
...
**Syntaxe :** obj = Marker Simulation(...Use Only Markers Found in Predictor Formula( state=0|1 )...)
...
**Syntaxe :** obj = Marker Simulation(...Window View( "Visible"|"Invisible"|"Private" )...)
