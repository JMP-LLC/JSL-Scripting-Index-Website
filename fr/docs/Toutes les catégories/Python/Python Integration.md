...
**Syntaxe :** result = jmp.from_arrow(&lt;library.Dataframe&gt;, requested_schema=&lt;schema&gt;, visibility=&lt;string&gt;, preserve_index=&lt;bool&gt;)

**Description :** Crée un objet jmp.DataTable à partir d&apos;un cadre de données qui implémente l&apos;interface PyArrow Capsule.
...
**Description :** La mise à jour des petites tables est rapide ; en revanche, pour les grandes tables, actualiser l&apos;interface utilisateur pendant que l&apos;on apporte des modifications massives à une colonne s&apos;avère très chronophage. La méthode begin_update() interrompt les mises à jour de l&apos;interface graphique de la table de données jusqu&apos;à l&apos;appel correspondant à end_update().
...
**Description :** Restaure le traitement de mise à jour de l&apos;interface graphique de la table de données.
