...
**Syntaxe :** dt.new_column(  name=&apos;column_name&apos;,
...
**Syntaxe :** jmp.RowState(selected?=<boolean>, hidden?=<booleane>, labeled?=<boolean>, excluded?=<boolean>, color?=<int>, marker?=<int>)
