...
**Syntaxe :** obj &lt;&lt; Add Axis Label( label )

**Description :** Ajoute une étiquette à l’axe avec la chaîne donnée.
...
**Syntaxe :** obj &lt;&lt; Add Ref Line( value, &lt;"Solid|Dashed|Double"&gt;, &lt;Color&gt;, &lt;"label"&gt;, &lt;line width&gt;, &lt;transparency&gt; )

**Description :** Ajoute une droite de référence à la grille à value.
...
**Syntaxe :** obj &lt;&lt; Axis Settings

**Description :** Permet d’ouvrir la boîte de dialogue des axes ou de définir les options de configuration des axes pour un axe donné.
...
**Syntaxe :** obj &lt;&lt; Copy Axis Settings

**Description :** Crée un script contenant les paramètres de l&apos;axe de référence, puis le place dans le presse-papiers.
...
**Syntaxe :** obj &lt;&lt; Custom Scale Name

**Description :** Nom de l&apos;échelle.
...
**Syntaxe :** obj &lt;&lt; Decimal( number )

**Description :** Définit le nombre de décimales des étiquettes numériques.
...
**Syntaxe :** obj &lt;&lt; Edit Value Order

**Description :** Ouvrir la propriété de colonne Valeurs ordonnées pour la modification.
...
**Syntaxe :** obj &lt;&lt; Edit Value Order Mode

**JMP Version ajoutée :** 16

### Format

**Syntaxe :** obj &lt;&lt; Format( "Meilleur"|"Décimale fixe"|"Pourcentage"|"P-value"|"Scientifique"|"Ingénierie"|"Ingénierie SI"|"Précision"|"Devise"|"m#j#a"|"mmjjaaaa"|"m#a"|"yyyyTt"|"j#m#a"|"jjmmaaaa"|"jjmoiaaaa"|"moijjaaaa"|"a#m#j"|"aaaammjj"|"aaaa-mm-jj"|"m#j#a h:m"|"m#j#a h:m:s"|"j#m#a h:m"|"j#m#a h:m:s"|"a#m#j h:m"|"a#m#j h:m:s"|"jjmoiaaaa h:m"|"jjmoiaaaa h:m:s"|"jjmoiaaaa:h:m"|"jjmoiaaaa:h:m:s"|"moijjaaaa h:m"|"moijjaaaa h:m:s"|"aaaa-mm-jjThh:mm"|"jj-mm-aaaaThh:mm:ss"|":jou:hh:m"|":jou:hh:m:s"|"hr:m"|"hr:m:s"|"min:s"|"h:m:s"|"h:m"|"Date longue"|"Date courte"|"Date locale"|"Date et heure locales h:m"|"Date et heure locales h:m:s" )

**Description :** Définit le format des étiquettes.
...
**Syntaxe :** obj &lt;&lt; Get Inc( number )

**Description :** Obtient la valeur d&apos;incrément de l’axe.
...
**Syntaxe :** obj &lt;&lt; Get Max( number )

**Description :** Obtient la valeur maximale de l’axe.
...
**Syntaxe :** obj &lt;&lt; Get Min( number )

**Description :** Obtient les valeurs minimales de l’axe.
...
**Syntaxe :** obj &lt;&lt; Get Minor Ticks( number )

**Description :** Obtient le nombre de petites graduations.
...
**Description :** Renvoie le script pour recréer la zone de l’axe.
...
**Syntaxe :** obj &lt;&lt; Inc( number )

**Description :** Définit la valeur de l’incrément sur l’axe.
...
**Description :** Affiche les marques de graduation à l’intérieur du cadre du graphique
...
**Syntaxe :** obj &lt;&lt; Interval( "Numérique"|"Année"|"Quartier"|"Mois"|"Semaine"|"Jour"|"Heure"|"Minute"|"Seconde" )

**Description :** Définit le format des étiquettes numériques.
...
**Syntaxe :** obj &lt;&lt; Label Row

### Label Row Nesting

**Syntaxe :** obj &lt;&lt; Label Row Nesting( number )

**Description :** Définit le nombre de lignes d&apos;étiquettes pour les axes de format de date
...
**Description :** Définit la couleur de ligne de la grande grille.
...
**Syntaxe :** obj &lt;&lt; Max( number )

**Description :** Définit la valeur maximale de l’axe.
...
**Syntaxe :** obj &lt;&lt; Min( number )

**Description :** Définit la valeur minimale de l’axe.
...
**Description :** Définit la couleur de ligne de la petite grille.
...
**Syntaxe :** obj &lt;&lt; Minor Ticks( number )

**Description :** Définit le nombre de marques de graduation à placer entre les étiquettes.
...
**Syntaxe :** obj &lt;&lt; Paste Axis Settings

**Description :** Le presse-papiers contient un script approprié aux paramètres de l&apos;axe de référence ; veuillez l&apos;appliquer.
...
**Syntaxe :** obj &lt;&lt; Remove Axis Label

**Description :** Supprime toutes les étiquettes ajoutées avec Ajouter une étiquette d&apos;axe de référence.
...
**Syntaxe :** obj &lt;&lt; Remove Ref Line( number )

**Description :** Supprime la droite de référence donnée.
...
**Syntaxe :** obj &lt;&lt; Reversed Scale

**Description :** Inverse le sens de l&apos;échelle normale de manière à ce que la valeur la plus élevée se trouve à gauche ou au fond.
...
**Syntaxe :** obj &lt;&lt; Revert Axis

**Description :** Rétablit les paramètres initiaux de l’axe (à partir de la date de création).
...
**Syntaxe :** obj &lt;&lt; Revert Scale

**Description :** Restaurer l&apos;échelle de l&apos;axe sans modifier les autres personnalisations
...
**Syntaxe :** obj &lt;&lt; Save To Column Property

**Description :** Enregistre les paramètres de l&apos;axe de référence comme une propriété de l&apos;axe dans la colonne de données associée à cet axe.
...
**Syntaxe :** obj &lt;&lt; Scale( "Modèle linéaire"|"Logarithme"|"Probabilité exponentielle"|"Probabilité de Weibull"|"Probabilité logistique"|"Probabilité de Frechet"|"Probabilité normale"|"Racine cubique"|"Su de Johnson"|"Géodésique"|"Géodésique américaine"|"Puissance"|"Probabilité Gamma"|"Probabilité Beta"|"Distribution de mélange de 2 normales"|"Distribution de mélange de 3 normales"|"Échelle personnalisée" )

**Description :** Indique le type d’échelle à appliquer sur l’axe. Si le type défini est Échelle personnalisée, ce message prévoit deux clauses supplémentaires ; voir Échelle log10 et Échelle réciproque de log10.
...
**Syntaxe :** obj &lt;&lt; Scale ID( number )

**Description :** Ajoutez un ID spécifique à l&apos;axe pour une utilisation avec plusieurs axes.
...
**Syntaxe :** obj &lt;&lt; Scale To External

**Description :** Met à l’échelle le système de coordonnées externes selon la formule personnalisée donnée.
...
**Syntaxe :** obj &lt;&lt; Scale To Internal

**Description :** Met à l’échelle le système de coordonnées internes selon la formule personnalisée donnée.
...
**Syntaxe :** obj &lt;&lt; Set Width( number )

**Description :** Définit la largeur de l’axe.
...
**Description :** Affiche(1) ou masque (0) les étiquettes d&apos;axe des grandes graduations. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Show Major Grid( state=0|1 )

**Description :** Affiche (1) ou masque (0) la grille placée à la même position que les étiquettes numériques.
...
**Syntaxe :** obj &lt;&lt; Show Major Labels( state=0|1 )
...
**Syntaxe :** obj &lt;&lt; Show Major Ticks( state=0|1 )

**Description :** Affiche (1) ou masque (0) les marques de graduation placées à la même position que les étiquettes numériques. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Show Minor Grid( state=0|1 )

**Description :** Affiche (1) ou masque (0) la grille placée entre les étiquettes numériques.
...
**Syntaxe :** obj &lt;&lt; Show Minor Labels( state=0|1 )

**Description :** Affiche(1) ou masque (0) les étiquettes d&apos;axe des petites graduations.
...
**Syntaxe :** obj &lt;&lt; Show Minor Ticks( state=0|1 )

**Description :** Affiche (1) ou masque (0) les marques de graduation placées entre les étiquettes numériques. Actif par défaut.
...
**Syntaxe :** &lt;X / Y&gt; Axis( Side ( &lt;1/2&gt; ) )

**Description :** Modifier le côté (primaire (1) ou secondaire (2)) de l&apos;axe
...
**Syntaxe :** obj &lt;&lt; Tick Font

**Description :** Définit la police des marques de graduation.
...
**Syntaxe :** obj &lt;&lt; Tick Label List

**Description :** Définit les valeurs et les positions des étiquettes de graduation
...
**Syntaxe :** obj &lt;&lt; Update Ref Line( ID, index, value, &lt;"Solid|Dashed|Double"&gt;, &lt;Color&gt;, &lt;"label"&gt;, &lt;line width&gt;, &lt;transparency&gt; )

**Description :** Modifie une ligne de référence existante.
