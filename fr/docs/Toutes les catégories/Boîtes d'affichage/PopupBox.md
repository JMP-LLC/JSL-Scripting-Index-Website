...
**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsqu&apos;un nouvel élément est sélectionné dans la zone pop-up.
