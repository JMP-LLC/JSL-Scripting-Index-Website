...
**Description :** Renvoie une boîte d’affichage contenant une hiérarchie de chaînes.
...
**Syntaxe :** obj &lt;&lt; Above( "string" )

**Description :** Insère une nouvelle chaîne au-dessus la boîte de la hiérarchie appelante.
...
**Syntaxe :** obj &lt;&lt; After( "string" )

**Description :** Insère une nouvelle chaîne après la boîte de la hiérarchie appelante.
...
**Syntaxe :** obj &lt;&lt; Before( "string" )

**Description :** Insère une nouvelle chaîne avant la boîte de la hiérarchie appelante.
...
**Syntaxe :** obj &lt;&lt; Below( "string" )

**Description :** Insère une nouvelle chaîne au-dessous la boîte de la hiérarchie appelante.
...
**Syntaxe :** obj &lt;&lt; Change Type( "Arête de poisson"|"Hiérarchique"|"Imbriqué" )

**Description :** Définit le style de la boîte de la hiérarchie.
...
**Description :** Masque tous les enfants sous la boîte de la hiérarchie donnée.
...
**Description :** Supprimer la boîte de la hiérarchie.
...
**Syntaxe :** obj &lt;&lt; Direction( 0|1 )

**Description :** Établit comment doivent pointer les chaînes dans la boîte de la hiérarchie, à droite (1) ou à gauche (0).
...
**Description :** Place la boîte de la hiérarchie appelante en première position.
...
**Syntaxe :** obj &lt;&lt; Force Alternate

**Description :** Alterne la boîte de la hiérarchie appelante avec la boîte sœur.
...
**Syntaxe :** obj &lt;&lt; Force Down

**Description :** Place la boîte de la hiérarchie appelante en bas.
...
**Syntaxe :** obj &lt;&lt; Force Left

**Description :** Place la boîte de la hiérarchie appelante sur la gauche.
...
**Syntaxe :** obj &lt;&lt; Force Right

**Description :** Place la boîte de la hiérarchie appelante sur la droite.
...
**Syntaxe :** obj &lt;&lt; Force Up

**Description :** Place la boîte de la hiérarchie appelante en haut.
...
**Syntaxe :** obj &lt;&lt; Horizontal

**Description :** Pivoter le texte à l’horizontale en partant à gauche.
...
**Description :** Place la boîte de la hiérarchie appelante en dernière position.
...
**Syntaxe :** obj &lt;&lt; Lean( 0|1 )

**Description :** Établit comment doivent pencher les chaînes dans la boîte de la hiérarchie, à droite (1) ou à gauche (0).
...
**Description :** Crée une nouvelle table de données contenant les chaînes de la boîte de la hiérarchie .
...
**Syntaxe :** obj &lt;&lt; Other Side

**Description :** Place la boîte de la hiérarchie appelante du côté opposé aux autres boîtes de la hiérarchie.
...
**Syntaxe :** obj &lt;&lt; Override Descendant Padding( state=0|1 )

**Description :** Cela est vrai si tous les descendants utilisent la même configuration de remplissage prévue.
...
**Syntaxe :** obj &lt;&lt; Pad Current Node( state=0|1 )

**Description :** Cela est vrai si nous appliquons la configuration de remplissage recommandée au nœud actif.
...
**Syntaxe :** obj &lt;&lt; Rotate Left

**Description :** Pivoter le texte à la verticale en partant par le bas.
...
**Syntaxe :** obj &lt;&lt; Rotate Right

**Description :** Pivoter le texte à la verticale en partant par le haut.
...
**Syntaxe :** obj &lt;&lt; Siblings Horizontal Pad( number )

**Description :** Il s&apos;agit du remplissage habituel entre les boîtes de hiérarchie.
...
**Syntaxe :** obj &lt;&lt; Siblings Total Pad( number )

**Description :** Il s&apos;agit du remplissage vertical entre les boîtes de hiérarchie sœurs et leur boîte parent.
...
**Syntaxe :** obj &lt;&lt; Siblings Vertical Pad( number )

**Description :** Il s&apos;agit du remplissage entre les boîtes de la hiérarchie pivotées de 90 degrés.
...
**Syntaxe :** obj &lt;&lt; Text Wrap Width( width )

**Description :** Spécifie la largeur possible de chaque chaîne avant de commencer une nouvelle ligne.
...
**Syntaxe :** obj &lt;&lt; Uneditable( state=0|1 )

**Description :** Si activé (1), vous pouvez cliquer sur les chaînes à l&apos;aide de la souris pour les modifier.
