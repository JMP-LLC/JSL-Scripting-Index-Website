...
**Description :** Renvoie une boîte d’affichage adaptée à un tableau formé d&apos;une ou de plusieurs colonnes.
...
**Syntaxe :** obj &lt;&lt; Add Row( {values,...} )

**Description :** Ajoute une ligne de données à la table.
...
**Syntaxe :** obj &lt;&lt; Bootstrap( nsample, Random Seed(number), Fractional Weights(0|1), Split Selected Column(0|1), Discard Stacked Table if Split Works(0|1) )

**Description :** Bootstrap cette analyse : en la répétant à de nombreuses reprises avec différents poids de rééchantillonnage et en rassemblant les tableaux tels qu’ils sont sélectionnés.
...
**Syntaxe :** obj &lt;&lt; Copy Selected Table Rows

**Description :** Copier le contenu des lignes sélectionnées dans le presse-papiers

**JMP Version ajoutée :** 15

### Copy Table

**Syntaxe :** obj &lt;&lt; Copy Table

**Description :** Copier le contenu de la table de données dans le presse-papiers

**JMP Version ajoutée :** 15

### Delete Row

**Syntaxe :** obj &lt;&lt; Delete Row( row number )

**Description :** Supprime une ligne de données de la table.
...
**Syntaxe :** obj &lt;&lt; Filter Where

**Description :** Filtre les lignes de la table de données en fonction des valeurs de cette ligne.
...
**Description :** Renvoie les entrées de la table de données sous forme de liste.
...
**Syntaxe :** obj &lt;&lt; Get As Matrix( &lt;"Visible"&gt; )

**Description :** Renvoie les entrées numériques de la table de données sous forme de matrice.  Si l’option Visible est spécifiée, seules les colonnes visibles seront incluses.
...
**Syntaxe :** font = obj &lt;&lt; Get Base Data Font
...
**Syntaxe :** font = obj &lt;&lt; Get Base Title Font
...
**Syntaxe :** 0|1 = obj &lt;&lt; Get Click Sort

**Description :** 1 si la table peut être triée avec un simple clic sur l&apos;en-tête de colonne, 0 dans le cas contraire
...
**Syntaxe :** obj &lt;&lt; Get Column Borders( state=0|1 )

**Description :** Renvoie 1 si les bordures de colonnes sont en cours de traçage
...
**Syntaxe :** obj &lt;&lt; Get Column Group Borders( state=0|1 )
...
**Syntaxe :** 0|1|-1 = obj &lt;&lt; Get Context Menu Item State( index )
...
**Syntaxe :** list = obj &lt;&lt; Get Context Menu Script

**Description :** Renvoie le script du menu contextuel joint à l’objet appelant.
...
**Syntaxe :** obj &lt;&lt; Get Context Menu Submenu( index )

**Description :** Renvoie le nombre de sous-menus présents sous l&apos;élément de menu donné
...
tb << Set Context Menu Script(
	{"A", Print( "A" ), "B", Print( "B" ), "B1", Print( "B1" ), "B2", Print( "B2" ),
	"B3", Print( "B3" ), "C", Print( "C" )}
);
...
**Syntaxe :** obj &lt;&lt; Get Data Font Name
...
**Syntaxe :** obj &lt;&lt; Get Data Font Scale
...
**Syntaxe :** obj &lt;&lt; Get Data Font Size
...
**Syntaxe :** obj &lt;&lt; Get Data Font Style
...
**Syntaxe :** obj &lt;&lt; Get Heading Column Borders( state=0|1 )

**Description :** Renvoie 1 si les en-têtes de colonne du tableau ont actuellement des bordures
...
**Syntaxe :** obj &lt;&lt; Heading Underline Color( color );color = obj &lt;&lt; Get Heading Underline Color
...
**Syntaxe :** obj &lt;&lt; Get Locked Columns

**Description :** Nombre de colonnes qui ne peuvent pas être glissées à l’aide du curseur manuel ou devant lesquelles des colonnes ont été déposées.
...
**Syntaxe :** obj &lt;&lt; Get Names

**Description :** Renvoie une liste de noms de colonnes
...
**Syntaxe :** obj &lt;&lt; Row Border Color( color );color = obj &lt;&lt; Get Row Border Color
...
**Syntaxe :** obj &lt;&lt; Get Row Borders( state=0|1 )

**Description :** Renvoie 1 si les bordures sont tracées au-dessus et au-dessous de chaque ligne
...
**Syntaxe :** obj &lt;&lt; Get Row Change Function

**Description :** Renvoie l’expression évaluée lors de la sélection d’une colonne.
...
**Syntaxe :** obj &lt;&lt; Row Height Scale( number );number = obj &lt;&lt; Get Row Height Scale

**Description :** Met à l&apos;échelle la hauteur par défaut ou les lignes d&apos;une table de données. La valeur par défaut est 1.
...
**Syntaxe :** obj &lt;&lt; Row Vertical Alignment( "Haut"|"Centre"|"Référence de base"|"Bas" );"Haut"|"Centre"|"Référence de base"|"Bas" = obj &lt;&lt; Get Row Vertical Alignment

**Description :** Définit l&apos;alignement vertical du texte ou des nombres dans les lignes d&apos;une table de données
...
**Syntaxe :** obj &lt;&lt; Get Selectable Rows

**Description :** Renvoie la valeur vraie si la boîte de la table permet actuellement la sélection de ligne
...
**Syntaxe :** obj &lt;&lt; Get Selected Row Color

**Description :** Obtient la couleur de fond des lignes sélectionnées
...
**Description :** Renvoie une matrice des numéros de ligne sélectionnés.
...
**Syntaxe :** obj &lt;&lt; Get Shade Alternate Rows( state=0|1 )

**Description :** Renvoie 1 si toutes les autres lignes sont ombrées
...
**Syntaxe :** obj &lt;&lt; Get Shade Cells( state=0|1 )

**Description :** Renvoie 1 si le fond de la cellule du tableau est ombré
...
**Syntaxe :** obj &lt;&lt; Get Shade Headings( state=0|1 )

**Description :** Renvoie 1 si les en-têtes de colonne du tableau sont actuellement ombrées
...
**Syntaxe :** obj &lt;&lt; Get Title Font Name
...
**Syntaxe :** obj &lt;&lt; Get Title Font Scale
...
**Syntaxe :** obj &lt;&lt; Get Title Font Size
...
**Syntaxe :** obj &lt;&lt; Get Title Font Style
...
**Syntaxe :** obj &lt;&lt; Get Underline Headings( state=0|1 )

**Description :** Renvoie 1 si les en-têtes de colonne sont soulignées
...
**Syntaxe :** obj &lt;&lt; Group By Column( &lt;column index or title&gt;, &lt;ascending=0|1&gt; )

**Description :** Regroupe toutes les lignes ayant la même valeur et trie la table de données en fonction de ces groupes. L&apos;ordre de tri par défaut est décroissant.
...
**Syntaxe :** obj &lt;&lt; Insert Row( row number, {values,...} )

**Description :** Insère une ligne de données à la table.
...
**Syntaxe :** obj &lt;&lt; Make Combined Data Table

**Description :** Crée une table de données qui recherche également dans le rapport des tables de données ayant les mêmes colonnes et combine le tout dans une nouvelle table de données.
...
**Syntaxe :** obj &lt;&lt; Make Into Data Table( &lt;Invisible(bool) | Private(bool)&gt; )

**Description :** Crée une nouvelle table de données contenant les valeurs du tableau croisé TableBox.
...
**Syntaxe :** obj &lt;&lt; Reorder Columns( from column index,to column index )

**Description :** Réorganise la colonne qui positionne l’indice de la colonne de départ from column index à la place de l’indice de la colonne de destination to column index.
...
**Description :** Efface un message « filtrer où » existant et affiche toutes les lignes de la table de données.
...
**Syntaxe :** obj &lt;&lt; Reset Style

**Description :** Rétablit le style de tableau d&apos;après les paramètres de préférence
...
**Description :** Sélectionne les lignes de la table de données en fonction des valeurs de cette ligne.
...
**Syntaxe :** obj &lt;&lt; Set Base Data Font( "Texte"|"En-tête"|"Titre"|"Petit"|"Mono"|"Éditeur de formules"|"Annotation"|"Axe"|"Marqueur"|"Titre de l&apos;axe"|"Étiquette du graphique"|"Légende"|"Titre du graphique"|"Légende"|"Table de données"|"Étiquette de survol" )
...
**Syntaxe :** obj &lt;&lt; Set Base Title Font( "Texte"|"En-tête"|"Titre"|"Petit"|"Mono"|"Éditeur de formules"|"Annotation"|"Axe"|"Marqueur"|"Titre de l&apos;axe"|"Étiquette du graphique"|"Légende"|"Titre du graphique"|"Légende"|"Table de données"|"Étiquette de survol" )
...
**Syntaxe :** obj &lt;&lt; Set Cell Changed Function( Function({thisBox, col box, row}, &lt;script&gt;;) )

**Description :** Définit une fonction qui est appelée toutes les fois qu&apos;un utilisateur modifie une cellule dans une colonne du tableau
...
**Syntaxe :** obj &lt;&lt; Set Click Sort( &lt;state=0|1&gt; )

**Description :** Autorise le triage de la table de données en cliquant simplement sur l&apos;en-tête de colonne
...
**Syntaxe :** obj &lt;&lt; Set Column Borders( state=0|1 )

**Description :** Tracer une bordure sur les deux côtés de chaque colonne
...
**Syntaxe :** obj &lt;&lt; Set Column Group Borders( state=0|1 )
...
**Syntaxe :** obj &lt;&lt; Set Context Menu Item State( index, 0|1|-1 )

**Description :** Définit l&apos;élément du menu contextuel à l’indice index comme normal (0), sélectionné (1) ou désactivé (-1).
...
**Syntaxe :** obj &lt;&lt; Set Context Menu Script( {"string",script,"string",script, ...} )

**Description :** Ajoute un menu contextuel à la boîte avec les options et les scripts spécifiés.
...
**Syntaxe :** obj &lt;&lt; Set Context Menu Submenu( index, submenu count )

**Description :** Transforme l’élément de menu "index" en un sous-menu avec des éléments de menu "dénombrement de sous-menu"
...
**Syntaxe :** obj &lt;&lt; Set Data Font( fontName, &lt;size&gt;, &lt;"bold italic underline strikeout"&gt;, &lt;angle&gt; )
...
**Syntaxe :** obj &lt;&lt; Set Data Font Name( fontname )
...
**Syntaxe :** obj &lt;&lt; Set Data Font Scale( f )
...
**Syntaxe :** obj &lt;&lt; Set Data Font Size( n )
...
**Syntaxe :** obj &lt;&lt; Set Data Font Style( style )
...
**Syntaxe :** obj &lt;&lt; Set Heading Column Borders( state=0|1 )

**Description :** Bordures des colonnes en en-têtes
...
**Syntaxe :** obj &lt;&lt; Set Locked Columns( number )

**Description :** Verrouille les n premières colonnes de sorte qu&apos;elles ne peuvent pas être glissées à l’aide du curseur manuel et qu’aucune autre colonne ne peut être déposée devant elles.
...
**Syntaxe :** obj &lt;&lt; Set Row Borders( state=0|1 )

**Description :** Tracer une brodure au-dessus et en-dessous de chaque ligne
...
**Syntaxe :** obj &lt;&lt; Set Row Change Function( Function( {thisBox}, &lt;script&gt; ) )

**Description :** Définit l’expression évaluée lors de la sélection d’une colonne.
...
**Syntaxe :** obj &lt;&lt; Set Scrollable( rows, columns )

**Description :** Active ou désactive le déroulement de la table de données TableBox.
...
**Syntaxe :** obj &lt;&lt; Set Selectable Rows( state=0|1 )

**Description :** Rend les lignes de la table de données TableBox sélectionnables ou pas.
...
**Syntaxe :** obj &lt;&lt; Set Selected Row Color( color )

**Description :** Définit la couleur de fond des lignes sélectionnées, valide uniquement si l’option "Définir les lignes sélectionnées" est sélectionnée
...
**Syntaxe :** obj &lt;&lt; Set Selected Rows( row matrix )

**Description :** Sélectionne les lignes données et désélectionne les autres.
...
**Syntaxe :** obj &lt;&lt; Set Shade Alternate Rows( state=0|1 )

**Description :** Ombrer le fond de toute autre ligne du tableau
...
**Syntaxe :** obj &lt;&lt; Set Shade Cells( state=0|1 )

**Description :** Ombrer le fond de chaque cellule du tableau
...
**Syntaxe :** obj &lt;&lt; Set Shade Headings( state=0|1 )

**Description :** Ombrer le fond des en-têtes de colonne
...
**Syntaxe :** obj &lt;&lt; Set Title Font( fontName, &lt;size&gt;, &lt;"bold italic underline strikeout"&gt;, &lt;angle&gt; )
...
**Syntaxe :** obj &lt;&lt; Set Title Font Name( fontname )
...
**Syntaxe :** obj &lt;&lt; Set Title Font Scale( f )
...
**Syntaxe :** obj &lt;&lt; Set Title Font Size( n )
...
**Syntaxe :** obj &lt;&lt; Set Title Font Style( style )
...
**Syntaxe :** obj &lt;&lt; Set Underline Headings( state=0|1 )

**Description :** Tracer une bordure au-dessous de l&apos;en-tête de colonne
...
**Syntaxe :** obj &lt;&lt; Simulate( nsample, Random Seed(number), Out(column), In(column), Update(&lt;columns&gt;) )

**Description :** Réalise une simulation en échangeant une colonne avec une autre colonne contenant une formule de simulation.
...
**Syntaxe :** obj &lt;&lt; Sort By Column( &lt;column index or title&gt;, &lt;ascending=0|1&gt; )

**Description :** Trie toutes les lignes de la table en fonction des valeurs de la colonne donnée. L&apos;ordre de tri est descendant par défaut.
