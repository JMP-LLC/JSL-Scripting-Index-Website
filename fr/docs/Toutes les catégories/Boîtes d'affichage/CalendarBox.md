...
**Syntaxe :** obj &lt;&lt; Date( number );number = obj &lt;&lt; Get Date

**Description :** La date actuellement sélectionnée sur le calendrier.
...
**Syntaxe :** obj &lt;&lt; Max Date( number );number = obj &lt;&lt; Get Max Date

**Description :** Définir la date maximum. Le contrôle calendaire se limitera aux sélections dans la plage appropriée.
...
**Syntaxe :** obj &lt;&lt; Min Date( number );number = obj &lt;&lt; Get Min Date

**Description :** Définir la date minimum. Le contrôle du calendrier se limitera aux sélections dans la plage appropriée.
...
**Syntaxe :** obj &lt;&lt; Show Time( state=0|1 );state = obj &lt;&lt; Get Show Time

**Description :** Sélectionner une heure en plus d&apos;une date.
...
**Syntaxe :** obj &lt;&lt; Set Function( Function( {thisBox, date}, &lt;script&gt; ) )

**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsque l&apos;utilisateur clique sur une date. date est la date actuellement sélectionnée.
