...
**Syntaxe :** obj &lt;&lt; Format( element, Format( format, &lt;options&gt; ) )

**Description :** Définit le format pour l&apos;élément CrossTabBox donné
...
**Description :** Renvoie une matrice des valeurs contenues dans le tableau croisé CrossTabBox.
...
**Description :** Crée une nouvelle table de données contenant les valeurs du tableau croisé CrossTabBox.
