...
**Description :** Renvoie une boîte d&apos;affichage affichant une arborescence hiérarchique. Par défaut, il est possible de sélectionner un seul élément. Si l&apos;option multisélection est spécifiée, il est possible de sélectionner plusieurs éléments de l&apos;arborescence.
...
**Syntaxe :** obj &lt;&lt; Add Root( node )

**Description :** Ajouter un nœud racine à l&apos;arborescence
...
**Syntaxe :** obj &lt;&lt; Collapse( node )

**Description :** Réduire le nœud dans l’arborescence.
...
**Syntaxe :** obj &lt;&lt; Enable Item( node, 0|1 )

**Description :** Activer ou désactiver le nœud de l&apos;arborescence. Définir l&apos;état à 1 pour activer le nœud, à 0 pour le désactiver.
...
**Syntaxe :** obj &lt;&lt; Expand( node )

**Description :** Développer le nœud dans l’arborescence.
...
**Syntaxe :** script = obj &lt;&lt; Get Context Menu Script

**Description :** Renvoie le script, la fonction ou la méthode exécutée lorsque l&apos;utilisateur clique à l&apos;aide du bouton droit sur une arborescence ou sur un nœud d&apos;arborescence.
...
tree << Set Context Menu Script(
	Function( {thistree, thisnode},
		If( Is Empty( thisnode ),
			{  /*Whole Tree Menu*/ {"Tree Menu", "",
			Function( {tree, node}, /*dont use node*/
				Print( "Tree one" )
...
**Syntaxe :** script = obj &lt;&lt; Get Node Double Click Script

**Description :** Renvoie le script, la fonction ou la méthode qui s&apos;exécute lorsqu&apos;un nœud fait l&apos;objet d&apos;un double clic.
...
**Syntaxe :** obj &lt;&lt; Get Node Select Script( script|Function( {thistree, thisnode}, &lt;script&gt; ) )

**Description :** Renvoie le script, la fonction ou la méthode qui s&apos;exécute lorsque la sélection change dans l&apos;arborescence.
...
**Syntaxe :** obj &lt;&lt; Get Roots

**Description :** Obtenir la liste des nœuds racine d&apos;arborescence. S&apos;il n&apos;existe aucun nœud racine, une liste vide est renvoyée.
...
**Description :** Dans une arborescence à sélection unique, obtient le nœud d&apos;arborescence sélectionné ou renvoie la valeur vide si aucun nœud n&apos;a été sélectionné. Dans une arborescence à sélection multiple, obtient la liste des nœuds sélectionnés ou renvoie la valeur vide si aucun nœud n&apos;a été sélectionné.
...
**Syntaxe :** collapsed = obj &lt;&lt; Is Collapsed( node )

**Description :** Renvoie la valeur Vrai si le nœud est réduit dans l’arborescence.
...
**Syntaxe :** expanded = obj &lt;&lt; Is Expanded( node )

**Description :** Renvoie la valeur Vrai si le nœud est développé dans l’arborescence.
...
**Syntaxe :** enabled = obj &lt;&lt; Is Item Enabled( node )

**Description :** Renvoie la valeur Vrai si le nœud est activé dans l’arborescence.
...
**Syntaxe :** obj &lt;&lt; Is Multiselect

**Description :** Renvoie 1 si l&apos;arborescence est à sélection multiple, 0 si l&apos;arborescence est à sélection unique.
...
**Syntaxe :** obj &lt;&lt; Is Root( node )

**Description :** Renvoie la valeur Vrai si le nœud est un nœud racine dans l’arborescence.
...
**Syntaxe :** selected = obj &lt;&lt; Is Selected( node )

**Description :** Renvoie la valeur Vrai si le nœud est sélectionné dans l’arborescence.
...
**Syntaxe :** obj &lt;&lt; Make Visible( node )

**Description :** Affiche le nœud dans l’arborescence.
...
**Syntaxe :** obj &lt;&lt; Remove Root( node )

**Description :** Supprimer un nœud racine de l&apos;arborescence
...
**Syntaxe :** obj &lt;&lt; Set Context Menu Script( Function( {thistree, thisnode}, &lt;script&gt; ) )

**Description :** Définissez le script, la fonction ou la méthode à exécuter lorsque l&apos;utilisateur clique à l&apos;aide du bouton droit sur une arborescence ou sur un nœud d&apos;arborescence.
...
**Syntaxe :** obj &lt;&lt; Set Multiselect( state=0|1 )

**Description :** Définissez l&apos;arborescence à sélection unique (0) ou à sélection multiple (1).
...
**Syntaxe :** obj &lt;&lt; Set Node Double Click Script( script )

**Description :** Définissez le script, la fonction ou la méthode à exécuter lorsqu&apos;un nœud fait l&apos;objet d&apos;un double clic.
...
**Syntaxe :** obj &lt;&lt; Set Node Select Script( script|Function( {thistree, thisnode}, &lt;script&gt; ) )

**Description :** Définissez le script, la fonction ou la méthode à exécuter lorsque la sélection change dans l&apos;arborescence. Le script reçoit la valeur Vide si la sélection a été annulée
...
**Syntaxe :** obj &lt;&lt; Set Roots( roots )

**Description :** Définir la liste des nœuds racine montrés dans l&apos;arborescence.
...
**Syntaxe :** obj &lt;&lt; Set Selected( node|{nodes}, &lt;0|1&gt; )

**Description :** Sélectionne le nœud d&apos;arborescence donné dans la boîte d&apos;affichage de l&apos;arborescence. Si vous donnez une liste de nœuds d&apos;arborescence, dans les arborescences à sélection multiple tous les nœuds de la liste seront sélectionnés alors que dans les arborescences à sélection unique, seul le premier nœud de la liste sera sélectionné.
...
**Description :** Définit la largeur et la hauteur de la boîte.
