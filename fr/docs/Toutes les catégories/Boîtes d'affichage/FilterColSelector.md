...
**Syntaxe :** obj << None( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes avec un type de modélisation &apos;aucun&apos;.
...
**Syntaxe :** obj << Character( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes de type caractère.
...
**Syntaxe :** obj << Continuous( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes de valeurs continues.
...
**Syntaxe :** obj << Expression( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes d&apos;expression.
...
**Syntaxe :** obj << Match case( (0 | 1) )

**Description :** La recherche des colonnes est sensible à la casse ou pas.
...
**Syntaxe :** obj << Multiple Response( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes à réponses multiples.
...
**Syntaxe :** obj << Name contains( Name contains( s ) )

**Description :** Lister uniquement les colonnes dont les noms contiennent le texte donné.
...
**Syntaxe :** obj << Name ends with( Name ends with ( text ) )

**Description :** Lister uniquement les colonnes dont les noms se terminent par le texte donné.
...
**Syntaxe :** obj << Name starts with( Name starts with ( text ) )

**Description :** Lister uniquement les colonnes dont les noms commencent par le texte donné.
...
**Syntaxe :** obj << Nominal( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes de valeurs nominales.
...
**Syntaxe :** obj << Numeric( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes de type numérique.
...
**Syntaxe :** obj << Ordinal( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes de valeurs ordinales.
...
**Description :** Rétablir la liste complète des colonnes.
...
**Syntaxe :** obj << Set Selected( index,<selected> )

**Description :** Définit l’élément à l’indice index devant être sélectionné (1) ou désélectionné (0).
...
**Syntaxe :** obj << Sort by name

**Description :** Trier la liste des colonnes par nom.
...
**Syntaxe :** obj << Unstructured Text( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes de texte non structuré.
...
**Syntaxe :** obj << Vector( (0 | 1) )

**Description :** Inclure ou exclure de la liste les colonnes de vecteur.
