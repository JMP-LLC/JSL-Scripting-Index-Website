...
**Description :** Renvoie une boîte d’affichage affichant une case à cocher pour chaque élément de la liste list saisie.
...
New Window( "Example",
	cb = Check Box(
		{"One", "Two", "Three"},
		Print(
			"Selected: " || Concat Items( cb << Get Selected(), ", " )
		)
	)
);
...
**Syntaxe :** obj &lt;&lt; Enable Item( index, 0|1 )

**Description :** Définit l’élément à l’indice index comme élément à activer (1) ou désactiver (0).
...
**Syntaxe :** 0|1 = obj &lt;&lt; Get( &lt;index&gt; )

**Description :** Renvoie si la case à cocher est cochée (1), décochée (0) ou non déterminé (empty()) pour les cases à cocher à trois états.
...
**Description :** Renvoie une liste des chaînes des éléments sélectionnés.
...
**Syntaxe :** obj &lt;&lt; Get Selected Indices
...
**Syntaxe :** indices = obj &lt;&lt; Get Selected Indices As Matrix
...
**Syntaxe :** obj &lt;&lt; Get Three State( &lt;Boolean&gt; )

**Description :** Crée une case à cocher à trois états. Tous les éléments sont 0, 1, ou empty().
...
**Syntaxe :** obj &lt;&lt; Set( &lt;index&gt;,&lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**Description :** Définit la case à cocher comme cochée (1) ou décochée (0). L&apos;utilisation de l&apos;option RunScript requiert également de spécifier l&apos;argument Boolean, car les arguments sont positionnels.
...
**Syntaxe :** obj &lt;&lt; Set All( &lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**Description :** Définit toutes les cases à cocher comme cochées (1) ou décochées (0). L&apos;utilisation de l&apos;option RunScript requiert également de spécifier l&apos;argument Boolean, car les arguments sont positionnels.
...
**Syntaxe :** obj &lt;&lt; Set Function( Function( {thisBox, index}, &lt;script&gt; ) )

**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsque l&apos;utilisateur clique sur une case à cocher.
...
**Syntaxe :** obj &lt;&lt; Set Three State( &lt;Boolean&gt; )
