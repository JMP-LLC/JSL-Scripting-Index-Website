...
**Description :** Définit la couleur de fond du texte.
...
**Syntaxe :** obj << Editable( state=0|1 )

**Description :** Si activé (1), vous pouvez cliquer sur le texte à l&apos;aide de la souris pour le modifier.
...
**Description :** Active ou désactive le texte écrit.
...
**Syntaxe :** obj << Fixed Size( state=0|1 )

**Description :** Si activée, respecte la taille d&apos;annotation définie par l&apos;utilisateur ; sinon, calcule la taille en fonction du contenu du texte.
...
**Syntaxe :** obj << Font( face,<size>,<style> )

**Description :** Définit la police du texte.
...
**Syntaxe :** font = obj << Get Font

**Description :** Renvoie la police du texte.
...
**Syntaxe :** color = obj << Get Text Color

**Description :** Renvoie la couleur du texte.
...
**Syntaxe :** 0|1 = obj << GetEditable

**Description :** Renvoie un message indiquant si le texte est modifiable.
...
**Syntaxe :** 0|1 = obj << GetFilled

**Description :** Renvoie un message indiquant si le texte est écrit.
...
**Syntaxe :** N|NE|E|SE|S|SW|W|NW = obj << GetOctant

**Description :** Renvoie la position où le texte a été placé.
...
**Syntaxe :** 0|1 = obj << GetTagLine

**Description :** Renvoie (1) si le slogan est activé ou (0) dans le cas contraire.
...
**Syntaxe :** obj << Justification( "string" )

**Description :** Définit la justification du texte
...
**Syntaxe :** obj << Minimized( state=0|1 )
...
**Syntaxe :** obj << Octant( <N|NE|E|SE|S|SW|W|NW> )

**Description :** Définit la position du texte dans la boîte d’affichage.
...
**Syntaxe :** obj << Tag Anchor

### Tag Line

**Syntaxe :** obj << Tag Line( state=0|1 )

**Description :** Ajoute une ligne partant du coin gauche supérieur de la boîte d’affichage jusqu’au texte
...
**Syntaxe :** obj << Text( "string" )

**Description :** Définit le texte comme étant la chaîne string.
...
**Syntaxe :** obj << Text Box( x1,y1,x2,y2 )

**Description :** Place le texte dans une boîte de texte.
