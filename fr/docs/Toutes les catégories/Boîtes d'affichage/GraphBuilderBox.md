...
**Syntaxe :** Graph Builder

**Description :** Composant interne du Constructeur de graphiques.
...
**Syntaxe :** obj &lt;&lt; Graph Margin( sides ); sides = obj &lt;&lt; Get Graph Margin

**Description :** La marge minimum autour de la zone du graphique, qui peut être rognée par les axes, la légende ou le titre.
...
**Syntaxe :** obj &lt;&lt; Scale Graph Margin( state=0|1 ); state = obj &lt;&lt; Get Scale Graph Margin

**Description :** Spécifie si les propriétés des marges du graphique doivent être mises à l&apos;échelle avec la taille du graphique appliquée.
...
**Syntaxe :** obj &lt;&lt; Graph Borders( color )
...
**Syntaxe :** obj &lt;&lt; Graph Spacing( color )

**Description :** Définit la largeur d&apos;espacement entre les panneaux du graphique.
...
**Description :** Définit la couleur de l&apos;espacement entre les panneaux du graphique.
...
**Syntaxe :** obj &lt;&lt; Graph Spacing Transparency( color )

**Description :** Définit la transparence de l&apos;espacement entre les panneaux du graphique.
