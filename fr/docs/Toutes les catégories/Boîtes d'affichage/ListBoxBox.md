...
**Syntaxe :** obj &lt;&lt; Enable Item( index,enable )

**Description :** Permet d’activer (1) ou de désactiver (0) l’élément placé à l’indice index.
...
**Syntaxe :** index = obj &lt;&lt; Get First Visible Item

**Description :** Renvoie l&apos;index du premier élément visible.
...
**Syntaxe :** 0|1 = obj &lt;&lt; Item Enabled( index )

**Description :** Renvoie (1) si l’élément à l’indice index est activé ou (0) dans le cas contraire.
...
**Syntaxe :** obj &lt;&lt; Set First Visible Item( index )

**Description :** Fait défiler la case de liste pour que l&apos;élément requis soit le premier élément visible.
...
**Syntaxe :** obj &lt;&lt; Show Item( index )

**Description :** Fait défiler la case de liste pour vérifier que l&apos;élément requis est visible dans la case de liste.
