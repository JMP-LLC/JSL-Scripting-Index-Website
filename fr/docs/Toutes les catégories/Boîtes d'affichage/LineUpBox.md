...
**Description :** Renvoie une boîte d’affichage qui organise avec ordre les boîtes d’affichage qui y sont contenues.
...
**Syntaxe :** obj << Get N Col

**Description :** Obtient le nombre de colonnes.
...
**Syntaxe :** pixels = obj << Get Spacing( number )

**Description :** Obtient le nombre de pixels qui doivent séparer les boîtes d’affichage.
...
**Syntaxe :** obj << NCol( number )

**Description :** Définit le nombre de colonnes.
...
**Syntaxe :** obj << Spacing( pixels )

**Description :** Définit le nombre de pixels qui doivent séparer les boîtes d’affichage.
...
**Syntaxe :** obj << Wrap When Printing

**Description :** L&apos;alignement procèdera aux ajustements nécessaires lors de l&apos;impression.
