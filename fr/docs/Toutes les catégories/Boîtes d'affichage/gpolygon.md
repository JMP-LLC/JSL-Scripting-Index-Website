...
**Syntaxe :** obj << Closed( state=0|1 )

**Description :** Si activé, le polygone présente automatiquement une partie interne même si les points initial et final ne correspondent pas.
...
**Description :** Définit la couleur du polygone.
...
**Description :** Active ou désactive un polygone plein.
...
**Description :** Définit les points d’extension du polygone.
...
**Syntaxe :** obj << Raised( state=0|1 )

**Description :** Active ou désactive un polygone en relief.
...
**Syntaxe :** obj << Smooth( state=0|1 )

**Description :** Active ou désactive un polygone lisse.
