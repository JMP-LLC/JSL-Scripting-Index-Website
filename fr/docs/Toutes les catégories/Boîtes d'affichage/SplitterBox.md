...
**Syntaxe :** obj &lt;&lt; Close Panel( index,&lt;previous&gt; )

**Description :** Fermer le panneau à l&apos;indice donné. Si l&apos;argument  estprevious 1, l&apos;espace est alloué dans la case précédente de la liste, autrement il est alloué dans la case suivante.
...
**Syntaxe :** obj &lt;&lt; Divider Color( color );color = obj &lt;&lt; Get Divider Color

**Description :** Spécifie ou renvoie la couleur de chaque ligne de division. Si elle n&apos;est pas définie, une couleur est utilisée en fonction de la couleur de fond.
...
**Syntaxe :** obj &lt;&lt; Divider Length( number );number = obj &lt;&lt; Get Divider Length

**Description :** Spécifie ou renvoie la longueur de chaque ligne de division sous forme de pourcentage. Une valeur de 0,0 indique une ligne de division invisible. Une valeur de 1,0 indique une ligne de division sur toute la longueur (par défaut).
...
**Syntaxe :** obj &lt;&lt; Divider Thickness( number );number = obj &lt;&lt; Get Divider Thickness

**Description :** Spécifie ou renvoie l&apos;épaisseur de ligne pour chaque ligne de division. Cette valeur ne peut pas être égale à zéro.
...
**Syntaxe :** {size1,...} = obj &lt;&lt; Get Sizes

**Description :** Renvoie les proportions de chaque panneau du Splitter Box.
...
**Syntaxe :** obj &lt;&lt; Open Panel( index,&lt;previous&gt; )

**Description :** Ouvrir le panneau à l&apos;indice donné. Si l&apos;argument  estprevious 1, l&apos;espace est pris de la boîte précédente de la liste, autrement il est pris de la boîte suivante.
...
**Syntaxe :** obj &lt;&lt; Set Sizes( {size1,...} )

**Description :** Définit les proportions de chaque panneau du Splitter Box.
...
**Syntaxe :** obj &lt;&lt; Size( size )

**Description :** Définit la proportion du dernier panneau du Splitter Box.
...
**Syntaxe :** state=0|1 = obj &lt;&lt; get horizontal

**Description :** Renvoie (1) si la liste est horizontale ou (0) si elle est verticale.
...
**Syntaxe :** obj &lt;&lt; set horizontal( state=0|1 )

**Description :** Définit l’orientation de la liste horizontale (1) ou verticale (0).
