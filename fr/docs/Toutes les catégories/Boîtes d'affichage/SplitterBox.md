...
**Syntaxe :** obj << Divider Color( color );

color = obj << Get Divider Color
...
**Syntaxe :** obj << Divider Length( number );

number = obj << Get Divider Length
...
**Syntaxe :** obj << Divider Thickness( number );

number = obj << Get Divider Thickness
