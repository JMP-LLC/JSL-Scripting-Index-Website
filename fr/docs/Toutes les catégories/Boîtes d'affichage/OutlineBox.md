...
**Description :** Renvoie une boîte d’affichage qui regroupent d’autres boîtes d’affichage.
...
**Syntaxe :** obj &lt;&lt; Add All Open Files( &lt;Menu(0,1)&gt; )

**Description :** Ouvre le menu pour ajouter tous les fichiers ouverts à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Add Context

**Description :** Paire clé-valeur pour les boîtes de structure qui ajoute une colonne pour la commande Construire une table de données combinée pour les tableaux

**JMP Version ajoutée :** 16

### Add Directory of Files

**Syntaxe :** obj &lt;&lt; Add Directory of Files

**Description :** Ouvre le menu pour ajouter un répertoire de fichiers à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Add File Reference

**Description :** Ouvre le menu pour ajouter une référence de fichier à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Add Open Files( &lt;Menu(0,1)&gt; )
...
**Syntaxe :** obj &lt;&lt; Add Outline Item

**Description :** Ouvre le menu pour ajouter un élément de la structure à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Add Script Button

**Description :** Ouvre le menu pour ajouter un bouton de script à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Add Text Item

**Description :** Ouvre le menu pour ajouter du texte à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Add URL Reference

**Description :** Ouvre le menu pour ajouter une adresse URL à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Add Window Reference

**Description :** Ouvre le menu pour ajouter une référence de fenêtre à la Boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Close( bool )

**Description :** Ferme la zone de structure.
...
**Syntaxe :** obj &lt;&lt; Close All Below

**Description :** Ferme tous les nœuds enfants du nœud.
...
**Syntaxe :** obj &lt;&lt; Close All Like This

**Description :** Ferme tous les nœuds similaires à cette zone de structure.
...
**Syntaxe :** obj &lt;&lt; Close Where No Outlines

**Description :** Ferme tous les nœuds n’ayant pas d’enfants.
...
**Syntaxe :** obj &lt;&lt; Edit Links

**Description :** Trouve tous les liens de fichiers dans les scripts des boutons de sorte à les modifier.

**JMP Version ajoutée :** 16

### Get Allow Title Wrapping

**Syntaxe :** 0|1 = obj &lt;&lt; Get Allow Title Wrapping( state=0|1 )

**Description :** Autorise le retour à la ligne des titres longs
...
**Syntaxe :** obj &lt;&lt; Get Close Orientation

**Description :** Renvoie le paramètre des boîtes de structure qui permet de réduire verticalement les boîtes de structure et gagner de l&apos;espace horizontal
...
**Syntaxe :** obj &lt;&lt; Get Image Export Display

**Description :** Obtenir l&apos;option permettant de supprimer le texte de contour lors de l&apos;enregistrement des images
...
**Syntaxe :** list = obj &lt;&lt; Get Menu Script

**Description :** Renvoie le script du menu joint à l’objet appelant.
...
ob << Set Menu Script(
	...
	"Get Menu Script", Print( ob << Get Menu Script )}
);
ob << Get Menu Script;
...
**Syntaxe :** scriptable object = obj &lt;&lt; Get Scriptable Object

**Description :** Renvoie une référence à l’objet scriptable de l’objet appelant.
...
**Syntaxe :** "string" = obj &lt;&lt; Get Title

**Description :** Obtient le titre de la zone de structure.
...
**Syntaxe :** obj &lt;&lt; Title Background Color( color );color = obj &lt;&lt; Get Title Background Color

**Description :** Si la couleur de fond est définie, le titre de structure est rempli de cette couleur avant que le contenu du titre ne soit dessiné. Si la couleur de fond est définie sur « Aucune », le fond et le contenu des boîtes contenantes sont visibles l&apos;un au travers de l&apos;autre.
...
**Syntaxe :** obj &lt;&lt; Title Border( sides );sides = obj &lt;&lt; Get Title Border

**Description :** Les bordures sont des lignes pleines dessinées tout autour d&apos;un titre de structure. Si vous spécifiez une seule valeur, celle-ci s&apos;applique à tous les côtés. Si vous spécifiez deux valeurs, elles sont appliquées aux bordures horizontales et verticales. Les bordures de titre sont relatives à l&apos;orientation du titre. Une structure fermée verticalement pivote la bordure et le contenu.
...
**Syntaxe :** obj &lt;&lt; Title Border Color( color );color = obj &lt;&lt; Get Title Border Color

**Description :** Couleur facultative pour remplacer la couleur par défaut des bordures de titre de structure.
...
**Syntaxe :** obj &lt;&lt; Title Padding( sides );sides = obj &lt;&lt; Get Title Padding

**Description :** Le remplissage de titre ajoute un espace entre le contenu du titre et la bordure du titre. Si une seule valeur est spécifiée, elle s&apos;applique à tous les côtés. Si deux valeurs sont spécifiées, elles sont appliquées aux remplissages horizontaux et verticaux. Le remplissage de titre est relatif à l&apos;orientation du titre. Une structure fermée verticalement pivote le remplissage et le contenu.
...
**Syntaxe :** obj &lt;&lt; Title Text Color( color );color = obj &lt;&lt; Get Title Text Color

**Description :** Le texte du titre de structure est écrit dans la couleur donnée si celle-ci a été définie. Dans le cas contraire, le titre hérite la couleur de texte de la boîte contenante.
...
**Syntaxe :** obj &lt;&lt; GetHorizontal

**Description :** Renvoie 1 si les enfants de la boîte de structure sont orientés horizontalement, 0 dans le cas contraire.
...
**Description :** Renvoie 1 si la boîte de structure est ouverte, 0 si elle est fermée.
...
**Syntaxe :** obj &lt;&lt; Horizontal( bool )

**Description :** Aligne à l&apos;horizontale les enfants de la boîte de structure.
...
**Syntaxe :** obj &lt;&lt; Image Export Display( "Normal"|"Texte uniquement"|"Aucun" )

**Description :** Option permettant de supprimer le texte de contour lors de l&apos;enregistrement des images
...
**Description :** Si la boîte de structure fait partie d&apos;un journal, déverrouille le journal afin de permettre des modifications ultérieures. Les journaux sont verrouillables en cliquant à l&apos;aide du bouton droit de la souris dans la zone de la marge.

**JMP Version ajoutée :** 16

### Lock Title

**Syntaxe :** obj &lt;&lt; Lock Title( state=0|1 )

**Description :** Verrouiller le titre de la structure pour empêcher les modifications interactives.
...
**Syntaxe :** obj &lt;&lt; Open All Below

**Description :** Ouvre tous les nœuds enfants du nœud.
...
**Syntaxe :** obj &lt;&lt; Open All Like This

**Description :** Ouvre tous les nœuds similaires à cette zone de structure.
...
**Syntaxe :** obj &lt;&lt; Set Allow Title Wrapping( 0|1 )
...
**Syntaxe :** obj &lt;&lt; Set Menu Script( {"string",script,"string",script, ...} )

**Description :** Ajoute une entrée au menu lorsque vous cliquez sur le triangle rouge.
...
ob << Set Menu Script(
	{"Beep", Beep(), "Beep Twice", Beep() ; Wait( 1.0 ) ; Beep() ; , "", 0,
	"Get Menu Script", Print( ob << Get Menu Script )}
);
...
**Syntaxe :** obj &lt;&lt; Set Scriptable Object( &lt;scriptable object&gt; )

**Description :** Définit l’objet scriptable associé à l’objet appelant. L&apos;objet appelant affichera un menu triangle rouge avec les messages qui peuvent être envoyés à l&apos;objet scriptable. Si aucun argument n&apos;est fourni, l&apos;objet scriptable sera annulé.
...
**Syntaxe :** obj &lt;&lt; Set Submenu( index, submenu count )
...
**Syntaxe :** obj &lt;&lt; Set Title( "string", &lt;Run Script(0 | 1)&gt; )

**Description :** Modifie le titre de la zone de structure.
...
**Syntaxe :** obj &lt;&lt; Set Title Changed

**Description :** Définir un script qui s&apos;exécute quand le titre de la structure est modifié.
...
**Syntaxe :** obj &lt;&lt; SetHorizontal( state=0|1 )
...
**Syntaxe :** obj &lt;&lt; SetOpen( state=0|1 )

**Description :** Ouvre ou ferme la structure.
...
**Syntaxe :** obj &lt;&lt; Size to Fit

**Description :** Garder la taille de la fenêtre ajustée au contenu.
