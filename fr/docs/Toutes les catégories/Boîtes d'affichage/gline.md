...
**Description :** Définit la couleur du trait.
...
**Syntaxe :** obj &lt;&lt; Dashed( state=0|1 )

**Description :** Active ou désactive une ligne en pointillés.
...
**Syntaxe :** obj &lt;&lt; Point from( state=0|1 )

**Description :** Dessine (1) ou supprime (0) une flèche en début de ligne.
...
**Syntaxe :** obj &lt;&lt; Point to( state=0|1 )

**Description :** Dessine (1) ou supprime (0) une flèche en fin de ligne.
...
**Syntaxe :** obj &lt;&lt; Thick( state=0|1 )

**Description :** Dessine une ligne épaisse (1) ou fine (0).
