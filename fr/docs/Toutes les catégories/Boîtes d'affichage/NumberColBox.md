...
**Description :** Renvoie une boîte d’affichage affichant les nombres dans une colonne.
...
**Syntaxe :** obj &lt;&lt; Align Decimal Separator( state=0|1 )

**Description :** Permet de spécifier que les valeurs dans la colonne soient alignées verticalement au niveau du séparateur décimal.
...
**Syntaxe :** obj &lt;&lt; Enable Semantic Formats( state=0|1 )

**Description :** Contrôle si les formats sémantiques sont appliqués à la colonne. Les formats sémantiques peuvent également être contrôlés dans les préférences.
...
**Syntaxe :** obj &lt;&lt; Get Align Decimal Separator

**Description :** Renvoie 1 si la colonne aligne les valeurs au niveau du séparateur décimal, 0 sinon.
...
**Syntaxe :** format = obj &lt;&lt; Get Conditional Format

**Description :** Renvoie le format conditionnel.
...
**Syntaxe :** obj &lt;&lt; Get Effective Format( &lt;row&gt; )

**Description :** Renvoie le format effectif de la colonne, c&apos;est-à-dire le format après avoir appliqué un format sémantique d&apos;appariement. Si row est donné, renvoie le format effectif pour cette ligne uniquement.
...
**Syntaxe :** obj &lt;&lt; Get Enable Semantic Formats

**Description :** Renvoie le paramètre Activer les formats sémantiques pour la colonne. Les formats sémantiques peuvent également être contrôlés dans les préférences.
...
**Syntaxe :** width,&lt;decimalplaces&gt; = obj &lt;&lt; Get Format

**Description :** Renvoie le format actuel (width, decimalplaces). A decimalplaces > 100 indique les valeurs de date/d&apos;heure.
...
**Syntaxe :** obj &lt;&lt; Hide Missing Values( state=0|1 )

**Description :** Les valeurs manquantes ne seront pas affichées lorsque défini sur 1
...
**Syntaxe :** obj &lt;&lt; Set Conditional Format( "Correlation"|"PValue"|"Factor Pattern" )

**Description :** Définit le format conditionnel.
...
**Syntaxe :** obj &lt;&lt; Set Format( "format", &lt;width, &lt;decimal places&gt;&gt;, &lt;"Use thousands separator"&gt; )

**Description :** Définissez le format des nombres à afficher.
...
**Syntaxe :** obj &lt;&lt; Set Values( matrix )

**Description :** Remplace les valeurs de NumberColBox par les valeurs fournies.
