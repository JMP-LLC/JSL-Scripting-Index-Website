...
**Syntaxe :** New Data Box

**Description :** Crée un affichage de la table de données dans une arborescence de boîtes d&apos;affichage. Remplace la table de données active par la table de données spécifiée.
...
**Syntaxe :** obj &lt;&lt; Close Data Grid( state=0|1 )

**Description :** Fermez ou ouvrez la grille de la table de données.
...
**Syntaxe :** obj &lt;&lt; Close Side Panels( state=0|1 )
...
**Syntaxe :** obj &lt;&lt; Close summary panels( state=0|1 )
...
**Syntaxe :** obj &lt;&lt; Get Close Data Grid

**Description :** Renvoie l&apos;état fermé de la grille de la table de données.
...
**Syntaxe :** obj &lt;&lt; Get Close Side Panels

**Description :** Renvoie l&apos;état fermé des panneaux latéraux de la table de données.
...
**Syntaxe :** obj &lt;&lt; Get Close Summary Panels

**Description :** Renvoie l&apos;état fermé des panneaux de résumé de la table de données.
...
**Description :** renvoie la table de données de cette boîte d&apos;affichage
...
**Syntaxe :** obj &lt;&lt; Set Data Table( dt )

**Description :** définit la table de données de cette boîte d&apos;affichage
...
**Description :** Affichez ou masquez les icônes de filtre sur les colonnes dans la vue filtrée actuelle.
