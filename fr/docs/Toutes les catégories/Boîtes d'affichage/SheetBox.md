...
**Description :** Renvoie une boîte d&apos;affichage dans laquelle d’autres boîtes peuvent être disposées horizontalement ou verticalement.
...
**Syntaxe :** obj &lt;&lt; Hold( element )

**Description :** Spécifie quel est l’élément que la feuille SheetBox doit contenir.
...
**Description :** Définit la largeur si la feuille SheetBox est disposée horizontalement, la hauteur autrement.
...
**Syntaxe :** obj &lt;&lt; Sizes( {width,height} )

**Description :** Définit la largeur et la hauteur de la feuille SheetBox.
