...
**Description :** Renvoie une boîte d’affichage avec des pages qui contiennent d’autres boîtes d’affichage.
...
**Syntaxe :** obj &lt;&lt; Add(&lt;index&gt;,"title",contents);obj &lt;&lt; Add(&lt;index&gt;,tabPageBox)

**Description :** Ajoute un nouvel onglet. Si aucun index n&apos;est spécifié, l&apos;onglet est inséré à la suite des onglets actuels. Si le contenu à ajouter n&apos;est pas un Tab Page Box, alors un nouvel Tab Page Box sera ajouté pour accueillir le contenu.
...
**Syntaxe :** obj &lt;&lt; Delete( &lt;index&gt; )

**Description :** Supprime le tableau à l’index index.  Si aucun index index n’est spécifié, le tableau sélectionné est supprimé.
...
**Syntaxe :** obj &lt;&lt; DockName( text )

### Dockable

**Syntaxe :** obj &lt;&lt; Dockable( bool )

**Description :** Si un conteneur est ancrable, les enfants déplaçables peuvent être réorganisés avec l&apos;option glisser-déposer.
			...
			Tab Page Box(
				...
				log = Logistic(
					...
					SendToReport(
						...
						Dispatch( {}, "Parameter Estimates", OutlineBox,
							{Close( 1 )}
						)
					)
				),
...
**Syntaxe :** obj &lt;&lt; Get DockName

### Get Dockable

**Syntaxe :** bool = obj &lt;&lt; Get Dockable

**Description :** Renvoie le paramètre ancrable de la zone de conteneur.
...
**Syntaxe :** obj &lt;&lt; Get Min Title Width

**Description :** Obtenez la largeur minimale des titres d&apos;onglet tronqués lorsque Overflow Enabledest défini. Le paramètre par défaut de 0 appliquera une largeur minimum par défaut.
...
**Syntaxe :** obj &lt;&lt; Get Overflow Enabled

**Description :** Lorsque Overflow Enabled est 1, la liste d&apos;onglets ne sera pas dimensionnée de la largeur des titres d&apos;onglets. Si la liste d&apos;onglets n&apos;est pas assez large pour tous les titres, un menu de dépassement s&apos;affichera pour permettre la sélection d&apos;un nouvel onglet.
...
**Syntaxe :** index = obj &lt;&lt; Get Selected

**Description :** Renvoie l’onglet actuellement sélectionné.
...
**Syntaxe :** obj &lt;&lt; Get Show Tabs

**Description :** Obtenir l’état actuel de la visibilité du tableau
...
**Description :** Obtenir l’aspect visuel actuel du contrôle du tableau.
...
**Syntaxe :** obj &lt;&lt; Get Tab Changed

**Description :** Renvoie le script exécuté lors de la sélection d’un tableau différent.
...
**Syntaxe :** obj &lt;&lt; Get Tab Close

**Description :** Renvoie le script qui est exécuté lorsqu&apos;un onglet est fermé depuis un script ou à l&apos;aide de l&apos;icône de fermeture. Le script doit renvoyer 1 pour autoriser la fermeture ou 0 pour l&apos;annuler.
...
**Syntaxe :** "string" = obj &lt;&lt; Get Tab Close Tip

**Description :** Renvoie l&apos;info-bulle de l&apos;icône Fermer l&apos;onglet.
...
**Syntaxe :** count = obj &lt;&lt; Get Tab Count

**Description :** Renvoie le nombre de tableaux.
...
**Syntaxe :** all | horizontal,vertical | left,top,right,bottom = obj &lt;&lt; Get Tab Margin

**Description :** Renvoie la marge des tableaux.
...
**Syntaxe :** obj &lt;&lt; Get Tab New

**Description :** Renvoie le script qui est exécuté lorsque vous cliquez sur l&apos;onglet Nouveau. Le script doit créer le nouvel onglet.
...
tb << Set Tab New(
	Function( {this},
		this << Add( "New Tab", Button Box( "Press" ) )
	)
);
tb << Get Tab New();
...
**Syntaxe :** "string" = obj &lt;&lt; Get Tab New Icon

**Description :** Renvoie l&apos;icône de l&apos;onglet Nouveau.
...
**Syntaxe :** "string" = obj &lt;&lt; Get Tab New Tip

**Description :** Renvoie l&apos;info-bulle de l&apos;onglet Nouveau.
...
**Syntaxe :** style = obj &lt;&lt; Get Title Location

**Description :** Obtenez le paramètre actuel de position du titre.
...
**Syntaxe :** index = obj &lt;&lt; Index of Tab( "string" )

**Description :** Renvoie l’index du tableau ayant le titre spécifié.
...
**Syntaxe :** obj &lt;&lt; Insert(&lt;index&gt;,"title",contents);obj &lt;&lt; Insert(&lt;index&gt;,tabPageBox)

**Description :** Insère un nouvel onglet. Si aucun index n&apos;est spécifié, le nouvel onglet est inséré à la suite des onglets actuels. Si le contenu à ajouter n&apos;est pas un Tab Page Box, alors un nouvel Tab Page Box sera ajouté pour accueillir le contenu.
...
**Syntaxe :** obj &lt;&lt; Move Tab( fromIndex, toIndex )

**Description :** Déplacer l&apos;onglet en position fromIndex à la position toIndex.
...
**Syntaxe :** obj &lt;&lt; Replace(&lt;index&gt;,"title",contents);obj &lt;&lt; Replace(&lt;index&gt;,tabPageBox)

**Description :** Remplace l&apos;onglet. Si aucun index n&apos;est spécifié, l&apos;onglet sélectionné est remplacé. Si le contenu à ajouter n&apos;est pas un Tab Page Box, alors un nouvel Tab Page Box sera ajouté pour accueillir le contenu.
...
**Syntaxe :** obj &lt;&lt; Set Min Title Width( number )

**Description :** Définissez la largeur minimum des titres d&apos;onglet tronqués lorsque Overflow Enabled est défini. Le paramètre par défaut de 0 appliquera une largeur minimum par défaut.
...
**Syntaxe :** obj &lt;&lt; Set Overflow Enabled( state=0|1 )

**Description :** Lorsque Overflow Enabled est vrai, la liste d&apos;onglets ne sera pas dimensionnée de la largeur des titres d&apos;onglets. Si la liste d&apos;onglets n&apos;est pas assez large pour tous les titres, un menu de dépassement s&apos;affichera pour permettre la sélection d&apos;un nouvel onglet. Cette option n&apos;est disponible que si le style est défini sur Tab.
...
**Syntaxe :** obj &lt;&lt; Set Selected( index )

**Description :** Amène le focus sur le tableau à l’index index.
...
**Syntaxe :** obj &lt;&lt; Set Style( "Tabulation"|"Combo"|"Structure"|"Étalement"|"Étalement horizontal"|"Réduire la taille" )

**Description :** Modifie l’aspect visuel du contrôle du tableau.
...
**Syntaxe :** obj &lt;&lt; Set Tab Changed( script|Function( {this}, &lt;script&gt; ) )

**Description :** À la suite d’une modification (la sélection d’un nouvel onglet, par exemple), le script ou la function spécifié(e) est exécuté(e).
...
**Syntaxe :** obj &lt;&lt; Set Tab Close( script|Function )

**Description :** Définir le script ou la Function à exécuter lorsqu&apos;un onglet est fermé depuis un script ou à l&apos;aide de l&apos;icône de fermeture. Le script ou la Function doit renvoyer 1 pour permettre la fermeture ou 0 pour l&apos;annuler.
...
**Syntaxe :** obj &lt;&lt; Set Tab Close Tip( "string" )

**Description :** Définit l&apos;info-bulle de l&apos;icône Fermer l&apos;onglet.
...
**Syntaxe :** obj &lt;&lt; Set Tab Margin( all | horizontal,vertical | left,top,right,bottom )

**Description :** Définit la marge des tableaux.  Les paramètres entrés peuvent être appliqués à tous les côtés, aux dimensions horizontales et verticales, ou des valeurs différentes pour chaque côté.
...
**Syntaxe :** obj &lt;&lt; Set Tab New( script|Function( {this}, &lt;script&gt; ) )

**Description :** Définit le script ou la Function à exécuter lorsque vous cliquez sur l&apos;onglet Nouveau. Le script ou la function doit créer le nouvel onglet.
...
**Syntaxe :** obj &lt;&lt; Set Tab New Icon( "string" )

**Description :** Définit l&apos;icône du nouvel onglet.
...
**Syntaxe :** obj &lt;&lt; Set Tab New Tip( "string" )

**Description :** Définit l&apos;info-bulle de l&apos;onglet Nouveau.
...
**Syntaxe :** obj &lt;&lt; Set Title Location( "Auto"|"Haut"|"Bas"|"Gauche"|"Droite" )

**Description :** Définissez la position des titres des pages d&apos;onglet. Avec le paramètre « Auto », la position est choisie automatiquement selon la taille du contenu. Cette option n&apos;est disponible que si le style est défini sur Tabbed.
...
**Syntaxe :** obj &lt;&lt; Show Tabs( state=0|1 )

**Description :** Affiche ou masque les tableaux.
