...
**Description :** Renvoie une boîte d’affichage contenant une liste déroulante d&apos;éléments texte. Pour chaque élément dans la zone combinée, une infobulle peut être spécifiée comme une chaîne entre parenthèses à la suite de la chaîne de l&apos;élément. L&apos;argument facultatif Editable autorise l&apos;édition du texte combiné.
...
**Syntaxe :** obj << Append Item( string )

**Description :** Ajoute une nouvelle chaîne à la fin de la liste des éléments de la zone de liste déroulante.
...
**Description :** Définit l’élément à l’indice index comme sélectionnable (1) ou non sélectionnable (0).
...
**Syntaxe :** index = obj << Get

**Description :** Renvoie l’indice de l’élément sélectionné.
...
**Description :** Renvoie une chaîne de l’élément sélectionné.
...
**Syntaxe :** obj << Insert Item( string, <position> )

**Description :** Insérer une nouvelle chaîne à la fin de la liste, ou à la place indiquée par la position facultative.
...
**Description :** Renvoie (1) si l’élément à l’indice index est sélectionnable ou (0) dans le cas contraire.
...
**Syntaxe :** obj << Set( index,<run script(0|1)> )

**Description :** Définit la zone de liste déroulante de l’élément à l’indice donné.
...
**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsqu&apos;un nouvel élément de la zone combinée est sélectionné.
