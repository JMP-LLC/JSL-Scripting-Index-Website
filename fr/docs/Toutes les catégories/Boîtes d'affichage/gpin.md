...
**Syntaxe :** obj << Add Text( "string" )

**Description :** Ajoute un bloc de texte personnalisé à l&apos;étiquette de survol épinglée.
...
**Syntaxe :** obj << Click Link( "<index, integer>" )

**Description :** Simule un clic sur le lien associé au texte donné ou à l&apos;index, le cas échéant. Dans le cas contraire, suppose que le dernier lien, qui est habituellement le graphlet, est présent.
...
frame << Set Gridlet(
	Annex(
		{{Matcher( "My Link" ), value( "Click Me!" ),
		click( Web( "https://jmp.com" ) )}}
	)
);
gpin = frame << Add Pin Annotation(
	Seg( BarSeg( 1 ) ),
...
**Description :** Ferme l&apos;étiquette de survol.
...
**Syntaxe :** "string" = obj << Copy

**Description :** Copie le contenu de l&apos;étiquette de survol dans le presse-papiers. 

Si l&apos;opération est assignée à une variable, le contenu texte de l&apos;étiquette de survol est enregistré dans cette variable.
...
**Description :** Supprime l’annotation qui se trouve au haut de la boîte d’affichage.
...
**Syntaxe :** obj << Deleteable

**Description :** Permet d’éliminer "supprimer" du menu contextuel
...
**Description :** Lance un éditeur visuel pour les contenus de l&apos;étiquette de survol.
...
**Syntaxe :** obj << Filled( state=0|1 )

### Font

**Syntaxe :** obj << Font

**Description :** Définit la police de l&apos;étiquette de survol épinglée.
...
**Syntaxe :** obj << Get Links

**Description :** Renvoie une liste du texte associé aux entrées cliquables dans l&apos;étiquette de survol. 

Les images et les graphlets sont associés à une chaîne vide
...
**Syntaxe :** Associative Array = obj << Get Local Context

**Description :** Renvoie un tableau associatif avec les noms et les valeurs des variables locales fournies dans le contexte d&apos;exécution de l&apos;étiquette de survol.

Consulte les définitions prédéfinies de graphlet pour obtenir des exemples d&apos;utilisation.
...
**Syntaxe :** obj << Launch graphlet

**Description :** Lance la visualisation du graphlet ou la plate-forme dans une nouvelle fenêtre.

Le lanceur ou le contenu précédent peuvent être récupérés avec une commande Annuler.

La même fonctionnalité est obtenue en cliquant sur la miniature du graphlet.
...
**Syntaxe :** obj << Launch in last

**Description :** Lance la visualisation du graphlet ou la plate-forme dans une nouvelle fenêtre ou dans la dernière fenêtre lancée et remplace le contenu de celle-ci.

Le lanceur ou le contenu précédent peuvent être récupérés avec une commande Annuler.

La même fonctionnalité est obtenue avec un Alt-clic sur la miniature du graphlet.
...
**Syntaxe :** obj << Launch in place

**Description :** Lance la visualisation du graphlet ou la plate-forme dans la fenêtre actuelle et remplace le contenu de celle-ci.

Le lanceur ou le contenu précédent peuvent être récupérés avec une commande Annuler.

La même fonctionnalité est obtenue avec un Ctrl-clic sur la miniature du graphlet.
...
**Syntaxe :** obj << Reanchor

### Replace Text

**Syntaxe :** obj << Replace Text( "string" )

**Description :** Remplace le contenu texte de l&apos;étiquette de survol épinglée par le texte donné.
...
**Syntaxe :** obj << Revert Text

**Description :** Rétablit le contenu texte de l&apos;étiquette de survol épinglée à son texte d&apos;origine.
...
**Description :** Lance une table de données avec un filtre de données locales qui affiche uniquement le sous-ensemble des données associées à l&apos;élément visuel sous l&apos;étiquette de survol.
...
**Syntaxe :** obj << Tag Line( state=0|1 )
...
**Syntaxe :** obj << Unanchor

### Use Gradient

**Syntaxe :** obj << Use Gradient( state=0|1 )
