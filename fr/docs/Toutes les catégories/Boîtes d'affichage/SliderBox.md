...
**Description :** Renvoie une boîte d’affichage avec un curseur de contrôle allant de  à . minValuemaxValueLorsque la position du curseur change, sa valeur est placée dans  et le script est exécutévariable.
...
**Syntaxe :** float = obj &lt;&lt; Get( &lt;index&gt; )

**Description :** Renvoie la valeur à virgule flottante à laquelle le curseur est défini.
...
**Syntaxe :** bool = obj &lt;&lt; Get Log Scale

**Description :** Renvoie (1) si l&apos;échelle du curseur est logarithmique, (0) si l&apos;échelle est linéaire
...
**Syntaxe :** float = obj &lt;&lt; Get Max( &lt;index&gt; )

**Description :** Renvoie la valeur maximale à laquelle le curseur peut être défini.
...
**Syntaxe :** float = obj &lt;&lt; Get Min( &lt;index&gt; )

**Description :** Renvoie la valeur minimale à laquelle le curseur peut être défini.
...
**Syntaxe :** float = obj &lt;&lt; Get N

**Description :** Renvoie le nombre de curseurs contenus dans la boîte de curseurs SliderBox.
...
**Syntaxe :** string = obj &lt;&lt; Get Var

**Description :** Renvoie le nom de variable associé au curseur.
...
**Description :** Obtient la largeur du curseur.
...
**Syntaxe :** obj &lt;&lt; Rescale Slider( min,max )

**Description :** Définit les valeurs minimales et maximales que le curseur doit accepter
...
**Syntaxe :** obj &lt;&lt; Set( float, &lt;index&gt;,&lt;run script(0|1)&gt; )

**Description :** Définit la valeur à virgule flottante du curseur.
...
**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsque le curseur change.
...
**Syntaxe :** obj &lt;&lt; Set Log Scale( 0|1 )

**Description :** Définit le curseur sur une échelle logarithmique (1) ou linéaire (0)
...
**Syntaxe :** obj &lt;&lt; Set Max( float, &lt;index&gt; )

**Description :** Définit la valeur maximale à laquelle le curseur peut être défini.
...
**Syntaxe :** obj &lt;&lt; Set Min( float, &lt;index&gt; )

**Description :** Définit la valeur minimale à laquelle le curseur peut être défini.
...
**Syntaxe :** string = obj &lt;&lt; Set Var

**Description :** Définit le nom de variable associé au curseur.
...
**Description :** Définit la largeur du curseur.
