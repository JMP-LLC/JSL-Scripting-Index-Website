...
**Description :** Renvoie une boîte d’affichage contenant une zone de script.
...
**Syntaxe :** obj &lt;&lt; Append Text( text )

**Description :** Ajoute le texte donné à la fin du script.
...
**Syntaxe :** obj &lt;&lt; Collapse All

**Description :** Réduit toutes les sections pliables des contenus de la zone de script.
...
**Syntaxe :** obj &lt;&lt; Expand All

**Description :** Étend toutes les sections réduites des contenus de la zone de script.
...
**Syntaxe :** obj &lt;&lt; Get Cursor Line

**Description :** Renvoie la ligne sur laquelle le curseur se trouve actuellement.
...
**Syntaxe :** obj &lt;&lt; Get Cursor Position

**Description :** Renvoie la position actuelle du curseur.
...
**Syntaxe :** obj &lt;&lt; Get Line Count

**Description :** Renvoie le nombre de lignes de la zone de script.
...
**Syntaxe :** obj &lt;&lt; Get Line Text( line number )

**Description :** Renvoie le texte au numéro de ligne donné.
...
**Syntaxe :** obj &lt;&lt; Get Lines

**Description :** Renvoie tout le texte présent dans la fenêtre du script sous forme d’une liste de chaînes, une ligne par chaîne.
...
**Syntaxe :** obj &lt;&lt; Get Selection Width

**Description :** Renvoie la largeur actuelle de la sélection.
...
**Syntaxe :** obj &lt;&lt; Get Show Empty Scrollbars( state=0|1 )

**Description :** Renvoie une valeur booléenne qui indique si les barres de défilement horizontales et verticales s&apos;affichent même si elles ne sont pas nécessaires
...
**Syntaxe :** obj &lt;&lt; Get Show Scrollbars

**Description :** Renvoie une liste de deux éléments indiquant si les barres de défilement horizontales et verticales sont affichées
...
**Syntaxe :** obj &lt;&lt; Read Only( state=0|1 )

**Description :** Si le résultat est vrai (1), le texte contenu dans la zone de script n’est pas modifiable.
...
**Syntaxe :** obj &lt;&lt; Reformat

**Description :** Met en forme le script de manière à en faciliter la lecture.
...
**Syntaxe :** obj &lt;&lt; Set Cursor Position( position )

**Description :** Définit la position du curseur sur la position fournie.
...
**Syntaxe :** obj &lt;&lt; Set Line Text( line number, text )

**Description :** Définit le texte au numéro de ligne donné.
...
**Syntaxe :** obj &lt;&lt; Set Selection Width( width )

**Description :** Définit la largeur de la sélection sur la largeur fournie.
...
**Syntaxe :** obj &lt;&lt; Set Show Empty Scrollbars( state=0|1 )

**Description :** Si vrai (1), les barres de défilement horizontales ou verticales s&apos;affichent même si elles ne sont pas nécessaires
...
**Syntaxe :** obj &lt;&lt; Set Show Scrollbars( state=0|1 )

**Description :** Spécifie si les barres de défilement horizontales et verticales sont affichées
...
**Description :** Remplace le texte actuel de la zone de script par le texte donné.
...
**Syntaxe :** obj &lt;&lt; Show Embedded Log( state=0|1 )

**Description :** Activer/désactiver le log incorporé.
...
**Syntaxe :** obj &lt;&lt; Show Line Numbers( state=0|1 )

**Description :** Affiche et masque les numéros de ligne sur le côté gauche de la zone de script
