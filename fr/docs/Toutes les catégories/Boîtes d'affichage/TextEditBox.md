...
**Description :** Renvoie une boîte d’affichage contenant un texte éditable.
...
**Syntaxe :** obj &lt;&lt; Bullet point( state=0|1 )

**Description :** Dessine une puce qui précède le texte.
...
**Syntaxe :** obj &lt;&lt; Enable( state=0|1 )

**Description :** Établit si la TextEditBox est éditable.
...
**Syntaxe :** obj &lt;&lt; Fixed Size( state=0|1, &lt;width&gt;, &lt;height&gt; )

**Description :** Si cet outil est activé, la zone de texte TextBox ne s’agrandit pas si la largeur du texte est supérieure à la largeur de la zone TextBox.
...
**Syntaxe :** bullet = obj &lt;&lt; Get Bullet

**Description :** Renvoie une valeur indiquant si le caractère de la puce est tracé avant le texte.
...
**Description :** Obtenir la fonction exécutée après avoir édité le texte.
...
**Syntaxe :** 0|1 = obj &lt;&lt; Get Hidden State( state=0|1 )
...
**Syntaxe :** "string" = obj &lt;&lt; Get Hint

**Description :** Texte de conseil affiché lorsque la zone de texte est vide.
...
**Syntaxe :** justify = obj &lt;&lt; Get Justify

**Description :** Aligne le texte à gauche, à droite ou au centre.
...
**Syntaxe :** rotation = obj &lt;&lt; Get Rotation

**Description :** Renvoie la rotation du texte.
...
**Description :** Renvoie le contenu chaîne de la zone.
...
**Syntaxe :** function = obj &lt;&lt; Get Text Changed

**Description :** Renvoie la fonction qui est exécutée à chaque modification apportée au texte.
...
**Syntaxe :** "string" = obj &lt;&lt; Get Tip

**Description :** Renvoie l&apos;info-bulle de la boîte Text Box.
...
**Description :** Renvoie la largeur de la TextBox.
...
**Syntaxe :** obj &lt;&lt; Get Wrap

**Description :** Renvoie le point de retour chariot en pixels.
...
**Syntaxe :** obj &lt;&lt; Hide( state=0|1 )

**Description :** Affiche ou masque le texte.
...
**Syntaxe :** obj &lt;&lt; Is Enabled( state=0|1 )
...
**Syntaxe :** obj &lt;&lt; Justify Text( "Gauche"|"Centre"|"Droite" )
...
**Syntaxe :** obj &lt;&lt; Markup( state=0|1 )

**Description :** Indique que le texte peut contenir une balise HTML et devrait être interprété. Les balises HTML prises en charge sont gras (<b></b>), italique (<i></i>), souligné (<u></u>), police de caractères (<font face=&apos;&apos;></font>), couleur de police (<font color=&apos;&apos;></font>), taille de police (<font size=&apos;&apos;></font> et couleur de fond (<background color=&apos;&apos;></background>). Pour la couleur de police et de fond, vous pouvez spécifier la couleur par nom (bleu), par triplet hexadécimal, spécifié dans la syntaxe HTML (#0000ff), ou au format hexadécimal (0x0000ff). Si un nom spécifie une couleur, il utilise la définition JMP de la couleur.
...
**Syntaxe :** obj &lt;&lt; Password Style( state=0|1 )

**Description :** Si activé, la TextEditBox affiche ***** à la place des mots de passe.
...
**Syntaxe :** obj &lt;&lt; Preprocess Markup( state=0|1 )

**Description :** Indique que le texte doit être prétraité pour remplacer les balises JMP par des balises HTML correctement formatées.
...
**Description :** Restaure le contenu texte à sa valeur initiale.
...
**Syntaxe :** obj &lt;&lt; Rotate Text( left|right|horizontal )

**Description :** Fait pivoter le texte de 90 degrés vers la gauche ou vers la droite, ou le remet à l’horizontale.
...
**Syntaxe :** obj &lt;&lt; Set Script( script ) obj &lt;&lt; Script( script )

**Description :** Le script spécifié sera exécuté après avoir édité le texte.
...
**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsque la modification apportée dans la zone d&apos;édition de texte est prise en compte.
...
**Syntaxe :** obj &lt;&lt; Set Text( "string", &lt;Run Script(bool)&gt; )

**Description :** Modifie le contenu chaîne de la zone. Pour la zone d&apos;édition de texte, un argument Run Script(bool) facultatif définit si le script de la zone d&apos;édition de texte est exécuté lorsque Définir le texte s&apos;exécute. La valeur par défaut est 0 (n&apos;exécute pas le script).
...
**Syntaxe :** obj &lt;&lt; Set Text Changed( Function( {this, value}, &lt;script&gt; ) )

**Description :** Définit la function qui est exécutée à chaque modification apportée au texte. Ce rappel est appelé au cours de l&apos;édition, avant que la modification soit prise en compte. En cas d&apos;annulation de l&apos;opération Modifier, un rappel supplémentaire sera généré de sorte à transmettre la valeur d&apos;origine.
...
**Syntaxe :** obj &lt;&lt; Set Tip( text )

**Description :** Définit l&apos;info-bulle de la boîte Text Box.
...
**Description :** Définit la largeur de la TextBox.
...
**Syntaxe :** obj &lt;&lt; Set Wrap( n )

**Description :** Définit le point de retour chariot, en pixels (n).
...
**Syntaxe :** obj &lt;&lt; SetNLines( number )

**Description :** Définit le nombre de lignes de texte affichables.
...
**Syntaxe :** obj &lt;&lt; White Box Style( 0=ordinary text, 1=bordered white box entry field )

**Description :** Détermine si afficher le texte en tant que zone de saisie contenant le texte à l’intérieur d’une boîte blanche à bordure ou comme texte brut éditable par un simple clic
