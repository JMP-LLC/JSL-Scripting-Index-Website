...
**Description :** Renvoie une boîte d’affichage qui place une barre de défilement en bas et à droite si le contenu est plus grand que la taille de la  ScrollBox.
...
**Syntaxe :** obj &lt;&lt; Get Auto Scrollable

**Description :** Renvoie le paramètre Déroulement automatique.
...
**Syntaxe :** obj &lt;&lt; Get Clip Printing( state=0|1 )

**Description :** Renvoie le paramètre actuel de détourage du contenu de la boîte de défilement lors de l&apos;impression.
...
**Description :** Renvoie la couleur de fond.

### Get Height

**Syntaxe :** pixels = obj &lt;&lt; Get Height

**Description :** Renvoie la hauteur de la zone de défilement.

### Get Scroll Extents

**Syntaxe :** {h pixels,v pixels} = obj &lt;&lt; Get Scroll Extents

**Description :** Renvoie les positions maximales des défilements, horizontal et vertical.
...
**Syntaxe :** {h,v} = obj &lt;&lt; Get Scroll Position

**Description :** Renvoie les positions actuelles de défilement horizontal et vertical.
...
**Syntaxe :** {h,v} = obj &lt;&lt; Get Scrollers

**Description :** Renvoie les indicateurs de défilement horizontal et vertical. Si le défilement est désactivé dans une direction donnée, la boîte  se comporte comme un conteneur normal dans cette directionScroll Box.
...
**Syntaxe :** obj &lt;&lt; Get Show Empty

**Description :** Renvoie le paramètre actuel d&apos;affichage des barres de défilement lorsqu&apos;elles sont vides.
...
**Description :** Renvoie la largeur de la zone de défilement.

### Height

**Syntaxe :** obj &lt;&lt; Height( pixels )

**Description :** Définit la hauteur de la zone de défilement.
...
**Syntaxe :** obj &lt;&lt; Set Auto Scrollable( state=0|1 )

**Description :** Définir automatiquement les paramètres de défilement en fonction des propriétés d&apos;ajustement de la boîte enfant. La barre de défilement multidirectionnelle sera active si la boîte n&apos;est pas ajustable dans cette direction.
...
**Description :** Définit la couleur de fond de la zone de défilement à la couleur donnée.
...
**Syntaxe :** obj &lt;&lt; Set Clip Printing( state=0|1 )

**Description :** Le contenu de la boîte de défilement est détouré en fonction de la taille de la boîte lors de l&apos;impression, ou le contenu intégral est affiché. Le détourage est désactivé par défaut.
...
**Syntaxe :** obj &lt;&lt; Set Scroll Position( h,v )

**Description :** Définit les positions actuelles de défilement horizontal et vertical. Les valeurs peuvent être données en pixels ou à l&apos;aide des mots-clés « Start » et « End ».
...
**Syntaxe :** obj &lt;&lt; Set Scrollers( h,v )

**Description :** Définit les indicateurs de défilement horizontal et vertical. Si le défilement est désactivé dans une direction donnée, la boîte se comporte comme un conteneur normal dans cette directionScroll Box.
...
**Syntaxe :** obj &lt;&lt; Set Show Empty( state=0|1 )

**Description :** Affiche les barres de défilement même si elles sont vides.
...
**Description :** Définit la largeur de la zone de défilement.
