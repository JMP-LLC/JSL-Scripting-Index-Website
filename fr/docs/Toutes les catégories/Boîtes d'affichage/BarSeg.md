...
**Syntaxe :** Bar Seg( x, y, &lt; Row States( dt | dt,[rows] | dt,{{rows}, ...} | {states} ) &gt;, &lt; Sizes( s ) &gt; )

**Description :** Renvoie un seg représentant les données résumées sous forme de barres.
...
**Syntaxe :** proportion = obj &lt;&lt; Get Side by Side Overlap

**Description :** Renvoie la quantité de superposition des sous-éléments en style de barre « côte à côte ».
...
**Syntaxe :** proportion = obj &lt;&lt; Get Width Proportion

**Description :** Renvoie la proportion de la largeur de barre disponible pour le dessin. 0 signifie que les tailles sont automatiques. 1 signifie qu&apos;il n&apos;y a pas d&apos;espace.
...
**Syntaxe :** Set Label Offset {Bar Index, X Scale Coordinate, Y Scale Coordinate}

**Description :** Définit l&apos;offset de l&apos;étiquette de valeur d&apos;une barre à une coordonnée dans un graphe
	...
	SendToReport(
		Dispatch( {}, "Graph Builder", FrameBox,
			{DispatchSeg(
				...
				Set Label Offset(
					{1, 1.2639751552795, 110.634333333333}
				), Set Label Offset(
					{2, 2.14596273291925, 111.794833333333}
				), Set Label Offset( {3, 3.12732919254658, 116.05} ),
				Set Label Offset(
					{4, 4.17080745341615, 127.268166666667}
				)}
			)}
		)
	)
...
**Syntaxe :** obj &lt;&lt; Set Side by Side Overlap( proportion or missing )

**Description :** Définit la quantité de superposition des sous-éléments en style de barre « côte à côte », de 0 (pas de superposition) à 1 (superposition totale).
...
**Syntaxe :** obj &lt;&lt; Set Width Proportion( proportion )

**Description :** Définit la proportion de la largeur de barre disponible pour le dessin. 0 signifie que les tailles sont automatiques. 1 signifie qu&apos;il n&apos;y a pas d&apos;espace.
