...
**Syntaxe :** "Promise" = obj &lt;&lt; Execute Script

**Description :** Exécute de manière asynchrone le script Java donné dans le contexte de la page active. Renvoie une confiance pour le résultat du script (sous la forme d&apos;une chaîne)
...
**Syntaxe :** "URL" = obj &lt;&lt; Get URL

**Description :** Renvoie l’adresse URL URL à laquelle le navigateur a accédé.
...
**Syntaxe :** obj &lt;&lt; Navigate( "URL" )

**Description :** Permet de naviguer vers l’adresse URL spécifiée URL.
...
**Description :** Définit la largeur et la hauteur de la fenêtre du navigateur Internet. La fenêtre du Navigateur Internet a un paramètre d&apos;étirement par défaut de &apos;Window&apos; qui doit être changé en &apos;Off&apos; pour accepter la taille demandée.
