...
**Description :** Renvoie une boîte d’affichage contenant une matrice.
...
**Syntaxe :** obj &lt;&lt; Column Names( strings or list of strings )
...
**Description :** Contrôle si les formats sémantiques sont appliqués à la matrice. Les formats sémantiques peuvent également être contrôlés dans les préférences.
...
**Syntaxe :** matrix = obj &lt;&lt; Get

**Description :** Renvoie une liste qui représente la matrice.
...
**Description :** Renvoie 1 si les colonnes alignent les valeurs au niveau du séparateur décimal, 0 sinon.
...
**Syntaxe :** obj &lt;&lt; Get Effective Format( col, &lt;row&gt; )

**Description :** Renvoie le format effectif d&apos;une colonne, c&apos;est-à-dire le format après avoir appliqué un format sémantique d&apos;appariement. Si row est donné, renvoie le format effectif pour cette ligne uniquement.
...
Show(
	mb << Get Effective Format( 1 ),
	mb << Get Effective Format( 2 ),
	mb << Get Format
);
...
**Description :** Obtient le paramètre Activer les formats sémantiques de la matrice. Les formats sémantiques peuvent également être contrôlés dans les préférences.
...
**Syntaxe :** obj &lt;&lt; Get Format( width, decimalplaces )

**Description :** Renvoie la spécification de format actuelle.
...
**Syntaxe :** obj &lt;&lt; Make Combined Data Table( &lt;Invisible(bool)&gt; )

**Description :** Crée une table de données à partir de toutes les matrices similaires.
...
**Description :** Crée une nouvelle table de données contenant les valeurs de la Boîte matrice.
...
**Syntaxe :** obj &lt;&lt; Open( state=0|1 )

**Description :** Affiche ou masque les valeurs à l’intérieur de la Boîte matrice.
...
**Syntaxe :** obj &lt;&lt; Row Names( strings or list of strings )
...
**Syntaxe :** obj &lt;&lt; Set( matrix )

**Description :** Définir la matrice à partir d’une liste.
...
**Syntaxe :** obj &lt;&lt; Set Conditional Format( None|Correlation|PValue|Factor Pattern )

**Description :** Définit le format de données des valeurs de la matrice.
...
New Window( "Example",
	multi = Multivariate(
		Y(
			:Mass, :Fore, :Bicep, :Chest, :Neck, :Shoulder, :Waist, :Height, :Calf,
			:Thigh, :Head
		),
...
**Syntaxe :** obj &lt;&lt; Sort( column, ascending )

**Description :** Trie les lignes de la matrice en fonction de l&apos;une des colonnes. Si la valeur de colonne spécifiée 0, le tri est supprimé.
