...
**Syntaxe :** obj = Normal Mixtures(...&lt;By( column(s) )&gt;...)
...
**Syntaxe :** obj = Normal Mixtures(...Columns( column(s) )...)
...
**Syntaxe :** obj = Normal Mixtures(...&lt;Freq( column )&gt;...)
...
**Syntaxe :** obj = Normal Mixtures(...&lt;Weight( column )&gt;...)
...
**Syntaxe :** obj = Normal Mixtures(...Y( column(s) )...)
...
**Syntaxe :** obj &lt;&lt; Diagonal Variance( state=0|1 )

**Description :** Fait l’hypothèse que les covariances sont nulles et n’utilise que la diagonale de la matrice des variances-covariances pour les mélanges normaux.
...
**Syntaxe :** obj &lt;&lt; Mixtures MaxIter( number )

**Description :** Définit le nombre maximum d’itérations pour les mélanges normaux. La valeur par défaut est 300.
...
**Syntaxe :** obj &lt;&lt; Mixtures N Starts( number )

**Description :** Définit le nombre de fois où la méthode des mélanges normaux recommence à former des clusters. La valeur par défaut est 30. Cela est connu sous le nom de Tours dans le rapport Commandes avancées.
...
**Syntaxe :** obj &lt;&lt; Mixtures Tolerance( number )

**Description :** Définit le critère de convergence pour les mélanges normaux. La valeur par défaut est 1e-8. Cela est connu sous le nom de Critère de convergence dans le rapport Commandes avancées.
...
**Syntaxe :** obj &lt;&lt; Outlier Cluster( state=0|1 )

**Description :** Fournit un cluster supplémentaire avec distribution uniforme pour collecter les valeurs aberrantes. Ce cluster est désigné comme le Cluster 0.
...
**Syntaxe :** obj = Normal Mixtures(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj &lt;&lt; Save Density Formula

**Description :** Enregistre la formule de densité dans la table de données.
...
**Syntaxe :** obj &lt;&lt; Save Mixture Formulas
...
**Syntaxe :** obj &lt;&lt; Save Mixture Probabilities
