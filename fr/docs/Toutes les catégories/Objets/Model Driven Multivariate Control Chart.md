...
**Syntaxe :** obj &lt;&lt; Change Point Detection( state=0|1 )

**Description :** Affiche ou masque un graphique de détection de phase des statistiques de test par numéro de ligne et une matrice de graphiques de nuages de points.
...
**Syntaxe :** obj &lt;&lt; Diagnose the Process( state=0|1 )
...
**Syntaxe :** obj = Model Driven Multivariate Control Chart(...Historical Data End at Row( number )...)

**Description :** Le numéro de ligne spécifié divise les observations en données historiques et actives.
...
**Syntaxe :** obj &lt;&lt; Normalized DModX Plot( state=0|1 )

**Description :** Affiche ou masque un graphique des valeurs de la DModX normalisée. La DModX mesure la distance de chaque observation par rapport au modèle ACP ou PLS.
...
**Syntaxe :** obj &lt;&lt; Score Plot( state=0|1 )

**Description :** Affiche ou masque un graphique des scores des composantes principales ou des facteurs des moindres carrés partiels.
...
**Syntaxe :** obj &lt;&lt; Set Alpha Level( "0.01"|"0.05"|"0.10"|"0.50"|"Autre..." )

**Description :** Spécifie le niveau alpha utilisé pour calculer les limites de décision.
...
**Syntaxe :** obj &lt;&lt; Set Component( number )

**Description :** Vous permet de définir le nombre de composantes pour les graphiques T², DModX et SPE.
...
**Syntaxe :** obj &lt;&lt; Set α Level( "0.01"|"0.05"|"0.10"|"0.50"|"Autre..." )
...
**Description :** Affiche ou masque le rapport de taux d&apos;alarme.
...
**Description :** Affiche ou masque les lignes exclues sur les graphiques. Lorsque cette option est sélectionnée, les lignes exclues sont incluses dans le dénombrement des points hors contrôle, mais exclues des calculs numériques. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Show History Summary Statistics( state=0|1 )

**Description :** Affiche ou masque les statistiques de résumé contenant les valeurs propres, les loadings des composantes principales, et les moyennes et écarts-types des variables du processus. Les moyennes et écarts-types sont calculés à partir des données historiques et utilisés pour calculer les scores des composantes principales, le T-carré, l&apos;erreur quadratique de prévision (SPE) et les statistiques DModX pour les données actives.
...
**Syntaxe :** obj &lt;&lt; Show Monitoring Plots( state=0|1 )

**Description :** Affiche ou masque les graphiques de surveillance des processus sélectionnés.
...
**Syntaxe :** obj &lt;&lt; Squared Prediction Error Plot( state=0|1 )

**Description :** Affiche ou masque un graphique de l&apos;erreur quadratique de prévision (SPE). La SPE mesure la somme des résidus au carré à partir du modèle ACP ou PLS.
...
**Syntaxe :** obj &lt;&lt; T² Plot( state=0|1 )

**Description :** Affiche ou masque un graphique de la statistique T². T² mesure l&apos;éloignement d&apos;une observation par rapport au centre d&apos;un modèle ACP ou PLS. Actif par défaut.
...
**Syntaxe :** obj = Model Driven Multivariate Control Chart(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
