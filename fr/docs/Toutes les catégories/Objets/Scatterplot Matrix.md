...
**Syntaxe :** obj = Scatterplot Matrix(...Matrix Format( "Triangulaire inférieur"|"Triangulaire supérieur"|"Carré" )...)
...
**Syntaxe :** obj = Scatterplot Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)
