...
**Syntaxe :** obj &lt;&lt; Density Ellipses( state=0|1 )
...
**Description :** Définit le niveau de couverture, qui est (1 - alpha) pour les ellipses affichés sur la matrice de nuages de points.
...
**Description :** Définit la transparence pour les ellipses affichés sur la matrice de nuages de points.
...
**Description :** Identifie une variable de groupe dont les niveaux servent à créer des ellipses séparés affichés sur la matrice de nuages de points.
...
**Description :** Verrouille les étendues des axes pour que celles-ci ne changent pas suite à des modifications de données ou de filtrage.
...
**Syntaxe :** obj = Scatterplot Matrix(...Matrix Format( "Triangulaire inférieur"|"Triangulaire supérieur"|"Carré" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj &lt;&lt; Nonpar Density( state=0|1 )
...
**Description :** Produit un jitter sur les points en les déplaçant légèrement sur la matrice de nuages de points. "Auto" par défaut.
...
**Syntaxe :** obj &lt;&lt; Shaded Ellipses( state=0|1 )
...
**Syntaxe :** obj = Scatterplot Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
