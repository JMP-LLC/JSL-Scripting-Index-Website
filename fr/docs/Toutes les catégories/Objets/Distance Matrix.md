...
**Description :** Spécifie la méthode de calcul de la distance.
...
**Syntaxe :** Permutations ( number = 1000 ) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Nombre de permutations pour calculer PERMANOVA "1000" par défaut.
...
**Syntaxe :** Pricpal Components ( number = 2 ) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Nombre de composantes principales "2" par défaut.
...
**Syntaxe :** obj = Distance Matrix(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
