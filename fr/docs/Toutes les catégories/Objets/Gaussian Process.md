...
**Syntaxe :** obj &lt;&lt; Block Size( number )

**Description :** Définit le nombre d&apos;observations à placer dans chaque bloc pour GASP rapide.
...
**Syntaxe :** obj &lt;&lt; Estimate Nugget( state=0|1 )

**Description :** Introduit un coefficient de ridge dans la procédure d’estimation. Ceci permet d’effectuer un lissage sur le bruit plutôt que de réaliser une interpolation exacte.
...
**Syntaxe :** obj &lt;&lt; Fast GASP( state=0|1 )

**Description :** L&apos;option GASP rapide permet l&apos;ajustement de modèles avec des milliers de lignes.
...
**Description :** Construit la formule de prévision et la publie sous la forme d&apos;un script de colonne de formule dans le dépôt des formules.
...
**Syntaxe :** obj &lt;&lt; Publish Variance Formula

**Description :** Construit la formule de la variance et la publie sous la forme d&apos;un script de colonne de formule dans le dépôt des formules.
...
**Syntaxe :** obj &lt;&lt; Save Jackknife Predicted Values

**Description :** Enregistre les valeurs prévues par Jackknife dans une nouvelle colonne de la table de données.
...
**Syntaxe :** obj &lt;&lt; Save Variance Formula

**Description :** Enregistre la formule de variance dans une nouvelle colonne de la table de données.
...
**Syntaxe :** obj &lt;&lt; Set Correlation Function( structure=Gaussien )

**Description :** Définit la structure des corrélations utilisée dans le modèle.

Une structure gaussienne impose que la corrélation entre deux réponses ne soit pas nulle.

Une structure cubique accepte que les corrélations puissent être nulles pour des points suffisamment distants. "Gaussien" par défaut.
...
**Syntaxe :** obj &lt;&lt; Set Minimum Theta( number )

**Description :** Définit la valeur thêta minimale utilisée dans le modèle ajusté.
...
**Syntaxe :** obj &lt;&lt; Set Nugget( number )

**Description :** Définit la taille de la pépite comme une constante utilisée en tant que coefficient de ridge dans la procédure d’estimation.
...
**Syntaxe :** obj = Gaussian Process(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
