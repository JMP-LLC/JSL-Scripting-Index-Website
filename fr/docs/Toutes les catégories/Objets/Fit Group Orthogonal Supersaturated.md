...
**Syntaxe :** Fit Group Orthogonal Supersaturated( Y( column ), X( columns ) )

**Description :** Analyse un plan de groupe orthogonal sursaturé. Un plan de groupe orthogonal supersaturé comprend moins d&apos;observations que les paramètres de modèle, où tous les effets principaux ne peuvent pas être estimés simultanément.
