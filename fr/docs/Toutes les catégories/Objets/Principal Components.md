...
**Description :** Affiche ou masque un tableau qui contient les coordonnées des composantes. Cette option est disponible uniquement lorsque l&apos;analyse contient une variable catégorielle.
