...
**Syntaxe :** obj = Degradation(...Censor Code( value=1 )...)
...
**Syntaxe :** obj = Degradation(...Use Pooled MSE for Nonpoolable Model( state=0 )...)
...
**Syntaxe :** obj = Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)
