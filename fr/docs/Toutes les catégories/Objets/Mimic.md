...
**Syntaxe :** obj &lt;&lt; Mouse Brush(rect, &lt;1|2|3|4&gt;)
...
**Syntaxe :** obj &lt;&lt; Mouse Circle Move(geo)
...
**Syntaxe :** obj &lt;&lt; Mouse Double Click(geo)
...
**Syntaxe :** obj &lt;&lt; Mouse Drag(geo src, geo dest)
...
**Syntaxe :** obj &lt;&lt; Mouse Right Click(geo)
...
**Syntaxe :** obj &lt;&lt; Typing("some string")
...
**Syntaxe :** obj &lt;&lt; Typing Special("enum key string")
...
Wait( 1 );
mc = Mimic( obj );
mc << Mouse Double Click( win[Text Edit Box( 2 )] ) << Wait( 1 ) <<
Typing( "HEIGHT" ) << Wait( 1 ) << Typing Special( "Enter" );
...
**Syntaxe :** obj &lt;&lt; With Modifier({"Shift"|"Control"|"Command"|"Alt"|"Option"|"Control", ...}, msg)
...
**Syntaxe :** [xmin ymin, xmax ymax] = Bounds(boxref)
...
**Syntaxe :** [x y] = Center(rect | boxref)
...
**Syntaxe :** pt = Disclosure(boxref | objref)
...
**Syntaxe :** geo = Frame Coords(framebox, geo)
...
**Syntaxe :** rect = Grid Region(gridbox, "IdColumn", 9)
...
**Syntaxe :** rect = List Item(listbox, item label)
...
mc = Mimic( obj );
mc << Mouse Drag(
	List Item( win[List Box Box( 1 )], "sex" ),
	box[Text Edit Box( 2 )]
);
...
**Syntaxe :** geo = Offset(geo | boxref, pt)
...
**Syntaxe :** [x y] = TopLeft(rect | boxref)
