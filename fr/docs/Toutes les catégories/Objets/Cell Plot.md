...
**Syntaxe :** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**Syntaxe :** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
...
**Syntaxe :** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
