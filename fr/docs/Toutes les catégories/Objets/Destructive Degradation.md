...
**Syntaxe :** obj &lt;&lt; Control( yTrans, timeTrans, distribution, path definition )

**Description :** Sélectionne un modèle dans le panneau Définition du chemin d’accès du rapport. Le modèle sélectionné est également affiché dans le graphique de dégradation.
...
**Syntaxe :** obj &lt;&lt; Model( yTrans, timeTrans, distribution, path definition )

**Description :** Spécifie un ajustement de modèle et affiche un rapport du modèle d&apos;ajustement.
...
**Syntaxe :** obj &lt;&lt; Shade( state=0|1 )

**Description :** Affiche ou masque les limites inférieure et supérieure du modèle affiché. Cette option affiche ou masque également l&apos;ombrage entre les limites. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Shade Coverage( proportion )

**Description :** Spécifie une proportion pour augmenter ou réduire la quantité de couverture de l&apos;ombre.
...
**Syntaxe :** obj &lt;&lt; Use Condition Temperature( "Celsius"|"Fahrenheit"|"Kelvin", temperature )

**Description :** Spécifie l&apos;échelle et la température pour la condition d&apos;utilisation (X0) dans les modèles cinétiques de premier ordre.
...
**Syntaxe :** obj = Destructive Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
