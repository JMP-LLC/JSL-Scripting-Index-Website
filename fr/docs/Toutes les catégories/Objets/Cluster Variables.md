...
**Syntaxe :** obj = Cluster Variables(...<By( column(s) )>...)
...
**Syntaxe :** obj = Cluster Variables(...Columns( column(s) )...)
...
**Syntaxe :** obj = Cluster Variables(...<Freq( column )>...)
...
**Syntaxe :** obj = Cluster Variables(...<Weight( column )>...)
...
**Syntaxe :** obj = Cluster Variables(...Y( column(s) )...)
...
**Syntaxe :** obj = Cluster Variables(...Window View( "Visible"|"Invisible"|"Private" )...)
