...
**Syntaxe :** obj = Ternary Plot(...&lt;By( column(s) )&gt;...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Ternary Plot(...Contour Formula( formula column )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Une colonne de formule pour créer les iso-réponses de la surface de réponse.
...
**Syntaxe :** obj = Ternary Plot(...Plotting( column(s) )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Trois ou davantage de colonnes qui représentent les proportions du mélange.
...
**Syntaxe :** obj = Ternary Plot(...X( column(s) )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj &lt;&lt; 3D Graph( state=0|1 )

**Description :** Affiche un graphique tridimensionnel en utilisant 4 variables X ou plus.
...
**Syntaxe :** obj &lt;&lt; Contour Fill( "Lignes uniquement"|"Remplir en montant"|"Remplir en descendant" )

**Description :** Remplit la courbe d&apos;isoréponses définie dans le graphique ternaire.
...
**Syntaxe :** obj &lt;&lt; Contour Value( [c1, c2, c3, c4, c5] )

**Description :** Change les courbes d&apos;isoréponses sur le graphique ternaire.
...
**Description :** Afficher les contraintes des composantes ombrées. Actif par défaut.
...
**Description :** Affiche ou masque les points sur le graphique ternaire. Actif par défaut.
...
**Syntaxe :** obj = Ternary Plot(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
