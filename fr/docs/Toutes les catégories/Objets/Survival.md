...
**Syntaxe :** obj = Survival(...Censor Code( value=1 )...)
...
**Syntaxe :** obj = Survival(...Plot Failure instead of Surivival( state=0|1 )...)
...
**Syntaxe :** obj = Survival(...Window View( "Visible"|"Invisible"|"Private" )...)
