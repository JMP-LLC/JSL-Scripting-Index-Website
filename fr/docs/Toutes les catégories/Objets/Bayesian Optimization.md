...
**Description :** Indique s&apos;il faut exécuter la génération automatique de l&apos;ensemble des candidats et la sélection par batchs. Cette option équivaut à activer ou désactiver simultanément Générer l&apos;ensemble des candidats et Sélection automatique par batchs.
...
**Syntaxe :** obj &lt;&lt; Nominal Correlation Type( "Corrélations égales" )
...
**Syntaxe :** obj &lt;&lt; Ordinal Correlation Type( "Corrélations égales"|"Corrélations inégales" )
...
**Description :** Désélectionne tous les points du batch actuel.
...
**Description :** Exporte les points du batch actuellement sélectionné dans la table de données selon les paramètres actuels.
