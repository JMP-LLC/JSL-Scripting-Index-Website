...
**Syntaxe :** obj = Marker Imputation(...Imputation Value( number=0 )...)
...
**Syntaxe :** obj = Marker Imputation(...Method( "LD-kNN"|"HWE désactivé"|"HWE activé"|"Aléatoire"|"Spécifiée"="LD-kNN" )...)
...
**Syntaxe :** obj = Marker Imputation(...Nearest Markers( number=15 )...)
...
**Syntaxe :** obj = Marker Imputation(...Nearest Samples( number=15 )...)
...
**Syntaxe :** obj = Marker Imputation(...Ploidy( number=2 )...)
...
**Syntaxe :** obj = Marker Imputation(...Set Random Seed( number=0 )...)
...
**Syntaxe :** obj = Marker Imputation(...Unthreaded( state=0|1 )...)
...
**Syntaxe :** obj = Marker Imputation(...Window View( "Visible"|"Invisible"|"Private" )...)
