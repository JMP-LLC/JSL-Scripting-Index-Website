...
**Syntaxe :** Parallel Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**Syntaxe :** Parallel Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
...
**Syntaxe :** obj = Parallel Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
