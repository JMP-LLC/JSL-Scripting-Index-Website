...
**Syntaxe :** obj = Latent Class Analysis(...<By( column(s) )>...)
...
**Syntaxe :** obj = Latent Class Analysis(...<Freq( column )>...)
...
**Syntaxe :** obj = Latent Class Analysis(...<ID( column )>...)
...
**Syntaxe :** obj = Latent Class Analysis(...<Weight( column )>...)
...
**Syntaxe :** obj = Latent Class Analysis(...Y( column(s) )...)
...
**Syntaxe :** obj = Latent Class Analysis(...Number of Clusters( number=3 )...)
...
**Syntaxe :** obj = Latent Class Analysis(...Up to( number )...)
...
**Syntaxe :** obj = Latent Class Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)
