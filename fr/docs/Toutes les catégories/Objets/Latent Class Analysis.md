...
**Syntaxe :** obj = Latent Class Analysis(...&lt;By( column(s) )&gt;...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Latent Class Analysis(...&lt;Freq( column )&gt;...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Latent Class Analysis(...&lt;ID( column )&gt;...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Latent Class Analysis(...&lt;Weight( column )&gt;...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Latent Class Analysis(...Y( column(s) )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj &lt;&lt; New Number of Clusters( number )

**Description :** Vous permet d&apos;exécuter une autre analyse en utilisant un nombre de clusters différent.
...
**Syntaxe :** obj = Latent Class Analysis(...Number of Clusters( number=3 )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Spécifie le nombre de classes latentes. "3" par défaut.
...
**Syntaxe :** obj = Latent Class Analysis(...Up to( number )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Spécifie un nombre maximum de clusters. Si ce nombre dépasse le nombre de clusters spécifié, une analyse des classes latentes est réalisée pour chaque valeur entière de l&apos;étendue.
...
**Syntaxe :** obj = Latent Class Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj&lt;&lt;(Fit[number] &lt;&lt; Color By Cluster)

**Description :** Colore les lignes de la table de données en fonction de leurs clusters les plus probables.
...
**Syntaxe :** obj &lt;&lt; ( fit[number] &lt;&lt; Effect Sizes( state=0|1 ) )

**Description :** Affiche ou masque le tableau de la taille des effets. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; (Fit[number] &lt;&lt; Get Probability Formulas)
...
**Syntaxe :** obj &lt;&lt; ( fit[number] &lt;&lt; MDS Plot( state=0|1 ) )

**Description :** Affiche ou masque le graphique MDS, qui est une représentation bidimensionnelle de la proximité de cluster. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; ( fit[number] &lt;&lt; Mixture Probabilities( state=0|1 ) )

**Description :** Affiche ou masque le tableau des probabilités de mélange.
...
**Description :** Affiche ou masque une table de résumé de modèle qui contient la log-vraisemblance négative, le nombre de paramètres et les valeurs BIC et AIC. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; ( fit[number] &lt;&lt; Parameter Estimates( state=0|1 ) )

**Description :** Affiche ou masque le rapport des estimations des paramètres qui contient les résumés tabulaire et graphique de ces estimations. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; (Fit[number] &lt;&lt; Publish Probability Formulas)
...
**Syntaxe :** obj &lt;&lt; (Fit[number]&lt;&lt;Rename Clusters( {argument list} )

**Description :** Vous permet de donner des noms pertinents aux clusters dans le rapport. Si aucune liste d&apos;arguments n&apos;est spécifiée, vous êtes invité(e) à fournir des noms de cluster.
...
obj << (Fit[1] << Rename Clusters(
	{"New Cluster 1", "New Cluster 2", "New Cluster 3"}
));
...
**Syntaxe :** obj &lt;&lt; (Fit[number] &lt;&lt; Save Cluster Formula Only)
...
**Syntaxe :** obj &lt;&lt; (Fit[number] &lt;&lt; Save Cluster Only)

**Description :** Enregistre une colonne dans la table de données qui contient le cluster le plus probable pour chaque ligne.
...
**Syntaxe :** obj &lt;&lt; (Fit[number] &lt;&lt; Save Mixture Probabilities)

**Description :** Enregistre la probabilité d&apos;appartenance à chaque cluster dans une colonne séparée de la table de données.
...
**Syntaxe :** obj &lt;&lt; (Fit[number] &lt;&lt; Save Mixture and Cluster Formulas)

**Description :** Enregistre la formule de probabilité de mélange à chaque cluster dans une colonne séparée de la table de données.
...
**Syntaxe :** obj &lt;&lt; ( fit[number] &lt;&lt; Transposed Parameter Estimates( state=0|1 ) )

**Description :** Affiche ou masque le tableau transposé des estimations des paramètres.
