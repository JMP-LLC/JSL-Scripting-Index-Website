...
**Syntaxe :** obj = Naive Bayes(...&lt;By( column(s) )&gt;...)
...
**Syntaxe :** obj = Naive Bayes(...Factor( column(s) )...)

**Description :** Spécifie les colonnes des prédicteurs continus ou catégoriels.
...
**Syntaxe :** obj = Naive Bayes(...&lt;Freq( column )&gt;...)
...
**Syntaxe :** obj = Naive Bayes(...Response( column )...)

**Description :** Spécifie la colonne de réponse catégorielle dont les valeurs représentent les classes d&apos;intérêt.
...
**Syntaxe :** obj = Naive Bayes(...&lt;Validation( column )&gt;...)
...
**Syntaxe :** obj = Naive Bayes(...&lt;Weight( column )&gt;...)
...
**Syntaxe :** obj = Naive Bayes(...X( column(s) )...)
...
**Syntaxe :** obj = Naive Bayes(...Y( column )...)
...
**Syntaxe :** obj = Naive Bayes(...Prior Bias( fraction=.5 )...)

**Description :** Définit la valeur du biais a priori. La valeur est divisée par le nombre de niveaux de réponse et cette quantité est ajoutée aux décomptes pour assurer des estimations de taux non nulles. ".5" par défaut.
...
**Description :** Affiche ou masque la courbe ROC pour chaque niveau de la variable de réponse. La courbe ROC est un graphique de la sensibilité par rapport à (1 - spécificité). Si vous avez utilisé la validation, un graphique s&apos;affiche pour chaque échantillon test, d&apos;apprentissage et de validation. Actif par défaut.
...
**Description :** Enregistre une nouvelle colonne dans la table de données. La colonne contient les classifications prédites.
...
**Description :** Enregistre une nouvelle colonne dans la table de données. La colonne contient la formule de prédiction des classifications.
...
**Description :** Enregistre de nouvelles colonnes dans la table de données. Les colonnes contiennent les formules utilisées pour classifier chaque observation.
...
**Syntaxe :** obj = Naive Bayes(...Use Excluded Rows for Validation( state=0|1 )...)
...
**Syntaxe :** obj = Naive Bayes(...Validation Portion( fraction=0 )...)

**Description :** Spécifie la portion des données à utiliser comme ensemble de validation. "0" par défaut.
...
**Syntaxe :** obj = Naive Bayes(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
