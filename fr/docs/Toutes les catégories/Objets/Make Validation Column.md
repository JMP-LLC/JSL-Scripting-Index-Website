...
**Syntaxe :** obj &lt;&lt; Cutpoint Batch ID( column )
...
**Syntaxe :** obj &lt;&lt; Cutpoint Column( column )
...
**Syntaxe :** obj &lt;&lt; Grouping Columns( column(s) )
...
**Syntaxe :** obj &lt;&lt; Stratification Columns( column(s) )
...
**Syntaxe :** obj &lt;&lt; Assign Extra Rows( "Vers apprentissage"|"Vers validation"|"Vers test" )

**Description :** Spécifie si des lignes supplémentaires doivent être affectées à l&apos;ensemble d&apos;apprentissage, de validation ou de test. Cette option est uniquement disponible lorsque Numéros de lignes est spécifié pour l&apos;option Déterminer les coupures avec, et qu&apos;une variable ID de lot de coupure est spécifiée.
...
**Syntaxe :** obj &lt;&lt; Determine cutpoints using( "Proportions"|"Numéros de lignes"|"Date ou heure fixe"|"Temps écoulé" )

**Description :** Spécifie la méthode utilisée pour déterminer les coupures.
...
**Description :** Créer une colonne de validation avec les paramètres actuels.
...
**Syntaxe :** obj &lt;&lt; New Column Name( text )

**Description :** Spécifie un nom pour la colonne de validation nouvellement créée.
...
**Syntaxe :** obj &lt;&lt; Number of Folds( number=4 )

**Description :** Spécifie le nombre de blocs utilisés pour la validation croisée en K blocs. "4" par défaut.
...
**Description :** Spécifie une graine aléatoire pour la production des colonnes de validation. Utilisez la même graine aléatoire pour reproduire la même colonne de validation lorsque vous utilisez la même méthode.
...
**Syntaxe :** obj &lt;&lt; Test Set( number=0.00 )

**Description :** Spécifie la proportion d&apos;observations à affecter à l&apos;ensemble de test. L&apos;ensemble de test est facultatif et est utilisé pour vérifier la capacité prédictive du modèle, une fois celui-ci choisi. "0.00" par défaut.
...
**Syntaxe :** obj &lt;&lt; Training Set( number=0.75 )

**Description :** Spécifie la proportion d&apos;observations à affecter à l&apos;ensemble d&apos;apprentissage. L&apos;ensemble d&apos;apprentissage est utilisé pour estimer le modèle. "0.75" par défaut.
...
**Syntaxe :** obj &lt;&lt; Validation Column Type( Fixe|Formule )

**Description :** Sélectionne le type de colonne (fixed ou formula) pour la nouvelle colonne de validation. Par défaut, il s&apos;agira d&apos;une colonne fixe.
...
**Syntaxe :** obj &lt;&lt; Validation Set( number=0.25 )

**Description :** Spécifie la proportion d&apos;observations à affecter à l&apos;ensemble de validation. L&apos;ensemble de validation est utilisé pour choisir un modèle qui prévoit bien. "0.25" par défaut.
...
**Syntaxe :** obj = Make Validation Column(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
