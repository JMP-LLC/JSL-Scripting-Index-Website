...
**Syntaxe :** obj &lt;&lt; Bayesian Models

**Description :** Spécifier les modèles bayésiens.
		...
		Models(
			Model(
				...
				Prior(
					...
					{"σ[ε]", Distribution( "Half Cauchy ( )" ),
					Prior Parameter( "Scale", 3 )}
				),
				Random Seed( 32323 ),
...
**Description :** Spécifie la transformation de la réponse, la transformation temporelle et le type de modèle.
...
**Syntaxe :** obj &lt;&lt; Reference Temperature

**Description :** Définit la valeur de température de référence utilisée par les modèles appropriés.
...
**Syntaxe :** obj &lt;&lt; Reference X

**Description :** Définit la valeur de référence utilisée par les modèles appropriés.
...
### Save Posterior To Script

**Syntaxe :** obj &lt;&lt; Save Posterior To Script( state=0|1 )

**Description :** Spécifie que lorsque vous enregistrez le script pour le rapport actuel, le script contient les échantillons a posteriori. Si vous exécutez le script enregistré, les échantillons a posteriori sont directement chargés à partir du script dans l&apos;analyse Dégradation des mesures répétées. Actif par défaut.
...
**Syntaxe :** obj = Repeated Measures Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
