...
**Syntaxe :** Attr( <<Boolean Box Message == 0|1 )
...
New Window( "Attr",
	JSS Context Box(
		...
		<<Set JSS(
			Expr(
				Attr( <<Get Horizontal == 1 ) << Background Color( "Blue" )
			)
		)
	)
);
...
**Syntaxe :** Child( parentSelector, childSelector )
...
**Syntaxe :** Constants( var1 = expr1; var2 = expr2; ... )
...
**Syntaxe :** Descend( selector, ..., selector )
...
New Window( "Child",
	JSS Context Box(
		...
		<<Set JSS(
			Expr(
				Descend( Type( OutlineBox ), Type( TextBox ) ) <<
				Font Color( "Blue" );
...
New Window( "Id",
	JSS Context Box(
		...
		<<Set JSS(
			Expr(
				Id( foo ) << Margin( Bottom( 8 ) ) << Background Color( "Blue" )
			)
		)
	)
);
...
**Syntaxe :** If( condA, rulesA, ..., rulesElse )
...
**Syntaxe :** Include( path, <<NoWarnIfMissing )
...
**Syntaxe :** Next Sibling( precedingSelector, selector )
...
New Window( "Next Sibling",
	JSS Context Box(
		...
		<<Set JSS(
			Expr(
				Next Sibling( Type( PanelBox ), Type( TextBox ) ) <<
				Font Color( "Blue" )
			)
		)
	)
...
New Window( "Selector List",
	JSS Context Box(
		...
		<<Set JSS(
			Expr(
				(Type( ButtonBox ) | Id( foo )) << Background Color( "blue" )
			)
		)
	)
);
