...
**Syntaxe :** obj &lt;&lt; Paired Response( column(s) )
...
**Syntaxe :** obj &lt;&lt; Bland Altman Analysis( state=0|1 )

**Description :** Affiche ou masque l&apos;analyse de Bland-Altman. Cette analyse est une technique de comparaison de méthode utilisée pour comparer deux mesures de la même variable.
...
**Syntaxe :** obj &lt;&lt; Bland Altman Percent Analysis( state=0|1 )

**Description :** Affiche ou masque l&apos;analyse de pourcentage de Bland-Altman.
...
**Syntaxe :** obj &lt;&lt; Dif Statistics( state=0|1 )

**Description :** Affiche ou masque les statistiques de différences. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Equivalence Tests

**JMP Version ajoutée :** 18

### Percent Dif Statistics

**Syntaxe :** obj &lt;&lt; Percent Dif Statistics( state=0|1 )

**Description :** Affiche ou masque les statistiques de pourcentage de différence.
...
**Syntaxe :** obj &lt;&lt; Plot Dif By Mean( state=0|1 )

**Description :** Affiche ou masque le graphique des différences appariées en fonction des moyennes appariées. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Plot Dif By Row( state=0|1 )

**Description :** Affiche ou masque le graphique des différences appariées en fonction du nombre de ligne.
...
**Syntaxe :** obj &lt;&lt; Plot Percent Dif by Mean( state=0|1 )

**Description :** Affiche ou masque un graphique du pourcentage de différence par moyenne.
...
**Syntaxe :** obj &lt;&lt; Plot Percent Dif by Row( state=0|1 )

**Description :** Affiche ou masque un graphique du pourcentage de différence par ligne.
...
**Syntaxe :** obj &lt;&lt; Reference Frame( state=0|1 )

**Description :** Affiche ou masque le cadre de référence sur le graphique des différences en fontion des moyennes. Actif par défaut.
...
**Description :** Modifie le niveau alpha utilisé dans les analyses. Influence les intervalles de confiance dans le rapport et sur le graphique.
...
**Syntaxe :** obj &lt;&lt; Sign Test( state=0|1 )

**Description :** Affiche ou masque le test des signes. Il s’agit d’une version non paramétrique du test t apparié.
...
**Syntaxe :** obj &lt;&lt; Wilcoxon Signed Rank( state=0|1 )

**Description :** Affiche ou masque le test de Wilcoxon (basé sur les rangs). Il s’agit d’une version non paramétrique du test t apparié.
...
**Syntaxe :** obj = Matched Pairs(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
