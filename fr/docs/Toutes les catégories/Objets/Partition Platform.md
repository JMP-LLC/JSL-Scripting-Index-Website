...
**Syntaxe :** obj = Decision Tree(...Informative Missing( state=0|1 )...)
...
**Syntaxe :** obj = Decision Tree(...Ordinal Restricts Order( state=0|1 )...)
...
**Syntaxe :** obj = Decision Tree(...Validation Portion( fraction=0 )...)
...
**Syntaxe :** obj = Decision Tree(...Window View( "Visible"|"Invisible"|"Private" )...)
