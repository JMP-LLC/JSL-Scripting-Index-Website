...
**Description :** Sélectionnez XGBoost ou LightGBM comme méthode d&apos;ajustement du boosting de gradient. "xgboost" par défaut.
...
**Description :** Spécifie le nombre de catégories qu&apos;une fonction catégorielle peut avoir pour utiliser l&apos;algorithme de division one-vs-other. Les fonctions catégorielles comportant plus que le nombre maximal de catégories sont traitées par un algorithme différent. "4" par défaut.
...
**Description :** Spécifie la graine utilisée par le générateur de nombres aléatoires pour le paramètre objectif. "5" par défaut.
...
**Description :** Spécifie la marge de seuil pour l&apos;arrêt précoce des prévisions lorsque celui-ci est spécifié. Ce paramètre permet au processus de prévision de s&apos;arrêter avant la fin si la marge est suffisamment éloignée du seuil. "10" par défaut.
...
**Syntaxe :** obj &lt;&lt; top_k( number=0 )

**Description :** Spécifie le nombre de fonctions clés à sélectionner dans le sélecteur de fonction avide et économe. Cette option s&apos;applique uniquement pour le booster gblinear. "0" par défaut.
...
**Description :** Spécifie s&apos;il faut sélectionner des arbres à éliminer dans le boosting DART en utilisant une probabilité uniforme. "0" par défaut.
