...
**Syntaxe :** obj = Marker Statistics(...Marker Format( "Numérique"|"Caractère unique"|"Caractère"|"Nucléotide à code unique"|"Nucléotide"="Numérique" )...)
...
**Syntaxe :** obj = Marker Statistics(...Ploidy( number=2 )...)
...
**Syntaxe :** obj = Marker Statistics(...Unthreaded( state=0|1 )...)
...
**Syntaxe :** obj = Marker Statistics(...Use Annotation Table( state=0|1 )...)
...
**Syntaxe :** obj = Marker Statistics(...Window View( "Visible"|"Invisible"|"Private" )...)
