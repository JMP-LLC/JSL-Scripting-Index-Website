...
**Description :** Analyse les lignes affectées à chaque niveau de la colonne spécifiée séparément. Tous les résultats sont présentés dans une seule table et un seul rapport.
...
**Syntaxe :** obj &lt;&lt; With Marker( column(s) )

**Description :** Spécifie les colonnes qui contiennent des marqueurs génétiques pour l&apos;estimation du déséquilibre de liaison par paires avec les colonnes des marqueurs génétiques spécifiées dans Marqueurs.
...
**Syntaxe :** obj &lt;&lt; Counts Table( state=1 )

**Description :** Affiche ou masque la table des dénombrements par niveaux du génotype. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; LD Decay Plot( state=1 )

**Description :** Affiche ou masque le graphique de décroissance LD. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Levels Table( state=1 )

**Description :** Affiche ou masque la table des niveaux du génotype. Actif par défaut.
...
**Syntaxe :** obj = Marker Statistics(...Marker Format( "Numérique"|"Caractère unique"|"Caractère"|"Nucléotide à code unique"|"Nucléotide"="Numérique" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Fournit des options permettant de choisir le format des génotypes : Caractère unique (A, B, H), Nucléotide à code unique (IUPAC : A,C,G,T,R,Y,S,W,K,M,+,0 ,-,N), Nucléotide (AA, CC, GG, TT, AC, AT, etc.), Numérique (0, 1, 2, ..., p) et Caractère (ApBp ou Ap/Bp). Les formats numérique et caractère prennent en charge le génotype avec ploïdie p. "Numérique" par défaut.

### PValue Plot

**Syntaxe :** obj &lt;&lt; PValue Plot( state=1 )

**Description :** Affiche ou masque le graphique de p-valeurs. Actif par défaut.
...
**Syntaxe :** obj = Marker Statistics(...PValues Table on Launch( state=0 )...)

**Description :** Spécifie si la table de données de p-valeurs doit être créée au lancement de la plate-forme. "0" par défaut.
...
**Syntaxe :** obj = Marker Statistics(...Ploidy( number=2 )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj &lt;&lt; Recode Marker

**Description :** Recode toutes les colonnes de marqueurs sélectionnées dans la table de données d&apos;origine en inversant les allèles mineurs et majeurs.
...
**Syntaxe :** obj &lt;&lt; Result Table( state=1 )

**Description :** Afficher la table de résultats Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Save Counts Table

**Description :** Enregistre les dénombrements dans une table de données
...
**Syntaxe :** obj &lt;&lt; Save Levels Table

**Description :** Enregistre les niveaux dans une table de données
...
**Syntaxe :** obj &lt;&lt; Save Proportion of Missing Markers

**Description :** Ajoute une colonne à la table de données d&apos;origine qui contient la proportion de génotypes manquants
...
**Syntaxe :** obj &lt;&lt; Save Result Table

**Description :** Enregistre les résultats dans une table de données.
...
**Syntaxe :** obj &lt;&lt; Select and Recode Marker

**Description :** Sélectionne et recode les colonnes de marqueur dans la table de données d&apos;origine en inversant les allèles mineurs et majeurs.
...
**Syntaxe :** obj = Marker Statistics(...Unthreaded( state=0|1 )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Marker Statistics(...Use Annotation Table( state=0|1 )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Marker Statistics(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
