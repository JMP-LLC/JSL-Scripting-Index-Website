...
**Syntaxe :** obj = Marker Relatedness(...Additive Type( "Méthode diploïde 1"|"Méthode diploïde 2"|"Polyploïde"="Méthode diploïde 1" )...)
...
**Syntaxe :** obj = Marker Relatedness(...Clustering( state=0|1 )...)
...
**Syntaxe :** obj = Marker Relatedness(...Dominance Type( "Méthode diploïde 1"|"Méthode diploïde 2"|"Polyploïde"="Méthode diploïde 1" )...)
...
**Syntaxe :** obj = Marker Relatedness(...Epistasis Type( "Additif par additif"|"Additif par dominance"|"Dominance par dominance"="Additif par additif" )...)
...
**Syntaxe :** obj = Marker Relatedness(...Imputation Value( number=0 )...)
...
**Syntaxe :** obj = Marker Relatedness(...Kinship Type( "Identique par état"|"Additif"|"Dominance"|"Épistasie"="Identique par état" )...)
...
**Syntaxe :** obj << Merge Kinship Table

**Description :** Fusionne la table de matrice de relation génomique dans la table de données d&apos;origine.
...
**Syntaxe :** obj = Marker Relatedness(...Missing Marker Imputation Method( "HWE désactivé"|"HWE activé"|"Aléatoire"|"Spécifiée"="HWE désactivé" )...)
...
**Syntaxe :** obj = Marker Relatedness(...Ploidy( number=2 )...)
...
**Syntaxe :** obj = Marker Relatedness(...Principal Components( state=0|1 )...)
...
**Syntaxe :** obj << Save Square Kinship Table

**Description :** Enregistre la relation génomique de la matrice carrée dans une table de données au format non empilé
...
**Syntaxe :** obj << Save Stacked Kinship Table

**Description :** Enregistre la partie triangulaire supérieure de la matrice de relation génomique dans une table de données au format empilé
...
**Syntaxe :** obj = Marker Relatedness(...Set Random Seed( number=0 )...)
...
**Syntaxe :** obj = Marker Relatedness(...Unthreaded( state=0|1 )...)
...
**Syntaxe :** obj = Marker Relatedness(...Window View( "Visible"|"Invisible"|"Private" )...)
