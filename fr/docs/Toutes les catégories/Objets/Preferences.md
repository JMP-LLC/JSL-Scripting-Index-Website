...
**Syntaxe :** obj &lt;&lt; Always allow publishing to JMP Public( state=0|1 )

**Description :** Toujours activer l&apos;élément de menu pour la publication sur JMP public, même si d&apos;autres connexions JMP Live sont configurées.
...
**Syntaxe :** Preferences[1] &lt;&lt; Name("Set ODBC Primary Key as Link ID") ( state = 0|1 )
...
**Syntaxe :** obj &lt;&lt; Show SAS Log( "Jamais"|"Toujours"|"En cas d&apos;erreur" )
