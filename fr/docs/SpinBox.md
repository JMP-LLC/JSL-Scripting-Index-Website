...
**Syntaxe :** obj << Click( <value> )

**Description :** Simule un clic sur le bouton pour exécuter le script qui l’accompagne.
...
**Syntaxe :** obj << Decrement( <value> )

**Description :** Simule un clic sur le bouton flèche en bas pour exécuter le script qui l’accompagne.
...
**Syntaxe :** obj << Increment( <value> )

**Description :** Simule un clic sur le bouton flèche en haut pour exécuter le script qui l’accompagne.
...
**Syntaxe :** obj << Set Function( Function( {thisBox, increment}, <script> ) )

**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsque les boutons de la zone de pivotement sont enfoncés. [increment] est l&apos;incrément défini pour la zone de nombre.
...
**Description :** Renvoie une boîte d’affichage qui présente un bouton avec un contrôle de déplacement vers le haut et un vers le bas. L&apos;argument  scriptest appelé avec un argument indiquant la direction de la flèche que vous avez cliquée (négatif désigne le bas, positif le haut). Si vous cliquez une seule fois, l&apos;ampleur du déplacement est égal à 1.Pour des valeurs supérieures, cliquez plusieurs fois.
