...
**Syntaxe :** obj = Association Analysis(...<By( column(s) )>...)
...
**Syntaxe :** obj = Association Analysis(...<ID( column(s) )>...)
...
**Syntaxe :** obj = Association Analysis(...Item( column(s) )...)
...
**Syntaxe :** obj = Association Analysis(...Maximum Antecedents( number=3 )...)
...
**Syntaxe :** obj = Association Analysis(...Maximum Rule Size( number=4 )...)
...
**Syntaxe :** obj = Association Analysis(...Minimum Confidence( number=0.40 )...)
...
**Syntaxe :** obj = Association Analysis(...Minimum Lift( number=1.2 )...)
...
**Syntaxe :** obj = Association Analysis(...Minimum Support( fraction=0.10 )...)
...
**Syntaxe :** obj = Association Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)
