...
**Syntaxe :** Data Format( Distance Matrix | Attribute List )
...
**Syntaxe :** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)
...
**Syntaxe :** Transformation( None | Ratio | Interval | Ordinal )
...
**Syntaxe :** obj = Multidimensional Scaling(...Window View( "Visible"|"Invisible"|"Private" )...)
