...
obj = dt << Tabulate(
	Add Table(
		Row Table( Columns by Categories( :Grades, :Sports, :Looks, :Money ) )
	)
);
...
obj << Modify Table(
	Row Table( 1 ),
	Modify Table Option( Stack Grouping Columns( true ) )
);
