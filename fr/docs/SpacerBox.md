...
**Description :** Définit la couleur de l’espacement à la couleur donnée.
...
**Description :** Renvoie la couleur de l’espacement.
...
**Description :** Renvoie la hauteur de l’espacement.
...
**Syntaxe :** alpha = obj << Get Transparency
...
**Description :** Renvoie la largeur de l’espacement.
...
**Description :** Définit la hauteur de l’espacement.
...
**Syntaxe :** obj << Size( width, height,<min width, min height>,<max width, max height> )

**Description :** Définit la largeur et la hauteur de l’espacement.
...
**Description :** Renvoie une boîte d’affichage à laquelle vous pouvez donner une taille et une couleur arbitraires.
...
**Syntaxe :** obj << Transparency( alpha )
...
**Description :** Définit la largeur de l’espacement.
