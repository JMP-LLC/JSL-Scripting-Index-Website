...
**Syntaxe :** obj = Predictor Screening(...<By( column(s) )>...)
...
**Syntaxe :** obj = Predictor Screening(...Response( column(s) )...)
...
**Syntaxe :** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Syntaxe :** obj = Predictor Screening(...X( column(s) )...)
...
**Syntaxe :** obj = Predictor Screening(...Y( column(s) )...)
