...
**Description :** Colorie les cellules dans la table de données qui correspondent à des observations qui se trouvent à l&apos;extérieur des limites de spécification. Les cellules correspondant à des observations inférieures à la limite de spécification inférieure sont coloriées en rouge clair. Les cellules correspondant à des observations supérieures à la limite de spécification supérieure sont coloriées en bleu clair.
...
**Syntaxe :** obj = Manage Limits( Process Variables( columns), Grouping( columns) )
...
**Syntaxe :** obj << Load from Limits Table

**Description :** Charger les données de limite à partir de la table de données.
...
**Syntaxe :** obj = Manage Limits( Process Variables( columns) )

**Description :** Spécifie les colonnes continues des processus.
...
**Syntaxe :** obj << Round Decimals

**Description :** Arrondit toutes les valeurs numériques au nombre de décimales spécifié.
...
**Syntaxe :** obj << Save to Column Properties

**Description :** Enregistre les données de limite en tant que propriétés de colonne.
...
**Syntaxe :** obj << Save to Column Properties in Split Table(  < Remaining Columns ( Drop All | Keep All | Split All )> )

**Description :** Enregistre les données de limites en tant que propriétés de colonne dans une nouvelle table de données séparée par variables de groupement.
...
**Syntaxe :** obj << Save to Tall Limits Table

**Description :** Crée une nouvelle table de données au format en lignes qui contient toutes les données de limite pour chaque colonne.
...
**Syntaxe :** obj << Save to Wide Limits Table

**Description :** Crée une nouvelle table de données au format en colonnes qui contient toutes les données de limite pour chaque colonne.
...
**Syntaxe :** obj << Show Limits All

**Description :** Cochez la case Afficher les limites pour tous les éléments.
...
**Syntaxe :** obj = Manage Limits(...Window View( "Visible"|"Invisible"|"Private" )...)
