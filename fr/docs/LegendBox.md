...
**Syntaxe :** LegendBox << Get Item(Model ID, Model Index)

**Description :** Renvoie un élément de légende qui peut faire l&apos;objet d&apos;une requête ou dont les propriétés visibles peuvent être modifiées.
...
**Syntaxe :** obj << Get Items

**Description :** Renvoie une liste de tous les éléments de légende qui peuvent faire l&apos;objet d&apos;une requête ou dont les propriétés visibles peuvent être modifiées.
...
**Syntaxe :** obj << Legend Position( list )

**Description :** Réorganise les éléments présents dans la zone de légende en fonction de la list saisie.
...
**Description :** Ouvre la fenêtre Légende pour modifier des paramètres.
...
**Description :** Définit la direction vers laquelle doivent se présenter les éléments dans la zone de légende.
...
**Syntaxe :** obj << Revert Legend

**Description :** Rétablit toutes les modifications apportées dans la zone de légende.
...
**Description :** Permet de spécifier le nombre maximum d&apos;éléments à afficher dans la légende. Ce paramètre permet d&apos;éviter qu&apos;une légende confuse n&apos;empêche la lecture du graphique.
...
**Syntaxe :** obj << Set Title( "string" )

**Description :** Définit le titre de la zone de légende.
...
**Syntaxe :** obj << Set Wrap( number )

**Description :** Indique le nombre de lignes occupées par les éléments de la légende ; 0 indique une seule ligne sans retour chariot ( c.-à-d., une seule largeur de colonne)
...
**Syntaxe :** obj << Sides( top|left )

**Description :** Définit la position de la zone de légende.
...
**Syntaxe :** obj << font( fontname, <fontsize>, <fontstyle> )

**Description :** Spécifier la police à utiliser pour le texte de la légende.
