...
**Syntaxe :** obj = Boosted Tree(...Informative Missing( state=0|1 )...)
...
**Syntaxe :** obj = Boosted Tree(...Ordinal Restricts Order( state=0|1 )...)
...
**Syntaxe :** obj = Boosted Tree(...Validation Portion( fraction=0 )...)
