...
**구문:** obj = Support Vector Machines(...Factor( column(s) )...)
...
**구문:** obj = Support Vector Machines(...Response( column )...)
...
**구문:** obj = Support Vector Machines(...X( column(s) )...)
...
**구문:** obj = Support Vector Machines(...Y( column )...)
...
**구문:** Set Random Seed( number )

**설명:** K 폴드 및 홀드백 검증에 사용되는 랜덤화 과정의 난수 시드값을 설정합니다. 분석을 재현하려는 경우에 유용합니다.
...
**설명:** 반응 프로필 그림을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
