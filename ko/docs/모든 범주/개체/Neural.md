...
**구문:** obj = Neural(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Neural(...Response( column(s) )...)
...
**구문:** obj = Neural(...<Validation( column )>...)
...
**구문:** obj = Neural(...Informative Missing( state=0|1 )...)
...
**구문:** obj = Neural(...Multithreading( state=0|1 )...)
...
**구문:** obj = Neural(...Set Random Seed( number )...)
