...
**구문:** obj = Multidimensional Scaling(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** Data Format( Distance Matrix | Attribute List )
...
**구문:** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)
...
**구문:** Transformation( None | Ratio | Interval | Ordinal )
