...
**구문:** obj = Multidimensional Scaling(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**설명:** 최소 3차원이 필요한 3D 그림을 표시하거나 숨깁니다.
...
**구문:** Data Format( Distance Matrix | Attribute List )&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 거리 행렬 또는 속성 목록이 될 수 있는 데이터 테이블의 형식을 지정합니다.
...
**설명:** 다차원 척도 그림을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**설명:** 반응 변수의 차원 좌표를 데이터 테이블에 저장합니다.
...
**구문:** obj &lt;&lt; Save Proximity

**설명:** 근접성 행렬을 데이터 테이블에 저장합니다. 데이터 형식이 속성 목록인 경우에만 사용할 수 있습니다.
...
obj = dt << Multidimensional Scaling(
	Y(
		:Top incisors, :Bottom incisors, :Top canines, :Bottom canines, :Top premolars, :Bottom premolars,
		:Top molars, :Bottom molars
	),
...
**구문:** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** MDS에 대한 차원을 지정합니다. 기본값은 "2"입니다.
...
**구문:** obj &lt;&lt; Shepard Diagram( state=0|1 )

**설명:** 실제 근접성과 예측된 근접성을 비교하여 그림으로 나타내는 Shepard 다이어그램을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Show Coordinates( state=0|1 )

**설명:** 반응 변수의 차원 좌표를 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Show Proximity( state=0|1 )

**설명:** 반응 변수 간의 실제 및 예측된 근접성 값에 대한 테이블을 표시하거나 숨깁니다.
...
**구문:** Transformation( None | Ratio | Interval | Ordinal )&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 다차원 척도 분석에 대한 변환 선택을 지정합니다.
...
**구문:** obj &lt;&lt; Waern Links( Smallest Portion | Largest Portion, portion, visible )

**설명:** MSD 그림에 대한 Waern 링크를 지정합니다. 첫 번째 인수는 링크를 가장 작은 부분에 대해 그릴 것인지 아니면 가장 큰 부분에 대해 그릴 것인지를 지정합니다. 두 번째 인수는 부분값을 지정합니다. 세 번째 인수는 Waern 링크 컨트롤을 표시할 것인지 여부를 지정하는 부울입니다.
