...
obj = dt << Attribute Chart( Y( :A, :B, :C ), X( :Part ), Standard( :Standard ), By( _bycol ) );
...
**구문:** obj = Attribute Chart(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Attribute Chart(...&lt;By( column(s) )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Attribute Chart(...&lt;Freq( column )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
obj = dt << Attribute Chart( Y( :A, :B, :C ), X( :Part ), Standard( :Standard ), Freq( _freqcol ) );

```

### Grouping

**구문:** obj = Attribute Chart(...Grouping( column(s) )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 평가를 그룹화하는 분류 열을 지정합니다(일반적으로 부품).
...
**구문:** obj = Attribute Chart(...Response( column(s) )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 각 평가자가 제공하는 평가 열을 지정합니다.
...
**구문:** obj = Attribute Chart(...&lt;Standard( column )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 각 그룹화 변수(부품) 수준에 대해 알려진 값을 포함하는 참조 열을 지정합니다.
...
**구문:** obj = Attribute Chart(...X( column(s) )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Attribute Chart(...Y( column(s) )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Agreement by Rater Confid Intervals( state=0|1 )

**설명:** 효율성 그래프에 셀 합치도(%)에 대한 신뢰 구간을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Attribute Gauge Charts( state=0|1 )

**설명:** 계수형 게이지 차트를 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Connect Agreement Points( state=0|1 )

**설명:** 계수형 게이지 차트와 효율성 그래프에 모두 셀 그룹 내 셀 평균을 연결하는 선을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Connect Effectiveness Points( state=0|1 )

**설명:** 계수형 게이지 차트와 효율성 그래프에 모두 평가자와 표준 간의 합치도(%) 값을 연결하는 빨간색 선을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Effectiveness Report( state=0|1 )

**설명:** 합치 개수, 유효성, 오분류 및 적합성이 포함된 보고서를 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Effectiveness by Rater Confid Intervals( state=0|1 )

**설명:** 효율성 그래프에 셀 유효성 백분율에 대한 신뢰 구간을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Show Agreement Grand Mean( state=0|1 )

**설명:** 계수형 게이지 차트에서 전체 합치도(%) 값에 선을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Show Agreement Group Means( state=0|1 )

**설명:** 계수형 게이지 차트에서 그룹 내 합치도(%) 값에 선을 표시하거나 숨깁니다. 이 옵션을 사용하려면 두 개 이상의 그룹화 변수가 필요합니다.
...
**구문:** obj &lt;&lt; Show Agreement Points( state=0|1 )

**설명:** 계수형 게이지 차트와 효율성 그래프에 모두 합치 점을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Show Effectiveness Points( state=0|1 )

**설명:** 계수형 게이지 차트와 효율성 그래프에 모두 유효성 점을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Calculate Escape Rate( state=0|1 )

**설명:** 지정된 부적합 확률에 기반한 이탈률이 포함된 보고서를 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Change Conforming Category( state=0|1 )

**설명:** 적합 식별자로 사용되는 범주를 지정합니다.
...
**구문:** Attribute Chart( Probability of Nonconformance( probability ) )

**설명:** 이후 이탈률 계산에 사용하기 위한 부적합 확률을 설정합니다.
