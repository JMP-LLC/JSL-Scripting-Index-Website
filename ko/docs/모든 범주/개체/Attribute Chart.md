...
**구문:** obj = Attribute Chart(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Attribute Chart(...<By( column(s) )>...)
...
**구문:** obj = Attribute Chart(...<Freq( column )>...)
...
**구문:** obj = Attribute Chart(...Grouping( column(s) )...)
...
**구문:** obj = Attribute Chart(...Response( column(s) )...)
...
**구문:** obj = Attribute Chart(...<Standard( column )>...)
...
**구문:** obj = Attribute Chart(...X( column(s) )...)
...
**구문:** obj = Attribute Chart(...Y( column(s) )...)
