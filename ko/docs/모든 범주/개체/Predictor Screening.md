...
**구문:** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Predictor Screening(...<By( column(s) )>...)
...
**구문:** obj = Predictor Screening(...Response( column(s) )...)
...
**구문:** obj = Predictor Screening(...X( column(s) )...)
...
**구문:** obj = Predictor Screening(...Y( column(s) )...)
