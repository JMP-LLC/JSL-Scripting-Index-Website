...
**구문:** obj = Variability Chart(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Variability Chart(...<By( column(s) )>...)
...
**구문:** obj = Variability Chart(...<Freq( column )>...)
...
**구문:** obj = Variability Chart(...<Grouping( column(s) )>...)
...
**구문:** obj = Variability Chart(...Response( column(s) )...)
...
**구문:** obj = Variability Chart(...<Standard( column )>...)
...
**구문:** obj = Variability Chart(...<X( column(s) )>...)
...
**구문:** obj = Variability Chart(...Y( column(s) )...)
...
**구문:** obj = Variability Chart(...Analysis Type( "최선의 분석(EMS REML 베이지안) 선택"|"최선의 분석(EMS REML) 선택"|"REML 분석 사용"|"베이지안 분석 사용" )...)
...
**구문:** obj = Variability Chart(...Conv Limit( number )...)
...
**구문:** obj = Variability Chart(...Max Iter( number )...)
...
**구문:** obj = Variability Chart(...Number Function Evals( number )...)
...
**구문:** obj = Variability Chart(...Number Integration Abscissas( number )...)
...
**구문:** obj = Variability Chart(...Set Alpha Level( number )...)
...
**구문:** obj = Variability Chart(...Set Random Seed( number )...)
...
**구문:** obj = Variability Chart(...Sigma Multiplier( number=6 )...)
