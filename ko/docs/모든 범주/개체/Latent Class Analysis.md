...
**구문:** obj = Latent Class Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Latent Class Analysis(...&lt;By( column(s) )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Latent Class Analysis(...&lt;Freq( column )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Latent Class Analysis(...&lt;ID( column )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Latent Class Analysis(...&lt;Weight( column )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Latent Class Analysis(...Y( column(s) )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; New Number of Clusters( number )

**설명:** 다른 개수의 군집을 사용하여 다른 분석을 실행할 수 있습니다.
...
**구문:** obj = Latent Class Analysis(...Number of Clusters( number=3 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 잠재 계층의 수를 지정합니다. 기본값은 "3"입니다.
...
**구문:** obj = Latent Class Analysis(...Up to( number )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 군집의 최대 개수를 지정합니다. 이 숫자가 지정된 군집 수를 초과하면 해당 범위의 각 정수 값에 대해 잠재 계층 분석이 생성됩니다.
...
**구문:** obj&lt;&lt;(Fit[number] &lt;&lt; Color By Cluster)

**설명:** 가장 확률이 높은 군집에 따라 데이터 테이블의 행에 색상을 적용합니다.
...
**구문:** obj &lt;&lt; ( fit[number] &lt;&lt; Effect Sizes( state=0|1 ) )

**설명:** 효과 크기에 대한 테이블을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; (Fit[number] &lt;&lt; Get Probability Formulas)
...
**구문:** obj &lt;&lt; ( fit[number] &lt;&lt; MDS Plot( state=0|1 ) )

**설명:** 군집 근접성을 2차원으로 표현하는 MDS 그림을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; ( fit[number] &lt;&lt; Mixture Probabilities( state=0|1 ) )

**설명:** 혼합 확률에 대한 테이블을 표시하거나 숨깁니다.
...
**설명:** 음의 로그 가능도, 모수 수, BIC 및 AIC 값을 포함하는 모형 요약 테이블을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; ( fit[number] &lt;&lt; Parameter Estimates( state=0|1 ) )

**설명:** 모수 추정값에 대한 테이블 및 그래픽 형식의 요약을 포함하는 모수 추정값 보고서를 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; (Fit[number] &lt;&lt; Publish Probability Formulas)
...
**구문:** obj &lt;&lt; (Fit[number]&lt;&lt;Rename Clusters( {argument list} )

**설명:** 보고서에서 군집에 대해 의미 있는 이름을 부여할 수 있습니다. 인수 목록이 지정되지 않은 경우 군집 이름을 제공하라는 메시지가 표시됩니다.
...
**구문:** obj &lt;&lt; (Fit[number] &lt;&lt; Save Cluster Formula Only)
...
**구문:** obj &lt;&lt; (Fit[number] &lt;&lt; Save Cluster Only)

**설명:** 각 행에 대해 최대 확률 분류 군집이 포함된 열을 데이터 테이블에 저장합니다.
...
**구문:** obj &lt;&lt; (Fit[number] &lt;&lt; Save Mixture Probabilities)
...
**구문:** obj &lt;&lt; (Fit[number] &lt;&lt; Save Mixture and Cluster Formulas)
...
**구문:** obj &lt;&lt; ( fit[number] &lt;&lt; Transposed Parameter Estimates( state=0|1 ) )

**설명:** 모수 추정값에 대한 전치 테이블을 표시하거나 숨깁니다.
