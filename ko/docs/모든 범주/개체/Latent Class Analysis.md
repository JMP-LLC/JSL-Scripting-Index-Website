...
**구문:** obj = Latent Class Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Latent Class Analysis(...<By( column(s) )>...)
...
**구문:** obj = Latent Class Analysis(...<Freq( column )>...)
...
**구문:** obj = Latent Class Analysis(...<ID( column )>...)
...
**구문:** obj = Latent Class Analysis(...<Weight( column )>...)
...
**구문:** obj = Latent Class Analysis(...Y( column(s) )...)
...
**구문:** obj = Latent Class Analysis(...Number of Clusters( number=3 )...)
...
**구문:** obj = Latent Class Analysis(...Up to( number )...)
