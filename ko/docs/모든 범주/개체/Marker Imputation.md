...
**구문:** obj = Marker Imputation(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Marker Imputation(...Imputation Value( number=0 )...)
...
**구문:** obj = Marker Imputation(...Method( "LD-kNN"|"HWE 해제"|"HWE 설정"|"랜덤"|"지정됨"="LD-kNN" )...)
...
**구문:** obj = Marker Imputation(...Nearest Markers( number=15 )...)
...
**구문:** obj = Marker Imputation(...Nearest Samples( number=15 )...)
...
**구문:** obj = Marker Imputation(...Ploidy( number=2 )...)
...
**구문:** obj = Marker Imputation(...Set Random Seed( number=0 )...)
...
**구문:** obj = Marker Imputation(...Unthreaded( state=0|1 )...)
