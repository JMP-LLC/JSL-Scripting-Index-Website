...
**구문:** obj = Association Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Association Analysis(...<By( column(s) )>...)
...
**구문:** obj = Association Analysis(...<ID( column(s) )>...)
...
**구문:** obj = Association Analysis(...Item( column(s) )...)
...
**구문:** obj = Association Analysis(...Maximum Antecedents( number=3 )...)
...
**구문:** obj = Association Analysis(...Maximum Rule Size( number=4 )...)
...
**구문:** obj = Association Analysis(...Minimum Confidence( number=0.40 )...)
...
**구문:** obj = Association Analysis(...Minimum Lift( number=1.2 )...)
...
**구문:** obj = Association Analysis(...Minimum Support( fraction=0.10 )...)
