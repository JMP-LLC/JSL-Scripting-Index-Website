...
**구문:** obj = Multivariate(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Multivariate(...Matrix Format( "하삼각"|"상삼각"|"정사각" )...)
...
**구문:** Variance Estimation( REML|ML|Robust|Row-wise|Pairwise )
