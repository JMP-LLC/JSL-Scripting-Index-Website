...
**구문:** obj = Fit Causal Treatment(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Generalized Linear Model(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Model(...Personality( "Generalized Linear Model" ), "Firth Bias-Adjusted Estimates"n( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Generalized Linear Model" ), GLM Distribution( distribution name )...)
...
**구문:** obj = Fit Model(...Personality( "Generalized Linear Model" ), Link Function( link type )...)
...
**구문:** obj = Fit Model(...Personality( "Generalized Linear Model" ), Overdispersion Tests and Intervals( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Generalized Linear Model" ), Power Link Parameter( value=1 )...)
...
**구문:** scrobj << LSMeans Contrast( [ l1, l2, l3, ... ] );
...
**구문:** scrobj << LSMeans Dunnett( state=0|1|<alpha>, Control Level( level ), <comparison options> );
...
**구문:** scrobj << Student&apos;s t( state=0|1|<alpha>, <comparison options> );
...
**구문:** scrobj << LSMeans Table( state=0|1 );
...
**구문:** scrobj << LSMeans Tukey HSD( state=0|1|<alpha>, <comparison options> );
...
**구문:** scrobj << Power Analysis( Alpha(from, to, by), Sigma(from, to, by), Delta(from, to, by), Number(from, to, by), objective, <Power Plot>, <Done>);
...
**구문:** scrobj << Test Slices( state=0|1 );
...
**구문:** scrobj << Comparisons with Control( state=0|1, Control Level( level ), <options> );
...
**구문:** scrobj << Comparisons with Overall Average( state=0|1, <options> );
...
**구문:** scrobj << Equivalence Tests( number );
...
**구문:** scrobj << Least Squares Means Plot;
...
**구문:** scrobj << Slice F Test( state=0|1 );
...
**구문:** scrobj << Student&apos;s t( state=0|1, <options> );
...
**구문:** scrobj << Tukey HSD( state=0|1, <options> );
...
**구문:** obj = Fit Model(...Convergence Limit( number=0.00000001 )...)
...
**구문:** obj = Fit Model(...Maximum Iterations( number=100 )...)
...
**구문:** obj = Fit Model(...Personality( "Standard Least Squares" ), Method( "EMS" | "REML" )...)
...
**구문:** obj = Fit Model(...Personality( "Standard Least Squares" ), NoBounds( state=0|1 )...)
...
**구문:** obj = Individual Response Fit(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Least Squares Personality(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Prediction Formula(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Manova(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Mixed(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Nominal Logistic(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Ordinal Logistic(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Parametric Survival(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Model(...Distribution("Weibull"|"Lognormal"|"Exponential"|"Frechet"|"Loglogistic"|"All Distributions"|"SEV"|"Normal"|"LEV"|"Logistic"...)
...
**구문:** obj = Fit Proportional Hazards(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Response Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Stepwise Personality(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Estimate Only Variance Components(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit GLMM Platform(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Generalized(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Model(...Personality( "Response Screening" ), Subgroup( column(s) )...)
...
**구문:** obj = Fit Model(...Switch( column(s) )...)
...
**구문:** obj = Fit Model(...Personality( "Response Screening" ), Cauchy Fit( state=0|1 )...)
...
**구문:** obj = Fit Model(...Censor Code( string )...)
...
**구문:** obj = Fit Model(...Center Polynomials( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Partial Least Squares" ), Centering( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Nominal Logistic" ), Choose High Target( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Standard Least Squares" ), Emphasis( "Effect Leverage" | "Effect Screening" | "Minimal Report" )...)
...
**구문:** obj = Fit Model(...Personality( "Standard Least Squares" ), Estimate Only Variance Components( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Generalized Regression" ), Generalized Distribution( distribution name )...)
...
**구문:** obj = Fit Model(...Personality( "Partial Least Squares" ), Imputation Method( "Mean" | "EM" )...)
...
**구문:** obj = Fit Model(...Personality( "Partial Least Squares" ), Impute Missing Data( state=0|1 )...)
...
**구문:** obj = Fit Model(...Informative Missing( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Partial Least Squares" ), Max Iterations( number=1 )...)
...
**구문:** obj = Fit Model(...No Intercept( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Standard Least Sqaures" | "Stepwise" | "Generalized Regression" | "Mixed Model" | "Generalized Linear Mixed Model" | "Manova" | "Loglinear Variance" | "Nominal Logistic" | "Ordinal Logistic" | "Proportional Hazard" | "Parametric Survival" | "Generalized Linear Model" | "Partial Least Squares" | "Response Screening" )...)
...
**구문:** obj = Fit Model(...Personality( "Response Screening" ), Robust Fit( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Partial Least Squares" ), Scaling( state=0|1 )...)
...
**구문:** obj = Fit Model(...Set Alpha Level( state=0|1 )...)
...
**구문:** obj = Fit Model(...Personality( "Partial Least Squares" ), Standardize X( state=0|1 )...)
...
**구문:** obj = Fit Model(...Suppress Coding( state=0|1 )...)
...
**구문:** obj = Fit Model(...Suppress Warning for Missing Effects( state=0|1 )...)
