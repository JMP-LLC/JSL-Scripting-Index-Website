...
**구문:** obj << Continuous Correlation Type( "가우시안"|"Matern 3/2"|"Matern 5/2"|"지수"="Matern 5/2" )

**설명:** 기본값은 "Matern 5/2"입니다.

### Copy All Model Fits Script

**구문:** obj << Copy All Model Fits Script

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 클립보드에 넣습니다.

### Copy Startup Script

**구문:** obj << Copy Startup Script
...
**구문:** obj << Model Based Augmentation RSquare Threshold( number )

### Nominal Correlation Type

**구문:** obj << Nominal Correlation Type( "동일한 상관"|"Unequal Correlations"="동일한 상관" )

**설명:** 기본값은 "동일한 상관"입니다.

### Ordinal Correlation Type

**구문:** obj << Ordinal Correlation Type( "동일한 상관"|"Unequal Correlations"|"Latent Variable"="동일한 상관" )

**설명:** 기본값은 "동일한 상관"입니다.

### Save All Model Fits Script to Data Table

**구문:** obj << Save All Model Fits Script to Data Table

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 데이터 테이블에 테이블 특성으로 저장합니다.

### Save All Model Fits Script to Journal

**구문:** obj << Save All Model Fits Script to Journal

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 이 스크립트가 포함된 저널에 버튼을 추가합니다.

### Save All Model Fits Script to Report

**구문:** obj << Save All Model Fits Script to Report

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 보고서 자체에 표시합니다. 수행된 작업에 대한 인쇄된 기록을 유지하려는 경우에 유용합니다.

### Save All Model Fits Script to Script Window

**구문:** obj << Save All Model Fits Script to Script Window

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 현재 스크립트 텍스트 창에 추가합니다.

### Save Startup Script to Data Table

**구문:** obj << Save Startup Script to Data Table

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 데이터 테이블에 테이블 특성으로 저장합니다.

### Save Startup Script to Journal

**구문:** obj << Save Startup Script to Journal

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 이 스크립트가 포함된 저널에 버튼을 추가합니다.

### Save Startup Script to Report

**구문:** obj << Save Startup Script to Report

**설명:** 이 분석을 수행하기 위한 JSL 스크립트를 생성하고 보고서 자체에 표시합니다. 수행된 작업에 대한 인쇄된 기록을 유지하려는 경우에 유용합니다.

### Save Startup Script to Script Window

**구문:** obj << Save Startup Script to Script Window
