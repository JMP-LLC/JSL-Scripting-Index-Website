...
**구문:** obj = Model Driven Multivariate Control Chart(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Change Point Detection( state=0|1 )

**설명:** 행 번호 및 산점도 행렬로 표시되는 통계량의 단계 감지 그림을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Diagnose the Process( state=0|1 )
...
**구문:** obj = Model Driven Multivariate Control Chart(...Historical Data End at Row( number )...)

**설명:** 지정된 행 번호를 기준으로 관측값이 과거 데이터와 현재 데이터로 나뉩니다.
...
**구문:** obj &lt;&lt; Normalized DModX Plot( state=0|1 )

**설명:** 정규화된 DModX 값의 그림을 표시하거나 숨깁니다. DModX는 각 관측값에서 PCA 또는 PLS 모형까지의 거리를 측정합니다.
...
**구문:** obj &lt;&lt; Score Plot( state=0|1 )

**설명:** 주성분 또는 부분 최소 제곱 요인의 스코어 그림을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Set Alpha Level( "0.01"|"0.05"|"0.10"|"0.50"|"기타…" )

**설명:** 결정 한계를 계산하는 데 사용되는 유의 수준을 지정합니다.
...
**구문:** obj &lt;&lt; Set Component( number )

**설명:** T², DModX 및 SPE 그림의 성분 수를 설정할 수 있습니다.
...
**구문:** obj &lt;&lt; Set α Level( "0.01"|"0.05"|"0.10"|"0.50"|"기타…" )
...
**설명:** 제외된 행을 그림에 표시하거나 숨깁니다. 이 옵션을 선택하면 제외된 행이 관리이탈 점 개수에 포함되지만 수치 계산에서는 제외됩니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Show History Summary Statistics( state=0|1 )

**설명:** 고유값, 주성분 적재, 그리고 공정 변수 평균 및 표준편차를 포함하는 요약 통계량을 표시하거나 숨깁니다. 평균 및 표준편차는 과거 데이터에서 계산되어 현재 데이터에 대한 주성분 스코어, T 제곱, SPE(제곱 예측 오차) 및 DModX 통계량을 계산하는 데 사용됩니다.
...
**구문:** obj &lt;&lt; Show Monitoring Plots( state=0|1 )

**설명:** 선택된 공정 모니터링 그림을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Squared Prediction Error Plot( state=0|1 )

**설명:** SPE(제곱 예측 오차)의 그림을 표시하거나 숨깁니다. SPE는 PCA 또는 PLS 모형의 제곱 잔차 합을 측정합니다.
...
**구문:** obj &lt;&lt; T² Plot( state=0|1 )

**설명:** T² 통계량의 그림을 표시하거나 숨깁니다. T²는 관측값이 PCA 또는 PLS 모형의 중심에서 얼마나 멀리 떨어져 있는지를 측정합니다. 기본적으로 설정되어 있습니다.
