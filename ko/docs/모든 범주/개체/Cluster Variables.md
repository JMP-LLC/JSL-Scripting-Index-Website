...
**구문:** obj = Cluster Variables(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Cluster Variables(...<By( column(s) )>...)
...
**구문:** obj = Cluster Variables(...Columns( column(s) )...)
...
**구문:** obj = Cluster Variables(...<Freq( column )>...)
...
**구문:** obj = Cluster Variables(...<Weight( column )>...)
...
**구문:** obj = Cluster Variables(...Y( column(s) )...)
