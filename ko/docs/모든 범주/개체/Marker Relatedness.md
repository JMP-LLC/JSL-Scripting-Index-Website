...
**설명:** 가법적 유전체 관계 행렬에 대한 추정 방법을 지정합니다. 기본값은 "이배체 방법 1"입니다.
...
**구문:** obj = Marker Relatedness(...Epistasis Type( "가법적 x 가법적"|"가법적 x 우성"|"우성 x 우성"="가법적 x 가법적" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 표지자에서 계산할 상위성 유전체 관계 행렬의 유형을 지정합니다. 기본값은 "가법적 x 가법적"입니다.
...
**구문:** obj = Marker Relatedness(...Kinship Type( "상태 동일성"|"가법적"|"우성"|"상위성"="상태 동일성" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
