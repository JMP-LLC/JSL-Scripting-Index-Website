...
**구문:** obj = Marker Relatedness(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Marker Relatedness(...Additive Type( "이배체 방법 1"|"이배체 방법 2"|"배수체"="이배체 방법 1" )...)
...
**구문:** obj = Marker Relatedness(...Clustering( state=0|1 )...)
...
**구문:** obj = Marker Relatedness(...Dominance Type( "이배체 방법 1"|"이배체 방법 2"|"배수체"="이배체 방법 1" )...)
...
**구문:** obj = Marker Relatedness(...Epistasis Type( "상가적 x 상가적"|"상가적 x 우성"|"우성 x 우성"="상가적 x 상가적" )...)
...
**구문:** obj = Marker Relatedness(...Imputation Value( number=0 )...)
...
**구문:** obj = Marker Relatedness(...Kinship Type( "상태별 동일성"|"상가적"|"우성"|"상위성"="상태별 동일성" )...)
...
**구문:** obj = Marker Relatedness(...Missing Marker Imputation Method( "HWE 해제"|"HWE 설정"|"랜덤"|"지정됨"="HWE 해제" )...)
...
**구문:** obj = Marker Relatedness(...Ploidy( number=2 )...)
...
**구문:** obj = Marker Relatedness(...Principal Components( state=0|1 )...)
...
**구문:** obj = Marker Relatedness(...Set Random Seed( number=0 )...)
...
**구문:** obj = Marker Relatedness(...Unthreaded( state=0|1 )...)
