...
**구문:** obj = Marker Simulation(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Cross( column(s) )

**설명:** 표본을 블록으로 그룹화하는 열을 지정합니다. 그러면 서로 다른 그룹의 표본 간에 교배가 수행됩니다.
...
**구문:** obj &lt;&lt; Predictor Formula( column(s) )

**설명:** 반응 또는 형질에 대한 예측 계산식을 포함하는 열을 지정합니다.
...
**구문:** obj = Marker Simulation(...Estimate Diversity( state=0|1 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 시뮬레이션된 개체의 유전적 다양성을 추정합니다.
...
**구문:** obj = Marker Simulation(...Imputation Value( number=0 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Simulation(...Missing Marker Imputation Method( "HWE 해제"|"HWE 설정"|"랜덤"|"지정됨"="HWE 해제" )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Simulation(...Number of Generations( number=1 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 교배 및 선택 과정에서 처리할 세대 수를 지정합니다. 기본값은 "1"입니다.
...
**구문:** obj = Marker Simulation(...Number of Individuals per Cross( number=5 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 교배당 시뮬레이션할 개체 수를 지정합니다. 기본값은 "5"입니다.
...
**구문:** obj = Marker Simulation(...Number of Selected Crosses( number=0 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 세대당 선택할 최대 가계 수를 지정합니다. 기본값은 "0"입니다.
...
**구문:** obj = Marker Simulation(...Number of Selected Individuals( number=0 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 가계당 선택할 최대 개체 수를 지정합니다. 기본값은 "0"입니다.
...
**구문:** obj = Marker Simulation(...Ploidy( number=2 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 배수성 수준을 나타내는 짝수를 지정합니다. 기본값은 "2"입니다.
...
**구문:** obj &lt;&lt; Save Simulated Table

**설명:** 시뮬레이션된 유전자형을 새 데이터 테이블에 저장합니다.
...
**구문:** obj = Marker Simulation(...Select Best Individuals( state=0|1 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 예측 변수 계산식의 규격 한계 열 특성에 지정된 모든 기준을 충족하는 최선 개체를 선택합니다.
...
**구문:** obj = Marker Simulation(...Set Random Seed( number=0 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Show Diversity Plot( state=1 )

**설명:** 유전적 다양성 그림을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Show Evaluation Plot( state=1 )

**설명:** 유전자 통계량 그림을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj = Marker Simulation(...Threshold to Make Line Plots( number=500 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 보고서에 선 그림을 그리기 위한 최대 교배 수를 지정합니다. 총 교배 수가 이 임계값보다 작으면 선 그림이 그려집니다. 기본값은 "500"입니다.
...
**구문:** obj = Marker Simulation(...Unthreaded( state=0|1 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Simulation(...Use Annotation Table( state=0|1 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Simulation(...Use Only Markers Found in Predictor Formula( state=0|1 )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 예측 변수 계산식에 있는 표지자만 시뮬레이션합니다.
