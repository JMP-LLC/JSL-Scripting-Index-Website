...
**구문:** obj = Type 1 Gauge(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** Type 1 Gauge( Y( column ) )

**설명:** 하나의 참조 부품에서 측정 공정의 반복성 및 치우침을 평가하기 위해 유형 1 게이지 방법을 사용하여 측정 시스템을 분석합니다.
...
**구문:** obj = Type 1 Gauge(...&lt;By( column(s) )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
obj = dt << Type 1 Gauge(
	Y( :Y1 ),
	Type 1 Gauge Metadata( :Y1( Tolerance Range( 2 ), Reference( 50.014 ), Resolution( .001 ) ) ),
	By( _bycol )
);
...
**구문:** obj = Type 1 Gauge(...&lt;Freq( column )&gt;...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Type 1 Gauge(...Measurement( column(s) )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Type 1 Gauge(...Y( column(s) )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Type 1 Gauge(...Percent of Tolerance( number=20 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 측정 변동과 비교하는 데 사용되는 부품 공차의 백분율을 변경합니다. 기본값은 "20"입니다.
...
**구문:** obj &lt;&lt; Save Type 1 Gauge Metadata as Column Properties

**설명:** 각 측정 데이터 열에 대해 유형 1 게이지 메타데이터를 원래 데이터 테이블의 열 내에 MSA 메타데이터 열 특성으로 저장합니다.
...
**구문:** obj &lt;&lt; Save Type 1 Gauge Metadata to Table

**설명:** 각 측정 데이터 열에 대한 유형 1 게이지 메타데이터가 포함된 새 데이터 테이블을 생성합니다. 이 테이블은 세로형 형식이고 각 측정 변수에 대한 행을 포함합니다.
...
**구문:** obj = Type 1 Gauge(...Set Alpha Level( number=.05 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 치우침 검정에 사용되는 유의 수준을 지정합니다. 기본값은 ".05"입니다.
...
**구문:** obj = Type 1 Gauge(...Sigma Multiplier( number=6 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Type 1 Gauge Analysis

**설명:** 각 측정 반응에 대한 유형 1 게이지 분석 보고서 옵션을 지정합니다.
...
**구문:** obj &lt;&lt; Customize Summary and Capability Statistics(statistic1( state=0|1 ), statistic2( state=0|1 ), ..., statisticN( state=0|1 )

**설명:** Customizes the summary statistics that are displayed in the Summary and Capability Statistics report.
...
obj = dt << Type 1 Gauge(
	Y( :Y1 ),
	Type 1 Gauge Metadata(
		:Y1( Lower Tolerance( 49.014 ), Upper Tolerance( 51.014 ), Reference( 50.014 ), Resolution( .001 ) )
	)
);
obj << (Type 1 Gauge Analysis[1] << Summary and Capability Statistics(
	1,
...
Report( obj )["Type 1 Gauge Analysis for Y1", "Summary and Capability Statistics"] << Close( 1 );
...
**구문:** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Bias Test( state=0|1 ))

**설명:** 유형 1 게이지 분석 보고서에 관측된 측정값의 평균과 참조 표준 값에 대한 치우침 검정을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Histogram( state=0|1 ))

**설명:** 유형 1 게이지 분석 보고서에 측정 데이터의 히스토그램을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( state=0|1 ))

**설명:** 유형 1 게이지 분석 보고서에 측정 데이터의 런 차트를 표시하거나 숨깁니다. 이 차트에는 참조 값 및 공차 범위 백분율에 대한 측정값의 변동이 표시됩니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Summary and Capability Statistics( state=0|1 ))

**설명:** 유형 1 게이지 요약 및 공정 능력 통계량 테이블을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Histogram(1, Show Count Axis( state=0|1 )))

**설명:** 유형 1 게이지 분석 보고서의 히스토그램 프레임 오른쪽에 개수 축을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Histogram(1, Show Reference( state=0|1 )))

**설명:** 유형 1 게이지 분석 보고서의 히스토그램에 참조선을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( 1, Show Mean( state=0|1 )))

**설명:** 유형 1 게이지 분석 보고서의 런 차트에 평균 선을 표시하거나 숨깁니다.
...
obj = dt << Type 1 Gauge(
	Y( :Y2 ),
	Type 1 Gauge Metadata(
		:Y2( Lower Tolerance( 21.90 ), Upper Tolerance( 27.90 ), Reference( 24.90 ), Resolution( .01 ) )
	)
);
Wait( 1 );
...
**구문:** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( 1, Show Portion of Tolerance( state=0|1 )))

**설명:** 유형 1 게이지 분석 보고서의 런 차트에 공차 비율 선을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( 1, Show Reference( state=0|1 )))

**설명:** 유형 1 게이지 분석 보고서의 런 차트에 참조선을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
