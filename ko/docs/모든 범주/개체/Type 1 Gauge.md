...
**구문:** obj = Type 1 Gauge(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Type 1 Gauge(...<By( column(s) )>...)
...
**구문:** obj = Type 1 Gauge(...<Freq( column )>...)
...
**구문:** obj = Type 1 Gauge(...Measurement( column(s) )...)
...
**구문:** obj = Type 1 Gauge(...Y( column(s) )...)
...
**구문:** obj = Type 1 Gauge(...Percent of Tolerance( number=20 )...)
...
**구문:** obj = Type 1 Gauge(...Set Alpha Level( number=.05 )...)
...
**구문:** obj = Type 1 Gauge(...Sigma Multiplier( number=6 )...)
