...
**구문:** obj = Uplift(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Uplift(...Informative Missing( state=0|1 )...)
...
**구문:** obj = Uplift(...Ordinal Restricts Order( state=0|1 )...)
...
**구문:** obj = Uplift(...Validation Portion( fraction=0 )...)
