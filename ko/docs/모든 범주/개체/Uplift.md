...
**구문:** obj = Uplift(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Get Difference Formula

**설명:** 차이 계산식을 생성하기 위한 스크립트를 생성한 후 반환합니다.
...
**구문:** obj = Uplift(...Informative Missing( state=0|1 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Uplift(...Ordinal Restricts Order( state=0|1 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Publish Difference Formula

**설명:** 차이 계산식을 생성하여 계산식 저장소에 계산식 열 스크립트로 게시합니다.
...
**구문:** obj &lt;&lt; Save Difference Formula

**설명:** 예측 처리 차이와 함께 계산식 열을 저장합니다.
...
**구문:** obj &lt;&lt; Uplift Graph( state=0|1 )

**설명:** 정렬된 종점 잎 간에 업리프트를 표시합니다.
...
**구문:** obj = Uplift(...Use Excluded Rows for Validation( state=0|1 )...)
...
**구문:** obj = Uplift(...Validation Portion( fraction=0 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
