...
**구문:** obj = Y(...<Attribute ID( column(s) )>...)
...
**구문:** obj = Hierarchical Cluster(...Add Spatial Measures( state=0|1 )...)
...
**구문:** obj = Hierarchical Cluster(...Hybrid Cycles( number=30 )...)
...
**구문:** obj = Hierarchical Cluster(...Hybrid Goal( number=400 )...)
...
**구문:** obj = Hierarchical Cluster(...Hybrid Initial K( number=10 )...)
...
**구문:** obj = Hierarchical Cluster(...Hybrid Log Details( state=0|1 )...)
...
**구문:** obj = Hierarchical Cluster(...Hybrid RandomPCA Dim( number=0 )...)
...
**구문:** Method( "Average"|"Centroid"|"Ward"|"Single"|"Complete"|"Fast Ward"|"Hybrid Ward" )
...
**구문:** obj = Hierarchical Cluster(...Missing value imputation( state=0|1 )...)
...
**구문:** obj = Hierarchical Cluster(...Standardize By( "표준화되지 않음"|"열"|"행"|"열 및 행" )...)
...
**구문:** obj = Hierarchical Cluster(...Standardize Robustly( state=0|1 )...)
...
**구문:** obj = Hierarchical Cluster(...Two Way Clustering...)
...
**구문:** obj = Hierarchical Cluster(...Use Saved Cluster Table( state=0|1 )...)
