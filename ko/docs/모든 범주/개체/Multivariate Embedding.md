...
**구문:** obj = Multivariate Embedding(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** Batch Mode if N greater than( number = 4096 )
...
**구문:** Convergence Criterion( number = 1e-8 )
...
**구문:** Distance Metric( "Euclidean" |  "Angular" | "Hamming" | "Manhattan")
...
**구문:** Gradient Descent Method( "SGD" |  "ADAM")
...
**구문:** Inflate Iterations( number = 250 )
...
**구문:** Initial Principal Component Dimensions( number = 50 )
...
**구문:** Initial Scale( number = 0.0001 )
...
**구문:** Local Connectivity( number = 1 )
...
**구문:** Maximum Iterations( number = 1000 )
...
**구문:** Minimum Distance( number = 0.01 )
...
**구문:** Nearest Neighbor Method( "Default" | "VPTree (Exact)" |  "ANNOY (Approximate)")
...
**구문:** Negative Sample Rate( number = 5 )
...
**구문:** Number of Epochs( number = 500 )
...
**구문:** Number of Neighbors( number = 15 )
