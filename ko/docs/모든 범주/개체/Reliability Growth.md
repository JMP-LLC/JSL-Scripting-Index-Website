...
**구문:** obj << Cumulative Events Plot( Crow AMSAA( state=0|1 ) );
...
**구문:** obj << Cumulative Events Plot( Crow AMSAA with Modified MLE( state=0|1 ) );
...
**구문:** obj << Cumulative Events Plot( Fixed Parameter Crow AMSAA( state=0|1 ) );
...
**구문:** obj << Cumulative Events Plot( Piecewise Weibull NHPP( state=0|1 ) );
...
**구문:** obj << Cumulative Events Plot( Piecewise Weibull NHPP Change Point Detection( state=0|1 ) );
...
**구문:** obj << Cumulative Events Plot( Reinitialized Weibull NHPP( state=0|1 ) );
...
**구문:** obj << Mean Time Between Failures Plot( ... );
...
**구문:** obj << Mean Time Between Failures( Options( Sample MTBF Type( "Customized Average MTBF" ), Customize Average MTBF( vector ) ) );
...
**구문:** obj << Mean Time Between Failures( Options( Sample MTBF Type( "Equal Interval Average MTBF" ), Interval Size( number ) ) );
...
**구문:** obj << Mean Time Between Failures( Options( ... ) );
...
**구문:** obj << Mean Time Between Failures( Options( Sample MTBF Type( "Equal Interval Average MTBF"|"Customized Average MTBF" ) ) );
