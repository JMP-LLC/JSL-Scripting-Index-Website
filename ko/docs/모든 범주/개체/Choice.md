...
**구문:** obj = Choice(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Choice(...<Profile Effects( column )>...)
...
**구문:** Choice( Response Profile ID Chosen( column ), ... )
...
**구문:** obj = Choice(...<Subject Effects( column )>...)
...
**구문:** obj = Choice(...Convergence Criterion( number )...)
...
**구문:** obj = Choice(...Firth Bias-Adjusted Estimates( state=0|1 )...)
...
**구문:** obj = Choice(...Hierarchical Bayes( state=0|1 )...)
...
**구문:** obj = Choice(...Number of Bayesian Iterations( number )...)
...
**구문:** obj = Choice(...Remove Subject Effects...)

<b>실행기 항목: 예</b>

### Respondents Are Allowed to Choose None

**구문:** Choice( Respondents Are Allowed to Choose None( state=0|1 ), ... )
