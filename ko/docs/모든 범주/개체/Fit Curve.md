...
**구문:** obj = Fit Curve(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** obj = Fit Curve(...<Regressor( column )>...)
...
**구문:** obj = Fit Curve(...Response( column(s) )...)
...
**구문:** obj = Fit Curve(...<Weight( column )>...)
...
**구문:** obj << Fit Inverse Michaelis Menten; 
...
**구문:** obj << Fit Command( Equivalence Test(..., Equivalence with Ratios( 1, Set Alpha Level( number )))); 
...
**구문:** obj << Fit Command( Equivalence Test(..., Equivalence with Ratios( 1, Set Decision Lines( lower, upper )))); 
...
**구문:** obj << Fit Command( Equivalence Test(..., Equivalence with Ratios( 1, Show Center Line( state=0|1 )))); 
...
**구문:** obj << Fit Command( Equivalence Test(..., Equivalence with Ratios( 1, Show Decision Limit Shading( state=0|1 )))); 
...
**구문:** obj << Fit Command( Equivalence Test(..., Equivalence with Ratios( 1, Show Decision Limits( state=0|1 )))); 
...
**구문:** obj << Fit Command( Equivalence Test(..., Equivalence with Ratios( 1, Show Summary Report( state=0|1 )))); 
...
**구문:** obj << Fit Command( Area Under Curve( state=0|1 )); 
...
**구문:** obj << Fit Command( Compare Parameter Estimates( state=0|1 )); 
...
**구문:** obj << Fit Command( Custom Inverse Prediction( Response( value ))); 
...
**구문:** obj << Fit Command( Equivalence Test( Reference Group( column ))); 
...
**구문:** obj << Fit Command( Inflection Point( state=0|1 )); 
...
**구문:** obj << Fit Command( Make Parameter Table ); 
...
**구문:** obj << Fit Command( Peak Response( state=0|1 ); 
...
**구문:** obj << Fit Command( Plot Actual by Predicted( state=0|1 ); 
...
**구문:** obj << Fit Command( Plot Residual by Predicted( state=0|1 ); 
...
**구문:** obj << Fit Command( Profiler( state=0|1 )); 
...
**구문:** obj << Fit Command( Save Bootstrap Results ); 
...
**구문:** obj << Fit Command( Save First Derivative ); 
...
**구문:** obj << Fit Command( Save Inverse Prediction Formula ); 
...
**구문:** obj << Fit Command( Save Parametric Prediction Formula ); 
...
**구문:** obj << Fit Command( Save Prediction Formula ); 
...
**구문:** obj << Fit Command( Save Residual Formula ); 
...
**구문:** obj << Fit Command( Save Stacked Data ); 
...
**구문:** obj << Fit Command( Save Std Error of First Derivative ); 
...
**구문:** obj << Fit Command( Save Std Error of Predicted ); 
...
**구문:** obj << Fit Command( Save Studentized Residual Formula ); 
...
**구문:** obj << Fit Command( Test Parallelism( state=0|1 )); 
...
**구문:** obj << Fit Command( Time to Peak Response( state=0|1 )); 
