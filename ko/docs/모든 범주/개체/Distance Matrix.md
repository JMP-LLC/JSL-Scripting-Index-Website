...
obj = dt << Distance Matrix( Y( :Sepal length, :Sepal width, :Petal length, :Petal width ), By( _bycol ) );
...
**구문:** obj = Distance Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** Permutations ( number = 1000 )&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** Number of Permutations to Calculate PERMANOVA 기본값은 "1000"입니다.
...
**구문:** Pricpal Components ( number = 2 )&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** Number of Principal Components 기본값은 "2"입니다.
