...
**구문:** obj = Y(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Mean Remaining Life( state=0|1 )obj &lt;&lt; Mean Remaining Life( Configuration(), Compute(), Get Results )
...
**구문:** obj = Life Distribution(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**설명:** 현재 그룹에서 선택한 모든 옵션을 결과의 다른 모든 기준 그룹에 적용합니다.
...
**설명:** 결함 부집단 Fréchet 분포를 데이터에 적합시킵니다. 기본적으로 설정되어 있습니다.
...
**설명:** 결함 부집단 로그로지스틱 분포를 데이터에 적합시킵니다. 기본적으로 설정되어 있습니다.
...
**설명:** 결함 부집단 로그 정규 분포를 데이터에 적합시킵니다. 기본적으로 설정되어 있습니다.
...
**설명:** 결함 부집단 Weibull 분포를 데이터에 적합시킵니다. 기본적으로 설정되어 있습니다.
