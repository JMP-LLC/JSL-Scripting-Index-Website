...
**구문:** Fit Definitive Screening( Y( column ), X( columns ) )

**설명:** DSD(확증적 선별 설계)를 위한 유효 모형 선택이라는 방법론을 사용하여 DSD를 분석합니다. 이 알고리즘은 설계의 고유 구조를 사용하여 주효과와 2차 효과를 식별합니다.
...
**구문:** obj &lt;&lt; Interactions Obey Strong Heredity( state=0|1 )

**JMP추가된 버전:** 14

### Make Model Callback

**구문:** obj &lt;&lt; Make Model Callback

**JMP추가된 버전:** 14

### Quadratic Terms Obey Strong Heredity

**구문:** obj &lt;&lt; Quadratic Terms Obey Strong Heredity( state=0|1 )

**JMP추가된 버전:** 14

### Run Model Callback

**구문:** obj &lt;&lt; Run Model Callback

**JMP추가된 버전:** 14

### Set Stage 1 p value

**구문:** obj &lt;&lt; Set Stage 1 p value

**JMP추가된 버전:** 15

### Set Stage 2 ratio

**구문:** obj &lt;&lt; Set Stage 2 ratio
