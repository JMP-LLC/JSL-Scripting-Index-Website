...
**구문:** obj = Normalization(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** Mean Expression Threshold ( number = 0.05 )
...
**구문:** Create New Tables for Results ( state =0|1 )
...
**구문:** Interpolated Quantiles( state =0|1 )
...
**구문:** Log Transformation( state =0|1 )
...
**구문:** Logratio Threshold ( number = 0.3 )
...
**구문:** Method( "Row Standardize" | "Wrench" )
...
**구문:** Missing Value Imputation( state =0|1 )
...
**구문:** Total Prior Count ( number = 0.25 )
