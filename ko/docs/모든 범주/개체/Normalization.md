...
obj = dt << Normalization( Y( :Sepal length, :Sepal width, :Petal length, :Petal width ), By( _bycol ) );
...
**설명:** MA 그림의 X 축(A 값) 임계 기본값은 "0.05"입니다.
...
**설명:** Create New Tables for Results
...
**설명:** TMM 정규화에서 참조 열을 결정하기 위한 보간 분위수
...
**설명:** Log Transformation of TMM Method
...
**설명:** MA 그림의 Y 축(M 값) 임계 기본값은 "0.3"입니다.
...
**구문:** Method( "Row Standardize" | "Wrench" )&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** Specifies the normalization method.
...
**설명:** 라이브러리 크기 조정을 위한 총 사전 카운트 기본값은 "0.25"입니다.
