...
**구문:** obj = Matched Pairs(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Paired Response( column(s) )
...
**구문:** obj &lt;&lt; Bland Altman Analysis( state=0|1 )

**설명:** Bland-Altman 분석을 표시하거나 숨깁니다. 이 분석은 동일한 변수의 두 측정값을 비교하는 데 사용되는 방법 비교 기법입니다.
...
**구문:** obj &lt;&lt; Bland Altman Percent Analysis( state=0|1 )

**설명:** Bland-Altman 백분율 분석을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Dif Statistics( state=0|1 )

**설명:** 차이 통계량을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Equivalence Tests

**JMP추가된 버전:** 18

### Percent Dif Statistics

**구문:** obj &lt;&lt; Percent Dif Statistics( state=0|1 )

**설명:** 차이 백분율 통계량을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Plot Dif By Mean( state=0|1 )

**설명:** 쌍체 평균별 쌍체 차이 그림을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Plot Dif By Row( state=0|1 )

**설명:** 행 번호별 쌍체 차이 그림을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Plot Percent Dif by Mean( state=0|1 )

**설명:** 평균별 차이 백분율 그림을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Plot Percent Dif by Row( state=0|1 )

**설명:** 행별 차이 백분율 그림을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Reference Frame( state=0|1 )

**설명:** 평균별 차이 그림에 참조 프레임을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**설명:** 분석에 사용되는 유의 수준을 변경합니다. 보고서와 그림 모두의 신뢰 구간에 영향을 줍니다.
...
**구문:** obj &lt;&lt; Sign Test( state=0|1 )

**설명:** 부호 검정을 표시하거나 숨깁니다. 쌍체 t-검정의 비모수 버전입니다.
...
**구문:** obj &lt;&lt; Wilcoxon Signed Rank( state=0|1 )

**설명:** Wilcoxon 부호 순위 검정을 표시하거나 숨깁니다. 쌍체 t-검정의 비모수 버전입니다.
