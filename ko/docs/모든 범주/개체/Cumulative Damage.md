...
**구문:** obj << Model Type( Step Stress | Ramp Stress | Sinusoid Stress | Piecewise Ramp Stress )

**설명:** 누적 손상 모형에 대한 스트레스 패턴 유형을 지정합니다. 이 옵션은 시작 스크립트에 지정해야 합니다.
