...
**구문:** obj = Parallel Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**구문:** Parallel Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**구문:** Parallel Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
