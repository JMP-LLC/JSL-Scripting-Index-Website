...
**구문:** obj = Parallel Plot(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Grouping( columns )

**설명:** 이 열의 값이 동일한 행에 대한 그래프 그룹을 생성합니다.
...
**구문:** obj &lt;&lt; Response( columns )

**설명:** 각 행의 모든 값이 하나의 선으로 연결된 열입니다.
...
**구문:** Parallel Plot( Y( columns ), Center at Zero( state=0|1 ) )&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Reversed( columns )

**설명:** 역순 축의 Y 변수를 식별합니다.
...
**구문:** Parallel Plot( Y( columns ), Scale Uniformly( state=0|1 ) )&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 모든 그림의 척도를 균등하게 설정합니다.
...
**구문:** obj &lt;&lt; Show Reversing Checkboxes( state=0|1 )

**설명:** 서로 다른 Y 변수에 대한 축을 역순으로 바꾸기 위한 체크박스를 표시하거나 숨깁니다.
