...
**구문:** x = Internal Rate of Return( values, <guess=0.1> );
...
**구문:** x = Modified Internal Rate of Return( values, finance_rate, reinvest_rate );
...
**구문:** x = Net Present Value( rate, values );
