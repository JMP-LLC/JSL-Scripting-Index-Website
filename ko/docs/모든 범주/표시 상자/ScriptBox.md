...
**설명:** 편집 가능한 스크립팅 상자가 포함된 표시 상자를 반환합니다.
...
**구문:** obj &lt;&lt; Append Text( text )

**설명:** 지정한 텍스트를 스크립트 끝에 추가합니다.
...
**설명:** 스크립트 상자의 콘텐츠 중 접을 수 있는 모든 섹션을 접습니다.
...
**설명:** 스크립트 상자의 콘텐츠 중 접힌 섹션을 모두 펼칩니다.
...
**구문:** obj &lt;&lt; Get Cursor Line

**설명:** 현재 커서가 있는 행을 반환합니다.
...
**구문:** obj &lt;&lt; Get Line Count

**설명:** 스크립트 상자의 줄 수를 반환합니다.
...
**구문:** obj &lt;&lt; Get Line Text( line number )

**설명:** 지정한 행 번호의 텍스트를 반환합니다.
...
**설명:** 스크립트 창의 모든 텍스트를 문자열 목록으로 반환합니다(문자열당 한 줄씩).
...
**구문:** obj &lt;&lt; Get Selection Width

**설명:** 선택 영역의 현재 너비를 반환합니다.
...
**구문:** obj &lt;&lt; Get Show Empty Scrollbars( state=0|1 )

**설명:** 필요하지 않은 경우에도 가로 및 세로 스크롤 막대가 표시되는지 여부를 나타내는 이진(boolean) 값을 반환합니다.
...
**구문:** obj &lt;&lt; Get Show Scrollbars

**설명:** 가로 및 세로 스크롤 막대가 표시되는지 여부를 나타내는 2 요소 목록을 반환합니다.
...
**구문:** obj &lt;&lt; Read Only( state=0|1 )

**설명:** true(1)일 경우 스크립트 상자 내의 텍스트를 수정할 수 없습니다.
...
**구문:** obj &lt;&lt; Set Cursor Position( position )

**설명:** 커서 위치를 제공된 위치로 설정합니다.
...
**구문:** obj &lt;&lt; Set Line Text( line number, text )

**설명:** 지정한 행 번호의 텍스트를 설정합니다.
...
**구문:** obj &lt;&lt; Set Selection Width( width )

**설명:** 선택 영역 너비를 제공된 너비로 설정합니다.
...
**구문:** obj &lt;&lt; Set Show Empty Scrollbars( state=0|1 )

**설명:** true(1)이면 필요하지 않은 경우에도 가로 또는 세로 스크롤 막대가 표시됩니다.
...
**구문:** obj &lt;&lt; Set Show Scrollbars( state=0|1 )

**설명:** 가로 및 세로 스크롤 막대가 표시되는지 여부를 지정합니다.
...
**설명:** 스크립트 상자의 현재 텍스트를 지정한 텍스트로 바꿉니다.
...
**구문:** obj &lt;&lt; Show Embedded Log( state=0|1 )

**설명:** 중첩된 로그를 활성화/비활성화합니다.
...
**구문:** obj &lt;&lt; Show Line Numbers( state=0|1 )

**설명:** 스크립트 상자의 왼쪽에 행 번호를 표시하거나 숨깁니다.
