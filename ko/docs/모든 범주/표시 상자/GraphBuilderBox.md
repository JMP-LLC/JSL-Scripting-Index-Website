...
**구문:** obj &lt;&lt; Graph Margin( sides );sides = obj &lt;&lt; Get Graph Margin

**설명:** 그래프 영역 주변의 최소 여백을 말하며 주위의 축, 범례 또는 제목에 의해 대체될 수 있습니다.
...
**구문:** obj &lt;&lt; Scale Graph Margin( state=0|1 );state = obj &lt;&lt; Get Scale Graph Margin

**설명:** 그래프 여백 특성을 적용할 때 그래프 크기에 따라 조정할지 여부를 지정합니다.
...
**구문:** obj &lt;&lt; Graph Spacing( color )

**설명:** 그래프 패널 사이의 간격 크기를 설정합니다.
...
**구문:** obj &lt;&lt; Graph Spacing Transparency( color )

**설명:** 그래프 패널 사이 간격의 투명도를 설정합니다.
