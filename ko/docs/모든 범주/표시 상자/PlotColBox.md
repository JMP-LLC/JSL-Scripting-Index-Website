...
**설명:** 숫자를 그래프로 나타내기 위해 제목으로 string 라벨이 지정된 표시 상자를 반환합니다.

```jsl


New Window( "Example", Table Box( col = pcb = Plot Col Box( "Probability", {25, 45, 5, 10, 10, 5} ) ) );
...
**구문:** obj &lt;&lt; Set Values( matrix|list )

**설명:** PlotColBox를 제공된 값으로 업데이트합니다.
...
**구문:** obj &lt;&lt; Significance( list|matrix )
