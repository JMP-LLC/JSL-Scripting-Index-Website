...
**설명:** 열에 편집 가능한 숫자를 표시하는 표시 상자를 반환합니다.
...
**구문:** obj &lt;&lt; Set Function( Function( {thisBox, which}, &lt;script&gt; ) )

**설명:** 컨트롤에 대해 제공된 함수를 설정합니다. 변경이 이뤄지면 함수의 스크립트가 실행됩니다. which는 변경된 셀의 행 번호입니다.
