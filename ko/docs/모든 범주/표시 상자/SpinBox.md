...
**설명:** 위쪽 및 아래쪽 컨트롤이 있는 버튼을 표시하는 표시 상자를 반환합니다. 화살표를 클릭한 방향(음수이면 아래쪽이고 양수이면 위쪽임)을 나타내는 인수와 함께 script 인수가 호출됩니다. 값이 1이면 한 번 클릭을 나타냅니다. 이보다 큰 값을 사용하면 반복 동작을 나타낼 수 있습니다.
...
**설명:** 첨부된 스크립트를 실행하여 버튼 클릭을 시뮬레이션합니다.
...
**구문:** obj &lt;&lt; Decrement( &lt;value&gt; )

**설명:** 첨부된 스크립트를 실행하여 아래쪽 화살표 클릭을 시뮬레이션합니다.
...
**구문:** obj &lt;&lt; Increment( &lt;value&gt; )

**설명:** 첨부된 스크립트를 실행하여 위쪽 화살표 클릭을 시뮬레이션합니다.
...
**구문:** obj &lt;&lt; Set Function( Function( {thisBox, increment}, &lt;script&gt; ) )

**설명:** 컨트롤에 대해 제공된 함수를 설정합니다. 스핀 상자의 버튼을 누르면 함수의 스크립트가 실행됩니다. [increment]는 숫자 상자에 대해 설정된 증분 값입니다.
