...
**구문:** obj &lt;&lt; Editable( state=0|1 )

**설명:** 활성화된 경우(1), 마우스로 텍스트를 클릭하여 편집할 수 있습니다.
...
**구문:** obj &lt;&lt; Fixed Size( state=0|1 )

**설명:** 활성화된 경우 사용자 정의 주석 크기를 적용하고, 그렇지 않은 경우에는 텍스트 내용을 기준으로 주석 크기를 계산합니다.
...
**구문:** 0|1 = obj &lt;&lt; GetEditable

**설명:** 텍스트가 편집 가능한지 여부를 반환합니다.
...
**구문:** 0|1 = obj &lt;&lt; GetFilled

**설명:** 텍스트가 채워졌는지 여부를 반환합니다.
...
**구문:** N|NE|E|SE|S|SW|W|NW = obj &lt;&lt; GetOctant
...
**구문:** 0|1 = obj &lt;&lt; GetTagLine

**설명:** 태그 선이 활성화되었는지(1) 아니면 비활성화되었는지(0)를 반환합니다.
...
**구문:** obj &lt;&lt; Octant( &lt;N|NE|E|SE|S|SW|W|NW&gt; )

**설명:** 표시 상자 내 텍스트의 위치를 설정합니다.
...
**구문:** obj &lt;&lt; Text Box( x1,y1,x2,y2 )

**설명:** 텍스트 상자에 텍스트를 배치합니다.
