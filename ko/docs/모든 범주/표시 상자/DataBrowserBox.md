...
**설명:** 표시 상자 트리에 데이터 테이블 보기를 생성합니다. 현재 데이터 테이블을 지정된 데이터 테이블로 변경합니다.
...
**구문:** obj &lt;&lt; Close Data Grid( state=0|1 )

**설명:** 데이터 테이블 격자를 닫거나 엽니다.
...
**구문:** obj &lt;&lt; Close Side Panels( state=0|1 )
...
**구문:** obj &lt;&lt; Close summary panels( state=0|1 )
...
**구문:** obj &lt;&lt; Get Close Data Grid

**설명:** 데이터 테이블 격자의 닫힌 상태를 반환합니다.
...
**구문:** obj &lt;&lt; Get Close Side Panels

**설명:** 데이터 테이블 측면 패널의 닫힌 상태를 반환합니다.
...
**구문:** obj &lt;&lt; Get Close Summary Panels

**설명:** 데이터 테이블 요약 패널의 닫힌 상태를 반환합니다.
...
**구문:** obj &lt;&lt; Set Data Table( dt )

**설명:** 이 표시 상자에 대한 데이터 테이블을 설정합니다.
