...
**구문:** LegendBox &lt;&lt; Get Item(Model ID, Model Index)

**설명:** 쿼리할 수 있거나 표시 특성이 변경된 범례 항목을 반환합니다.
...
**설명:** 쿼리할 수 있거나 표시 특성이 변경된 모든 범례 항목의 목록을 반환합니다.
...
**구문:** obj &lt;&lt; Legend Position( list )

**설명:** 범례 상자 내의 항목을 입력된 list에 따라 재배열합니다.
...
**설명:** 다양한 설정을 변경할 수 있는 범례 창을 표시합니다.
...
**구문:** obj &lt;&lt; Orientation( vertical|horizontal )

**설명:** 범례 상자 내의 항목이 향할 방향을 설정합니다.
...
**구문:** obj &lt;&lt; Revert Legend

**설명:** 범례 상자에 대한 모든 변경 사항을 되돌립니다.
...
**설명:** 범례에 표시할 최대 항목 수를 지정합니다. 이 값을 설정하면 쓸데없는 범례가 그래프를 가득 채우는 것을 방지합니다.
...
**구문:** obj &lt;&lt; Set Wrap( number )

**설명:** 표시할 범례 항목의 줄 수를 지정합니다. 0은 줄바꿈 없음(단일 열)을 나타냅니다.
...
**구문:** obj &lt;&lt; font( fontname, &lt;fontsize&gt;, &lt;fontstyle&gt; )

**설명:** 범례의 텍스트에 사용할 글꼴을 지정하십시오.
