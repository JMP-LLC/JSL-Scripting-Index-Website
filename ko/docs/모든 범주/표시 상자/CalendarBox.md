...
**구문:** obj &lt;&lt; Date( number );number = obj &lt;&lt; Get Date

**설명:** 달력에서 현재 선택된 날짜입니다.
...
**구문:** obj &lt;&lt; Max Date( number );number = obj &lt;&lt; Get Max Date

**설명:** 최대 날짜를 설정합니다. 달력 컨트롤은 올바른 범위의 선택으로 제한됩니다.
...
**구문:** obj &lt;&lt; Min Date( number );number = obj &lt;&lt; Get Min Date

**설명:** 최소 날짜를 설정합니다. 달력 컨트롤은 올바른 범위의 선택으로 제한됩니다.
...
**구문:** obj &lt;&lt; Show Time( state=0|1 );state = obj &lt;&lt; Get Show Time
...
**구문:** obj &lt;&lt; Set Function( Function( {thisBox, date}, &lt;script&gt; ) )

**설명:** 컨트롤에 대해 제공된 함수를 설정합니다. 날짜를 클릭하면 함수의 스크립트가 실행됩니다. date는 현재 선택된 날짜입니다.
