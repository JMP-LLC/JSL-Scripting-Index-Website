...
**설명:** 실행 중 라이트 상자를 비활성화하고 숨깁니다. Disable이 작동하려면 Automatic을 해제해야 합니다. Automatic을 설정하거나 해당 상자를 보내면 Advance 메시지가 실행 중 라이트 상자를 다시 활성화하고 표시합니다.
...
**설명:** Automatic이 설정될 때 실행 중 라이트 상자가 움직이는 속도를 설정합니다.
...
**설명:** 실행 중 라이트 상자의 크기를 픽셀 단위로 설정합니다.
