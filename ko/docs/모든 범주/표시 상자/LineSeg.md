...
**설명:** 연결된 선분의 표시 세그먼트를 생성합니다. 선택적 인수인 세 번째 인수를 사용하면 데이터 테이블(dt)에서 또는 개별적으로 행 상태를 할당할 수 있습니다.
...
**구문:** obj &lt;&lt; Arrowhead( "None"|"Start"|"End"|"Both" )

**설명:** 선 세그먼트의 끝에 화살촉을 그릴 시기를 지정합니다.
...
**구문:** obj &lt;&lt; Get Arrowhead

**설명:** 선분에 화살촉을 그릴 시기를 지정하기 위한 현재 값입니다.
...
**구문:** obj &lt;&lt; Get Connect Missing

**설명:** 결측값 연결 모드를 가져옵니다. "통과하여 연결", "흐린선 연결", "파선 연결" 또는 "연결 없음" 중 하나입니다.
...
**구문:** 0|1 = obj &lt;&lt; Get Log Curve

**설명:** 로그 곡선 설정을 가져옵니다. 그래프에 로그 척도를 사용하는 축이 있는 경우 선을 따라가는 모든 점의 x 및 y 값이 같도록(축이 선형일 경우의 x 및 y 값) 선이 곡선이 됩니다.
...
**구문:** obj &lt;&lt; Get Unconnected Marker

**설명:** 끝점이 하나인 선분을 나타내는 데 사용할 표식을 가져옵니다.
...
**구문:** 0|1 = obj &lt;&lt; Get halfpoint is unbounded line

**설명:** 결측 좌표가 하나 있는 단일 점을 경계가 없는 선으로 처리할지 여부를 반환합니다.
...
**구문:** obj &lt;&lt; Set Arrowhead( "None"|"Start"|"End"|"Both" )
...
**구문:** obj &lt;&lt; Set Connect Missing( "통과하여 연결"|"흐린선 연결"|"파선 연결"|"연결 없음" )

**설명:** 결측값 연결 모드를 설정합니다. "통과하여 연결", "흐린선 연결", "파선 연결" 또는 "연결 없음" 중 하나입니다.
...
**구문:** obj &lt;&lt; Set Log Curve( state=0|1 )

**설명:** 로그 곡선 설정을 설정합니다. 그래프에 로그 척도를 사용하는 축이 있는 경우 선을 따라가는 모든 점의 x 및 y 값이 같도록(축이 선형일 경우의 x 및 y 값) 선이 곡선이 됩니다.
...
**구문:** obj &lt;&lt; Set Smooth( state=0|1 )

**설명:** 평활기 곡선의 상태를 설정합니다.
...
**구문:** obj &lt;&lt; Set Unconnected Marker( marker )

**설명:** 끝점이 하나인 선분을 나타내는 데 사용할 표식을 설정합니다. 표식을 나타내지 않으려면 " "을 사용하십시오.
...
**구문:** obj &lt;&lt; Set halfpoint is unbounded line( state=0|1 )

**설명:** 결측 좌표가 하나 있는 단일 점을 경계가 없는 선으로 처리할지 여부를 설정합니다.
