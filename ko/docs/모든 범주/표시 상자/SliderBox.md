...
**구문:** float = obj &lt;&lt; Get( &lt;index&gt; )

**설명:** 슬라이더가 현재 설정된 부동 소수점 값을 반환합니다.
...
**구문:** bool = obj &lt;&lt; Get Log Scale

**설명:** 슬라이더가 로그 척도에 있는지(1) 또는 선형 척도에 있는지(0)를 반환합니다.
...
**구문:** float = obj &lt;&lt; Get Max( &lt;index&gt; )

**설명:** 슬라이더에 대해 설정할 수 있는 최대값을 반환합니다.
...
**구문:** float = obj &lt;&lt; Get Min( &lt;index&gt; )

**설명:** 슬라이더에 대해 설정할 수 있는 최소값을 반환합니다.
...
**설명:** SliderBox에 있는 슬라이더 수를 반환합니다.
...
**구문:** string = obj &lt;&lt; Get Var

**설명:** 슬라이더와 연결된 변수 이름을 반환합니다.
...
**구문:** obj &lt;&lt; Rescale Slider( min,max )

**설명:** 슬라이더가 허용해야 할 최소값 및 최대값을 설정합니다.
...
**구문:** obj &lt;&lt; Set( float, &lt;index&gt;,&lt;run script(0|1)&gt; )

**설명:** 슬라이더의 부동 소수점 값을 설정합니다.
...
**설명:** 컨트롤에 대해 제공된 함수를 설정합니다. 슬라이더가 변경되면 함수의 스크립트가 실행됩니다.
...
**구문:** obj &lt;&lt; Set Log Scale( 0|1 )

**설명:** 슬라이더를 로그 척도(1) 또는 선형 척도(0)로 설정합니다.
...
**구문:** obj &lt;&lt; Set Max( float, &lt;index&gt; )

**설명:** 슬라이더에 대해 설정할 수 있는 최대값을 설정합니다.
...
**구문:** obj &lt;&lt; Set Min( float, &lt;index&gt; )

**설명:** 슬라이더에 대해 설정할 수 있는 최소값을 설정합니다.
...
**구문:** string = obj &lt;&lt; Set Var

**설명:** 슬라이더와 연결된 변수 이름을 설정합니다.
