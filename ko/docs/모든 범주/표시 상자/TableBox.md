...
**구문:** obj << Heading Underline Color( color );
...
**구문:** obj << Row Height Scale( number );
...
**구문:** obj << Row Vertical Alignment( "위쪽"|"가운데"|"기준선"|"아래쪽" );

"위쪽"|"가운데"|"기준선"|"아래쪽" = obj << Get Row Vertical Alignment
