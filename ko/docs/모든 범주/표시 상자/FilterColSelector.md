...
**설명:** 목록에 모델링 유형이 &apos;없음&apos;인 열을 포함하거나 제외합니다.
...
**구문:** obj &lt;&lt; Character( (0 | 1) )

**설명:** 목록에 문자 열을 포함하거나 제외합니다.
...
**구문:** obj &lt;&lt; Continuous( (0 | 1) )

**설명:** 목록에 연속형 열을 포함하거나 제외합니다.
...
**구문:** obj &lt;&lt; Expression( (0 | 1) )

**설명:** 목록에 표현식 열을 포함하거나 제외합니다.
...
**구문:** obj &lt;&lt; Match case( (0 | 1) )

**설명:** 열 검색 시 대/소문자를 구분하거나 구분하지 않습니다.
...
**구문:** obj &lt;&lt; Multiple Response( (0 | 1) )

**설명:** 다중 반응 열을 목록에 포함하거나 목록에서 제외합니다.
...
**구문:** obj &lt;&lt; Name contains( Name contains( s ) )

**설명:** 지정된 텍스트가 이름에 포함된 열만 나열합니다.
...
**구문:** obj &lt;&lt; Name ends with( Name ends with ( text ) )

**설명:** 지정된 텍스트로 이름이 끝나는 열만 나열합니다.
...
**구문:** obj &lt;&lt; Name starts with( Name starts with ( text ) )

**설명:** 지정된 텍스트로 이름이 시작하는 열만 나열합니다.
...
**구문:** obj &lt;&lt; Set Selected( index,&lt;selected&gt; )

**설명:** index에 있는 항목을 선택됨(1) 또는 선택 취소됨(0)으로 설정합니다.
...
**구문:** obj &lt;&lt; Unstructured Text( (0 | 1) )

**설명:** 비정형 텍스트 열을 목록에 포함하거나 목록에서 제외합니다.
