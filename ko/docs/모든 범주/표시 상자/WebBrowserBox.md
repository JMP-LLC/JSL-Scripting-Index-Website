...
**구문:** "Promise" = obj &lt;&lt; Execute Script

**설명:** 제공된 Javascript를 현재 페이지의 컨텍스트에서 비동기적으로 실행합니다. 스크립트 결과에 대한 Promise를 문자열로 반환합니다.
...
// Possibly remove outer double-quotes
	If( Length( content ) >= 2 & Substr( content, 1, 1 ) == "\!"" & Substr( content, -1, 1 ) == "\!"",
...
**설명:** 웹 브라우저 상자의 너비와 높이를 설정합니다. 웹 브라우저 상자의 기본 Stretch 설정은 &apos;Window&apos;이며 요청된 크기를 적용하려면 &apos;Off&apos;로 변경해야 합니다.
