...
**설명:** 다른 표시 상자를 그룹화하는 표시 상자를 반환합니다.
...
**구문:** obj &lt;&lt; Add All Open Files( &lt;Menu(0,1)&gt; )

**설명:** 개요 상자에 모든 열려 있는 파일을 추가하기 위한 메뉴를 표시합니다.
...
**설명:** TableBox에 대해 결합 데이터 테이블 생성 명령을 위한 열을 추가하는 OutlineBox의 키-값 쌍

**JMP추가된 버전:** 16

### Add Directory of Files

**구문:** obj &lt;&lt; Add Directory of Files

**설명:** 개요 상자에 파일 디렉터리를 추가하기 위한 메뉴를 표시합니다.
...
**구문:** obj &lt;&lt; Add File Reference

**설명:** 개요 상자에 파일 참조를 추가하기 위한 메뉴를 표시합니다.
...
**구문:** obj &lt;&lt; Add Open Files( &lt;Menu(0,1)&gt; )
...
**구문:** obj &lt;&lt; Add Outline Item

**설명:** 개요 상자에 개요 항목을 추가하기 위한 메뉴를 표시합니다.
...
**구문:** obj &lt;&lt; Add Script Button

**설명:** 개요 상자에 스크립트 버튼을 추가하기 위한 메뉴를 표시합니다.
...
**구문:** obj &lt;&lt; Add Text Item

**설명:** 개요 상자에 텍스트를 추가하기 위한 메뉴를 표시합니다.
...
**구문:** obj &lt;&lt; Add URL Reference

**설명:** 개요 상자에 URL을 추가하기 위한 메뉴를 표시합니다.
...
**구문:** obj &lt;&lt; Add Window Reference

**설명:** 개요 상자에 창 참조를 추가하기 위한 메뉴를 표시합니다.
...
**구문:** obj &lt;&lt; Close All Below

**설명:** 이 개요 상자와 그 아래에 있는 모든 하위 개요 상자를 닫습니다.
...
**구문:** obj &lt;&lt; Close All Like This

**설명:** 이 개요 상자와 표시 트리에서 동일한 원래 제목 또는 도움말 키를 가진 모든 개요 상자를 닫습니다.
...
**구문:** obj &lt;&lt; Close Where No Outlines

**설명:** 하위가 없는 모든 노드를 닫습니다.
...
**설명:** 버튼 스크립트에서 모든 파일 링크를 찾아 편집합니다.

**JMP추가된 버전:** 16

### Get Allow Title Wrapping

**구문:** 0|1 = obj &lt;&lt; Get Allow Title Wrapping( state=0|1 )

**설명:** 긴 제목을 줄바꿈 할 수 있습니다.
...
New Window( "test",
	...
	ob = Outline Box( Repeat( "abc ", 15 ), Text Box( "def" ), <<set allow title wrapping( 0 ) )
);
...
**구문:** obj &lt;&lt; Get Close Orientation

**설명:** 가로 공간을 절약하기 위해 세로로 접는 개요 상자에 대한 설정을 반환합니다.
...
**구문:** obj &lt;&lt; Get Image Export Display

**설명:** 이미지를 저장할 때 개요 텍스트를 표시하지 않는 옵션을 가져옵니다.
...
**구문:** 0|1|-1 = obj &lt;&lt; Get Menu Item State( index )

**설명:** index 메뉴 항목의 팝업 메뉴 항목 상태를 가져옵니다. 상태는 일반(0), 선택됨(1) 또는 비활성화됨(-1)입니다.
...
**구문:** list = obj &lt;&lt; Get Menu Script

**설명:** 호출 개체에 첨부된 메뉴 스크립트를 반환합니다.
...
**구문:** scriptable object = obj &lt;&lt; Get Scriptable Object

**설명:** 개요 상자와 연결된 스크립트 가능 개체에 대한 참조를 반환합니다.
...
**구문:** obj &lt;&lt; Title Background Color( color );color = obj &lt;&lt; Get Title Background Color

**설명:** 배경 색상이 설정되어 있으면 제목 내용을 그리기 전에 개요 제목에 배경 색상이 채워집니다. 배경 색상이 "없음"으로 설정되면 배경과 포함하는 상자의 내용이 비쳐 보입니다.
...
**구문:** obj &lt;&lt; Title Border( sides );sides = obj &lt;&lt; Get Title Border

**설명:** 제목 테두리는 개요 제목 바깥쪽을 둘러싸는 실선입니다. 값을 하나만 제공하면 모든 변에 적용되고, 값을 두 개 지정하면 가로 및 세로 테두리에 적용됩니다. 제목 테두리는 제목 방향과 관계가 있습니다. 개요가 세로로 닫혀 있으면 테두리와 내용이 회전합니다.
...
**구문:** obj &lt;&lt; Title Border Color( color );color = obj &lt;&lt; Get Title Border Color

**설명:** 개요 제목 테두리의 기본 색상을 재정의하는 선택적 색상입니다.
...
**구문:** obj &lt;&lt; Title Padding( sides );sides = obj &lt;&lt; Get Title Padding

**설명:** 제목 안쪽 여백은 제목 내용과 제목 테두리 사이에 공백을 추가합니다. 값을 하나만 제공하면 모든 변에 적용되고, 값을 두 개 지정하면 가로 및 세로 안쪽 여백에 적용됩니다. 제목 안쪽 여백은 제목 방향과 관계가 있습니다. 개요가 세로로 닫혀 있으면 안쪽 여백과 내용이 회전합니다.
...
**구문:** obj &lt;&lt; Title Text Color( color );color = obj &lt;&lt; Get Title Text Color

**설명:** 색상이 설정되어 있으면 해당 색상을 사용하여 개요 제목 텍스트를 그립니다. 특성이 설정되지 않은 경우 제목은 포함하는 상자의 텍스트 색상을 상속합니다.
...
**구문:** obj &lt;&lt; GetHorizontal

**설명:** 개요 상자의 하위 항목이 가로 방향이면 1을 반환하고 그렇지 않으면 0을 반환합니다.
...
**설명:** 개요 상자가 열려 있으면 1을 반환하고 닫혀 있으면 0을 반환합니다.
...
**구문:** obj &lt;&lt; Horizontal( bool )

**설명:** 개요 상자의 하위 항목을 가로로 맞춥니다.
...
**구문:** obj &lt;&lt; Image Export Display( "보통"|"텍스트만"|"없음" )

**설명:** 이미지를 저장할 때 개요 텍스트를 표시하지 않는 옵션입니다.
...
**설명:** 개요 상자가 저널의 일부인 경우 추가 수정을 위해 저널의 잠금을 해제합니다. 여백 영역을 마우스 오른쪽 버튼으로 클릭하여 저널을 잠글 수 있습니다.

**JMP추가된 버전:** 16

### Lock Title

**구문:** obj &lt;&lt; Lock Title( state=0|1 )

**설명:** 대화식으로 변경할 수 없도록 개요 제목을 잠급니다.
...
**구문:** obj &lt;&lt; Open All Below

**설명:** 이 개요 상자와 그 아래에 있는 모든 하위 개요 상자를 엽니다.
...
**구문:** obj &lt;&lt; Open All Like This

**설명:** 이 개요 상자와 표시 트리에서 동일한 원래 제목 또는 도움말 키를 가진 모든 개요 상자를 엽니다.
...
**구문:** obj &lt;&lt; Set Allow Title Wrapping( 0|1 )
...
**구문:** obj &lt;&lt; Set Menu Item State( index, 0|1|-1 )

**설명:** index의 팝업 메뉴 항목을 보통(0), 선택됨(1) 또는 비활성화됨(-1)으로 설정합니다.
...
**구문:** obj &lt;&lt; Set Menu Script( {"string",script,"string",script, ...} )

**설명:** 빨간색 삼각형을 클릭하면 메뉴에 항목을 추가합니다.
...
**구문:** obj &lt;&lt; Set Scriptable Object( &lt;scriptable object&gt; )

**설명:** 개요 상자와 연결된 스크립트 가능 개체를 설정합니다. 개요 상자는 스크립트 가능 개체로 보낼 수 있는 빨간색 삼각형 메시지 메뉴를 표시합니다. 인수를 제공하지 않으면 스크립트 가능 개체가 지워집니다.
...
**구문:** obj &lt;&lt; Set Submenu( index, submenu count )
...
**구문:** obj &lt;&lt; Set Title( "string", &lt;Run Script(0 | 1)&gt; )
...
**구문:** obj &lt;&lt; Set Title Changed

**설명:** 개요 제목이 변경될 때 실행되는 스크립트를 설정합니다.
...
ob << Set Title Changed(
	Function( {this, oldtitle},
		Print( "title changed: old (" || oldtitle || ") new (" || (this << Get Title()) || ")" )
	)
);
...
**구문:** obj &lt;&lt; SetHorizontal( state=0|1 )
