...
**구문:** obj &lt;&lt; Divider Lines

**설명:** 축에 구분자 눈금 표식을 그립니다.
...
**구문:** obj &lt;&lt; Lower Frame( state=0|1 )

**설명:** 아래쪽 프레임을 활성화하여 축에 나타나도록 하거나 비활성화하여 나타나지 않도록 합니다.
...
**구문:** obj &lt;&lt; Rotated Tick Labels( state=0|1 )

**설명:** 눈금 라벨을 가로로(1) 또는 세로로(0) 회전합니다.
