...
**구문:** me = Contour Seg( Triangulation, [ levels ], &lt; zColor([colors], &lt;Cycle Colors|Interpolate Colors&gt;) &gt;, &lt;Fill|Fill Between|Fill Below|Fill Above&gt;, &lt; Transparency([] | t) &gt;

**설명:** 삼각 분할의 등고선을 나타내는 표시 세그먼트를 반환합니다. 행렬 또는 목록으로 각 수준에 대해 색상을 지정할 수 있습니다. 투명도는 숫자 또는 행렬로 지정할 수 있습니다.
...
**구문:** fill = obj &lt;&lt; Get Fill

**설명:** 등고선에 대한 채우기 옵션을 반환합니다.
...
**구문:** obj &lt;&lt; Set Fill( "Lines"|"Fill Above"|"Fill Between"|"Fill Below" )

**설명:** 등고선에 대한 채우기 옵션을 설정합니다.
