...
**구문:** "left"|"right"|"center" = obj &lt;&lt; Get Justify

**설명:** 열에 대한 가로 맞춤을 가져옵니다.
...
**구문:** obj &lt;&lt; Numerical Order( &lt;0 | 1&gt; )

**설명:** 숫자를 포함하는 텍스트가 숫자 순서대로 정렬됩니다.
...
**구문:** obj &lt;&lt; Set Allow Text Search( &lt;0 | 1&gt; )

**설명:** 선택 가능한 행이 포함된 테이블 상자에서 이 명령은 포커스가 있는 문자열 열이 선택된 행을 변경하기 위한 키보드 입력에 응답할 수 있도록 합니다.
...
**구문:** obj &lt;&lt; Set Justify( "left","right","center" )

**설명:** 열에 대한 가로 맞춤을 설정합니다.
