...
**구문:** obj &lt;&lt; Dashed( state=0|1 )

**설명:** 파선을 활성화하거나 비활성화합니다.
...
**구문:** obj &lt;&lt; Line( x1,y1,x2,y2 )

**설명:** 표시 상자 위쪽에 선을 그립니다.
...
**구문:** obj &lt;&lt; Point from( state=0|1 )

**설명:** 선 시작 부분에 화살표를 그리거나(1) 제거합니다(0).
...
**구문:** obj &lt;&lt; Point to( state=0|1 )

**설명:** 선 끝 부분에 화살표를 그리거나(1) 제거합니다(0).
...
**구문:** obj &lt;&lt; Thick( state=0|1 )

**설명:** 선을 두껍게(1) 또는 가늘게(0) 그립니다.
