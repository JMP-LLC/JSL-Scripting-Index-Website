...
**구문:** obj &lt;&lt; Color Theme( Green to Black to Red|Green to White to Red|White to Black|Blue to Gray to Red|Blue to Green to Red|Spectral|Jet|White to Blue|White to Green|White to Red )

**설명:** 셀 그림을 표시할 때 사용할 색상 범위를 지정합니다.
...
**구문:** obj &lt;&lt; Graph Type( "색상 맵"|"점 그림"|"수직선 그림"|"수평선 그림"|"수평 막대 그림" )

**설명:** 셀 그림의 시각적 스타일을 지정합니다.
...
**구문:** obj &lt;&lt; No separator lines( state=0|1 )

**설명:** 셀 그림의 각 열 주위에 그려진 선을 제거합니다.
...
**설명:** 선택된 첫 번째 행부터 시작하여 행 편집기 창을 엽니다.
