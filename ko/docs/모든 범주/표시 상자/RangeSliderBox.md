...
**설명:** 컨트롤에 대해 제공된 함수를 설정합니다. 두 슬라이더 중 하나의 값이 변경되면 함수의 스크립트가 실행됩니다.
...
**구문:** obj &lt;&lt; Set Lower( float, &lt;index&gt;, &lt;run script(0|1)&gt; )
...
**구문:** obj &lt;&lt; Set Upper( float, &lt;index&gt;, &lt;run script(0|1)&gt; )
