...
**구문:** project &lt;&lt; Add Bookmarks( {&lt;File(path)&gt;, &lt;Folder( path, &lt;Expanded(boolean)&gt; )&gt;, &lt;Group(name, &lt;Expanded(boolean)&gt;, {contents}&gt;} )

**설명:** 프로젝트에 목록 책갈피를 추가합니다. 기존 책갈피는 유지됩니다. 인수는 책갈피 항목의 목록이며 각각 File(), Folder() 또는 Group()을 사용하여 지정합니다. Group() 유형의 경우 동일한 구문을 재귀적으로 사용하여 하위 항목으로 File, Folder 및 Group을 지정할 수 있습니다.
...
**구문:** project &lt;&lt; Extract("file")

**설명:** 프로젝트에서 특정 파일을 추출합니다. JMP Open() 명령은 JMP에서 직접 열 수 없는 파일을 프로젝트에서 추출하지 않습니다. parquet 파일을 예로 들 수 있습니다.
...
**구문:** project &lt;&lt; Extract All()

**설명:** 프로젝트의 모든 파일을 임시 디렉터리로 추출합니다.
...
**구문:** project &lt;&lt; Get Bookmarks()

**설명:** 프로젝트의 책갈피 목록을 반환합니다. 반환되는 목록의 형식은 Add Bookmarks() 및 Set Bookmarks()에서 사용하는 목록과 동일합니다.
...
**구문:** project &lt;&lt; Get Layout()

**설명:** 프로젝트의 창 레이아웃을 반환합니다. 형식은 Set Layout()에서 사용하는 형식과 동일합니다.
...
**구문:** project &lt;&lt; Get Temp Dir()

**설명:** 프로젝트의 임시 디렉터리에 대한 디스크 경로를 가져옵니다.
...
**구문:** project &lt;&lt; Is Extracted("file")

**설명:** 프로젝트의 특정 파일이 임시 디렉터리에 추출되었는지 확인합니다. JMP Open() 명령은 JMP에서 직접 열 수 없는 파일을 프로젝트에서 추출하지 않습니다. parquet 파일을 예로 들 수 있습니다.
...
**구문:** project &lt;&lt; Project File Path()

**설명:** 저장된 프로젝트 파일의 디스크 경로 가져오기
...
**구문:** project &lt;&lt; Reset Layout()

**설명:** 프로젝트에서 기본 창 레이아웃을 사용하도록 설정합니다.
...
**구문:** project &lt;&lt; Run Script(script)

**설명:** 프로젝트의 컨텍스트에서 스크립트를 실행합니다. 스크립트에 의해 열린 창은 프로젝트의 일부가 됩니다. 스크립트는 포함하는 스크립트의 컨텍스트가 아니라 프로젝트의 컨텍스트에서 JSL 이름에 액세스합니다.
...
**구문:** project &lt;&lt; Save Project(&lt;path&gt;)

**설명:** 프로젝트를 저장합니다. 경로와 파일 이름을 지정하여 프로젝트를 특정 위치에 저장할 수 있습니다. 프로젝트가 이미 저장된 경우 이 인수는 선택 사항입니다.



프로젝트를 저장하기 전에 프로젝트에서 저장되지 않은 문서를 저장해야 합니다.
...
**구문:** project &lt;&lt; Set Bookmarks( {&lt;File(path)&gt;, &lt;Folder( path, &lt;Expanded(boolean)&gt; )&gt;, &lt;Group(name, &lt;Expanded(boolean)&gt;, {contents}&gt;} )

**설명:** 프로젝트에 대한 책갈피를 설정합니다. 기존 책갈피는 제거됩니다. 인수는 책갈피 항목의 목록이며 각각 File(), Folder() 또는 Group()을 사용하여 지정합니다. Group() 유형의 경우 동일한 구문을 재귀적으로 사용하여 하위 항목으로 File, Folder 및 Group을 지정할 수 있습니다.
...
**구문:** project &lt;&lt; Show Bookmarks(boolean)

**설명:** 프로젝트에 책갈피 페인을 표시하거나 숨깁니다.
...
**구문:** project &lt;&lt; Show Contents(boolean)

**설명:** 프로젝트에 내용 페인을 표시하거나 숨깁니다.
...
**구문:** project &lt;&lt; Show Log(boolean)

**설명:** 프로젝트에 로그 페인을 표시하거나 숨깁니다.
...
**구문:** project &lt;&lt; Show Recent Files(boolean)

**설명:** 프로젝트에 최근 사용한 파일 페인을 표시하거나 숨깁니다.
...
**구문:** project &lt;&lt; Show Workspace(boolean)

**설명:** 프로젝트에 작업 영역 페인을 표시하거나 숨깁니다.
