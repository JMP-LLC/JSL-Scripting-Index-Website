...
**구문:** color = obj &lt;&lt; Get Group Label Border Color

**설명:** 부동 그룹 라벨 테두리 색상을 가져옵니다.
...
**구문:** color = obj &lt;&lt; Get Group Label Color

**설명:** 부동 그룹 라벨 채우기 색상을 가져옵니다.
...
**구문:** font = obj &lt;&lt; Get Group Label Font
...
**구문:** color = obj &lt;&lt; Get Group Label Font Color

**설명:** 그룹 라벨 글꼴 색상을 가져옵니다.
...
**구문:** obj &lt;&lt; Get Group Spacing

**설명:** 그룹 타일 주위의 공간 크기를 반환합니다.
...
**구문:** bias = obj &lt;&lt; Get Orientation Bias

**설명:** 가로 영역 분할과 세로 영역 분할의 상대적 환경 설정을 가져옵니다.
...
**구문:** obj &lt;&lt; Group Label Background( transparency )

**설명:** 그룹 라벨의 배경 투명도를 설정합니다.
...
**구문:** obj &lt;&lt; Ignore Group Hierarchy( state=0|1 )

**설명:** 둘 이상의 범주를 지정하면 범주가 그룹화됩니다. 이 메시지가 활성화되어 있으면 그룹 계층이 무시됩니다.
...
**구문:** obj &lt;&lt; Set Group Label Border Color( color )

**설명:** 부동 그룹 라벨 테두리 색상을 설정합니다.
...
**구문:** obj &lt;&lt; Set Group Label Color( color )

**설명:** 부동 그룹 라벨 채우기 색상을 설정합니다.
...
**구문:** obj &lt;&lt; Set Group Label Font( &lt;label position&gt; fontName, &lt;size&gt;, &lt;"bold italic underline strikeout"&gt;, &lt;angle&gt;, &lt;label position&gt;, &lt;Font(fontName)&gt;, &lt;Size(size)&gt;, &lt;Style("bold italic underline strikeout")&gt;, &lt;Angle(angle)&gt; )

**설명:** 그룹 라벨 글꼴을 설정합니다. 라벨 위치가 지정되면 그룹 라벨이 해당 위치를 사용하는 경우에만 글꼴이 적용됩니다.
...
**구문:** obj &lt;&lt; Set Group Label Font Color( color )

**설명:** 그룹 라벨 글꼴 색상을 설정합니다.
...
**구문:** obj &lt;&lt; Set Group Spacing( spacing=1 )

**설명:** 그룹 타일 주위의 공간 크기를 설정합니다. 기본값은 "1"입니다.
...
Graph Builder(
	...
	Elements( Treemap( X( 1 ), X( 2 ), Legend( 3 ) ) ),
	SendToReport(
		Dispatch( {}, "Graph Builder", FrameBox, {DispatchSeg( TreeMapSeg( 1 ), Set Group Spacing( 4 ) )} )
	)
);
...
**구문:** obj &lt;&lt; Set Orientation Bias( bias )

**설명:** 가로 영역 분할과 세로 영역 분할의 상대적 환경 설정을 지정합니다. 인수는 -1에서 1 사이의 숫자여야 합니다.
...
**구문:** obj &lt;&lt; Set Text Style( [왼쪽|중심|오른쪽], [위쪽|세로 가운데|기준선|아래쪽], [지워짐], [박스 처리됨] )

**설명:** 커서 펜과 관련하여 텍스트를 그리는 방법을 설정합니다. 지원될 경우 "지워짐"은 텍스트의 경계 상자를 채우고 "지워짐"은 외곽선을 그립니다. 지정하지 않을 경우 기본 가로 맞춤은 "왼쪽"이고 세로 맞춤은 "기준선"입니다.
...
**구문:** obj &lt;&lt; Show Category Name( state=0|1 )

### Show Group Labels

**구문:** obj &lt;&lt; Show Group Labels( state=0|1 )

**설명:** 비활성화된 경우, 그룹 라벨이 표시되지 않습니다. 기본적으로 설정되어 있습니다.
...
**설명:** 비활성화된 경우, 라벨이 표시되지 않습니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Suppress Box Frames( state=0|1 )

**설명:** 활성화된 경우, 상자 프레임이 표시되지 않습니다.
...
**구문:** obj &lt;&lt; Text Style( [왼쪽|중심|오른쪽], [위쪽|세로 가운데|기준선|아래쪽], [지워짐], [박스 처리됨] )
