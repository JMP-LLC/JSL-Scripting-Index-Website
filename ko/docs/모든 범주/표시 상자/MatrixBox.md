...
**구문:** obj &lt;&lt; Column Names( strings or list of strings )
...
**설명:** 의미 체계 형식을 행렬에 적용할지 여부를 제어합니다. 의미 체계 형식은 환경 설정을 통해서도 제어할 수 있습니다.
...
**구문:** obj &lt;&lt; Get Effective Format( col, &lt;row&gt; )
...
New Window( "Example MB",
	mb = Matrix Box( [0.123 0.123, 3.1415 3.1415, 45.6789 45.6789], Column Names( "Column1", "Column2" ) )
);
...
**설명:** 행렬의 의미 체계 형식 활성화 설정을 가져옵니다. 의미 체계 형식은 환경 설정을 통해서도 제어할 수 있습니다.
...
**구문:** obj &lt;&lt; Get Format( width, decimalplaces )
...
**구문:** obj &lt;&lt; Make Combined Data Table( &lt;Invisible(bool)&gt; )

**설명:** 모든 유사한 행렬에서 데이터 테이블을 만듭니다.
...
**설명:** MatrixBox의 값이 포함된 새 데이터 테이블을 생성합니다.
...
**구문:** obj &lt;&lt; Open( state=0|1 )

**설명:** 행렬 상자 내에 값을 표시하거나 숨깁니다.
...
**구문:** obj &lt;&lt; Row Names( strings or list of strings )
...
**구문:** obj &lt;&lt; Set Conditional Format( None|Correlation|PValue|Factor Pattern )

**설명:** 행렬 값의 데이터 형식을 설정합니다.
...
**구문:** obj &lt;&lt; Sort( column, ascending )

**설명:** 열 중 하나를 기반으로 행렬의 행을 정렬합니다. 열에 대해 0이 지정된 경우 정렬이 제거됩니다.
