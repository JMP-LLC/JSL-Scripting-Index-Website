...
New Window( "Example",
	ggparent = Hier Box(
		...
		fontobj = gparent2 = Hier Box(
			"Grand Parent 2",
			parent3 = Hier Box( "Parent 3", child1 = Hier Box( "Child 1" ), child2 = Hier Box( "Child 2" ) ),
...
**구문:** obj &lt;&lt; Before( "string" )

**설명:** 호출하는 계층 상자 앞에 새 문자열을 삽입합니다.
...
**설명:** 호출하는 계층 상자 아래에 새 문자열을 삽입합니다.
...
**구문:** obj &lt;&lt; Change Type( "Fishbone"|"계층"|"내포됨" )

**설명:** 계층적 상자의 스타일을 설정합니다.
...
**구문:** obj &lt;&lt; Direction( 0|1 )

**설명:** 계층 상자의 문자열이 오른쪽(1)을 가리키는지 왼쪽(0)을 가리키는지를 설정합니다.
...
**설명:** 호출하는 계층 상자를 첫 번째 계층 상자로 이동합니다.
...
**구문:** obj &lt;&lt; Force Alternate

**설명:** 호출하는 계층적 상자가 형제 계층적 상자와 교대로 나오도록 이동합니다.
...
**설명:** 텍스트를 수평으로 회전하여 왼쪽에서 시작되도록 합니다.
...
**설명:** 호출하는 계층 상자를 마지막 계층 상자로 이동합니다.
...
**설명:** 계층 상자의 문자열이 오른쪽(1)으로 기울어야 하는지 왼쪽(0)으로 기울어야 하는지를 설정합니다.
...
**설명:** 계층 상자에 문자열이 포함된 새 데이터 테이블을 생성합니다.
...
**설명:** 호출하는 계층 상자를 다른 계층 상자의 다른 측면으로 이동합니다.
...
**구문:** obj &lt;&lt; Override Descendant Padding( state=0|1 )

**설명:** 규정된 동일한 안쪽 여백 설정을 모든 하위 항목에 적용하는 경우에 해당됩니다.
...
**구문:** obj &lt;&lt; Pad Current Node( state=0|1 )

**설명:** 규정된 안쪽 여백 설정을 현재 노드에 적용하는 경우에 해당합니다.
...
**설명:** 텍스트를 수직으로 회전하여 아래쪽에서 시작되도록 합니다
...
**설명:** 텍스트를 수직으로 회전하여 위쪽에서 시작되도록 합니다.
...
**구문:** obj &lt;&lt; Siblings Horizontal Pad( number )

**설명:** 계층 상자 사이의 일반적인 안쪽 여백입니다.
...
**구문:** obj &lt;&lt; Siblings Total Pad( number )

**설명:** 형제 계층 상자와 상위 상자 사이의 세로 안쪽 여백입니다.
...
**구문:** obj &lt;&lt; Siblings Vertical Pad( number )

**설명:** 90도 회전했을 때 계층 상자 사이의 안쪽 여백입니다.
...
**구문:** obj &lt;&lt; Text Wrap Width( width )

**설명:** 각 문자열이 새 줄을 시작하기 전에 문자열 앞에 올 수 있는 너비를 지정합니다.
...
**구문:** obj &lt;&lt; Uneditable( state=0|1 )

**설명:** 활성화된 경우, 편집할 문자열을 마우스를 사용하여 클릭할 수 있습니다.
