...
**설명:** 포함하고 있는 표시 상자 주위에 테두리가 있는 표시 상자를 반환합니다.

```jsl


New Window( "Example",
	Border Box( Left( 10 ), Right( 10 ), Top( 10 ), Bottom( 10 ), Sides( 15 ), Text Box( "Hello World!" ) )
);
...
**구문:** obj &lt;&lt; Bottom( pixels )

**설명:** 테두리 상자의 아래쪽과 테두리 상자의 내용 사이에 공백을 추가합니다.
...
**설명:** 배경 채우기가 해제되어 있으면 0을 반환하고 배경 채우기가 설정되어 있으면 1을 반환합니다.
...
**설명:** 테두리 상자의 왼쪽과 테두리 상자의 내용 사이에 공백을 추가합니다.
...
**설명:** 테두리 상자의 오른쪽과 테두리 상자의 내용 사이에 공백을 추가합니다.
...
**설명:** 배경 색상으로 테두리 상자 배경 채우기를 활성화 또는 비활성화합니다.
...
**구문:** obj &lt;&lt; Set Style( pen style )

**설명:** 테두리의 선 스타일을 설정합니다. Pen style은 숫자 또는 따옴표로 묶은 문자열일 수 있습니다. 0(실선), 1(점선), 2(파선), 3(일점 쇄선), 4(이점 쇄선)로 지정될 수 있습니다.
...
**설명:** 테두리 상자의 위쪽과 테두리 상자의 내용 사이에 공백을 추가합니다.
