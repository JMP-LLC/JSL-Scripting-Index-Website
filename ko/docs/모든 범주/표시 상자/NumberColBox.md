...
**구문:** obj &lt;&lt; Align Decimal Separator( state=0|1 )

**설명:** 열의 값이 소수점 구분 기호를 사용하여 세로로 정렬되도록 지정합니다.
...
obj = Bivariate( Y( :Weight ), X( :Height ) );
obj << Fit Line;
(obj << Report)[Number Col Box( 1 )] << Bootstrap( 50, Fractional Weights( 1 ), Split Selected Column( 1 ) );
...
**구문:** obj &lt;&lt; Enable Semantic Formats( state=0|1 )

**설명:** 의미 체계 형식을 열에 적용할지 여부를 제어합니다. 의미 체계 형식은 환경 설정을 통해서도 제어할 수 있습니다.
...
**구문:** obj &lt;&lt; Get Align Decimal Separator

**설명:** 열의 값이 소수점 구분 기호로 정렬되면 1을 반환하고 그렇지 않으면 0을 반환합니다.
...
**구문:** format = obj &lt;&lt; Get Conditional Format
...
**구문:** obj &lt;&lt; Get Effective Format( &lt;row&gt; )

**설명:** 열의 유효 형식, 즉 매칭되는 의미 체계 형식을 적용한 후의 형식을 반환합니다. row가 제공되면 해당 행에 대해서만 유효 형식을 반환합니다.
...
Show( ncb1 << Get Effective Format, ncb1 << Get Format, ncb2 << Get Effective Format, ncb2 << Get Format );

```

### Get Enable Semantic Formats

**구문:** obj &lt;&lt; Get Enable Semantic Formats

**설명:** 열에 대한 의미 체계 형식 활성화 설정을 반환합니다. 의미 체계 형식은 환경 설정을 통해서도 제어할 수 있습니다.
...
**구문:** width,&lt;decimalplaces&gt; = obj &lt;&lt; Get Format

**설명:** 현재 형식(width, decimalplaces)을 반환합니다. decimalplaces > 100은 날짜/시간 값을 나타냅니다.
...
**구문:** obj &lt;&lt; Hide Missing Values( state=0|1 )

**설명:** 1로 설정하면 결측값이 표시되지 않습니다.
...
**구문:** obj &lt;&lt; Set Conditional Format( "Correlation"|"PValue"|"Factor Pattern" )
...
**구문:** obj &lt;&lt; Set Format( "format", &lt;width, &lt;decimal places&gt;&gt;, &lt;"Use thousands separator"&gt; )

**설명:** 표시할 숫자의 형식을 설정합니다.
...
**구문:** obj &lt;&lt; Set Values( matrix )

**설명:** NumberColBox를 제공된 값으로 업데이트합니다.
