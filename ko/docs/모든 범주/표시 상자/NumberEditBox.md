...
**구문:** obj &lt;&lt; Get Exclude Maximum

**설명:** 설정된 경우, 유효한 숫자 범위에서 최대값이 제외됩니다.
...
**구문:** obj &lt;&lt; Get Exclude Minimum

**설명:** 설정된 경우, 유효한 숫자 범위에서 최소값이 제외됩니다.
...
**구문:** format = obj &lt;&lt; Get Format

**설명:** 표시할 숫자의 형식을 반환합니다.
...
**구문:** inc = obj &lt;&lt; Get Increment

**설명:** stepping 제어에 사용될 증분 값을 반환합니다. 이 값은 편집 중에 위쪽/아래쪽 화살표 키를 누르거나 <<Increment 또는 <<Decrement 메시지가 전송될 때 사용됩니다.
...
**구문:** obj &lt;&lt; Get Integer Only

**설명:** 설정된 경우, 정수값만 허용됩니다.
...
**구문:** max = obj &lt;&lt; Get Maximum

**설명:** 최대값을 반환합니다. 결측값은 최대값이 없음을 나타냅니다.
...
**구문:** min = obj &lt;&lt; Get Minimum

**설명:** 최소값을 반환합니다. 결측값은 최소값이 없음을 나타냅니다.
...
**구문:** function = obj &lt;&lt; Get Number Changed

**설명:** 번호가 변경될 때마다 실행되는 함수를 반환합니다.
...
New Window( "Example",
	numbox = Number Edit Box(
		...
		10,
		<<Set Number Changed(
			Function( {thisBox, value}, /* put my value into my sibling's display */(thisBox << sib) <<
				settext( Char( value ) )
			)
		)
	),
...
**구문:** obj &lt;&lt; Get Show Spin Box

**설명:** Spin Box 설정을 반환합니다.
...
**설명:** Returns the tooltip of the Number Box.
...
**설명:** stepping 제어에 사용될 증분 값을 설정합니다. 이 값은 편집 중에 위쪽/아래쪽 화살표 키를 누르거나 <<Increment 또는 <<Decrement 메시지가 전송될 때 사용됩니다.
...
**구문:** obj &lt;&lt; Set( numeric value,&lt;run script(0|1)&gt; )

**설명:** 편집 상자의 내용을 전달된 숫자로 설정합니다.
...
**구문:** obj &lt;&lt; Set Exclude Maximum( state=0|1 )
...
**구문:** obj &lt;&lt; Set Exclude Minimum( state=0|1 )
...
**설명:** 컨트롤에 대해 제공된 함수를 설정합니다. 숫자 편집 상자에 대한 변경이 이뤄지면 함수의 스크립트가 실행됩니다.
...
**구문:** obj &lt;&lt; Set Integer Only( state=0|1 )
...
**구문:** obj &lt;&lt; Set Maximum( max )

**설명:** 최대값을 설정합니다. 결측값은 최대값이 없음을 나타냅니다.
...
**구문:** obj &lt;&lt; Set Minimum( min )

**설명:** 최소값을 설정합니다. 결측값은 최소값이 없음을 나타냅니다.
...
**구문:** obj &lt;&lt; Set Number Changed( Function( {thisBox, value}, &lt;script&gt; ) )

**설명:** 번호가 변경될 때마다 실행되는 함수를 설정합니다. 이 콜백은 편집 중 변경 사항이 커밋되기 전에 호출됩니다. 취소된 편집 작업의 경우 원래 값을 제공하기 위해 추가 콜백이 생성됩니다.
...
**구문:** obj &lt;&lt; Set Show Spin Box( state=0|1 )

**설명:** 값을 증분하기 위한 Spin Box를 표시합니다.
...
**설명:** Sets the tooltip of the Number Box.
...
**설명:** 숫자 편집 상자의 너비가 n 문자 수가 되도록 설정합니다.
