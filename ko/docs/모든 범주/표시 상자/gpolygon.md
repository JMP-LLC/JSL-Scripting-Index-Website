...
**구문:** obj &lt;&lt; Closed( state=0|1 )

**설명:** 활성화된 경우, 시작 위치와 마지막 위치가 매칭되지 않아도 다각형 내부가 자동으로 채워집니다.
...
**구문:** obj &lt;&lt; Raised( state=0|1 )

**설명:** 양각 다각형을 활성화하거나 비활성화합니다.
...
**구문:** obj &lt;&lt; Smooth( state=0|1 )

**설명:** 부드러운 다각형을 활성화하거나 비활성화합니다.
