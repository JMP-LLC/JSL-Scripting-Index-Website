...
**설명:** 내용의 크기가 ScrollBox보다 큰 경우 아래쪽과 오른쪽에 스크롤 막대를 배치하는 표시 상자를 반환합니다.
...
**구문:** obj &lt;&lt; Get Auto Scrollable

**설명:** 자동 스크롤 가능 설정을 반환합니다.
...
**구문:** obj &lt;&lt; Get Clip Printing( state=0|1 )

**설명:** 인쇄 시 스크롤 상자 내용 자르기에 대한 현재 설정을 반환합니다.
...
**구문:** pixels = obj &lt;&lt; Get Height

**설명:** 스크롤 영역의 높이를 반환합니다.

### Get Scroll Extents

**구문:** {h pixels,v pixels} = obj &lt;&lt; Get Scroll Extents

**설명:** 가로 및 세로 스크롤에 대한 최대 위치를 반환합니다.
...
**구문:** {h,v} = obj &lt;&lt; Get Scroll Position

**설명:** 현재 가로 및 세로 스크롤 위치를 반환합니다.
...
**구문:** {h,v} = obj &lt;&lt; Get Scrollers

**설명:** 가로 및 세로 스크롤에 대한 플래그를 반환합니다. 지정한 방향으로 스크롤이 비활성화된 경우 Scroll Box가 해당 방향으로 일반 컨테이너처럼 동작합니다.
...
**구문:** obj &lt;&lt; Get Show Empty

**설명:** 스크롤 막대가 비어 있을 때의 스크롤 막대 표시에 대한 현재 설정을 반환합니다.
...
**설명:** 스크롤 영역의 너비를 반환합니다.

### Height

**구문:** obj &lt;&lt; Height( pixels )

**설명:** 스크롤 영역의 높이를 설정합니다.
...
**구문:** obj &lt;&lt; Set Auto Scrollable( state=0|1 )

**설명:** 하위 상자의 늘이기 특성을 기반으로 스크롤 파라미터를 자동으로 설정합니다. 상자를 해당 방향으로 늘릴 수 없는 경우 각 방향의 스크롤 막대가 활성화됩니다.
...
**구문:** obj &lt;&lt; Set Clip Printing( state=0|1 )

**설명:** 인쇄 시 스크롤 상자 내용이 스크롤 상자 크기에 맞게 잘리거나 전체 내용이 표시됩니다. 자르기는 기본적으로 해제되어 있습니다.
...
**구문:** obj &lt;&lt; Set Scroll Position( h,v )

**설명:** 가로 및 세로 스크롤 위치를 설정합니다. 값은 픽셀 단위로 지정하거나, "Start" 및 "End" 키워드를 사용하여 지정할 수 있습니다.
...
**구문:** obj &lt;&lt; Set Scrollers( h,v )

**설명:** 가로 및 세로 스크롤에 대한 플래그를 설정합니다. 지정한 방향으로 스크롤이 비활성화된 경우 Scroll Box가 해당 방향으로 일반 컨테이너처럼 동작합니다.
...
**구문:** obj &lt;&lt; Set Show Empty( state=0|1 )

**설명:** 스크롤 막대가 비어 있는 경우에도 스크롤 막대를 표시합니다.
