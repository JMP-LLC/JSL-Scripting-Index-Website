...
**설명:** 목록 또는 라디오 버튼을 표시하는 표시 상자를 반환합니다. 라디오 버튼을 클릭하면 스크립트가 실행됩니다.
...
**설명:** 라디오 상자의 개별 항목을 활성화 또는 비활성화합니다.
...
**설명:** 선택된 라디오 버튼의 1에서 시작하는 인덱스를 반환합니다.
...
**구문:** selectedText = obj &lt;&lt; Get Selected

**설명:** 선택된 라디오 버튼의 텍스트를 가져옵니다.

```jsl


New Window( "Example", r1 = Radio Box( {"Red", "Green", "Blue"}, Print( r1 << Get Selected ) ) );

```

### Group

**구문:** obj &lt;&lt; Group( radiobox )

**설명:** 라디오 상자를 그룹화하여 그룹 내의 라디오 버튼이 한 번에 하나씩만 선택되도록 합니다.
...
**구문:** obj &lt;&lt; Index Of( string )

**설명:** 문자열의 인덱스를 반환하거나, 인덱스를 찾을 수 없는 경우에는 0을 반환합니다.
...
**구문:** obj &lt;&lt; Item Enabled( index )

**설명:** 라디오 상자 내 개별 항목의 활성화 또는 비활성화 여부를 결정하려면 선택합니다.
...
**설명:** 컨트롤에 대해 제공된 함수를 설정합니다. 라디오 상자를 클릭하면 함수의 스크립트가 실행됩니다.
