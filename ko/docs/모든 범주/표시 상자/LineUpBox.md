...
**설명:** 포함하고 있는 표시 상자를 간결하게 배열하는 표시 상자를 반환합니다.
...
**구문:** pixels = obj &lt;&lt; Get Spacing( number )

**설명:** 표시 상자를 분리해야 하는 픽셀 수를 가져옵니다.
...
**구문:** obj &lt;&lt; Spacing( pixels )

**설명:** 표시 상자를 분리할 픽셀 수를 설정합니다.
...
**구문:** obj &lt;&lt; Wrap When Printing

**설명:** 정렬 기능은 인쇄 시 필요에 따라 줄바꿈을 수행합니다.
