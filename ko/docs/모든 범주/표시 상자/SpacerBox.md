...
**설명:** 임의 크기와 색상을 제공할 수 있는 표시 상자를 반환합니다.
...
**구문:** boolean = obj &lt;&lt; Get Fill

**설명:** Returns whether the background is painted or not.
...
**구문:** alpha = obj &lt;&lt; Get Transparency

**설명:** Returns the transparency value, 0..1.
...
**설명:** Sets whether the background is painted or not.
...
**구문:** obj &lt;&lt; Size( width, height,&lt;min width, min height&gt;,&lt;max width, max height&gt; )

**설명:** 공백의 너비 및 높이를 설정합니다.
...
**구문:** obj &lt;&lt; Transparency( alpha )

**설명:** Sets the transparency value, 0..1.
