...
**Descrizione:** Simula un clic sul pulsante, eseguendo eventuali richiami se appropriati. Un pulsante di attivazione/disattivazione cambierà stato prima che venga invocato il richiamo. Un pulsante di menu richiede un argomento per specificare su quale voce fare clic.
...
**Sintassi:** pressed = obj << Get

**Descrizione:** Restituisce 1 se si preme il pulsante di attivazione/disattivazione, 0 se non lo si preme. Si applica solo ai pulsanti con Stile("Attiva/Disattiva").
...
**Sintassi:** name = obj << Get Button Name

**Descrizione:** Restituisce il nome del pulsante.
...
**Sintassi:** icon = obj << Get Icon

**Descrizione:** Restituisce l&apos;icona per il pulsante.
...
**Sintassi:** left|right = obj << Get Icon Location

**Descrizione:** Restituisce la posizione di un&apos;icona in una casella a pulsante. L&apos;icona può essere visualizzata a sinistra o a destra del testo del pulsante.
...
**Sintassi:** obj << Get Menu Choice

**Descrizione:** Ottiene l&apos;indice dell&apos;ultima selezione di menu da parte dell&apos;utente
...
**Sintassi:** list of menu items = obj << Get Menu Items

**Descrizione:** Ottiene gli elementi da visualizzare nel menu di scelta rapida quando si fa clic sul pulsante.
...
**Descrizione:** Restituisce lo stile corrente del pulsante.
...
**Sintassi:** style = obj << Get Underline Style

**Descrizione:** Restituisce lo stile di sottolineatura corrente del pulsante.
...
**Sintassi:** obj << Open Next Outline

**Descrizione:** Chiude il riquadro contenente e apre il successivo.
...
**Sintassi:** obj << Restore Focus After Click( state=0|1 )

**Descrizione:** Mantiene lo stato attivo di modificabilità per il pulsante dopo averlo selezionato. Per impostazione predefinita in ambiente Windows viene mantenuto lo stato attivo. Per impostazione predefinita in ambiente Macintosh viene preservato lo stato attivo.
...
**Sintassi:** obj << Set( pressed, <run script(0|1)> )

**Descrizione:** Imposta lo stato del pulsante di attivazione/disattivazione su premuto (1) o non premuto (0). Si applica solo ai pulsanti con Stile("Attiva/Disattiva").
...
**Sintassi:** obj << Set Button Name( name )

**Descrizione:** Imposta il testo specificato come nome del pulsante.
...
**Sintassi:** obj << Set Function( Function( {thisBox}, <script> ) | Method({thisBox}, <script>) | <symbol> )

**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando si preme il pulsante.
...
**Sintassi:** obj << Set Icon( icon name|image filepath )

**Descrizione:** Visualizza un&apos;icona di JMP o un&apos;immagine sul pulsante. Usare il nome di un&apos;icona di JMP o il percorso a un&apos;immagine.
...
**Sintassi:** obj << Set Icon Location( left,right )

**Descrizione:** Imposta la posizione dell&apos;icona sul lato sinistro o destro del testo del pulsante
...
**Sintassi:** obj << Set Menu Choice( index )

**Descrizione:** Imposta l&apos;indice della selezione di menu da parte dell&apos;utente.
...
**Sintassi:** obj << Set Menu Items( list of menu items )

**Descrizione:** Definisce gli elementi da visualizzare nel menu di scelta rapida quando si fa clic sul pulsante.
...
**Sintassi:** obj << Style( "Normale"|"Sottolineato"|"Attiva/disattiva" )

**Descrizione:** Imposta lo stile del pulsante.
...
**Sintassi:** obj << Underline Style( state=0|1 )

**Descrizione:** Imposta lo stile sottolineato invece dello stile normale per il nome del pulsante.
...
**Sintassi:** obj << Unhide Next Item

**Descrizione:** Visualizza elementi nascosti nel riquadro contenente.
