...
**Sintassi:** Continuous|Nominal|Ordinal|<path to file> = obj << Get Title

**Descrizione:** Restituisce l&apos;icona corrente.
...
**Sintassi:** obj << Title( Continuous|Nominal|Ordinal )

**Descrizione:** Imposta una nuova icona.
