...
**Sintassi:** float = obj << Get Lower( <index> )
...
**Sintassi:** string = obj << Get Lower Var
...
**Sintassi:** float = obj << Get Upper( <index> )
...
**Sintassi:** string = obj << Get Upper Var
...
**Descrizione:** Restituisce un riquadro di visualizzazione che mostra il controllo di uno slider che va da minValue a maxValue. Al modificare delle due posizioni dello slider, i valori sono posizionati in lowVariable e highVariable e viene eseguito lo script.
...
**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando cambia il valore di uno dei cursori.
...
**Sintassi:** obj << Set Lower( float, <index>, <run script(0|1)> )
...
**Sintassi:** string = obj << Set Lower Var
...
**Sintassi:** obj << Set Upper( float, <index>, <run script(0|1)> )
...
**Sintassi:** string = obj << Set Upper Var
