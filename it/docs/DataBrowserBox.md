...
**Sintassi:** obj << Close Data Grid( state=0|1 )

**Descrizione:** Chiude o apre la griglia della tabella di dati.
...
**Sintassi:** obj << Close Side Panels( state=0|1 )
...
**Sintassi:** obj << Close summary panels( state=0|1 )
...
**Sintassi:** obj << Get Close Data Grid

**Descrizione:** Restituisce lo stato di chiusura della griglia della tabella di dati.
...
**Sintassi:** obj << Get Close Side Panels

**Descrizione:** Restituisce lo stato di chiusura dei riquadri laterali delle tabelle di dati.
...
**Sintassi:** obj << Get Close Summary Panels

**Descrizione:** Restituisce lo stato di chiusura dei riquadri di riepilogo delle tabelle di dati.
...
**Descrizione:** restituisce la tabella di dati per il riquadro di visualizzazione
...
**Sintassi:** New Data Box

**Descrizione:** Visualizza una vista tabella di dati in un riquadro di visualizzazione. Cambia la tabella di dati corrente nella tabella di dati specificata.
...
**Sintassi:** obj << Set Data Table( dt )

**Descrizione:** imposta la tabella di dati per il riquadro di visualizzazione
