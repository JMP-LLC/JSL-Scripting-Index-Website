...
**Sintassi:** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**Sintassi:** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
...
**Sintassi:** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
