...
**Sintassi:** obj << Add Text( "string" )

**Descrizione:** Aggiunge un blocco di testo personalizzato all&apos;etichetta sensibile al passaggio del mouse.
...
**Sintassi:** obj << Click Link( "<index, integer>" )

**Descrizione:** Simula un&apos;azione di clic sul collegamento associato al testo o all&apos;indice dato. Se non ne viene fornito alcuno, considera l&apos;ultimo collegamento, che di solito è il graphlet, se presente.
...
**Descrizione:** Chiude l&apos;etichetta sensibile al passaggio del mouse.
...
**Sintassi:** "string" = obj << Copy

**Descrizione:** Copia negli Appunti il contenuto dell&apos;etichetta sensibile al passaggio del mouse. 

Se l&apos;operazione è assegnata a una variabile, il contenuto del testo dell&apos;etichetta sensibile al passaggio del mouse viene memorizzato in essa.
...
**Descrizione:** Rimuove l&apos;annotazione che si trova sopra il riquadro di visualizzazione.
...
**Sintassi:** obj << Deleteable

**Descrizione:** Consente di rimuovere "elimina" dal menu di scelta rapida
...
**Descrizione:** Avvia un editor visuale per il contenuto dell&apos;etichetta sensibile al passaggio del mouse.
...
**Descrizione:** Imposta il carattere dell&apos;etichetta sensibile al passaggio del mouse.
...
**Sintassi:** obj << Get Links

**Descrizione:** "Restituisce un elenco del testo associato alle voci selezionabili nell&apos;etichetta sensibile al passaggio del mouse. 

Immagini e graphlet sono associati a una stringa vuota
...
**Sintassi:** Associative Array = obj << Get Local Context

**Descrizione:** Restituisce un array associativo con i nomi e i valori delle variabili locali fornite come parte del contesto di esecuzione dell&apos;etichetta sensibile al passaggio del mouse.

Per esempi di utilizzo, vedere le definizioni delle preimpostazioni dei graphlet.
...
**Sintassi:** obj << Launch graphlet

**Descrizione:** Avvia la visualizzazione del graphlet o della piattaforma in una nuova finestra.

Il programma di avvio o il contenuto precedente può essere recuperato con un comando Annulla. 

La stessa funzionalità è fornita facendo clic sulla miniatura del graphlet.
...
**Sintassi:** obj << Launch in last

**Descrizione:** Avvia la visualizzazione del graphlet o della piattaforma in una nuova finestra o nell&apos;ultima finestra avviata, sostituendone il contenuto.

Il programma di avvio o il contenuto precedente può essere recuperato con un comando Annulla.

La stessa funzionalità è disponibile facendo Alt+clic sulla miniatura del graphlet.
...
**Sintassi:** obj << Launch in place

**Descrizione:** Avvia la visualizzazione del graphlet o della piattaforma nella finestra corrente, sostituendone il contenuto.

Il programma di avvio o il contenuto precedente può essere recuperato con un comando Annulla. 

La stessa funzionalità è disponibile facendo Ctrl+clic sulla miniatura del graphlet.
...
**Sintassi:** obj << Reanchor

### Replace Text

**Sintassi:** obj << Replace Text( "string" )

**Descrizione:** Sostituisce il contenuto del testo dell&apos;etichetta sensibile al passaggio del mouse con il testo indicato.
...
**Sintassi:** obj << Revert Text

**Descrizione:** Riporta il contenuto del testo dell&apos;etichetta sensibile al passaggio del mouse al testo originale.
...
**Descrizione:** Avvia una tabella di dati con un filtro sui dati locali che mostra solo il sottoinsieme di dati associati all&apos;elemento visuale posto sotto l&apos;etichetta sensibile al passaggio del mouse.
...
**Sintassi:** obj << Tag Line( state=0|1 )
...
**Sintassi:** obj << Use Gradient( state=0|1 )
