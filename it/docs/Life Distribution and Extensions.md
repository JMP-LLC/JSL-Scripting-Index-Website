...
**Sintassi:** obj = Y(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Sintassi:** obj << Mean Remaining Life( state=0|1 )
...
**Sintassi:** obj = Life Distribution(...Window View( "Visible"|"Invisible"|"Private" )...)
