...
**Sintassi:** result = jmp.from_arrow(&lt;library.Dataframe&gt;, requested_schema=&lt;schema&gt;, visibility=&lt;string&gt;, preserve_index=&lt;bool&gt;)

**Descrizione:** Crea un oggeto jmp.DataTable da un Dataframe che implementa l&apos;interfaccia PyArrow Capsule.
...
**Descrizione:** Le tabelle di piccole dimensioni si aggiornano rapidamente, ma per le tabelle di grandi dimensioni, dover aggiornare l&apos;interfaccia utente mentre si apportano modifiche importanti a una colonna richiede molto tempo. Il metodo begin_update() blocca gli aggiornamenti dell&apos;interfaccia grafica alla tabella di dati fino al corrispondente end_update().
...
**Descrizione:** Ripristina l&apos;elaborazione dell&apos;aggiornamento dell&apos;interfaccia grafica della tabella di dati.
