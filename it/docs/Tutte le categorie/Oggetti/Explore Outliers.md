...
**Sintassi:** obj &lt;&lt; Randomized SVD Dim( number=200 )

**Descrizione:** Specifica il numero di dimensioni nella SVD randomizzata a cui ridurre il problema ampio. "200", per impostazione predefinita.
