...
**Sintassi:** obj &lt;&lt; Show Scripts( state=0|1 )

**Descrizione:** For each platform called, shows options added to launch script.
...
**Descrizione:** Usa solo le partizioni di training e convalida invece delle partizioni di training, convalida e test.
