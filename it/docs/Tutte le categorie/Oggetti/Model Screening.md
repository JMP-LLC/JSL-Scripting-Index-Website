...
**Sintassi:** obj = Model Screening(...Log Methods( state=0|1 )...)
...
**Sintassi:** <<Select Fit( Training | Validation | Test | Summary | Clear All,
...
**Sintassi:** obj = Model Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Sintassi:** obj = Model Screening(...XGBoost( state=0|1 )...)
