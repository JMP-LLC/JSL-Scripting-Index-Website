...
**Sintassi:** Type 1 Gauge( Y( column ) )

**Descrizione:** Analizza i sistemi di misurazione utilizzando il metodo del gauge di tipo 1 per valutare la ripetibilità e la distorsione di un processo di misurazione su una parte di riferimento.
...
**Descrizione:** Personalizza le statistiche di riepilogo che sono visualizzate nel report Statistiche di riepilogo e capability.
