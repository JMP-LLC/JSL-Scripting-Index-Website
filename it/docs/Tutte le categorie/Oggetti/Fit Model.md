...
**Descrizione:** Mostra o nasconde un grafico che contiene un punto per ogni livello dell&apos;effetto diverso dal controllo. Ogni punto mostra la media dei minimi quadrati per quel livello in relazione alla media dei minimi quadrati per il livello di controllo. Vengono tracciati i limiti decisionali superiori (UDL) e inferiori (LDL).
