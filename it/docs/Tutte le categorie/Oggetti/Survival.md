...
**Sintassi:** obj = Survival(...Censor Code( value=1 )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Survival(...Plot Failure instead of Surivival( state=0|1 )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Survival(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
