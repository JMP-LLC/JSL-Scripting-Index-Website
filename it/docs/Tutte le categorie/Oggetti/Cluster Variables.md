...
**Sintassi:** obj = Cluster Variables(...&lt;By( column(s) )&gt;...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
obj = dt << Cluster Variables( Y( :OZONE, :CO, :SO2, :NO, :PM10 ), By( _bycol ) );

```

### Columns

**Sintassi:** obj = Cluster Variables(...Columns( column(s) )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;

**Descrizione:** Specifica le variabili da clusterizzare.
...
**Sintassi:** obj = Cluster Variables(...&lt;Freq( column )&gt;...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Cluster Variables(...&lt;Weight( column )&gt;...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Cluster Variables(...Y( column(s) )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Cluster Variables(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
