...
**Sintassi:** obj = Cluster Variables(...<By( column(s) )>...)
...
**Sintassi:** obj = Cluster Variables(...Columns( column(s) )...)
...
**Sintassi:** obj = Cluster Variables(...<Freq( column )>...)
...
**Sintassi:** obj = Cluster Variables(...<Weight( column )>...)
...
**Sintassi:** obj = Cluster Variables(...Y( column(s) )...)
...
**Sintassi:** obj = Cluster Variables(...Window View( "Visible"|"Invisible"|"Private" )...)
