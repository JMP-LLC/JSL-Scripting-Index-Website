...
**Sintassi:** Data Format( Distance Matrix | Attribute List )&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** Transformation( None | Ratio | Interval | Ordinal )&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Multidimensional Scaling(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
