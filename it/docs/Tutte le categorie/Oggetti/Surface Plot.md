...
**Sintassi:** obj << Clip Sheet( state=0|1 ); 
...
**Sintassi:** obj << Contour Color( color ); 
...
**Sintassi:** obj << Data Points Color( color ); 
...
**Sintassi:** obj << Datapoints Choice( "Off"|"Points"|"Needles"|"Mesh"|"Surface" ); 
...
**Sintassi:** obj << Resolution( number )
...
**Sintassi:** obj << Response Column Color Theme( color theme ); 
...
**Sintassi:** obj << Response Column Fill( "Solid"|"Continuous Gradients"|"Discrete Gradients" ); 
...
**Sintassi:** obj << Response Column Gradient Lines( state=0|1 ); 
...
**Sintassi:** obj << Response Column Gradients( number ); 
...
**Sintassi:** obj = Surface Plot(...Scale response axes indenpendently( state=0|1 )...); 
...
**Sintassi:** obj << Show Contour( "Off"|"Below"|"Above"|"On Surface" ); 
...
**Sintassi:** obj << Show Mesh( "Off"|"X"|"Y"|"X and Y" ); 
...
**Sintassi:** obj << Show Surface( "Off"|"Both sides"|"Above only"|"Below only" ); 
...
**Sintassi:** obj << Surface Alpha( number ); 
...
**Sintassi:** obj << Surface Color( color ); 
...
**Sintassi:** obj << Surface Color Range( "Data"|"Axis" ); 
...
**Sintassi:** obj << Surface Color Theme( color theme ); 
...
**Sintassi:** obj << Surface Gradient Type( "Solid"|"Continuous Gradients"|"Discrete Gradients" ); 
...
**Sintassi:** obj << Surface Gradients( number ); 
...
**Sintassi:** obj << Surface Lighting( "None"|"Low Reflection"|"Normal" ); 
...
**Sintassi:** obj = Surface Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
