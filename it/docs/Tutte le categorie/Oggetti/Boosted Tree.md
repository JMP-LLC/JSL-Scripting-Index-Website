...
**Sintassi:** obj = Boosted Tree(...Informative Missing( state=0|1 )...)
...
**Sintassi:** obj = Boosted Tree(...Ordinal Restricts Order( state=0|1 )...)
...
**Sintassi:** obj = Boosted Tree(...Validation Portion( fraction=0 )...)
