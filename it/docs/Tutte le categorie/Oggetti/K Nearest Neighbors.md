...
**Sintassi:** obj = K Nearest Neighbors(...Factor( column(s) )...)
...
**Sintassi:** obj = K Nearest Neighbors(...X( column(s) )...)
...
**Sintassi:** obj = K Nearest Neighbors(...Category Bias( number=0.5 )...)

**Descrizione:** Specifica un parametro di calibrazione che assicura che le probabilità stimate di risposte categoriche siano sempre positive. "0.5", per impostazione predefinita.
...
**Sintassi:** obj = K Nearest Neighbors(...K( number=10 )...)

**Descrizione:** Imposta il numero massimo di vicini più prossimi da analizzare. "10", per impostazione predefinita.
...
**Sintassi:** obj = K Nearest Neighbors(...Set Random Seed( number )...)
...
**Sintassi:** obj = K Nearest Neighbors(...Validation Portion( fraction=0 )...)
