...
**Descrizione:** Mostra o nasconde una tabella che contiene le coordinate dei componenti. Questa opzione è disponibile solo quando nell&apos;analisi è presente una variabile categorica.
