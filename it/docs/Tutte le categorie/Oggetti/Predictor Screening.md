...
**Sintassi:** obj = Predictor Screening(...<By( column(s) )>...)
...
**Sintassi:** obj = Predictor Screening(...Response( column(s) )...)
...
**Sintassi:** obj = Predictor Screening(...X( column(s) )...)
...
**Sintassi:** obj = Predictor Screening(...Y( column(s) )...)
...
**Sintassi:** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
