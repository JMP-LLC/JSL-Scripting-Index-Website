...
**Sintassi:** obj = Variability Chart(...<By( column(s) )>...)
...
**Sintassi:** obj = Variability Chart(...<Freq( column )>...)
...
**Sintassi:** obj = Variability Chart(...<Grouping( column(s) )>...)
...
**Sintassi:** obj = Variability Chart(...Response( column(s) )...)
...
**Sintassi:** obj = Variability Chart(...<Standard( column )>...)
...
**Sintassi:** obj = Variability Chart(...<X( column(s) )>...)
...
**Sintassi:** obj = Variability Chart(...Y( column(s) )...)
...
**Sintassi:** obj = Variability Chart(...Analysis Type( "Scegli analisi migliore (EMS REML Bayesiana)"|"Scegli analisi migliore (EMS REML)"|"Utilizza analisi REML"|"Utilizza analisi bayesiana" )...)
...
**Sintassi:** obj = Variability Chart(...Conv Limit( number )...)
...
**Sintassi:** obj = Variability Chart(...Max Iter( number )...)
...
**Sintassi:** obj = Variability Chart(...Number Function Evals( number )...)
...
**Sintassi:** obj = Variability Chart(...Number Integration Abscissas( number )...)
...
**Sintassi:** obj = Variability Chart(...Set Alpha Level( number )...)
...
**Sintassi:** obj = Variability Chart(...Set Random Seed( number )...)
...
**Sintassi:** obj = Variability Chart(...Sigma Multiplier( number=6 )...)
...
**Sintassi:** obj = Variability Chart(...Window View( "Visible"|"Invisible"|"Private" )...)
