...
**Sintassi:** obj &lt;&lt; Bayesian Models

**Descrizione:** Specifica i modelli bayesiani.
...
**Sintassi:** obj &lt;&lt; Control

**Descrizione:** Specifica la trasformazione della risposta, la trasformazione del tempo e il tipo di modello.
...
**Sintassi:** obj &lt;&lt; Reference Temperature

**Descrizione:** Imposta il valore della temperatura di riferimento utilizzato dai modelli appropriati.
...
**Sintassi:** obj &lt;&lt; Reference X

**Descrizione:** Imposta il valore di riferimento utilizzato dai modelli appropriati.
...
**Sintassi:** obj &lt;&lt; Save Posterior To Script( state=0|1 )

**Descrizione:** Specifica che quando si salva lo script per il report corrente, lo script contiene i campioni a posteriori. Se si esegue lo script salvato, i campioni a posteriori vengono caricati direttamente dallo script nell&apos;analisi di degradazione su misure ripetute. Per impostazione predefinita l&apos;opzione è attivata.
...
**Sintassi:** obj = Repeated Measures Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
