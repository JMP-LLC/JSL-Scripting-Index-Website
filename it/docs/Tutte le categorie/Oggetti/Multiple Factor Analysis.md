...
**Sintassi:** obj = Multiple Factor Analysis(...&lt;By( column(s) )&gt;...)
...
**Sintassi:** obj = Multiple Factor Analysis(...&lt;Freq( column )&gt;...)
...
**Sintassi:** obj = Multiple Factor Analysis(...&lt;MFA Blocks( column )&gt;...)

**Descrizione:** Specifica gruppi di colonne che devono essere trattate come sottotabelle entro l&apos;analisi fattoriale multipla.
...
**Sintassi:** obj = Multiple Factor Analysis(...&lt;Product ID( column )&gt;...)

**Descrizione:** Specifica le colonne di elementi o prodotti da analizzare.
...
**Sintassi:** obj = Multiple Factor Analysis(...&lt;Supplementary( column )&gt;...)
...
**Sintassi:** obj = Multiple Factor Analysis(...&lt;Weight( column )&gt;...)
...
**Sintassi:** obj = Multiple Factor Analysis(...&lt;Z( column )&gt;...)
...
**Sintassi:** obj&lt;&lt;Biplot Select Component( 1, 3 )

**Descrizione:** Seleziona i componenti usati come assi nel biplot.
...
**Sintassi:** obj &lt;&lt; Block Partial Contributions( state=0|1 )

**Descrizione:** Mostra o nasconde contributi di blocco che sono la somma dei contributi delle rispettive variabili.
...
**Sintassi:** obj &lt;&lt; Block Partial Inertias( state=0|1 )

**Descrizione:** Mostra o nasconde contributi di blocco ridimensionati in modo che la somma dell&apos;inerzia tra i blocchi sia pari all&apos;autovalore del componente principale.
...
**Sintassi:** obj &lt;&lt; Block Partial and Consensus Correlations( state=0|1 )

**Descrizione:** Mostra o nasconde una matrice di coefficienti che indica le correlazioni tra score parziali e di consenso su ogni dimensione del componente principale.
...
**Sintassi:** obj &lt;&lt; Block Squared Cosines( state=0|1 )

**Descrizione:** Mostra o nasconde la proporzione di sovrapposizione nella varianza tra blocchi e dimensioni del componente principale.
...
**Sintassi:** obj &lt;&lt; Block Weights( state=0|1 )

**Descrizione:** Mostra o nasconde una matrice del peso del blocco che è l&apos;inverso di ogni primo valore singolare del blocco.
...
**Sintassi:** obj &lt;&lt; Consensus Map( state=0|1 )

**Descrizione:** Mostra o nasconde una mappa di consenso che sovrappone gli score centroidi e gli score parziali di ogni blocco. Per impostazione predefinita l&apos;opzione è attivata.
...
**Sintassi:** obj&lt;&lt;Consensus Map Select Component( 1, 3 )

**Descrizione:** Seleziona i componenti usati come assi nella mappa di consenso.
...
**Sintassi:** obj&lt;&lt;Partial Axes Plot Select Component( 1, 3 )

**Descrizione:** Evidenzia cluster di prodotti sulla base del valore di inerzia specificato.
...
**Sintassi:** obj &lt;&lt; Lg Coefficients( state=0|1 )

**Descrizione:** Mostra o nasconde una matrice di coefficienti che indica la similarità tra blocchi. Equivalente a correlazioni RV non standardizzate.
...
**Sintassi:** obj &lt;&lt; Partial Axes Plot( state=0|1 )

**Descrizione:** Mostra o nasconde un diagramma parziale degli assi che mostra il collegamento tra piano centroide e blocchi.
...
**Descrizione:** Seleziona i componenti usati come assi nel diagramma parziale degli assi.
...
**Sintassi:** obj &lt;&lt; RV Correlations( state=0|1 )

**Descrizione:** Mostra o nasconde una matrice dei coefficienti di correlazione quadrati tra blocchi. I coefficienti RV sono compresi in un range da 0 a 1.
...
**Sintassi:** obj &lt;&lt; Save Block Partial Scores

**Descrizione:** Salva score parziali del blocco in nuove colonne in una tabella di dati.
...
**Sintassi:** obj &lt;&lt; Save Individual Partial Contributions
...
**Sintassi:** obj &lt;&lt; Save Individual Scores
...
**Sintassi:** obj &lt;&lt; Save Individual Squared Cosines
...
**Sintassi:** obj &lt;&lt; Save Partial Axes Coordinates

**Descrizione:** Salva coordinate parziali degli assi in nuove colonne in una tabella di dati.
...
**Descrizione:** Mostra o nasconde le etichette dei punti nel grafico.
...
**Sintassi:** obj&lt;&lt;Summary Plot Select Component( 1, 3 )

**Descrizione:** Seleziona i componenti usati come assi in diagrammi di riepilogo.
...
**Sintassi:** obj &lt;&lt; Variable Loadings( state=0|1 )

**Descrizione:** Mostra o nasconde un report che visualizza le colonne corrispondenti ai pesi dei componenti.
...
**Sintassi:** obj &lt;&lt; Variable Partial Contributions( state=0|1 )
...
**Sintassi:** obj &lt;&lt; Variable Squared Cosines( state=0|1 )
...
**Sintassi:** obj = Multiple Factor Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
