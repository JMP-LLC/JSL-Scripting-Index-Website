...
**Descrizione:** Restituisce un riquadro di visualizzazione che contiene una matrice.
...
**Sintassi:** obj << Align Decimal Separator( state=0|1 )

**Descrizione:** Specifica che i valori nella colonna sono allineati verticalmente usando il separatore decimale.
...
**Sintassi:** obj << Column Names( strings or list of strings )
...
**Sintassi:** obj << Enable Semantic Formats( state=0|1 )

**Descrizione:** Controlla se i formati semantici sono applicati alla matrice. I formati semantici possono anche essere controllati tramite le preferenze.
...
**Sintassi:** matrix = obj << Get

**Descrizione:** Restituisce un elenco che rappresenta la matrice.
...
**Sintassi:** obj << Get Align Decimal Separator

**Descrizione:** Restituisce 1 se le colonne allineano i valori sul separatore decimale, 0 in caso contrario.
...
**Sintassi:** obj << Get Effective Format( col, <row> )

**Descrizione:** Restituisce il formato effettivo di una colonna, cioè il formato dopo avere applicato qualsiasi formato semantico corrispondente. Se è specificato row, restituisce il formato effettivo solo per quella riga.
...
**Sintassi:** obj << Get Enable Semantic Formats

**Descrizione:** Ottiene l&apos;impostazione Abilita formati semantici della matrice. I formati semantici possono anche essere controllati tramite le preferenze.
...
**Sintassi:** obj << Get Format( width, decimalplaces )

**Descrizione:** Restituisce la specifica del formato corrente.
...
**Sintassi:** obj << Make Combined Data Table( <Invisible(bool)> )

**Descrizione:** Crea una tabella di dati da tutte le matrici simili.
...
**Descrizione:** Crea una nuova tabella di dati che contiene i valori nella casella della matrice.
...
**Sintassi:** obj << Open( state=0|1 )

**Descrizione:** Mostra/Nasconde i valori nella casella della matrice.
...
**Sintassi:** obj << Row Names( strings or list of strings )
...
**Sintassi:** obj << Set( matrix )

**Descrizione:** Imposta la matrice da un elenco.
...
**Sintassi:** obj << Set Conditional Format( None|Correlation|PValue|Factor Pattern )

**Descrizione:** Imposta il formato di dati dei valori della matrice.
...
**Descrizione:** Imposta il formato dei numeri da visualizzare.
...
**Sintassi:** obj << Sort( column, ascending )

**Descrizione:** Ordina le righe della matrice sulla base di una delle colonne. Se è specificato 0 per la colonna, l&apos;ordinamento viene rimosso.
