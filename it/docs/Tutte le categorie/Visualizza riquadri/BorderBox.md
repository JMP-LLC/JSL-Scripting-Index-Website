...
**Descrizione:** Restituisce un riquadro di visualizzazione che contiene altri riquadri dotati di bordo.
...
**Sintassi:** obj &lt;&lt; Bottom( pixels )

**Descrizione:** Aumenta la distanza tra il bordo inferiore della casella e il suo contenuto.
...
**Descrizione:** Restituisce 0 se il riempimento dello sfondo è disattivato o 1 se il riempimento dello sfondo è attivato.
...
**Sintassi:** obj &lt;&lt; Get Style

**Descrizione:** Restituisce il numero di codice dello stile di linea del bordo.
...
**Sintassi:** pixels = obj &lt;&lt; GetBottom

**Descrizione:** Restituisce il bordo in basso.
...
**Sintassi:** pixels = obj &lt;&lt; GetLeft

**Descrizione:** Restituisce il bordo a sinistra.
...
**Sintassi:** pixels = obj &lt;&lt; GetRight

**Descrizione:** Restituisce il bordo a destra.
...
**Sintassi:** value = obj &lt;&lt; GetSides

**Descrizione:** Restituisce quali lati sono disegnati.
...
**Sintassi:** pixels = obj &lt;&lt; GetTop

**Descrizione:** Restituisce il bordo in alto.
...
**Sintassi:** obj &lt;&lt; Left( pixels )

**Descrizione:** Aumenta la distanza tra il bordo sinistro della casella e il suo contenuto.
...
**Sintassi:** obj &lt;&lt; Right( pixels )

**Descrizione:** Aumenta la distanza tra il bordo destro della casella e il suo contenuto.
...
**Descrizione:** Abilita o disabilita il riempimento dello sfondo della casella del bordo con il colore di sfondo.
...
**Sintassi:** obj &lt;&lt; Set Style( pen style )

**Descrizione:** Imposta lo stile di linea per il bordo. Pen style può essere o il numero o la stringa tra virgolette: 0 (continua), 1 (punteggiata), 2 (tratteggiata), 3 (trattino-punto), 4 (trattino-punto-punto).
...
**Sintassi:** obj &lt;&lt; Sides( value )

**Descrizione:** Un numero intero che corrisponde alle impostazioni per il riquadro di visualizzazione.
...
**Sintassi:** obj &lt;&lt; Top( pixels )

**Descrizione:** Aumenta la distanza tra il bordo superiore della casella e il suo contenuto.
