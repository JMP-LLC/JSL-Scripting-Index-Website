...
**Sintassi:** "Promise" = obj &lt;&lt; Execute Script

**Descrizione:** Esegue in modo asincrono il Javascript specificato nel contesto della pagina corrente. Restituisce una promessa per il risultato dello script (come stringa)
...
**Sintassi:** "URL" = obj &lt;&lt; Get URL

**Descrizione:** Restituisce l&apos;URL in cui si è posizionato il browser.
...
**Sintassi:** obj &lt;&lt; Navigate( "URL" )

**Descrizione:** Va all&apos;URL specificato.
...
**Descrizione:** Imposta la larghezza e l&apos;altezza del riquadro del browser web. Il riquadro del browser web ha un&apos;impostazione di default di "Finestra" che deve essere modificata in "Off" per rispettare le dimensioni richieste.
