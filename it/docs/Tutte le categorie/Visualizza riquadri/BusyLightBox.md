...
**Sintassi:** obj &lt;&lt; Advance

**Descrizione:** Consente alla spia di occupato di procedere.
...
**Sintassi:** obj &lt;&lt; Automatic

**Descrizione:** Determina la rotazione della spia di occupato.
...
**Descrizione:** Disabilita e nasconde il riquadro della spia di occupato. L&apos;opzione Automatic deve essere disattivata perché funzioni l&apos;opzione Disable. Attivando Automatic o inviando al riquadro un messaggio Advance, il riquadro della spia di occupato viene riattivato e visualizzato.
...
**Descrizione:** Imposta la velocità di movimento della spia di occupato quando l&apos;opzione Automatic è attivata.
...
**Descrizione:** Imposta le dimensioni del riquadro della spia di occupato in pixel.
