...
**Descrizione:** Imposta il colore della linea.
...
**Sintassi:** obj << Dashed( state=0|1 )

**Descrizione:** Attiva o disattiva una linea tratteggiata.
...
**Sintassi:** obj << Line( x1,y1,x2,y2 )

**Descrizione:** Disegna una linea sopra il riquadro di visualizzazione.
...
**Sintassi:** obj << Point from( state=0|1 )

**Descrizione:** Disegna (1) o rimuove (0) una freccia all&apos;inizio della linea.
...
**Sintassi:** obj << Point to( state=0|1 )

**Descrizione:** Disegna (1) o rimuove (0) una freccia alla fine della linea.
...
**Sintassi:** obj << Thick( state=0|1 )

**Descrizione:** Disegna la linea spessa (1) o sottile (0).
