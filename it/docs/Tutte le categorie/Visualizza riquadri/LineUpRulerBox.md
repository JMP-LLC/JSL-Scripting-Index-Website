...
**Sintassi:** list = obj << Get Widths

**Descrizione:** Restituisce le larghezze delle colonne per i riquadri di allineamento contenuti.
...
**Sintassi:** obj << Widths( list )

**Descrizione:** Imposta le larghezze delle colonne per i riquadri di allineamento contenuti.
