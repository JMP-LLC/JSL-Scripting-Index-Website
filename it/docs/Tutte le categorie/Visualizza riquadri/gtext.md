...
**Sintassi:** obj &lt;&lt; Editable( state=0|1 )

**Descrizione:** Se questa opzione è attivata (1), si può fare clic con il mouse sul testo per modificarlo.
...
**Descrizione:** Attiva o disattiva il riempimento del testo.
...
**Sintassi:** obj &lt;&lt; Fixed Size( state=0|1 )

**Descrizione:** Se attivato rispetta la dimensione dell&apos;annotazione definita dall&apos;utente, altrimenti la calcola in base al contenuto di testo.
...
**Sintassi:** obj &lt;&lt; Font( face,&lt;size&gt;,&lt;style&gt; )

**Descrizione:** Imposta il carattere del testo.
...
**Sintassi:** font = obj &lt;&lt; Get Font

**Descrizione:** Restituisce il carattere del testo.
...
**Sintassi:** color = obj &lt;&lt; Get Text Color

**Descrizione:** Restituisce il colore del testo.
...
**Sintassi:** 0|1 = obj &lt;&lt; GetEditable

**Descrizione:** Restituisce se il testo è modificabile.
...
**Sintassi:** 0|1 = obj &lt;&lt; GetFilled

**Descrizione:** Restituisce se il testo è riempito.
...
**Sintassi:** N|NE|E|SE|S|SW|W|NW = obj &lt;&lt; GetOctant

**Descrizione:** Restituisce la posizione in cui è inserito il testo.
...
**Sintassi:** 0|1 = obj &lt;&lt; GetTagLine

**Descrizione:** Restituisce se la linea tag è attivata (1) o disattivata (0).
...
**Sintassi:** "string" = obj &lt;&lt; GetText

**Descrizione:** Restituisce il testo.
...
**Sintassi:** obj &lt;&lt; Justification( "string" )

**Descrizione:** Imposta la giustificazione del testo
...
**Sintassi:** obj &lt;&lt; Minimized( state=0|1 )
...
**Sintassi:** obj &lt;&lt; Octant( &lt;N|NE|E|SE|S|SW|W|NW&gt; )

**Descrizione:** Imposta la posizione nel riquadro di visualizzazione in cui deve essere inserito il testo.
...
**Sintassi:** obj &lt;&lt; Tag Anchor

### Tag Line

**Sintassi:** obj &lt;&lt; Tag Line( state=0|1 )

**Descrizione:** Aggiunge una linea che va dall&apos;area in alto a sinistra del riquadro di visualizzazione al testo.
...
**Sintassi:** obj &lt;&lt; Text( "string" )

**Descrizione:** Imposta come testo string.
...
**Sintassi:** obj &lt;&lt; Text Box( x1,y1,x2,y2 )

**Descrizione:** Inserisce il testo in una casella.
