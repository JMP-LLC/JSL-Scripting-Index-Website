...
**Descrizione:** Restituisce un riquadro di visualizzazione che può organizzare altri riquadri in direzione orizzontale o verticale. Le dimensioni dell&apos;elemento figlio sono specificate come proporzione della larghezza o dell&apos;altezza del Splitter Box. L&apos;argomento facoltativo Size è utilizzato solo per il riquadro di suddivisione più in alto; i riquadri di livello inferiore sono dimensionati come qualsiasi altro riquadro figlio.
...
**Sintassi:** obj &lt;&lt; Close Panel( index,&lt;previous&gt; )

**Descrizione:** Chiude il riquadro all&apos;indice specificato. Se l&apos;argomento previous è 1 lo spazio sarà assegnato al riquadro precedente nell&apos;elenco, altrimenti sarà assegnato al riquadro successivo.
...
**Sintassi:** obj &lt;&lt; Divider Color( color );color = obj &lt;&lt; Get Divider Color

**Descrizione:** Specifica o restituisce il colore per ciascun divisore. Se non è impostato, viene utilizzato un colore basato sul colore di sfondo.
...
**Sintassi:** obj &lt;&lt; Divider Length( number );number = obj &lt;&lt; Get Divider Length

**Descrizione:** Specifica o restituisce la lunghezza in percentuale per ciascun divisore. Un valore di 0,0 determina un divisore invisibile. Un valore di 1,0 determina la linea divisoria (di default) di tutta la lunghezza.
...
**Sintassi:** obj &lt;&lt; Divider Thickness( number );number = obj &lt;&lt; Get Divider Thickness

**Descrizione:** Specifica o restituisce lo spessore della linea per ciascun divisore. Questo valore deve essere diverso da zero.
...
**Sintassi:** {size1,...} = obj &lt;&lt; Get Sizes

**Descrizione:** Restituisce le proporzioni per ciascun riquadro del Splitter Box.
...
**Sintassi:** obj &lt;&lt; Open Panel( index,&lt;previous&gt; )

**Descrizione:** Apre il riquadro all&apos;indice specificato. Se l&apos;argomento previous è 1 lo spazio sarà preso dal riquadro precedente nell&apos;elenco, altrimenti sarà preso dal riquadro successivo.
...
**Sintassi:** obj &lt;&lt; Set Sizes( {size1,...} )

**Descrizione:** Imposta le proporzioni per ciascun riquadro del Splitter Box.
...
**Sintassi:** obj &lt;&lt; Size( size )

**Descrizione:** Imposta le proporzioni per l&apos;ultimo riquadro del Splitter Box.
...
**Sintassi:** state=0|1 = obj &lt;&lt; get horizontal

**Descrizione:** Restituisce (1) se la casella di riepilogo è orizzontale o (0) se è verticale.
...
**Sintassi:** obj &lt;&lt; set horizontal( state=0|1 )

**Descrizione:** Imposta la casella di riepilogo come orizzontale (1) o verticale (0).
