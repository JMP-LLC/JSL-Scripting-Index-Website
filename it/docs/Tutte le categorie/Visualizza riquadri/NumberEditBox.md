...
**Sintassi:** obj &lt;&lt; Decrement

**Descrizione:** Decrementa il valore dell&apos;impostazione corrente.
...
**Descrizione:** Restituisce il numero inserito attualmente nella casella di modifica
...
**Sintassi:** obj &lt;&lt; Get Exclude Maximum

**Descrizione:** Se questa opzione è impostata, il valore massimo è escluso dal range di numeri valido.
...
**Sintassi:** obj &lt;&lt; Get Exclude Minimum

**Descrizione:** Se questa opzione è impostata, il valore minimo è escluso dal range di numeri valido.
...
**Sintassi:** format = obj &lt;&lt; Get Format

**Descrizione:** Restituisce il formato del numero da visualizzare.
...
**Sintassi:** inc = obj &lt;&lt; Get Increment

**Descrizione:** Restituisce il valore di incremento da utilizzare per il controllo dei passi. Questo valore sarà utilizzato quando si premeranno le frecce giù o su durante la modifica o quando verranno inviati messaggi di <<Increment o <<Decrement.
...
**Sintassi:** obj &lt;&lt; Get Integer Only

**Descrizione:** Se questa opzione è impostata, saranno ammessi solo valori interi.
...
**Sintassi:** max = obj &lt;&lt; Get Maximum

**Descrizione:** Restituisce il valore massimo. Un valore mancante indica che non esiste un valore massimo.
...
**Sintassi:** min = obj &lt;&lt; Get Minimum

**Descrizione:** Restituisce il valore minimo. Un valore mancante indica che non esiste un valore minimo.
...
**Sintassi:** function = obj &lt;&lt; Get Number Changed

**Descrizione:** Restituisce la funzione eseguita ogni volta che si apporta una modifica al numero.
...
**Sintassi:** obj &lt;&lt; Get Show Spin Box

**Descrizione:** Restituisce l&apos;impostazione della Spin Box
...
**Descrizione:** Returns the tooltip of the Number Box.
...
**Descrizione:** Restituisce l&apos;ampiezza in numero di caratteri della casella di modifica dei numeri.
...
**Sintassi:** obj &lt;&lt; Increment

**Descrizione:** Imposta il valore di incremento da utilizzare per il controllo dei passi. Questo valore sarà utilizzato quando si premono le frecce giù o su durante la modifica o quando vengono inviati messaggi di <<Increment o <<Decrement.
...
**Sintassi:** obj &lt;&lt; Set( numeric value,&lt;run script(0|1)&gt; )

**Descrizione:** Imposta come contenuto della casella di modifica il numero passato
...
**Sintassi:** obj &lt;&lt; Set Exclude Maximum( state=0|1 )
...
**Sintassi:** obj &lt;&lt; Set Exclude Minimum( state=0|1 )
...
**Sintassi:** obj &lt;&lt; Set Format( "format", &lt;width, &lt;decimal places&gt;&gt;, &lt;"Use thousands separator"&gt; )

**Descrizione:** Imposta il formato del numero da visualizzare.
...
**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando la modifica alla casella di modifica dei numeri viene confermata.
...
**Sintassi:** obj &lt;&lt; Set Increment( inc )

**Descrizione:** Imposta il valore di incremento da utilizzare per il controllo dei passi. Questo valore sarà utilizzato quando si premeranno le frecce giù/su durante la modifica o quando verranno inviati messaggi di <<Increment o <<Decrement.
...
**Sintassi:** obj &lt;&lt; Set Integer Only( state=0|1 )
...
**Sintassi:** obj &lt;&lt; Set Maximum( max )

**Descrizione:** Imposta il valore massimo. Un valore mancante indica che non esiste un valore massimo.
...
**Sintassi:** obj &lt;&lt; Set Minimum( min )

**Descrizione:** Imposta il valore minimo. Un valore mancante indica che non esiste un valore minimo.
...
**Sintassi:** obj &lt;&lt; Set Number Changed( Function( {thisBox, value}, &lt;script&gt; ) )

**Descrizione:** Imposta la funzione che viene eseguita ogni volta che si apporta una modifica al numero. Questo callback viene chiamato durante la modifica, prima che sia completata. Nel caso di annullamento di un&apos;operazione di modifica, viene generato un altro callback che fornisce il valore originario.
...
**Sintassi:** obj &lt;&lt; Set Show Spin Box( state=0|1 )

**Descrizione:** Mostra una Spin Box per incrementare il valore.
...
**Descrizione:** Sets the tooltip of the Number Box.
...
**Descrizione:** Imposta un numero di caratteri n per l&apos;ampiezza della casella di modifica dei numeri.
