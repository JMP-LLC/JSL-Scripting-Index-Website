...
**Descrizione:** Restituisce un riquadro di visualizzazione per mostrare un elenco di pulsanti di opzione. Lo script viene eseguito quando si fa clic su un pulsante.
...
**Descrizione:** Attiva o disattiva un singolo elemento in una casella di opzione.
...
**Descrizione:** Restituisce l&apos;indice in base 1 del pulsante di opzione selezionato.
...
**Sintassi:** selectedText = obj << Get Selected

**Descrizione:** Ottiene il testo del pulsante di opzione selezionato.
...
**Sintassi:** obj << Group( radiobox )

**Descrizione:** Raggruppa insieme le caselle di opzione, in modo che venga selezionata una sola casella del gruppo alla volta.
...
**Sintassi:** obj << Index Of( string )

**Descrizione:** Restituisce l&apos;indice di una stringa o 0 se non la trova
...
**Sintassi:** obj << Item Enabled( index )

**Descrizione:** Verifica se un singolo elemento in una casella di opzione è attivato o disattivato
...
**Descrizione:** Imposta il pulsante di opzione selezionato.
...
**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando si fa clic sulla casella di opzione.
