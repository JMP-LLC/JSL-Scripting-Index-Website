...
**Sintassi:** obj &lt;&lt; Enable Item( index,enable )

**Descrizione:** Imposta l&apos;elemento che si trova in index per essere attivato (1) o disattivato (0).
...
**Sintassi:** index = obj &lt;&lt; Get First Visible Item

**Descrizione:** Restituisce l&apos;indice del primo elemento visibile.
...
**Sintassi:** 0|1 = obj &lt;&lt; Item Enabled( index )

**Descrizione:** Restituisce se l&apos;elemento che si trova in index è attivato (1) o disattivato (0).
...
**Sintassi:** obj &lt;&lt; Set First Visible Item( index )

**Descrizione:** Scorre la casella di riepilogo in modo che l&apos;elemento richiesto sia il primo elemento visibile.
...
**Sintassi:** obj &lt;&lt; Show Item( index )

**Descrizione:** Scorre la casella di riepilogo per verificare che l&apos;elemento richiesto sia visibile nella casella di riepilogo.
