...
**Descrizione:** Restituisce un riquadro di visualizzazione che mostra i numeri modificabili in una colonna.
...
**Descrizione:** Controlla se i formati semantici sono applicati alla colonna. I formati semantici possono anche essere controllati tramite le preferenze.
...
**Descrizione:** Restituisce 1 se la colonna allinea i valori sul separatore decimale, 0 in caso contrario.
...
**Sintassi:** format = obj &lt;&lt; Get Conditional Format

**Descrizione:** Restituisce il formato condizionale.
...
**Sintassi:** obj &lt;&lt; Get Effective Format( &lt;row&gt; )

**Descrizione:** Restituisce il formato effettivo della colonna, cioè il formato dopo avere applicato qualsiasi formato semantico corrispondente. Se è specificato row, restituisce il formato effettivo solo per quella riga.
...
**Descrizione:** Restituisce l&apos;impostazione Abilita formati semantici per la colonna. I formati semantici possono anche essere controllati tramite le preferenze.
...
**Sintassi:** width,&lt;decimalplaces&gt; = obj &lt;&lt; Get Format

**Descrizione:** Restituisce il formato corrente (width, decimalplaces). Un decimalplaces > 100 indica valori di data e ora.
...
**Sintassi:** obj &lt;&lt; Hide Missing Values( state=0|1 )

**Descrizione:** I valori mancanti non saranno visualizzati se impostati a 1
...
**Sintassi:** obj &lt;&lt; Set Conditional Format( "Correlation"|"PValue"|"Factor Pattern" )

**Descrizione:** Imposta il formato condizionale.
...
**Sintassi:** obj &lt;&lt; Set Function( Function( {thisBox, which}, &lt;script&gt; ) )

**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando si apporta una modifica. which è il numero di riga della cella modificata.
...
**Sintassi:** obj &lt;&lt; Set Values( matrix )

**Descrizione:** Aggiorna il NumberColBox ai valori forniti.
