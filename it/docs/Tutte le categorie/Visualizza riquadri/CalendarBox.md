...
**Sintassi:** obj &lt;&lt; Date( number );number = obj &lt;&lt; Get Date

**Descrizione:** La data corrente selezionata nel calendario.
...
**Sintassi:** obj &lt;&lt; Max Date( number );number = obj &lt;&lt; Get Max Date

**Descrizione:** Imposta la data massima. Il controllo di tipo calendario sarà limitato alle selezioni nel range corretto.
...
**Sintassi:** obj &lt;&lt; Min Date( number );number = obj &lt;&lt; Get Min Date

**Descrizione:** Imposta la data minima. Il controllo di tipo calendario sarà limitato alle selezioni nel range corretto.
...
**Sintassi:** obj &lt;&lt; Show Time( state=0|1 );state = obj &lt;&lt; Get Show Time

**Descrizione:** Seleziona un&apos;ora oltre a una data.
...
**Sintassi:** obj &lt;&lt; Set Function( Function( {thisBox, date}, &lt;script&gt; ) )

**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando si fa clic su una data. date è la data corrente selezionata.
