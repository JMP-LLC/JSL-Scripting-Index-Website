...
**Sintassi:** obj << Set Row States( dt, rs )

**Descrizione:** Imposta gli stati delle righe per la tabella di dati specificata all&apos;interno del filtro. Le selezioni effettuate in questo stato della riga non saranno collegate alla tabella di dati, ma saranno incluse nei report collegati al filtro di selezione.
