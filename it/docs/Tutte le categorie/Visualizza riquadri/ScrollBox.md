...
**Descrizione:** Restituisce un riquadro di visualizzazione che aggiunge una barra di scorrimento sul lato inferiore destro se il contenuto è maggiore della dimensione di ScrollBox.
...
**Sintassi:** obj &lt;&lt; Get Auto Scrollable

**Descrizione:** Restituisce l&apos;impostazione per lo scorrimento automatico
...
**Sintassi:** obj &lt;&lt; Get Clip Printing( state=0|1 )

**Descrizione:** Restituisce l&apos;impostazione corrente per ritagliare il contenuto della casella di scorrimento durante la stampa.
...
**Descrizione:** Restituisce il colore di sfondo.
...
**Sintassi:** pixels = obj &lt;&lt; Get Height

**Descrizione:** Restituisce l&apos;altezza dell&apos;area di scorrimento.
...
**Sintassi:** {h pixels,v pixels} = obj &lt;&lt; Get Scroll Extents

**Descrizione:** Restituisce le posizioni massime di scorrimento orizzontale e verticale.
...
**Sintassi:** {h,v} = obj &lt;&lt; Get Scroll Position

**Descrizione:** Restituisce le posizioni correnti di scorrimento orizzontale e verticale.
...
**Sintassi:** {h,v} = obj &lt;&lt; Get Scrollers

**Descrizione:** Restituisce i flag per lo scorrimento orizzontale e verticale. Se lo scorrimento è disattivato in una determinata direzione, la Scroll Box si comporterà come un normale contenitore in quella direzione.
...
**Sintassi:** obj &lt;&lt; Get Show Empty

**Descrizione:** Restituisce l&apos;impostazione corrente per mostrare le barre di scorrimento quando sono vuote.
...
**Descrizione:** Restituisce la larghezza dell&apos;area di scorrimento.
...
**Descrizione:** Imposta l&apos;altezza dell&apos;area di scorrimento.
...
**Sintassi:** obj &lt;&lt; Set Auto Scrollable( state=0|1 )

**Descrizione:** Imposta automaticamente i parametri di scorrimento sulla base delle proprietà di estensione del riquadro figlio. La barra di scorrimento in ogni direzione sarà attiva se il riquadro non è estensibile in quella direzione.
...
**Descrizione:** Imposta il colore specificato per lo sfondo della casella di scorrimento.
...
**Sintassi:** obj &lt;&lt; Set Clip Printing( state=0|1 )

**Descrizione:** Il contenuto della casella di scorrimento è ritagliato alle dimensioni della casella durante la stampa, oppure viene visualizzato l&apos;intero contenuto. Il ritaglio è disattivato per impostazione predefinita.
...
**Sintassi:** obj &lt;&lt; Set Scroll Position( h,v )

**Descrizione:** Imposta le posizioni di scorrimento orizzontale e verticale. I valori possono essere specificati in pixel o utilizzando le parole chiave "Inizio" e "Fine".
...
**Sintassi:** obj &lt;&lt; Set Scrollers( h,v )

**Descrizione:** Imposta i flag per lo scorrimento orizzontale e verticale. Se lo scorrimento è disattivato in una determinata direzione, la Scroll Box si comporterà come un normale contenitore in quella direzione.
...
**Sintassi:** obj &lt;&lt; Set Show Empty( state=0|1 )

**Descrizione:** Mostra le barre di scorrimento anche se sono vuote.
...
**Descrizione:** Imposta la larghezza dell&apos;area di scorrimento.
