...
**Sintassi:** Graph Builder

**Descrizione:** Componente interna del Costruttore di grafici.
...
**Sintassi:** obj &lt;&lt; Graph Margin( sides ); sides = obj &lt;&lt; Get Graph Margin

**Descrizione:** Il margine minimo intorno all&apos;area del grafico, che può essere sostituito da qualsiasi asse, legenda o titolo circostante.
...
**Sintassi:** obj &lt;&lt; Scale Graph Margin( state=0|1 ); state = obj &lt;&lt; Get Scale Graph Margin

**Descrizione:** Specifica se le proprietà del margine del grafico devono scalare con le dimensioni del grafico quando vengono applicate.
...
**Sintassi:** obj &lt;&lt; Graph Borders( color )
...
**Sintassi:** obj &lt;&lt; Graph Spacing( color )

**Descrizione:** Imposta la misura della spaziatura tra i riquadri del grafico.
...
**Descrizione:** Imposta il colore della spaziatura tra i riquadri del grafico.
...
**Sintassi:** obj &lt;&lt; Graph Spacing Transparency( color )

**Descrizione:** Imposta la trasparenza della spaziatura tra i riquadri del grafico.
