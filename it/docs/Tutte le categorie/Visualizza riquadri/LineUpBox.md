...
**Descrizione:** Restituisce un riquadro di visualizzazione che dispone in modo regolare i riquadri al suo interno.
...
**Sintassi:** obj &lt;&lt; Get N Col

**Descrizione:** Ottiene il numero di colonne.
...
**Sintassi:** pixels = obj &lt;&lt; Get Spacing( number )

**Descrizione:** Ottiene il numero di pixel che devono separare i riquadri di visualizzazione.
...
**Sintassi:** obj &lt;&lt; NCol( number )

**Descrizione:** Imposta il numero di colonne.
...
**Sintassi:** obj &lt;&lt; Spacing( pixels )

**Descrizione:** Imposta il numero di pixel che devono separare i riquadri di visualizzazione.
...
**Sintassi:** obj &lt;&lt; Wrap When Printing

**Descrizione:** Allinea manderà a capo, quando necessario, durante la stampa.
