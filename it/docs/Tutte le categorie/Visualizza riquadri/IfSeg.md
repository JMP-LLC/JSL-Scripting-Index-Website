...
**Descrizione:** Crea un segmento che mostra o nasconde gli elementi figlio del segmento di visualizzazione.
...
**Sintassi:** obj &lt;&lt; Append( seg2 )

**Descrizione:** Aggiunge il segmento come ultimo figlio del segmento corrente.
...
**Sintassi:** 0|1 = obj &lt;&lt; Get

**Descrizione:** Restituisce lo stato di IfSeg.
...
**Sintassi:** obj &lt;&lt; Set( state=0|1 )

**Descrizione:** Mostra/Nasconde i segmenti di visualizzazione entro IfSeg.
