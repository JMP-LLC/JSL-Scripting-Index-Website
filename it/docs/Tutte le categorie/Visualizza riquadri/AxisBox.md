...
**Sintassi:** obj &lt;&lt; Add Axis Label( label )

**Descrizione:** Aggiunge un&apos;etichetta dell&apos;asse che contiene la stringa fornita.
...
**Sintassi:** obj &lt;&lt; Add Ref Line( value, &lt;"Solid|Dashed|Double"&gt;, &lt;Color&gt;, &lt;"label"&gt;, &lt;line width&gt;, &lt;transparency&gt; )

**Descrizione:** Aggiungi una linea di riferimento alla griglia in value.
...
**Sintassi:** obj &lt;&lt; Axis Settings

**Descrizione:** Offre un modo per visualizzare la finestra di dialogo dell&apos;asse o impostare le opzioni configurabili per un dato asse.
...
**Sintassi:** obj &lt;&lt; Copy Axis Settings

**Descrizione:** Crea uno script che contiene le impostazioni attuali dell&apos;asse e mettilo negli Appunti.
...
**Sintassi:** obj &lt;&lt; Custom Scale Name

**Descrizione:** Nome della scala.
...
**Sintassi:** obj &lt;&lt; Decimal( number )

**Descrizione:** Imposta il numero di cifre dopo la virgola decimale per le etichette numeriche.
...
**Sintassi:** obj &lt;&lt; Edit Value Order

**Descrizione:** Apre la proprietà della colonna Ordine valore per la modifica.
...
**Sintassi:** obj &lt;&lt; Edit Value Order Mode
...
**Sintassi:** obj &lt;&lt; Format( "Migliore"|"Decimale fisso"|"Percentuale"|"p-value"|"Scientifico"|"Engineering"|"Engineering SI"|"Precisione"|"Valuta"|"m#g#a"|"mmggaaaa"|"m#a"|"aaaaQt"|"g#m#a"|"ggmmaaaa"|"ggmmmaaaa"|"Monddyyyy"|"a#m#g"|"aaaammgg"|"yyyy-mm-dd"|"m#g#a h:m"|"m#g#a h:m:s"|"g#m#a h:m"|"g#m#a h:m:s"|"y#m#d h:m"|"y#m#d h:m:s"|"ggmmmaaaa h:m"|"ggmmmaaaa h:m:s"|"ggmmmaaaa:h:m"|"ggmmmaaaa:h:m:s"|"Monddyyyy h:m"|"Monddyyyy h:m:s"|"yyyy-mm-ddThh:mm"|"aaaa-mm-ggTh:mm:ss"|":giorno:h:m"|":giorno:h:m:s"|"hr:m"|"hr:m:s"|"min:s"|"h:m:s"|"h:m"|"Data lunga"|"Data breve"|"Data locale"|"Data e ora locali h:m"|"Data e ora locali h:m:s" )

**Descrizione:** Imposta il formato delle etichette.
...
**Descrizione:** Returns the format specification for axis values.
...
**Sintassi:** obj &lt;&lt; Get Inc( number )

**Descrizione:** Ottiene il valore di incremento dell&apos;asse
...
**Sintassi:** obj &lt;&lt; Get Max( number )

**Descrizione:** Ottiene il valore massimo dell&apos;asse.
...
**Sintassi:** obj &lt;&lt; Get Min( number )

**Descrizione:** Ottiene i valori minimi dell&apos;asse.
...
**Sintassi:** obj &lt;&lt; Get Minor Ticks( number )

**Descrizione:** Ottiene il numero di tacche secondarie.
...
**Descrizione:** Restituisce lo script per creare di nuovo la casella dell&apos;asse.
...
**Sintassi:** obj &lt;&lt; Inc( number )

**Descrizione:** Imposta il valore dell&apos;incremento dell&apos;asse.
...
**Descrizione:** Mostra tacche di riferimento dell&apos;asse all&apos;interno del frame del grafico
...
**Sintassi:** obj &lt;&lt; Interval( "Numerico"|"Anno"|"Trimestre"|"Mese"|"Settimana"|"Giorno"|"Ora"|"Minuto"|"Secondo" )

**Descrizione:** Imposta il formato delle etichette numeriche.
...
**Sintassi:** obj &lt;&lt; Label Row

### Label Row Nesting

**Sintassi:** obj &lt;&lt; Label Row Nesting( number )

**Descrizione:** Imposta il numero di righe delle etichette per gli assi del formato data
...
**Descrizione:** Imposta il colore della linea della griglia principale.
...
**Sintassi:** obj &lt;&lt; Max( number )

**Descrizione:** Imposta il valore massimo dell&apos;asse.
...
**Sintassi:** obj &lt;&lt; Min( number )

**Descrizione:** Imposta il valore minimo dell&apos;asse.
...
**Descrizione:** Imposta il colore della linea della griglia secondaria
...
**Sintassi:** obj &lt;&lt; Minor Ticks( number )

**Descrizione:** Imposta il numero di tacche tra le etichette.
...
**Sintassi:** obj &lt;&lt; Paste Axis Settings

**Descrizione:** Applica lo script contenuto negli Appunti, se è appropriato alle impostazioni dell&apos;asse.
...
**Sintassi:** obj &lt;&lt; Remove Axis Label

**Descrizione:** Rimuove tutte le etichette aggiunte con la funzione Aggiungi etichetta dell&apos;asse.
...
**Sintassi:** obj &lt;&lt; Remove Ref Line( number )

**Descrizione:** Rimuove la linea di riferimento indicata.
...
**Sintassi:** obj &lt;&lt; Reversed Scale

**Descrizione:** Inverte la normale direzione della scala in modo che il valore più elevato sia a sinistra o in basso.
...
**Sintassi:** obj &lt;&lt; Revert Axis

**Descrizione:** Ripristina le impostazioni originali dell&apos;asse al momento della creazione.
...
**Sintassi:** obj &lt;&lt; Revert Scale

**Descrizione:** Ripristina la scala dell&apos;asse senza alterare altre personalizzazioni
...
**Sintassi:** obj &lt;&lt; Save To Column Property

**Descrizione:** Salva le impostazioni dell&apos;asse come una proprietà dell&apos;asse nella colonna di dati associata a questo asse.
...
**Sintassi:** obj &lt;&lt; Scale( "Lineare"|"Log"|"Probabilità esponenziale"|"Probabilità di Weibull"|"Probabilità logistica"|"Probabilità di Frechet"|"Probabilità normale"|"Radice cubica"|"Johnson Su"|"Geodetica"|"Geodetica USA"|"Potenza"|"Probabilità gamma"|"Probabilità Beta"|"Miscela di 2 probabilità di numeri normali"|"Miscela di 3 probabilità di numeri normali"|"Scala personalizzata" )

**Descrizione:** Specifica il tipo di scala da applicare all&apos;asse. Se il tipo è Scala personalizzata, questo messaggio prevede due clausole aggiuntive; vedere Scala per interni e Scala per esterni.
...
**Sintassi:** obj &lt;&lt; Scale ID( number )

**Descrizione:** Aggiungere un ID specifico all&apos;asse per l&apos;utilizzo con più assi.
...
**Sintassi:** obj &lt;&lt; Scale To External

**Descrizione:** Scala il sistema di coordinate esterne in base alla formula personalizzata specificata.
...
**Sintassi:** obj &lt;&lt; Scale To Internal

**Descrizione:** Scala il sistema di coordinate interne in base alla formula personalizzata specificata.
...
**Sintassi:** obj &lt;&lt; Set Width( number )

**Descrizione:** Imposta la larghezza dell&apos;asse.
...
**Descrizione:** Mostra (1) o nasconde (0) le etichette dell&apos;asse per le tacche principali. Per impostazione predefinita l&apos;opzione è attivata.
...
**Sintassi:** obj &lt;&lt; Show Major Grid( state=0|1 )

**Descrizione:** Mostra (1) o nasconde (0) la griglia la cui posizione coincide con quella delle etichette numeriche.
...
**Sintassi:** obj &lt;&lt; Show Major Labels( state=0|1 )
...
**Sintassi:** obj &lt;&lt; Show Major Ticks( state=0|1 )

**Descrizione:** Mostra (1) o nasconde (0) le tacche di riferimento la cui posizione coincide con quella delle etichette numeriche. Per impostazione predefinita l&apos;opzione è attivata.
...
**Sintassi:** obj &lt;&lt; Show Minor Grid( state=0|1 )

**Descrizione:** Mostra (1) o nasconde (0) la griglia in posizione intermedia tra due etichette numeriche.
...
**Sintassi:** obj &lt;&lt; Show Minor Labels( state=0|1 )

**Descrizione:** Mostra (1) o nasconde (0) le etichette dell&apos;asse per le tacche secondarie.
...
**Sintassi:** obj &lt;&lt; Show Minor Ticks( state=0|1 )

**Descrizione:** Mostra (1) o nasconde (0) le tacche di riferimento in posizione intermedia tra due etichette numeriche. Per impostazione predefinita l&apos;opzione è attivata.
...
**Sintassi:** &lt;X / Y&gt; Axis( Side ( &lt;1/2&gt; ) )

**Descrizione:** Cambia il lato (principale (1) o secondario (2)) dell&apos;asse
...
**Sintassi:** obj &lt;&lt; Tick Font

**Descrizione:** Imposta il carattere delle tacche di riferimento.
...
**Sintassi:** obj &lt;&lt; Tick Label List

**Descrizione:** Imposta i valori e le posizioni delle etichette della tacca dell&apos;asse.
...
**Sintassi:** obj &lt;&lt; Update Ref Line( ID, index, value, &lt;"Solid|Dashed|Double"&gt;, &lt;Color&gt;, &lt;"label"&gt;, &lt;line width&gt;, &lt;transparency&gt; )

**Descrizione:** Modifica una linea di riferimento esistente.
