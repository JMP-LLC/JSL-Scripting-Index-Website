...
**Descrizione:** Restituisce un riquadro di visualizzazione che mostra una casella di controllo per ciascun elemento che si trova in list inserito.
...
**Sintassi:** obj &lt;&lt; Enable Item( index, 0|1 )

**Descrizione:** Imposta l&apos;elemento che si trova in index nella modalità attivato (1) o disattivato (0).
...
**Sintassi:** 0|1 = obj &lt;&lt; Get( &lt;index&gt; )

**Descrizione:** Restituisce se la casella di controllo è selezionata (1), deselezionata (0) o indeterminata (vuota()) per le caselle di controllo a tre stati.
...
**Descrizione:** Restituisce un elenco di stringhe di elementi selezionati.
...
**Sintassi:** obj &lt;&lt; Get Selected Indices
...
**Sintassi:** indices = obj &lt;&lt; Get Selected Indices As Matrix

**Descrizione:** Returns a list of all of the selected indices as a matrix
...
**Sintassi:** obj &lt;&lt; Get Three State( &lt;Boolean&gt; )

**Descrizione:** Crea una casella di controllo a tre stati. Tutti gli elementi sono 0, 1 o vuoto().
...
**Sintassi:** obj &lt;&lt; Set( &lt;index&gt;,&lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**Descrizione:** Imposta la casella di controllo da selezionare (1) o deselezionare (0). L&apos;uso dell&apos;opzione RunScript richiede anche di specificare l&apos;argomento Boolean, poiché gli argomenti sono posizionali.
...
**Sintassi:** obj &lt;&lt; Set All( &lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**Descrizione:** Imposta tutte le caselle di controllo da selezionare (1) o deselezionare (0). L&apos;uso dell&apos;opzione RunScript richiede anche di specificare l&apos;argomento Boolean, poiché gli argomenti sono posizionali.
...
**Sintassi:** obj &lt;&lt; Set Function( Function( {thisBox, index}, &lt;script&gt; ) )

**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando si fa clic sulla casella di controllo.
...
**Sintassi:** obj &lt;&lt; Set Three State( &lt;Boolean&gt; )
