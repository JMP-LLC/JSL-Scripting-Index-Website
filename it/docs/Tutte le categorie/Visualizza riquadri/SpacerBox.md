...
**Descrizione:** Restituisce un riquadro di visualizzazione al quale si possono assegnare una dimensione e un colore arbitrari.
...
**Descrizione:** Imposta il colore specificato per il distanziatore
...
**Descrizione:** Restituisce il colore del distanziatore.
...
**Sintassi:** boolean = obj &lt;&lt; Get Fill

**Descrizione:** Returns whether the background is painted or not.
...
**Descrizione:** Restituisce l&apos;altezza del distanziatore.
...
**Sintassi:** alpha = obj &lt;&lt; Get Transparency

**Descrizione:** Returns the transparency value, 0..1.
...
**Descrizione:** Restituisce la larghezza del distanziatore.
...
**Descrizione:** Imposta l&apos;altezza del distanziatore.
...
**Descrizione:** Sets whether the background is painted or not.
...
**Sintassi:** obj &lt;&lt; Size( width, height,&lt;min width, min height&gt;,&lt;max width, max height&gt; )

**Descrizione:** Imposta la larghezza e l&apos;altezza del distanziatore.
...
**Sintassi:** obj &lt;&lt; Transparency( alpha )

**Descrizione:** Sets the transparency value, 0..1.
...
**Descrizione:** Imposta la larghezza del distanziatore.
