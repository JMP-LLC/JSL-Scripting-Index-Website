...
**Descrizione:** Restituisce un riquadro di visualizzazione che mostra le stringhe in una colonna.
...
**Sintassi:** "left"|"right"|"center" = obj << Get Justify

**Descrizione:** Ottiene la giustificazione orizzontale della colonna
...
**Sintassi:** obj << Numerical Order( <0 | 1> )

**Descrizione:** I testi contenenti numeri vengono ordinati in ordine numerico.
...
**Sintassi:** obj << Set Allow Text Search( <0 | 1> )

**Descrizione:** Nelle caselle della tabella con righe selezionabili, questo comando consente a una colonna di tipo stringa con lo stato attivo di rispondere all&apos;input da tastiera per cambiare la riga selezionata.
...
**Sintassi:** obj << Set Justify( "left","right","center" )

**Descrizione:** Imposta la giustificazione orizzontale della colonna
...
**Sintassi:** obj << Set Values( <list> )

**Descrizione:** Imposta i valori da un elenco.
