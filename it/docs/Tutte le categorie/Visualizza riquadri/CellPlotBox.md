...
**Sintassi:** obj &lt;&lt; Color Theme( Green to Black to Red|Green to White to Red|White to Black|Blue to Gray to Red|Blue to Green to Red|Spectral|Jet|White to Blue|White to Green|White to Red )

**Descrizione:** Specifica il range di colori da utilizzare per visualizzare il diagramma a celle.
...
**Sintassi:** obj &lt;&lt; Graph Type( "Mappa dei colori"|"Diagramma a punti"|"Grafico a linee verticali"|"Grafico a linee orizzontali"|"Grafico a barre orizzontali" )

**Descrizione:** Specifica lo stile degli elementi visivi del diagramma a celle.
...
**Sintassi:** obj &lt;&lt; No separator lines( state=0|1 )

**Descrizione:** Rimuove le linee disegnate intorno a ogni colonna nel diagramma a celle.
...
**Descrizione:** Richiama la finestra dell&apos;editor delle righe, a partire dal primo punto selezionato.
...
**Descrizione:** Nasconde o mostra le righe corrispondenti nella tabella di dati
...
**Sintassi:** obj &lt;&lt; Sort Ascending

**Descrizione:** Ordina i valori in ordine crescente.
...
**Sintassi:** obj &lt;&lt; Sort Descending

**Descrizione:** Ordina i valori in ordine decrescente.
