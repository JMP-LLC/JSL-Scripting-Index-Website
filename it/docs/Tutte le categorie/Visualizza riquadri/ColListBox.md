...
**Sintassi:** obj &lt;&lt; Append( "string" | {"string", ...} )

**Descrizione:** Aggiunge la nuova stringa o un elenco di stringhe all&apos;ultima posizione.
...
**Sintassi:** "bool" = obj &lt;&lt; Get Case Sensitive

**Descrizione:** Restituisce vero se gli elementi aggiunti all&apos;elenco possono corrispondere a eccezione delle maiuscole/minuscole
...
**Sintassi:** obj &lt;&lt; Get Data Type

**Descrizione:** Restituisce il tipo di dati di una casella di riepilogo di colonna.
...
**Sintassi:** obj &lt;&lt; Item Padding( sides );sides = obj &lt;&lt; Get Item Padding

**Descrizione:** La spaziatura interna aggiunge spazio tra il testo degli elementi della casella di riepilogo
...
**Sintassi:** list = obj &lt;&lt; Get Items( &lt;"Column Reference"&gt;)
...
**Sintassi:** obj &lt;&lt; Get Max Items

**Descrizione:** Restituisce il numero massimo di elementi consentiti per l&apos;elenco.
...
**Sintassi:** obj &lt;&lt; Get Min Items

**Descrizione:** Restituisce il numero minimo di elementi richiesti per l&apos;elenco.
...
**Sintassi:** obj &lt;&lt; Get Modeling Type

**Descrizione:** Restituisce un elenco di tipi di modellizzazione per una casella di riepilogo di colonna.
...
**Sintassi:** list = obj &lt;&lt; Get Selected(&lt;"Column Reference"&gt;)
...
**Sintassi:** obj &lt;&lt; Insert( "string",index )

**Descrizione:** Aggiunge l&apos;elemento o elenco di elementi specificato alla casella di riepilogo dopo index specificato.
...
**Sintassi:** obj &lt;&lt; Menus Enabled( state=0|1 )

**Descrizione:** Attiva o disattiva la comparsa del menu della casella di riepilogo quando si fa clic con il pulsante destro del mouse.
...
**Sintassi:** obj &lt;&lt; Modeling Type( {"Any","Continuous","Nominal","Ordinal","Multiple Response","Unstructured Text","Vector","None","Row State"}) &gt; )

**Descrizione:** Imposta i tipi di modellizzazione di colonne accettati per una casella di riepilogo di colonna. Il valore predefinito "Any" consentirà qualsiasi colonna con un tipo di modellizzazione classico ("Continuous", "Nominal", "Ordinal").
...
**Sintassi:** obj &lt;&lt; On Change( script )

**Descrizione:** Esegue lo script quando cambia la selezione nell&apos;elenco.
...
**Descrizione:** Rimuove tutti gli elementi.
...
**Sintassi:** obj &lt;&lt; Remove Item( index )

**Descrizione:** Rimuove gli elementi specificati in index.
...
**Sintassi:** obj &lt;&lt; Remove Selected

**Descrizione:** Rimuove gli elementi selezionati.
...
**Sintassi:** obj &lt;&lt; Set Case Sensitive( "bool" )

**Descrizione:** Determina se gli elementi aggiunti alla casella di riepilogo devono essere confrontati con elementi esistenti facendo distinzione o meno fra maiuscole/minuscole
...
**Sintassi:** obj &lt;&lt; Set Data Type( "Qualsiasi"|"Numerico"|"Alfanumerico" )

**Descrizione:** Imposta il tipo di colonne che una casella di riepilogo di colonna può accettare: Qualsiasi, Alfanumerico o Numerico.
...
**Sintassi:** obj &lt;&lt; Set Items( list )

**Descrizione:** Imposta l&apos;elenco di tutti gli elementi.
...
**Sintassi:** obj &lt;&lt; Set Max Items( number )

**Descrizione:** Imposta il numero massimo di elementi consentiti per l&apos;elenco.
...
**Sintassi:** obj &lt;&lt; Set Min Items( number )

**Descrizione:** Imposta il numero minimo di elementi richiesti per l&apos;elenco.
...
**Sintassi:** obj &lt;&lt; Set Selected( index|{index1, index2, ...}|"All",&lt;selected&gt;,&lt;Run Script(0|1)&gt; )

**Descrizione:** Imposta l&apos;elemento che si trova in index per essere selezionato (1) o deselezionato (0). Per impostazione predefinita questo messaggio esegue lo script per il rispettivo ListBoxBox. Usare l&apos;opzione RunScript(0) per annullare l&apos;esecuzione dello script. L&apos;uso dell&apos;opzione RunScript richiede inoltre di specificare l&apos;argomento selected poiché gli argomenti sono posizionali.
...
**Sintassi:** obj &lt;&lt; Set Tips( Elenco di suggerimenti )

**Descrizione:** Imposta i suggerimenti per i singoli elementi della casella di riepilogo.
