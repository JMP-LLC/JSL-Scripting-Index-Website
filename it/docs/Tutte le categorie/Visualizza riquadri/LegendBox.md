...
**Sintassi:** LegendBox &lt;&lt; Get Item(Model ID, Model Index)

**Descrizione:** Restituisce un elemento della legenda che può essere interrogato o le cui proprietà visibili sono state modificate.
...
**Sintassi:** obj &lt;&lt; Get Items

**Descrizione:** Restituisce un elenco di tutti gli elementi della legenda che possono essere interrogati o le cui proprietà visibili sono state modificate.
...
**Sintassi:** obj &lt;&lt; Legend Position( list )

**Descrizione:** Cambia la disposizione degli elementi nella finestra della legenda in base all&apos;list inserito.
...
**Descrizione:** Visualizza la finestra Legenda, per modificare varie impostazioni.
...
**Sintassi:** obj &lt;&lt; Orientation( vertical|horizontal )

**Descrizione:** Imposta la direzione in cui sono rivolti gli elementi nella finestra della legenda.
...
**Sintassi:** obj &lt;&lt; Revert Legend

**Descrizione:** Ripristina tutte le modifiche apportate nella finestra della legenda.
...
**Descrizione:** Specifica il numero massimo di elementi da visualizzare nella legenda. Questa impostazione impedisce che una legenda troppo grande sovrasti il grafico.
...
**Sintassi:** obj &lt;&lt; Set Title( "string" )

**Descrizione:** Imposta il titolo della finestra della legenda.
...
**Sintassi:** obj &lt;&lt; Set Wrap( number )

**Descrizione:** Specifica il numero di righe in cui devono essere visualizzati gli elementi della legenda; 0 indica nessun testo a capo (cioè un&apos;unica colonna ampia)
...
**Sintassi:** obj &lt;&lt; Sides( top|left )

**Descrizione:** Imposta la posizione della finestra della legenda.
...
**Sintassi:** obj &lt;&lt; font( fontname, &lt;fontsize&gt;, &lt;fontstyle&gt; )

**Descrizione:** Specifica il carattere da usare per il testo nella legenda.
