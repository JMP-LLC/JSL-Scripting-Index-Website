...
**Descrizione:** Crea un segmento di visualizzazione con una sequenza di segmenti di linee per i valori x e y specificati. Il secondo argomento facoltativo consente l&apos;assegnazione di stati delle righe da una tabella di dati (dt) o in modo indipendente.
