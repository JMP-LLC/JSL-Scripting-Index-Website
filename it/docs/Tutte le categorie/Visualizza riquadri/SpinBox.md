...
**Descrizione:** Restituisce un riquadro di visualizzazione per mostrare un pulsante con comandi su e giù. L&apos;argomento script viene richiamato con un argomento indicante la direzione della freccia su cui fare clic (negativo è giù, positivo è su). Una grandezza di 1 indica un unico clic. È possibile usare valori maggiori per indicare un&apos;azione ripetuta.
...
**Sintassi:** obj &lt;&lt; Click( &lt;value&gt; )

**Descrizione:** Simula un clic sul pulsante ed esegue eventuali script associati.
...
**Sintassi:** obj &lt;&lt; Decrement( &lt;value&gt; )

**Descrizione:** Simula un clic sulla freccia giù ed esegue eventuali script associati.
...
**Sintassi:** obj &lt;&lt; Increment( &lt;value&gt; )

**Descrizione:** Simula un clic sulla freccia su ed esegue eventuali script associati.
...
**Sintassi:** obj &lt;&lt; Set Function( Function( {thisBox, increment}, &lt;script&gt; ) )

**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando vengono premuti i pulsanti del selettore numerico. [incremento] è l’incremento impostato per la casella numerica.
