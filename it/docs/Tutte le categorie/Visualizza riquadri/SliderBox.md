...
**Descrizione:** Restituisce un riquadro di visualizzazione che mostra il controllo di uno slider che va da minValue a maxValue. Al modificare della posizione dello slider, il suo valore è posizionato in variable e viene eseguito lo script.
...
**Sintassi:** float = obj << Get( <index> )

**Descrizione:** Restituisce il valore in virgola mobile a cui è attualmente impostato il cursore.
...
**Sintassi:** bool = obj << Get Log Scale

**Descrizione:** Restituisce se lo slider è in una scala logaritmica (1) o scala lineare (0)
...
**Sintassi:** float = obj << Get Max( <index> )

**Descrizione:** Restituisce il valore massimo a cui si può impostare il cursore.
...
**Sintassi:** float = obj << Get Min( <index> )

**Descrizione:** Restituisce il valore minimo a cui si può impostare il cursore.
...
**Sintassi:** float = obj << Get N

**Descrizione:** Restituisce il numero di cursori che si trovano in SliderBox.
...
**Sintassi:** string = obj << Get Var

**Descrizione:** Restituisce il nome della variabile associato al cursore.
...
**Descrizione:** Ottiene la larghezza del cursore.
...
**Sintassi:** obj << Rescale Slider( min,max )

**Descrizione:** Imposta i valori minimo e massimo accettabili dal cursore.
...
**Sintassi:** obj << Set( float, <index>,<run script(0|1)> )

**Descrizione:** Imposta il valore in virgola mobile del cursore.
...
**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando cambia il cursore.
...
**Sintassi:** obj << Set Log Scale( 0|1 )

**Descrizione:** Imposta lo slider su una scala logaritmica (1) o scala lineare (0)
...
**Sintassi:** obj << Set Max( float, <index> )

**Descrizione:** Imposta il valore massimo a cui si può impostare il cursore.
...
**Sintassi:** obj << Set Min( float, <index> )

**Descrizione:** Imposta il valore minimo a cui si può impostare il cursore.
...
**Sintassi:** string = obj << Set Var

**Descrizione:** Imposta il nome della variabile associato al cursore.
...
**Descrizione:** Imposta la larghezza del cursore.
