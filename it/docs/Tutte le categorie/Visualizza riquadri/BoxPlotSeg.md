...
**Sintassi:** Box Plot Seg( <data>, <frequency>, <weight>, <vertical=0|1> )
...
**Sintassi:** obj << Get Confidence Diamond
...
**Sintassi:** obj << Get Median Line Style
...
**Sintassi:** Matrix = obj << Get Quantiles( number )

**Descrizione:** Restituisce una matrice che rappresenta i quantili calcolati. La prima colonna elenca i quantili che vengono calcolati e la seconda colonna contiene i valori di quei quantili.
...
**Sintassi:** obj << Get Shortest Half Bracket
...
**Sintassi:** obj << Get Shortest Half Color
...
**Sintassi:** obj << Median Line Style( pen style )
...
**Sintassi:** obj << Set Box Style( "Normale"|"Continuo"|"Fine" )
...
**Sintassi:** obj << Set Box Type( "Quantile"|"Outlier" )
...
**Sintassi:** obj << Set Confidence Diamond( state=0|1 )
...
**Sintassi:** obj << Set Fences( state=0|1 )
...
**Sintassi:** obj << Set Fill( state = 0|1 )
...
**Sintassi:** obj << Set Median Line Style( pen style )
...
**Sintassi:** obj << Set Notched( state=0|1 )
...
**Sintassi:** obj << Set Shortest Half Bracket( state = 0|1 )
...
**Sintassi:** obj << Set Shortest Half Color( color )
...
**Sintassi:** obj << Shortest Half Bracket( state = 0|1 )
