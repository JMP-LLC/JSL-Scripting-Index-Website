...
**Sintassi:** obj = Marker Imputation(...Imputation Value( number=0 )...)
...
**Sintassi:** obj = Marker Imputation(...Method( "LD-kNN"|"HWE disattivato"|"HWE attivato"|"Casuali"|"Specificato"="LD-kNN" )...)
...
**Sintassi:** obj = Marker Imputation(...Nearest Markers( number=15 )...)

<b>Elemento Finestra di dialogo di avvio: Sì</b>

**Descrizione:** Specifies the number of neighbor markers. "15", per impostazione predefinita.
...
**Sintassi:** obj = Marker Imputation(...Nearest Samples( number=15 )...)

<b>Elemento Finestra di dialogo di avvio: Sì</b>

**Descrizione:** Specifies the number of neighbor samples. "15", per impostazione predefinita.
...
**Sintassi:** obj = Marker Imputation(...Ploidy( number=2 )...)
...
**Sintassi:** obj = Marker Imputation(...Set Random Seed( number=0 )...)
...
**Sintassi:** obj = Marker Imputation(...Unthreaded( state=0|1 )...)
...
**Sintassi:** obj = Marker Imputation(...Window View( "Visible"|"Invisible"|"Private" )...)
