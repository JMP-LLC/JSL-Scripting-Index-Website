...
**Sintassi:** obj = Marker Statistics(...Marker Format( "Numerico"|"A carattere singolo"|"Alfanumerico"|"Nucleotide a codice singolo"|"Nucleotide"="Numerico" )...)
...
**Sintassi:** obj = Marker Statistics(...Ploidy( number=2 )...)
...
**Sintassi:** obj = Marker Statistics(...Unthreaded( state=0|1 )...)
...
**Sintassi:** obj = Marker Statistics(...Use Annotation Table( state=0|1 )...)
...
**Sintassi:** obj = Marker Statistics(...Window View( "Visible"|"Invisible"|"Private" )...)
