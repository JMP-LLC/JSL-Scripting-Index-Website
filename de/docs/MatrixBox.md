...
**Beschreibung:** Legt fest, ob semantische Formate auf die Matrix angewendet werden. Semantische Formate können auch über die Voreinstellungen festgelegt werden.
...
**Beschreibung:** Gibt eine Liste zurück, welche die Matrix darstellt.
...
**Beschreibung:** Gibt 1 zurück, wenn die Spalten Werte am Dezimaltrennzeichen ausrichten, ansonsten 0.
...
**Beschreibung:** Gibt das geltende Format einer Spalte zurück, dabei handelt es sich um das Format nach Anwenden eines übereinstimmenden semantischen Formats. Wird row vorgegeben, wird das geltende Format für nur die Zeile zurückgegeben.
...
**Beschreibung:** Ruft die Einstellung „Semantische Formate aktivieren“ der Matrix ab. Semantische Formate können auch über die Voreinstellungen festgelegt werden.
...
**Beschreibung:** Gibt die aktuelle Formatspezifikation zurück.
...
**Beschreibung:** Erzeugt eine Datentabelle aus allen ähnlichen Matrizen.
...
**Beschreibung:** Erstellt eine neue Datentabelle mit Werten aus dem Matrixfeld.
...
**Beschreibung:** Gibt ein Anzeigefeld mit einer Matrix zurück.
...
**Beschreibung:** Blendet die Werte im Matrixfeld ein oder aus.
...
**Beschreibung:** Legt die Matrix aus einer Liste fest.
...
**Beschreibung:** Legt das Datenformat der Matrixwerte fest.
...
**Beschreibung:** Das Format der anzuzeigenden Zahlen festlegen.
...
**Beschreibung:** Sortiert die Zeilen der Matrix basierend auf einer der Spalten. Wird 0 für die Spalte angegeben, wird die Sortierung entfernt.
