...
**Beschreibung:** Gibt den Gleitkommawert zurück, auf den der Schieberegler derzeit gesetzt ist.
...
**Beschreibung:** Gibt zurück, ob sich der Schieberegler in einer Log-Skala (1) oder in einer linearen Skala (0) befindet
...
**Beschreibung:** Gibt den größten Wert zurück, auf den der Schieberegler gesetzt werden kann.
...
**Beschreibung:** Gibt den kleinsten Wert zurück, auf den der Schieberegler gesetzt werden kann.
...
**Beschreibung:** Gibt die Anzahl der Schieberegler im SliderBox zurück.
...
**Beschreibung:** Gibt den Variablennamen zurück, der dem Schieberegler zugewiesen ist.
...
**Beschreibung:** Ruft die Breite des Schiebereglers ab.
...
**Beschreibung:** Legt den Minimal- und Maximalwert für den Schieberegler fest.
...
**Beschreibung:** Legt den Gleitkommawert des Schiebereglers fest.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn sich der Wert des Schiebereglers ändert.
...
**Beschreibung:** Legt für den Schieberegler eine Log-Skala (1) oder lineare Skala (0) fest
...
**Beschreibung:** Legt den größten Wert fest, auf den der Schieberegler gesetzt werden kann.
...
**Beschreibung:** Legt den kleinsten Wert fest, auf den der Schieberegler gesetzt werden kann.
...
**Beschreibung:** Legt den Variablennamen für den Schieberegler fest.
...
**Beschreibung:** Legt die Breite des Schiebereglers fest.
