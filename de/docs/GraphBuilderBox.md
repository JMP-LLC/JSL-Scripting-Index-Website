...
**Syntax:** obj << Graph Margin( sides );

sides = obj << Get Graph Margin

**Beschreibung:** The minimum margin around the graph area, which might be superseded by any surrounding axis, legend, or title.
...
**Syntax:** obj << Scale Graph Margin( state=0|1 );

state = obj << Get Scale Graph Margin

**Beschreibung:** Specifies whether the Graph Margin properties should scale with the graph size when applied.
...
**Beschreibung:** Interne Komponente der Plattform „Graphik erstellen“.
...
**Beschreibung:** Legt den Abstand zwischen Graphenbereichen fest.
...
**Beschreibung:** Legt die Farbe des Abstands zwischen Graphenbereichen fest.
...
**Beschreibung:** Legt die Transparenz des Abstands zwischen Graphenbereichen fest.
