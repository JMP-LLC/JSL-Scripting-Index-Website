...
**Syntax:** <<Select Fit( Training | Validation | Test | Summary | Clear All,
...
**Beschreibung:** Uses only training and validation splits instead of training, validation, and test splits.
