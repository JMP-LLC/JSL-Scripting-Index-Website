...
**Beschreibung:** Gibt an, wann am Ende eines Liniensegments Pfeilspitzen zu zeichnen sind.
...
**Beschreibung:** Der aktuelle Wert, der angibt, wann an Liniensegmenten Pfeilspitzen gezeichnet werden.
...
**Beschreibung:** Ruft die Verbindungsart für die fehlenden Werte ab, entweder „Durchgezogen verbinden“, „Schwächer verbinden“, „Gestrichelt verbinden“ oder „Nicht verbinden“.
...
**Beschreibung:** Ruft die Einstellung der Log-Kurve ab. Wenn ein Graph über eine Achse mit einer Log-Skala verfügt, wird die Linie als Kurve dargestellt, damit alle Punkte entlang der Linie die gleichen x- und y-Werte wie auf einer linearen Achse haben.
...
**Beschreibung:** Gibt die Kurveneinstellung der Glättungsfunktion zurück.
...
**Beschreibung:** Ruft das Symbol ab, das zur Darstellung von Liniensegmenten mit einem einzelnen Endpunkt verwendet werden soll.
...
**Beschreibung:** Gibt einen Vektor der X-Koordinatenwerte zurück.
...
**Beschreibung:** Gibt einen Vektor der Y-Koordinatenwerte zurück.
...
**Beschreibung:** Gibt zurück, ob ein einzelner Punkt mit einer fehlenden Koordinate als unbeschränkte Linie behandelt wird.
...
**Syntax:** obj &lt;&lt; Set Connect Missing( "Durchgezogen verbinden"|"Schwächer verbinden"|"Gestrichelt verbinden"|"Nicht verbinden" )

**Beschreibung:** Legt die Verbindungsart für die fehlenden Werte fest, entweder „Durchgezogen verbinden“, „Schwächer verbinden“, „Gestrichelt verbinden“ oder „Nicht verbinden“.
...
**Beschreibung:** Legt die Einstellung der Log-Kurve fest. Wenn ein Graph über eine Achse mit einer Log-Skala verfügt, wird die Linie als Kurve dargestellt, damit alle Punkte entlang der Linie die gleichen x- und y-Werte wie auf einer linearen Achse haben.
...
**Beschreibung:** Legt den Zustand für eine Glättungsfunktion fest.
...
**Beschreibung:** Legt das Symbol fest, das zur Darstellung von Liniensegmenten mit einem einzelnen Endpunkt verwendet werden soll. Verwenden Sie " " für keine Darstellung.
...
**Beschreibung:** Legt fest, ob ein einzelner Punkt mit einer fehlenden Koordinate als unbeschränkte Linie behandelt wird.
...
**Beschreibung:** Erstellt ein Anzeigesegment aus verbundenen Liniensegmenten. Das optionale dritte Argument aktiviert zugewiesene Zeileneigenschaften, entweder aus einer Datentabelle (dt) oder unabhängig.
