...
**Beschreibung:** Gibt die vom Textsegment verwendete Zeichenkette zurück.
...
**Beschreibung:** Legt die Lage des Texts fest. Wenn Relativ festgelegt ist, ist 0,0 oben links und 1,1 unten rechts. Wenn Relativ nicht festgelegt ist, sind die Koordinaten relativ zu den Achsen.
...
**Beschreibung:** Der Wert 0 bedeutet, dass die X- oder Y-Koordinate relativ zum Rahmenfeld ist, und der Wert 1 bedeutet, dass der X- oder Y-Wert relativ zu den Achsen ist. Wenn für Relativ der Wert 0 festgelegt ist, werden die X- und Y-Koordinaten von 0,0 bis 1,1 zugeordnet, von oben links bis unten rechts des Graphenfelds.
...
**Beschreibung:** Legt die vom Textsegment verwendete Zeichenkette fest.
