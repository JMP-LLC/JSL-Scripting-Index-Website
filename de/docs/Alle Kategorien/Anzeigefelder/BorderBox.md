...
**Beschreibung:** Fügt einen Abstand zwischen dem unteren Rand des Randfelds und dem Inhalt des Randfelds ein.
...
**Beschreibung:** Gibt 0 zurück, wenn das Ausfüllen des Hintergrunds ausgeschaltet ist, und 1, wenn das Ausfüllen des Hintergrunds  eingeschaltet ist.
...
**Beschreibung:** Gibt den Zahlencode für den Linienstil des Rands zurück.
...
**Beschreibung:** Gibt den unteren Rand zurück.
...
**Beschreibung:** Gibt den linken Rand zurück.
...
**Beschreibung:** Gibt den rechten Rand zurück.
...
**Beschreibung:** Gibt zurück, welche Seiten gezeichnet sind.
...
**Beschreibung:** Gibt den oberen Rand zurück.
...
**Beschreibung:** Fügt einen Abstand zwischen dem linken Rand des Randfelds und dem Inhalt des Randfelds ein.
...
**Beschreibung:** Fügt einen Abstand zwischen dem rechten Rand des Randfelds und dem Inhalt des Randfelds ein.
...
**Beschreibung:** Aktiviert oder deaktiviert das Ausfüllen des Hintergrunds des Randfelds in der Hintergrundfarbe.
...
**Beschreibung:** Legt den Linienstil für den Rand fest. Pen style kann entweder die Zahl oder die Zeichenkette in Anführungszeichen sein: 0 (durchgezogen), 1 (gepunktet), 2 (gestrichelt), 3 (Strich-Punkt), 4 (Strich-Punkt-Punkt).
...
**Beschreibung:** Eine ganze Zahl, die Einstellungen für das Anzeigefeld zugeordnet ist.
...
**Beschreibung:** Fügt einen Abstand zwischen dem oberen Rand des Randfelds und dem Inhalt des Randfelds ein.
...
**Beschreibung:** Gibt ein Anzeigefeld zurück, in dem die darin enthaltenen Anzeigefelder einen Rand haben.
