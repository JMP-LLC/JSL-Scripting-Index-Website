...
**Beschreibung:** Stammknoten zum Baum hinzufügen
...
**Beschreibung:** Knoten im Baum reduzieren.
...
**Beschreibung:** Knoten im Baum aktivieren oder deaktivieren. Zustand 1 festlegen, um den Knoten zu aktivieren. Zustand 0 festlegen, um den Knoten zu deaktivieren.
...
**Beschreibung:** Knoten im Baum erweitern.
...
**Beschreibung:** Gibt das Skript, die Funktion oder Methode zurück, die ausgeführt wird, wenn der Benutzer mit der rechten Maustaste auf den Baum oder einen Knoten im Baum klickt.
...
**Beschreibung:** Gibt das Skript, die Funktion oder Methode zurück, die ausgeführt wird, wenn auf einen Knoten doppelt geklickt wird.
...
**Beschreibung:** Gibt das Skript, die Funktion oder Methode zurück, die ausgeführt wird, wenn sich die Auswahl im Baum ändert.
...
**Beschreibung:** Liste der Stammknoten des Baums abrufen. Sind keine Stammknoten vorhanden, wird eine leere Liste zurückgegeben.
...
**Beschreibung:** Bei einem Baum mit Einzelauswahl wird der ausgewählte Baumknoten abgerufen; Leer, wenn kein Knoten ausgewählt ist. Bei einem Baum mit Mehrfachauswahl wird eine Liste der ausgewählten Knoten abgerufen; Leer, wenn kein Knoten ausgewählt ist.
...
**Beschreibung:** Gibt „wahr“ zurück, wenn der Knoten im Baum reduziert ist.
...
**Beschreibung:** Gibt „wahr“ zurück, wenn der Knoten im Baum erweitert ist.
...
**Beschreibung:** Gibt „wahr“ zurück, wenn der Knoten im Baum aktiviert ist.
...
**Beschreibung:** Gibt 1 zurück, wenn der Baum eine Mehrfachauswahl aufweist. Gibt  0 zurück, wenn der Baum eine Einzelauswahl aufweist.
...
**Beschreibung:** Gibt „wahr“ zurück, wenn es sich bei dem Knoten um einen Stammknoten im Baum handelt.
...
**Beschreibung:** Gibt „wahr“ zurück, wenn der Knoten im Baum ausgewählt ist.
...
**Beschreibung:** Knoten im Baum zur Ansicht bringen.
...
**Beschreibung:** Stammknoten aus dem Baum entfernen
...
**Beschreibung:** Legt das Skript, die Funktion oder Methode fest, die ausgeführt wird, wenn der Benutzer mit der rechten Maustaste auf den Baum oder einen Knoten im Baum klickt.
...
**Beschreibung:** Für den Baum Einzelauswahl (0) oder Mehrfachauswahl (1) festlegen.
...
**Beschreibung:** Legt das Skript, die Funktion oder Methode fest, die ausgeführt werden soll, wenn auf einen Knoten doppelt geklickt wird.
...
**Beschreibung:** Legt das Skript, die Funktion oder Methode fest, die ausgeführt werden soll, wenn sich die Auswahl im Baum ändert. „Leer“ wird an das Skript übergeben, wenn die Auswahl gelöscht wurde.
...
**Beschreibung:** Liste der im Baum gezeigten Stammknoten festlegen.
...
**Beschreibung:** Wählt den angegebenen Baumknoten im Anzeigefeld des Baums aus. Wird eine Liste von Baumknoten verwendet, werden bei Bäumen mit Mehrfachauswahl alle Knoten in der Liste ausgewählt. Wird eine Liste von Baumknoten verwendet, wird bei Bäumen mit Einzelauswahl der ersten Knoten in der Liste ausgewählt.
...
**Beschreibung:** Legt die Breite und Höhe des Felds fest.
...
**Beschreibung:** Gibt ein Anzeigefeld zurück, um einen Hierarchiebaum anzuzeigen. Standardmäßig kann ein einzelnes Element ausgewählt werden. Bei Angabe von Mehrfachauswahl können mehrere Elemente im Baum ausgewählt werden.
