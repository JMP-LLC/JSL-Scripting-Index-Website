...
**Beschreibung:** Fügt eine neue Zeichenkette über dem aufrufenden Hierarchiefeld ein.
...
**Beschreibung:** Fügt eine neue Zeichenkette nach dem aufrufenden Hierarchiefeld ein.
...
**Beschreibung:** Fügt eine neue Zeichenkette vor dem aufrufenden Hierarchiefeld ein.
...
**Beschreibung:** Fügt eine neue Zeichenkette unter dem aufrufenden Hierarchiefeld ein.
...
**Syntax:** obj &lt;&lt; Change Type( "Fischgräten"|"Hierarchie"|"Geschachtelt" )

**Beschreibung:** Legt den Stil des Hierarchiefelds fest.
...
**Beschreibung:** Blendet alle untergeordneten Elemente unter dem angegebenen Hierarchiefeld aus.
...
**Beschreibung:** Legt die Farbe des Texts fest.
...
**Beschreibung:** Entfernt das Hierarchiefeld.
...
**Beschreibung:** Legt fest, ob die Zeichenketten im Hierarchiefeld nacht rechts (1) oder links (0) zeigen.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld, so dass es das erste Hierarchiefeld ist.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld, so dass es mit dem Geschwister-Hierarchiefeld alterniert.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld nach unten.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld nach links.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld nach rechts.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld nach oben.
...
**Beschreibung:** Dreht den Text, so dass er horizontal angezeigt wird und von links beginnt.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld, so dass es das letzte Hierarchiefeld ist.
...
**Beschreibung:** Legt fest, ob die Zeichenketten im Hierarchiefeld rechts (1) oder links (0) ausgerichtet sind.
...
**Beschreibung:** Erstellt eine neue Datentabelle mit Zeichenketten im Hierarchiefeld.
...
**Beschreibung:** Verschiebt das aufrufende Hierarchiefeld auf die andere Seite der anderen Hierarchiefelder.
...
**Beschreibung:** Dies ist wahr, wenn alle Nachkommen die gleiche vorgegebene Abstandskonfiguration annehmen.
...
**Beschreibung:** Dies ist wahr, wenn die vorgegebene Abstandskonfiguration auf den aktuellen Knoten angewendet wird.
...
**Beschreibung:** Dreht den Text, so dass er vertikal angezeigt wird und von unten beginnt.
...
**Beschreibung:** Dreht den Text, so dass er vertikal angezeigt wird und von oben beginnt.
...
**Beschreibung:** Dies ist der übliche Abstand zwischen Hierarchiefeldern.
...
**Beschreibung:** Dies ist der vertikale Abstand zwischen Geschwister-Hierarchiefeldern und dem übergeordneten Feld.
...
**Beschreibung:** Dies ist der Abstand zwischen Hierarchiefeldern bei einer Drehung um 90 Grad.
...
**Beschreibung:** Gibt die Breite an, die jede Zeichenkette einnehmen kann, bevor die Zeichenkette in einer neuen Zeile weitergeführt wird.
...
**Beschreibung:** Wenn aktiviert (1), können die Zeichenketten zum Bearbeiten mit der Maus angeklickt werden.
...
**Beschreibung:** Gibt ein Anzeigefeld mit einer Hierarchie von Zeichenketten zurück.
