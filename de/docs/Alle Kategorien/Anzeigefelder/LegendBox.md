...
**Beschreibung:** Gibt ein Legendenelement zurück, das abgefragt werden kann oder dessen sichtbare Eigenschaften geändert werden können.
...
**Beschreibung:** Gibt eine Liste aller Legendenelemente zurück, die abgefragt werden können oder deren sichtbare Eigenschaften geändert werden können.
...
**Beschreibung:** Ordnet die Elemente im Legendenfeld entsprechend der eingegebenen list neu an.
...
**Beschreibung:** Legendenfenster aufrufen, um verschiedene Einstellungen zu ändern.
...
**Beschreibung:** Legt die Ausrichtung der Elemente im Legendenfeld fest.
...
**Beschreibung:** Macht alle am Legendenfeld vorgenommenen Änderungen rückgängig.
...
**Beschreibung:** Gibt die maximale Anzahl von Elementen an, die in der Legende angezeigt werden sollen. Diese Einstellung verhindert, dass eine überfüllte Legende den Graphen überfrachtet.
...
**Beschreibung:** Legt den Titel für das Legendenfeld fest.
...
**Beschreibung:** Gibt die Anzahl von Zeilen an, auf denen die Legendenelemente angezeigt werden sollen; 0 bedeutet kein Zeilenumbruch (d.h. eine einzige breite Spalte)
...
**Beschreibung:** Legt die Position des Legendefelds fest.
...
**Beschreibung:** Schriftart für Text in der Legende angeben.
