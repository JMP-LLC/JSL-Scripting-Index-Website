...
**Beschreibung:** Gibt den Farbbereich für die Anzeige des Zellendiagramms an.
...
**Syntax:** obj << Graph Type( "Farbkodierung"|"Punktdiagramm"|"VLine-Diagramm"|"HLine-Diagramm"|"HBar-Diagramm" )

**Beschreibung:** Gibt den Stil des Zellendiagramms an.
...
**Beschreibung:** Entfernt die Linien, die im Zellendiagramm um jede Spalte gezeichnet werden.
...
**Beschreibung:** Zeileneditor aufrufen und mit dem ersten ausgewählten Punkt beginnen.
...
**Beschreibung:** Sortiert die Werte in aufsteigender Reihenfolge.
...
**Beschreibung:** Sortiert die Werte in absteigender Reihenfolge.
