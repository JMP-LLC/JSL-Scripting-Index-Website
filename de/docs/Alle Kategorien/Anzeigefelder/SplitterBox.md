...
**Beschreibung:** Schließt den Bereich am vorgegebenen Index. Wenn das Argument previous 1 ist, wird der Platz dem vorherigen Feld in der Liste zugeordnet. Andernfalls wird der Platz dem nächsten Feld zugeordnet.
...
**Syntax:** obj << Divider Color( color );

color = obj << Get Divider Color

**Beschreibung:** Gibt die Farbe für jede Teilungslinie an oder gibt sie zurück. Wenn nicht festgelegt, wird eine Farbe basierend auf der Hintergrundfarbe verwendet.
...
**Syntax:** obj << Divider Length( number );

number = obj << Get Divider Length

**Beschreibung:** Gibt die Länge als Prozentsatz für jede Teilungslinie an oder gibt sie zurück. Ein Wert von 0,0 führt zu einer unsichtbaren Teilungslinie. Ein Wert von 1,0 ergibt eine Teilungslinie in voller Länge (Standard).
...
**Syntax:** obj << Divider Thickness( number );

number = obj << Get Divider Thickness

**Beschreibung:** Gibt die Linienstärke für jede Teilungslinie an oder gibt sie zurück. Dieser Wert muss ungleich Null sein.
...
**Beschreibung:** Gibt die Anteile für jeden Bereich des Splitter Box zurück.
...
**Beschreibung:** Öffnet den Bereich am vorgegebenen Index. Wenn das Argument previous 1 ist, wird der Platz vom vorherigen Feld in der Liste genommen. Andernfalls wird der Platz vom nächsten Feld genommen.
...
**Beschreibung:** Legt die Anteile für jeden Bereich des Splitter Box fest.
...
**Beschreibung:** Legt den Anteil für den letzten Bereich des Splitter Box fest.
...
**Beschreibung:** Gibt zurück, ob das Listenfeld horizontal (1) oder vertikal (0) ist.
...
**Beschreibung:** Legt fest, ob das Listenfeld horizontal (1) oder vertikal (0) ist.
...
**Beschreibung:** Gibt ein Anzeigefeld zurück, das andere Anzeigefelder mit interaktiver Steuerung der Größen horizontal oder vertikal organisieren kann. Die Größen untergeordneter Elemente werden als Anteil der Breite oder Höhe des Splitter Box angegeben. Das optionale Argument Size wird nur für das oberste Fensterbereichsfeld verwendet; Felder auf unteren Ebenen erhalten die gleiche Größe wie alle anderen untergeordneten Felder.
