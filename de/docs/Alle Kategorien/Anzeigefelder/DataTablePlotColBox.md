...
**Beschreibung:** Hängt einen neuen Wert an das Anzeigefeld an.
...
**Beschreibung:** Inhalt der Spalte in die Zwischenablage kopieren
...
**Beschreibung:** Spaltendaten aus den ausgewählten Zeilen in die Zwischenablage kopieren
...
**Beschreibung:** Zeigt einen Punkt statt eines Balkens.
...
**Beschreibung:** Gibt die Werte in einer Liste zurück, oder den i-ten Wert. Standardmäßig werden die Werte in der Reihenfolge zurückgegeben, in der sie in der Tabelle angezeigt werden. Wird „Unsortiert“ angegeben, sind die Werte immer in der gleichen Reihenfolge, unabhängig von der Sortierung der Tabelle.
...
**Beschreibung:** Gibt die Werte in einer Matrix zurück, insbesondere einen Spaltenvektor.
...
**Beschreibung:** Achsenposition der Diagrammspalte abrufen. Standardmäßig wird sie gelegentlich oben angezeigt, abhängig von der Skala und dem Titel.
...
**Beschreibung:** Farbe der Balken im Diagramm abrufen
...
**Beschreibung:** Farbe der Balken im Diagramm abrufen, wenn die entsprechende Zeile ausgewählt ist
...
**Beschreibung:** Returns a reference to the data table column that corresponds to this table box column.
...
**Beschreibung:** Gibt den Text der Spaltenüberschrift zurück.
...
**Beschreibung:** Gibt die Beschriftungen für jede Zeile zurück.
...
**Beschreibung:** Blendet das Anzeigefeld ein oder aus.
...
**Beschreibung:** Aktiviert oder deaktiviert die Bearbeitung von Spaltenüberschriften
...
**Beschreibung:** Die untere Grenze zeichnet eine Kurve an den angegebenen Punkten.
...
**Beschreibung:** Zeigt Symbole an den Grenzen jedes Werts.
...
**Beschreibung:** Entfernt ein Element aus der Spalte.
...
**Beschreibung:** Legt die Werte aus einer Liste fest. Wird „Vorsortiert“ angegeben, erscheinen die Werte in der gleichen Reihenfolge wie in der übergebenen Liste, andernfalls werden die Werte basierend auf der Sortierreihenfolge der aktuellen Tabelle sortiert.
...
**Beschreibung:** Konfiguriert die Achse von PlotColBox. Weitere Einzelheiten finden Sie unter AxisBox.
...
**Beschreibung:** Für die Achse der Diagrammspalte festlegen, dass sie immer oben oder unten ist. Standardmäßig wird sie gelegentlich oben angezeigt, abhängig von der Skala und dem Titel.
...
**Beschreibung:** Farbe der Balken im Diagramm festlegen
...
**Beschreibung:** Farbe der Balken im Diagramm festlegen, wenn die entsprechende Zeile ausgewählt ist
...
**Beschreibung:** Sets the data table column that corresponds to this table box column.
...
**Beschreibung:** Ändert den Text der Spaltenüberschrift.
...
**Beschreibung:** Legt die Beschriftungen für jede Zeile fest.
...
**Beschreibung:** Ändert die visuelle Darstellung der Diagrammspalte.
...
**Beschreibung:** Schaltet die Möglichkeit ein oder aus, die Größe einer Spalte interaktiv zu ändern.
...
**Beschreibung:** Legt die minimum und maximum Skala des PlotColBox fest. Die Formatparameter geben ein Format an, das nur verwendet wird, wenn die ersten beiden Parameter 0 und 1 sind.
...
**Beschreibung:** Wenn aktiviert, warten Spalten, deren Größe automatisch festgelegt wird, mit der Verkleinerung, bis das breiteste Element kleiner als 2/3 der aktuellen Breite ist.
...
**Beschreibung:** Legt die Werte aus einer Liste fest.
...
**Beschreibung:** Legt die Breite (in Pixel) von PlotColBox fest.
...
**Beschreibung:** Dient zum Festlegen der Größe der Symbole, wenn die Diagrammspalte im Intervallmodus ist.
...
**Beschreibung:** Die obere Grenze zeichnet eine Kurve an den angegebenen Punkten.  Zunächst muss eine untere Grenze angegeben werden.
...
**Beschreibung:** Gibt ein Anzeigefeld mit einer Spalte aus einer Datentabelle zurück.
