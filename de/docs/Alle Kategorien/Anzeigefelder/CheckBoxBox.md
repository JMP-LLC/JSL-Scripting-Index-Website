...
**Beschreibung:** Legt fest, ob das Element an index aktiviert (1) oder deaktiviert (0) ist.
...
**Beschreibung:** Gibt bei Kontrollkästchen mit drei Zuständen zurück, ob das Kontrollkästchen aktiviert (1), deaktiviert (0) oder unbestimmt (leer()) ist.
...
**Beschreibung:** Gibt eine Liste mit Zeichenketten aktivierter Elemente zurück.
...
**Beschreibung:** Returns a list of all of the selected indices as a matrix
...
**Beschreibung:** Erstellt ein Kontrollkästchen mit drei Zuständen. Alle Elemente sind entweder 0, 1 oder leer().
...
**Beschreibung:** Legt fest, ob das Kontrollkästchen aktiviert (1) oder deaktiviert (0) ist. Bei Verwendung der Option RunScript muss auch das Argument Boolean angegeben werden, da die Argumente positionsbezogen sind.
...
**Beschreibung:** Legt fest, ob alle Kontrollkästchen aktiviert (1) oder deaktiviert (0) sind. Bei Verwendung der Option RunScript muss auch das Argument Boolean angegeben werden, da die Argumente positionsbezogen sind.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn ein Kontrollkästchen angeklickt wird.
...
**Beschreibung:** Gibt ein Anzeigefeld mit einem Kontrollkästchen für jedes Element in der eingegebenen list zurück.
