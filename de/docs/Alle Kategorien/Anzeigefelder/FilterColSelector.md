...
**Beschreibung:** Spalten mit dem Modellierungstyp „Keine“ in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Zeichenspalten in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Stetige Spalten in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Ausdrucksspalten in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Bei der Spaltensuche wird zwischen Groß- und Kleinschreibung unterschieden oder nicht.
...
**Beschreibung:** Spalten mit Mehrfachantworten in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Nur die Spalten aufführen, deren Namen den angegebenen Text enthalten.
...
**Beschreibung:** Nur die Spalten aufführen, deren Namen mit dem angegebenen Text enden.
...
**Beschreibung:** Nur die Spalten aufführen, deren Namen mit dem angegebenen Text beginnen.
...
**Beschreibung:** Nominale Spalten in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Numerische Spalten in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Ordinale Spalten in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Spaltenliste auf die gesamte Liste zurücksetzen.
...
**Beschreibung:** Legt fest, ob das Element an index ausgewählt (1) oder nicht ausgewählt (0) ist.
...
**Beschreibung:** Spaltenliste nach Namen sortieren.
...
**Beschreibung:** Spalten mit unstrukturiertem Text in die Liste einschließen oder aus der Liste ausschließen.
...
**Beschreibung:** Vektorspalten in die Liste einschließen oder aus der Liste ausschließen.
