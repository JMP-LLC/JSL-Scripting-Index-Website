...
**Beschreibung:** Fügt der angehefteten Hover-Beschriftung einen benutzerdefinierten Textblock hinzu.
...
**Beschreibung:** Simuliert eine Klick-Aktion auf den Link, der dem vorgegebenen Text oder Index zugewiesen ist. Ist keiner angegeben, wird der letzte Link angenommen, üblicherweise das Graphlet, sofern vorhanden.
...
**Beschreibung:** Schließt die Hover-Beschriftung.
...
**Beschreibung:** Kopiert den Inhalt der Hover-Beschriftung in die Zwischenablage. 

Wenn der Vorgang einer Variablen zugewiesen wird, wird der Text der Hover-Beschriftung in dieser gespeichert.
...
**Beschreibung:** Entfernt die Anmerkung, die sich im Vordergrund des Anzeigefensters befindet.
...
**Beschreibung:** Gestattet, dass „Löschen“ aus dem Kontextmenü entfernt wird
...
**Beschreibung:** Ruft einen visuellen Editor für den Inhalt der Hover-Beschriftung auf.
...
**Beschreibung:** Legt die Schriftart für die angeheftete Hover-Beschriftung fest.
...
**Beschreibung:** Gibt eine Liste der Texte mit den klickbaren Einträgen in der Hover-Beschriftung zurück. 

Bilder und Graphlets sind einer leeren Zeichenkette zugewiesen.
...
**Beschreibung:** Gibt ein assoziatives Array mit den Namen und Werten der lokalen Variablen zurück, die als Teil des Kontexts für die Ausführung der Hover-Beschriftung angegeben sind.

Nutzungsbeispiele siehe voreingestellte Definitionen für Graphlets.
...
**Beschreibung:** Ruft die Visualisierung des Graphlets oder die Plattform in einem neuen Fenster auf.

Der aufrufende/vorherige Inhalt kann mit dem Befehl „Rückgängig“ wiederhergestellt werden.

Die gleiche Funktionalität wird bei Klicken auf das Miniaturbild eines Graphlets bereitgestellt.
...
**Beschreibung:** Ruft die Visualisierung des Graphlets oder die Plattform in einem neuen Fenster oder im zuletzt aufgerufenen Fenster auf, wobei dessen Inhalt ersetzt wird.

Der aufrufende/vorherige Inhalt kann mit dem Befehl „Rückgängig“ wiederhergestellt werden.

Die gleiche Funktionalität wird mit Alt+Klicken auf das Miniaturbild eines Graphlets bereitgestellt.
...
**Beschreibung:** Ruft die Visualisierung des Graphlets oder die Plattform in einem neuen Fenster auf, wobei dessen Inhalt ersetzt wird.

Der aufrufende/vorherige Inhalt kann mit dem Befehl „Rückgängig“ wiederhergestellt werden.

Die gleiche Funktionalität wird mit Strg+Klicken auf das Miniaturbild eines Graphlets bereitgestellt.
...
**Beschreibung:** Ersetzt den Textinhalt der angehefteten Hover-Beschriftung durch den vorgegebenen Text.
...
**Beschreibung:** Setzt den Textinhalt der angehefteten Hover-Beschriftung wieder auf seinen ursprünglichen Text zurück.
...
**Beschreibung:** Ruft eine Datentabelle mit einem lokalen Datenfilter auf, der nur die Teilmenge der Daten anzeigt, die dem visuellen Element unter der Hover-Beschriftung zugewiesen ist.
