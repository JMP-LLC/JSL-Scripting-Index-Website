...
**Beschreibung:** Simuliert einen Klick auf die Schaltfläche und führt ggf. Rückrufe aus. Eine Schaltfläche zum Umschalten ändert ihren Zustand, bevor der Rückruf aufgerufen wird. Eine Menüschaltfläche erfordert ein Argument, um anzugeben, welches Element angeklickt werden soll.
...
**Beschreibung:** Gibt 1 zurück, wenn die Schaltfläche zum Umschalten betätigt wird, 0, wenn sie nicht betätigt wird. Gilt nur für Schaltflächen mit Style(„Umschalten“).
...
**Beschreibung:** Gibt den Namen der Schaltfläche zurück.
...
**Beschreibung:** Gibt das Icon für die Schaltfläche zurück.
...
**Beschreibung:** Gibt die Position eines Symbols in einem Schaltflächenfeld zurück. Das Symbol kann links oder rechts vom Schaltflächentext angezeigt werden.
...
**Beschreibung:** Gibt den Index des zuletzt vom Benutzer ausgewählten Menübefehls zurück.
...
**Beschreibung:** Ruft die Menüelemente ab, die im Popup-Menü angezeigt werden, wenn auf die Schaltfläche geklickt wird.
...
**Beschreibung:** Gibt den aktuellen Stil der Schaltfläche zurück.
...
**Beschreibung:** Gibt den aktuellen Unterstreichungsstil der Schaltfläche zurück.
...
**Beschreibung:** Schließt das enthaltene Gliederungsfeld und öffnet das nächste.
...
**Beschreibung:** Legt für die Schaltfläche fest, dass der Bearbeitungsfokus nach dem Klicken unverändert bleibt. Standardmäßig wird der Fokus unter Windows übernommen. Unter Macintosh bleibt der Fokus standardmäßig erhalten.
...
**Beschreibung:** Legt den Umschaltzustand einer Schaltfläche zum Umschalten als betätigt (1) oder nicht betätigt (0) fest. Gilt nur für Schaltflächen mit Style(„Umschalten“).
...
**Beschreibung:** Legt den angegebenen Text als Namen der Schaltfläche fest.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn die Schaltfläche betätigt wird.
...
**Beschreibung:** Zeigt ein JMP-Symbol oder ein Bild auf der Schaltfläche an. Verwenden Sie einen JMP-Symbolnamen oder den Dateipfad zu einem Bild.
...
**Beschreibung:** Legt den Ort des Symbols links oder rechts vom Schaltflächentext fest
...
**Beschreibung:** Gibt den Index des vom Benutzer ausgewählten Menüelements zurück.
...
**Beschreibung:** Legt die Menüelemente fest, die im Popup-Menü angezeigt werden, wenn auf die Schaltfläche geklickt wird.
...
**Syntax:** obj << Style( "Normal"|"Unterstrichen"|"Umschalten" )

**Beschreibung:** Legt den Stil der Schaltfläche fest.
...
**Beschreibung:** Legt für die Schaltfläche statt des standardmäßigen Stils den Stil mit unterstrichenem Text fest.
...
**Beschreibung:** Deckt versteckte Elemente im enthaltenen Gliederungsfeld auf.
