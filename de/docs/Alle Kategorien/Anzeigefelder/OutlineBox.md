...
**Beschreibung:** Zeigt das Menü an, um alle geöffneten Dateien zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Schlüssel-Wert-Paar für Gliederungsfelder, das eine Spalte für den Befehl „Kombinierte Datentabelle erzeugen“ für Tabellenfelder hinzufügt
...
**Beschreibung:** Zeigt das Menü an, um ein Verzeichnis mit Dateien zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Zeigt das Menü an, um eine Dateireferenz zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Zeigt das Menü an, um ein Gliederungselement zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Zeigt das Menü an, um eine Skriptschaltfläche zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Zeigt das Menü an, um Text zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Zeigt das Menü an, um eine URL zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Zeigt das Menü an, um eine Fensterreferenz zum Gliederungsfeld hinzuzufügen.
...
**Beschreibung:** Schließt das Gliederungsfeld.
...
**Beschreibung:** Schließt alle untergeordneten Elemente des Knotens.
...
**Beschreibung:** Schließt alle Knoten, die diesem Gliederungsfeld ähnlich sind.
...
**Beschreibung:** Schließt alle Knoten, die keine untergeordneten Elemente enthalten.
...
**Beschreibung:** Findet alle Dateiverknüpfungen in Schaltflächenskripten, um sie zu bearbeiten.
...
**Beschreibung:** Erlaubt den Umbruch langer Titel
...
**Beschreibung:** Gibt die Einstellung zurück, Gliederungsfelder in vertikaler Richtung zu reduzieren, um in horizontaler Richtung Platz zu sparen.
...
**Beschreibung:** Option zum Unterdrücken von Gliederungstext beim Speichern von Bildern abrufen
...
**Beschreibung:** Ruft den Zustand des Menüelements index im Popup-Menü ab. Der Zustand ist normal (0), aktiviert (1) oder deaktiviert (-1).
...
**Beschreibung:** Gibt das an das aufrufende Objekt angehängte Menüskript zurück.
...
**Beschreibung:** Gibt eine Referenz auf das skriptfähige Objekt des aufrufenden Objekts zurück.
...
**Beschreibung:** Ruft den Titel des Gliederungsfelds ab.
...
**Syntax:** obj << Title Background Color( color );

color = obj << Get Title Background Color

**Beschreibung:** Ist die Hintergrundfarbe festgelegt, wird der Gliederungstitel vor dem Darstellen des Titelinhalts mit der Hintergrundfarbe ausgefüllt. Ist für die Hintergrundfarbe „Keine“ festgelegt, sind Hintergrund und Inhalt der beinhaltenden Boxen sichtbar.
...
**Syntax:** obj << Title Border( sides );

sides = obj << Get Title Border

**Beschreibung:** Titelränder sind durchgezogene Linien, die um die Außenseite des Gliederungstitels gezogen werden. Wird ein einzelner Wert angegeben, gilt er für alle Seiten. Werden zwei Werte angegeben, gelten sie für den horizontalen und den vertikalen Rand. Titelränder sind relativ zur Ausrichtung des Titels. Bei einer geschlossenen Gliederung werden der Rand und der Inhalt vertikal rotiert.
...
**Syntax:** obj << Title Border Color( color );

color = obj << Get Title Border Color

**Beschreibung:** Optionale Farbe zum Überschreiben der Standardfarbe für Rahmen von Gliederungstiteln.
...
**Syntax:** obj << Title Padding( sides );

sides = obj << Get Title Padding

**Beschreibung:** Der Innenabstand des Titels fügt Platz zwischen dem Titelinhalt und dem Rand des Titels hinzu. Wird ein einzelner Wert angegeben, gilt er für alle Seiten. Werden zwei Werte angegeben, gelten sie für den horizontalen und den vertikalen Innenabstand. Der Innenabstand des Titels ist relativ zur Ausrichtung des Titels. Bei einer geschlossenen Gliederung werden der Innenabstand und der Inhalt vertikal rotiert.
...
**Beschreibung:** Der Gliederungstitel wird in der vorgegebenen Farbe dargestellt, sofern eine festgelegt ist. Ist die Eigenschaft nicht festgelegt, erbt der Titel die Textfarbe der beinhaltenden Box.
...
**Beschreibung:** Gibt 1 zurück, wenn die untergeordneten Elemente des Gliederungsfelds horizontal ausgerichtet sind, und 0, wenn nicht.
...
**Beschreibung:** Gibt 1 zurück, wenn das Gliederungsfeld offen ist, und 0, wenn es geschlossen ist.
...
**Beschreibung:** Richtet die untergeordneten Elemente des Gliederungsfelds horizontal aus.
...
**Syntax:** obj << Image Export Display( "Normal"|"Nur Text"|"Keine" )

**Beschreibung:** Option zum Unterdrücken von Gliederungstext beim Speichern von Bildern
...
**Beschreibung:** Wenn das Gliederungsfeld Bestandteil eines Journals ist, wird das Journal entsperrt, um weitere Änderungen zuzulassen. Journale können über Rechtsklick im Randbereich gesperrt werden.
...
**Beschreibung:** Gliederungstitel sperren, um interaktive Änderungen zu verhindern.
...
**Beschreibung:** Öffnet alle untergeordneten Elemente des Knotens.
...
**Beschreibung:** Öffnet alle Knoten, die diesem Gliederungsfeld ähnlich sind.
...
**Beschreibung:** Legt den Zustand des Elements im Popup-Menü an index als normal (0), aktiviert (1) oder deaktiviert (-1) fest.
...
**Beschreibung:** Fügt dem Menü einen Eintrag hinzu, wenn Sie auf das rote Dreieck klicken.
...
**Beschreibung:** Legt das dem Gliederungsfeld zugewiesene skriptfähige Objekt fest. Das Gliederungsfeld zeigt ein durch ein rotes Dreieck gekennzeichnetes Menü mit Meldungen an, die an das skriptfähige Objekt gesendet werden können. Wenn kein Argument angegeben ist, wird das skriptfähige Objekt gelöscht.
...
**Beschreibung:** Ändert den Titel des Gliederungsfelds.
...
**Beschreibung:** Skript festlegen, das ausgeführt wird, wenn der Gliederungstitel geändert wird.
...
**Beschreibung:** Öffnet oder schließt die Gliederung.
...
**Beschreibung:** Stellt die Größe des Fensters so ein, dass der Inhalt in das Fenster passt.
...
**Beschreibung:** Gibt ein Anzeigefeld zurück, das andere Anzeigefelder gruppiert.
