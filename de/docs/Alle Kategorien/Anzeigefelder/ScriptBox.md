...
**Beschreibung:** Fügt den vorgegebenen Text am Ende des Skripts ein.
...
**Beschreibung:** Reduziert alle faltbaren Abschnitte des Inhalts im Skriptfeld.
...
**Beschreibung:** Erweitert alle reduzierten Abschnitte des Inhalts im Skriptfeld.
...
**Beschreibung:** Gibt die Zeile zurück, in der sich der Cursor derzeit befindet.
...
**Beschreibung:** Gibt die aktuelle Position des Mauszeigers zurück.
...
**Beschreibung:** Gibt die Zeilenanzahl des Skriptfelds zurück.
...
**Beschreibung:** Gibt den Text an der angegebenen Zeilennummer zurück.
...
**Beschreibung:** Gibt den gesamten Text im Skriptfenster als Liste von Zeichenketten mit jeweils einer Zeile für jede Zeichenkette zurück.
...
**Beschreibung:** Gibt die aktuelle Breite der Auswahl zurück.
...
**Beschreibung:** Gibt einen Booleschen Wert zurück, der anzeigt, ob die horizontalen und vertikalen Bildlaufleisten angezeigt werden, auch wenn sie nicht nötig sind
...
**Beschreibung:** Gibt eine Liste mit zwei Elementen zurück, die anzeigt, ob die horizontalen und vertikalen Bildlaufleisten angezeigt werden
...
**Beschreibung:** Wenn wahr (1), kann der Text im Skriptfeld nicht geändert werden.
...
**Beschreibung:** Formatiert das Skript, damit es besser lesbar ist.
...
**Beschreibung:** Wertet das Skript aus.
...
**Beschreibung:** Legt für den Mauszeiger die angegebene Position fest.
...
**Beschreibung:** Legt den Text an der angegebenen Zeilennummer fest.
...
**Beschreibung:** Legt für die Auswahl die angegebene Breite fest.
...
**Beschreibung:** Wenn wahr (1), werden die horizontalen und vertikalen Bildlaufleisten angezeigt, auch wenn sie nicht nötig sind
...
**Beschreibung:** Gibt an, ob die horizontalen und vertikalen Bildlaufleisten angezeigt werden
...
**Beschreibung:** Ersetzt den aktuellen Text im Skriptfeld mit dem vorgegebenen Text.
...
**Beschreibung:** Eingebettetes Log aktivieren/deaktivieren.
...
**Beschreibung:** Zeigt die Zeilennummern auf der linken Seite des Skriptfelds an oder blendet sie aus
...
**Beschreibung:** Gibt ein Anzeigefeld mit einem bearbeitbarem Skriptfeld zurück.
