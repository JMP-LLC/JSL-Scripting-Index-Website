...
**Beschreibung:** Gibt das Gewicht an, das in der doppel-exponentiellen Holt-Glättung für die Drifterkennung verwendet wird. Standardmäßig „.05“.
...
**Beschreibung:** Speichert alle Verschiebungsinformationen, damit sie später mit der Option „Verschiebungstabelle speichern“ in einer Datentabelle gespeichert werden können. Diese Option muss im Startskript angegeben werden.
...
**Beschreibung:** Blendet die Diagrammtypen Maximum für Häufigkeit und Nicht-negativ stetig, ein oder aus. Standardmäßig ein.
...
**Beschreibung:** Startet die Prozess-Screening-Plattform neu, um einen neuen Bericht zu erstellen, der aus dem ursprünglichen Bericht nur die ausgewählten Prozesse enthält.
...
**Beschreibung:** Erstellt eine neue Datentabelle, die die gespeicherten Daten über Verschiebungen enthält. Diese Option erfordert, dass die Option „Detaillierte Verschiebungsdaten erzeugen“ im Startskript angegeben ist.
...
**Beschreibung:** Blendet die Spalte mit den Aktionen in der Zusammenfassungstabelle ein oder aus. Dieser Test wird ausgelöst, wenn ein Punkt größer als eine obere Aktionsgrenze oder kleiner als eine untere Aktionsgrenze ist. Standardmäßig ein.
...
**Beschreibung:** Blendet die Spalte mit den Alarmen in der Zusammenfassungstabelle ein oder aus. Dieser Test wird ausgelöst, wenn ein Punkt größer als die obere Alarmgrenze oder kleiner als die untere Alarmgrenze ist.
...
**Beschreibung:** Blendet die Spalte „Alarm ansteigend“ in der Zusammenfassungstabelle ein oder aus. In dieser Spalte wird gezählt, wenn der Prozess ansteigt und der vorherige Punkt über der oberen Alarmgrenze liegt oder wenn ein Prozess abnimmt und der vorherige Punkt unter der unteren Alarmgrenze liegt.
...
**Beschreibung:** Gibt an, ob die untere Grenze von K-Sigma verwendet werden soll. Diese Option ist nur für Anteilsdiagramme verfügbar.
...
**Beschreibung:** Gibt an, ob die obere Grenze von K-Sigma verwendet werden soll. Diese Option ist nur für Anteilsdiagramme verfügbar. Standardmäßig ein.
