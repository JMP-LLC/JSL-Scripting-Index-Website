...
**Beschreibung:** Zeigt die Bland-Altman-Analyse an oder blendet sie aus. Diese Analyse ist eine Methodenvergleichstechnik, mit der zwei Messungen derselben Variablen verglichen werden.
...
**Beschreibung:** Blendet die Bland-Altman-Prozent-Analyse ein oder aus.
...
**Beschreibung:** Blendet die Differenzkenngrößen ein oder aus. Standardmäßig ein.
...
**Beschreibung:** Blendet die Kenngrößen der Prozent-Differenz ein oder aus.
...
**Beschreibung:** Blendet das Diagramm der paarweisen Differenzen nach paarweisen Mittelwerten ein oder aus. Standardmäßig ein.
...
**Beschreibung:** Blendet das Diagramm der paarweisen Differenzen nach Zeilennummer ein oder aus.
...
**Beschreibung:** Blendet ein Diagramm der Prozent-Differenz nach Mittelwert ein oder aus.
...
**Beschreibung:** Blendet ein Diagramm der Prozent-Differenz nach Zeile ein oder aus.
...
**Beschreibung:** Zeigt den Referenzrahmen im Diagramm „Diff. nach Mittelwert“ an oder blendet ihn aus. Standardmäßig ein.
...
**Beschreibung:** Ändert das Alpha-Niveau für die Analysen. Wirkt sich auf die Konfidenzintervalle im Bericht und im Diagramm aus.
...
**Beschreibung:** Blendet den Vorzeichen-Test ein oder aus. Dies ist eine nichtparametrische Version des paarweisen t-Tests.
...
**Beschreibung:** Blendet den Wilcoxon-Vorzeichen-Rang-Test ein oder aus. Dies ist eine nichtparametrische Version des paarweisen t-Tests.
