...
**Syntax:** obj = Bootstrap Forest(...Informative Missing( state=0|1 )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Legt die maximale Anzahl von Termen fest, die bei der Berechnung von mehreren Modellen verwendet werden können.
...
**Beschreibung:** Legt die maximale Anzahl von Teilungen pro Baum fest.
...
**Syntax:** Method( "Bootstrap Forest" ) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Legt die minimale Anzahl von Teilungen pro Baum fest. Standardwert ist 10.
...
**Beschreibung:** Legt die Anzahl der Terme in einer Stichprobe je Teilung fest. Standard ist floor(nX/4), wobei „nX“ die Anzahl von X-Spalten ist.
...
**Beschreibung:** Legt die Anzahl der Bäume im Wald fest. Standardwert ist 100.
...
**Syntax:** obj = Bootstrap Forest(...Ordinal Restricts Order( state=0|1 )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Legt den Anteil der Gesamtheit fest, der für die Bootstrap-Stichprobe verwendet wird. Standardwert ist 1.
...
**Beschreibung:** Speichert Validierungs-r² zusammen mit der Baumnummer in einer neuen Datentabelle. Nur verfügbar, wenn eine Validierungsspalte verwendet wird.
...
**Beschreibung:** Zeigt eine Liste der einzelnen Bäume an, entweder nur mit Namen, mit Namen und Kategorien oder mit Namen, Kategorien und Schätzwerten an jedem Knoten.
...
**Beschreibung:** Legt die Zeitgrenze für Iterationen fest. Die Zahl ist der Grenzwert in Sekunden, um das Hinzufügen von Bäumen zu stoppen.
...
**Beschreibung:** Eine Tabelle mit Tuning-Parametern für die Ausführung. Unterstützt werden: Anzahl Terme, minimale Anzahl Teilungen je Baum, maximale Anzahl Teilungen je Baum, Anzahl Bäume, Bootstrap-Anteil, minimale Anzahl für Teilung
...
**Syntax:** obj = Bootstrap Forest(...Validation Portion( fraction=0 )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Bootstrap Forest(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
