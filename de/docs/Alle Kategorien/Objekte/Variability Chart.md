...
**Syntax:** obj = Variability Chart(...Analysis Type( "Beste Analyse auswählen (EMS REML Bayes)"|"Beste Analyse auswählen (EMS REML)"|"REML-Analyse verwenden"|"Bayessche Analyse verwenden" )...)
