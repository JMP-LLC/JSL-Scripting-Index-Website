...
**Beschreibung:** Wählen Sie entweder XGBoost oder LightGBM als Methode für die Gradient-Boosting-Anpassung aus. Standardmäßig „xgboost“.
...
**Beschreibung:** Gibt die maximale Anzahl der Kategorien an, die ein kategoriales Feature haben kann, bevor der One-vs-Other-Algorithmus zur Teilung verwendet wird. Kategoriale Features mit mehr als der maximalen Anzahl an Kategorien werden von einem anderen Algorithmus verarbeitet. Standardmäßig „4“.
...
**Beschreibung:** Gibt den Startwert an, der im Zufallszahlengenerator für den Zielparameter verwendet wird. Standardmäßig „5“.
...
**Beschreibung:** Legt die Schwellenwertgrenze für das vorzeitige Stoppen der Vorhersage fest, wenn das vorzeitige Stoppen der Vorhersage angegeben ist. Mit diesem Parameter kann der Vorhersageprozess vorzeitig gestoppt werden, wenn die Grenze weit genug vom Schwellenwert entfernt ist. Standardmäßig „10“.
...
**Syntax:** obj &lt;&lt; top_k( number=0 )

**Beschreibung:** Gibt die Anzahl von Top-Funktionen an, die bei den Greedy- und Thrifty-Funktionen zur Auswahl steht. Diese Option gilt nur für den gblinear-Booster. Standardmäßig „0“.
...
**Beschreibung:** Gibt an, ob Bäume für das Dropping beim DART-Boosting unter Verwendung einer Gleichverteilung ausgewählt werden sollen. Standardmäßig „0“.
