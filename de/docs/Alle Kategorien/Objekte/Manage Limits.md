...
**Beschreibung:** Färbt die Zellen in der Datentabelle, die Beobachtungen entsprechen, die außerhalb der Spezifikationsgrenzen liegen. Zellen für Beobachtungen, die unterhalb der unteren Spezifikationsgrenze liegen, werden hellrot gefärbt. Zellen für Beobachtungen, die über der oberen Spezifikationsgrenze liegen, werden hellblau gefärbt.
...
**Beschreibung:** Grenzwertdaten aus einer Datentabelle laden.
...
**Beschreibung:** Rundet alle numerischen Werte auf eine angegebene Anzahl Dezimalstellen.
...
**Beschreibung:** Speichert die Grenzwertdaten als Spalteneigenschaften.
...
**Beschreibung:** Speichert die Grenzen als Spalteneigenschaften in einer neuen Datentabelle, die nach den Gruppierungsvariablen geteilt ist.
...
**Beschreibung:** Erstellt eine neue Datentabelle im langen Format, die alle Grenzwertdaten für jede Spalte enthält.
...
**Beschreibung:** Erstellt eine neue Datentabelle im breiten Format, die alle Grenzwertdaten für jede Spalte enthält.
...
**Beschreibung:** Prüft die Kontrollkästchen „Grenzen anzeigen“ für alle Elemente.
...
**Syntax:** obj = Manage Limits(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Gibt die stetigen Spalten von Prozessen an.
