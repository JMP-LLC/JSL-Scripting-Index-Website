...
**Beschreibung:** Bayessche Modelle angeben.
...
**Beschreibung:** Gibt die Transformation der Zielgröße, die Transformation von Zeit und den Modelltyp an.
...
**Beschreibung:** Legt den Referenztemperaturwert fest, der von entsprechenden Modellen verwendet wird.
...
**Beschreibung:** Legt den Referenzwert fest, der von entsprechenden Modellen verwendet wird.
...
**Beschreibung:** Gibt an, dass beim Speichern des Skripts für den aktuellen Bericht das Skript die A-posteriori-Stichproben enthält. Wenn Sie das gespeicherte Skript ausführen, werden die A-posteriori-Stichproben direkt aus dem Skript in die Analyse der Degradation von wiederholten Messungen geladen. Standardmäßig ein.
...
**Syntax:** obj = Repeated Measures Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
