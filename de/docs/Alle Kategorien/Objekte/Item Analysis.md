...
**Syntax:** obj = Item Analysis(...Model( "Logistisch 2PL"|"Logistisch 3PL"|"Logistisch 1PL" )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;

**Beschreibung:** Identifiziert das Modell für die Item-Analyse.
...
**Beschreibung:** Ändert das Layout der Item-Charakteristikkurven, die standardmäßig geschlossen sind.
...
**Beschreibung:** Speichert die Fähigkeitsformel in einer neuen Spalte in der Datentabelle.
...
**Syntax:** obj = Item Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
