...
**Beschreibung:** Blendet ein Diagramm ein oder aus, das für jede Stufe des Effekts außer der Kontrolle einen Punkt enthält. Jeder Punkt zeigt den Kleinste-Quadrate-Mittelwert für diese Stufe in Bezug zum Kleinste-Quadrate-Mittelwert für die Kontrollstufe. Obere Entscheidungsgrenzen (UDL) und untere Entscheidungsgrenzen (LDL) werden eingezeichnet.
