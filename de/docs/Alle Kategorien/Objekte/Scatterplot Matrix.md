...
**Beschreibung:** Legt den Überdeckungsbereich fest, dieser ist (1 - Alpha), für die in der Streudiagramm-Matrix angezeigten Ellipsen.
...
**Beschreibung:** Legt die Transparenz für die in der Streudiagramm-Matrix angezeigten Ellipsen fest.
...
**Beschreibung:** Identifiziert eine Gruppierungsvariable, deren Stufen dazu dienen, separate Ellipsen zu erstellen, die in der Streudiagramm-Matrix angezeigt werden.
...
**Beschreibung:** Sperrt Achsenbereiche, damit sich diese in Folge von Daten- oder Filteränderungen nicht verändern.
...
**Syntax:** obj = Scatterplot Matrix(...Matrix Format( "Unteres Dreieck"|"Oberes Dreieck"|"Quadrat" )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Lässt die Punkte zittern, indem sie in der Streudiagramm-Matrix leicht verschoben werden. Standardmäßig „Automatisch“.
...
**Syntax:** obj = Scatterplot Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
