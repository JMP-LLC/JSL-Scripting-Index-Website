...
**Beschreibung:** Legt die Hintergrundfarbe des Texts fest.
...
**Beschreibung:** Wenn aktiviert (1), kann der Text zum Bearbeiten mit der Maus angeklickt werden.
...
**Beschreibung:** Aktiviert oder deaktiviert ausgefüllten Text.
...
**Beschreibung:** Wenn aktiviert, wird die benutzerdefinierte Anmerkungsgröße berücksichtigt. Ansonsten wird sie basierend auf dem Textinhalt berechnet.
...
**Beschreibung:** Legt die Schriftart des Texts fest.
...
**Beschreibung:** Gibt die Farbe des Hintergrunds zurück.
...
**Beschreibung:** Gibt die Schriftart des Texts zurück.
...
**Beschreibung:** Gibt die Farbe des Texts zurück.
...
**Beschreibung:** Gibt zurück, ob der Text bearbeitbar ist.
...
**Beschreibung:** Gibt zurück, ob der Text ausgefüllt ist.
...
**Beschreibung:** Gibt die Position für den Text zurück.
...
**Beschreibung:** Gibt zurück, ob die Tag-Linie aktiviert (1) oder deaktiviert (0) ist.
...
**Beschreibung:** Legt die Textausrichtung fest
...
**Beschreibung:** Legt die Position im Anzeigefeld fest, an dem der Text eingefügt werden soll.
...
**Beschreibung:** Fügt eine Linie von der oberen linken Ecke des Anzeigefelds zum Text ein.
...
**Beschreibung:** Legt für den Text string fest.
...
**Beschreibung:** Legt den Text in einem Textfeld ab.
