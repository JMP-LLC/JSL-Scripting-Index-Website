...
**Description:** Indicates whether to run automatic candidate set generation and batch selection. This option is equivalent to enabling or disabling both the Generate Candidate Set option and Autoselect Batch option simultaneously.
...
**Syntax:** obj &lt;&lt; Nominal Correlation Type( "Equal Correlations" )
...
**Syntax:** obj &lt;&lt; Ordinal Correlation Type( "Equal Correlations"|"Unequal Correlations" )
...
**Description:** Deselects all points in the current batch.
...
**Description:** Exports the currently selected batch points to the data table based on current settings.
