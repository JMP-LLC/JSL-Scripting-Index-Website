...
**Description:** Specifies the number of top features to select in greedy and thrifty feature selector. This option applies only for the gblinear booster. "0" by default.
