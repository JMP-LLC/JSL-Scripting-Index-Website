...
obj = dt << Time Series Forecast( Y( :Y ), Grouping( :Series ), Time( :Time ), By( _bycol ) );
...
**Sintaxis:** obj << Set Forecast Interval Level

**Descripción:** Establecer nivel de intervalo pronosticado.
...
**Sintaxis:** obj << Set NAhead

**Descripción:** Establecer NAhead.
