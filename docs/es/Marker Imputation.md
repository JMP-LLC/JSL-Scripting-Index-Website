...
**Sintaxis:** obj = Marker Imputation(...Imputation Value( number=0 )...)
...
**Sintaxis:** obj = Marker Imputation(...Method( "LD-kNN"|"HWE desactivado"|"HWE activado"|"Aleatorio"|"Especificado"="LD-kNN" )...)
...
**Sintaxis:** obj = Marker Imputation(...Nearest Markers( number=15 )...)
...
**Sintaxis:** obj = Marker Imputation(...Nearest Samples( number=15 )...)
...
**Sintaxis:** obj = Marker Imputation(...Ploidy( number=2 )...)
...
**Sintaxis:** obj = Marker Imputation(...Set Random Seed( number=0 )...)
...
**Sintaxis:** obj = Marker Imputation(...Unthreaded( state=0|1 )...)
...
**Sintaxis:** obj = Marker Imputation(...Window View( "Visible"|"Invisible"|"Private" )...)
