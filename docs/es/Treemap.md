...
**Sintaxis:** obj << Categories( column(s) )
...
**Sintaxis:** obj << Change Color Column( column )

**Descripción:** Cambia la columna utilizada para colorear las categorías.
...
**Sintaxis:** obj << Color Range( low, high )

**Descripción:** Establece el rango para el gradiente de color. Los valores predefinidos por defecto son bajo=mín. y alto=máx. de la columna de coloración.
...
**Descripción:** Establece el tema de color utilizado para el mapa en árbol.
...
**Sintaxis:** obj = Treemap(...Layout( "Dividir"|"Squarify"|"Mixto" )...)
...
**Descripción:** Muestra u oculta una leyenda que expone los valores de la columna de coloración asignados a los colores reales.
...
**Sintaxis:** obj << Ordering( column(s) )
...
**Sintaxis:** Treemap( Categories( column ), <Sizes( column )>, <Coloring( column )> )

**Descripción:** El Constructor de gráficos es una alternativa a la creación de un mosaico rectangular para una variable nominal u ordinal. Las categorías de mosaicos son proporcionales en tamaño a los conteos de categorías dentro de una variable seleccionada.
...
**Sintaxis:** obj = Treemap(...Window View( "Visible"|"Invisible"|"Private" )...)
