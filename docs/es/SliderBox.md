...
**Sintaxis:** float = obj << Get( <index> )

**Descripción:** Devuelve el valor de coma flotante en que está establecido actualmente el control deslizante.
...
**Sintaxis:** bool = obj << Get Log Scale

**Descripción:** Devuelve si el control deslizante tiene escala logarítmica (1) o lineal (0).
...
**Sintaxis:** float = obj << Get Max( <index> )

**Descripción:** Devuelve el valor máximo al que puede establecerse el control deslizante.
...
**Sintaxis:** float = obj << Get Min( <index> )

**Descripción:** Devuelve el valor mínimo al que puede establecerse el control deslizante.
...
**Sintaxis:** float = obj << Get N

**Descripción:** Devuelve el número de controles deslizantes del SliderBox.
...
**Sintaxis:** string = obj << Get Var

**Descripción:** Devuelve el nombre de la variable asociada al control deslizante.
...
**Descripción:** Obtiene el ancho del control deslizante.
...
**Sintaxis:** obj << Rescale Slider( min,max )

**Descripción:** Establece los valores mínimo y máximo que puede aceptar el control deslizante
...
**Sintaxis:** obj << Set( float, <index>,<run script(0|1)> )

**Descripción:** Establece el valor de coma flotante del control deslizante.
...
**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando cambia el control deslizante.
...
**Sintaxis:** obj << Set Log Scale( 0|1 )

**Descripción:** Establece que el control deslizante tenga escala logarítmica (1) o lineal (0).
...
**Sintaxis:** obj << Set Max( float, <index> )

**Descripción:** Establece el valor máximo al que puede establecerse el control deslizante.
...
**Sintaxis:** obj << Set Min( float, <index> )

**Descripción:** Establece el valor mínimo al que puede establecerse el control deslizante.
...
**Sintaxis:** string = obj << Set Var

**Descripción:** Establece el nombre de la variable asociado al control deslizante.
...
**Descripción:** Establece el ancho del control deslizante.
