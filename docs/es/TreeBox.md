...
**Sintaxis:** obj << Add Root( node )

**Descripción:** Añade un nodo raíz al árbol.
...
**Sintaxis:** obj << Collapse( node )

**Descripción:** Contrae el nodo del árbol.
...
**Sintaxis:** obj << Enable Item( node, 0|1 )

**Descripción:** Activa o desactiva el nodo del árbol. Establezca el estado con el valor 1 para activar el nodo y 0 para desactivarlo.
...
**Sintaxis:** obj << Expand( node )

**Descripción:** Expande el nodo del árbol.
...
**Sintaxis:** script = obj << Get Context Menu Script

**Descripción:** Devuelve el script, función o método que se ejecuta cuando el usuario hace clic con el botón derecho en el árbol o en un nodo de árbol.
...
### Get Node Double Click Script

**Sintaxis:** script = obj << Get Node Double Click Script

**Descripción:** Devuelve el script, función o método que se ejecuta al hacer doble clic en un nodo.
...
### Get Node Select Script

**Sintaxis:** obj << Get Node Select Script( script|Function( {thistree, thisnode}, <script> ) )

**Descripción:** Devuelve el script, función o método que se ejecuta cuando cambia la selección en el árbol.
...
**Sintaxis:** obj << Get Roots

**Descripción:** Obtiene una lista de los nodos raíz del árbol. Si no hay ningún nodo raíz, devuelve una lista vacía.
...
**Descripción:** Para un árbol de selección única, obtiene el nodo de árbol seleccionado o Vacío si no se selecciona ningún nodo. Para un árbol de selección múltiple, obtiene una lista de los nodos seleccionados o Vacío si no se selecciona ningún nodo.
...
**Sintaxis:** collapsed = obj << Is Collapsed( node )

**Descripción:** Devuelve Verdadero si el nodo está contraído en el árbol.
...
**Sintaxis:** expanded = obj << Is Expanded( node )

**Descripción:** Devuelve Verdadero si el nodo está expandido en el árbol.
...
**Sintaxis:** enabled = obj << Is Item Enabled( node )

**Descripción:** Devuelve el valor verdadero si el nodo está activado en el árbol.
...
**Sintaxis:** obj << Is Multiselect

**Descripción:** Devuelve 1 si el árbol es de selección múltiple. Devuelve 0 si el árbol es de selección única.
...
**Sintaxis:** obj << Is Root( node )

**Descripción:** Devuelve Verdadero si el nodo es un nodo raíz del árbol.
...
**Sintaxis:** selected = obj << Is Selected( node )

**Descripción:** Devuelve Verdadero si el nodo está seleccionado en el árbol.
...
**Sintaxis:** obj << Make Visible( node )

**Descripción:** Muestra el nodo dentro del árbol.
...
**Sintaxis:** obj << Remove Root( node )

**Descripción:** Quita un nodo raíz del árbol.
...
**Sintaxis:** obj << Set Context Menu Script( Function( {thistree, thisnode}, <script> ) )

**Descripción:** Establece el script, función o método que se ejecutará cuando el usuario haga clic con el botón derecho en el árbol o en un nodo de árbol.
...
**Sintaxis:** obj << Set Multiselect( state=0|1 )

**Descripción:** Establece el árbol para que sea de selección única (0) o selección múltiple (1).
...
**Sintaxis:** obj << Set Node Double Click Script( script )

**Descripción:** Establece el script, función o método que se ejecutará al hacer doble clic en un nodo.
...
**Sintaxis:** obj << Set Node Select Script( script|Function( {thistree, thisnode}, <script> ) )

**Descripción:** Establece el script, función o método que se ejecutará cuando cambie la selección en el árbol. Vacío se pasa al script si se borró la selección
...
**Sintaxis:** obj << Set Roots( roots )

**Descripción:** Establece la lista de nodos raíz que se muestran en el árbol.
...
**Sintaxis:** obj << Set Selected( node|{nodes}, <0|1> )

**Descripción:** Selecciona el nodo de árbol dado en el cuadro de visualización del árbol. Si se utiliza una lista de nodos del árbol, los árboles de selección múltiple seleccionarán todos los nodos de la lista. Si se utiliza una lista de nodos del árbol, los árboles de selección única seleccionarán el primer nodo de la lista.
...
**Descripción:** Establece el ancho y la altura del cuadro.
...
**Descripción:** Devuelve un cuadro de visualización para mostrar un árbol jerárquico. De forma predeterminada, solo se puede seleccionar un elemento. Si se especifica la selección múltiple, es posible seleccionar más de un elemento del árbol.
