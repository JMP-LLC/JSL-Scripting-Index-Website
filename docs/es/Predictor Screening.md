...
**Sintaxis:** obj = Predictor Screening(...<By( column(s) )>...)
...
**Sintaxis:** obj = Predictor Screening(...Response( column(s) )...)
...
**Sintaxis:** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Sintaxis:** obj = Predictor Screening(...X( column(s) )...)
...
**Sintaxis:** obj = Predictor Screening(...Y( column(s) )...)
