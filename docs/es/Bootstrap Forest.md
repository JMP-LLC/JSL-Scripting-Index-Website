...
**Sintaxis:** obj = Bootstrap Forest(...Informative Missing( state=0|1 )...)
...
**Sintaxis:** Method( "Bootstrap Forest" )
...
**Sintaxis:** obj = Bootstrap Forest(...Ordinal Restricts Order( state=0|1 )...)
...
**Sintaxis:** obj = Bootstrap Forest(...Validation Portion( fraction=0 )...)
...
**Sintaxis:** obj = Bootstrap Forest(...Window View( "Visible"|"Invisible"|"Private" )...)
