...
**Sintaxis:** obj = Contour Plot(...<By( column(s) )>...)
...
**Sintaxis:** obj = Contour Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Sintaxis:** obj = Contour Plot(...X( column, column )...)
...
**Sintaxis:** obj = Contour Plot(...Y( column(s) )...)
