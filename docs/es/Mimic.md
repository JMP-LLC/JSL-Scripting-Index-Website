...
**Sintaxis:** [xmin ymin, xmax ymax] = Bounds(boxref)

**Descripción:** Gets the rectangle for a given box.
...
**Sintaxis:** boxref = Button(label)

**Descripción:** Gets the first button box ref with the given label under Mimic box.
...
**Sintaxis:** [x y] = Center(rect | boxref)

**Descripción:** Calculates the center point for a given box or rectangle.
...
**Sintaxis:** pt = Disclosure(boxref | objref)

**Descripción:** Get position of the gray disclosure triangle for the given object or outline.
...
**Sintaxis:** geo = Frame Coords(framebox, geo)

**Descripción:** Converts a point or rectangle in Frame coordinates into a point or rectangle in screen space. Works best with continuous scales.
...
**Sintaxis:** rect = Grid Region(gridbox, "IdColumn", 9)

**Descripción:** Looks up named regions from the Data Grid.
...
**Sintaxis:** rect = List Item(listbox, item label)

**Descripción:** Finds the first item with the given label in a List Box Box, reveals it, and gets its bounds
...
**Sintaxis:** pt = Lrt(boxref | objref)

**Descripción:** Get position of the Little Red Triangle for the given object or outline.
...
**Sintaxis:** geo = Offset(geo | boxref, pt)

**Descripción:** Offset the given box/point/rectangle by given point.
...
**Sintaxis:** [x y] = TopLeft(rect | boxref)

**Descripción:** Calculates the top-left corner point for a given box or rectangle.
...
**Sintaxis:** obj << Clear Marks()

**Descripción:** Removes all all marks added by <<Mark.
...
**Sintaxis:** obj << Eval(mimiclang)

**Descripción:** Evaluates a mimiclang expression and returns the result.
...
**Sintaxis:** obj << Mark(mimiclang)

**Descripción:** Marks points and rectangles on the report. Does not respond to scrolling, resizing, or content movement well at this time. The rectangle grid is on 20 units.
...
**Descripción:** Mimic a human user using JSL scripting.
...
**Sintaxis:** obj << Mouse Circle Move(geo)

**Descripción:** Move the mouse quickly in a small (several pixel) circle around given point.
...
**Sintaxis:** obj << Mouse Click(geo)

**Descripción:** Left click on given geometry.
...
**Sintaxis:** obj << Mouse Double Click(geo)

**Descripción:** Double left click on given geometry.
...
**Sintaxis:** obj << Mouse Drag(geo src, geo dest)

**Descripción:** Left click geo src, drag to geo dest, and release.
...
**Sintaxis:** obj << Mouse Move(geo)

**Descripción:** Moves the mouse to the given point.
...
**Sintaxis:** obj << Mouse Right Click(geo)

**Descripción:** Right click on given geometry.
...
**Sintaxis:** obj << Typing("some string")

**Descripción:** Simulate typing the given string on the keyboard.
...
**Sintaxis:** obj << Typing Special("enum key string")

**Descripción:** Simulate typing the given special key on the keyboard.
...
**Descripción:** Equivalent to Wait(<n>). For convenience.

**JMP Versión agregada:** 19

### With Modifier

**Sintaxis:** obj << With Modifier({"Shift"|"Control"|"Command"|"Alt"|"Option"|"Control", ...}, msg)

**Descripción:** Push one or more modifier keys, run another Mimic message, then release the keys.
