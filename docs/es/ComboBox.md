...
**Sintaxis:** obj << Append Item( string )

**Descripción:** Agrega una nueva cadena al final de la lista de elementos del cuadro combinado.
...
**Descripción:** Devuelve un cuadro de visualización que muestra una lista desplegable de elementos de texto. Cada elemento del cuadro combinado puede contener información opcional sobre la herramienta que se especifica como cadena entre paréntesis, a continuación de la cadena de texto que corresponde al elemento. El argumento opcional Editable permite la edición del texto combinado.
...
**Descripción:** Establece que pueda seleccionar (1) o deseleccionar (0) el elemento del index.
...
**Sintaxis:** index = obj << Get

**Descripción:** Devuelve el índice del elemento seleccionado.
...
**Descripción:** Devuelve una cadena del elemento seleccionado.
...
**Sintaxis:** obj << Insert Item( string, <position> )

**Descripción:** Inserte una cadena nueva al final de la lista o en el lugar indicado por el valor opcional de position.
...
**Descripción:** Devuelve (1) si el elemento del index es seleccionable o (0) si no es seleccionable.
...
**Sintaxis:** obj << Set( index,<run script(0|1)> )

**Descripción:** Establece el cuadro combinado para el elemento en el índice indicado.
...
**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se selecciona un nuevo elemento del cuadro combinado.
