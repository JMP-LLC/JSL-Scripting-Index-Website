...
**Sintassi:** obj << Append Text( text )

**Descrizione:** Aggiunge il testo specificato alla fine dello script.
...
**Sintassi:** obj << Collapse All

**Descrizione:** Comprime tutte le sezioni richiudibili del contenuto del riquadro dello script.
...
**Sintassi:** obj << Expand All

**Descrizione:** Espande tutte le sezioni compresse del contenuto del riquadro dello script.
...
**Sintassi:** obj << Get Cursor Line

**Descrizione:** Restituisce la linea in cui si trova correntemente il cursore.
...
**Sintassi:** obj << Get Cursor Position

**Descrizione:** Restituisce la posizione corrente del cursore.
...
**Sintassi:** obj << Get Line Count

**Descrizione:** Restituisce il conteggio delle righe nel riquadro di script.
...
**Sintassi:** obj << Get Line Text( line number )

**Descrizione:** Restituisce il testo al numero di riga specificato.
...
**Sintassi:** obj << Get Lines

**Descrizione:** Restituisce tutto il testo nel riquadro di script come un elenco di stringhe, una per ciascuna riga.
...
**Sintassi:** obj << Get Selection Width

**Descrizione:** Restituisce la larghezza corrente della selezione.
...
### Get Show Empty Scrollbars

**Sintassi:** obj << Get Show Empty Scrollbars( state=0|1 )

**Descrizione:** Restituisce un valore booleano che indica se le barre di scorrimento orizzontale e verticale vengono mostrate anche se non necessarie
...
**Sintassi:** obj << Get Show Scrollbars

**Descrizione:** Restituisce un elenco di due elementi che indica se le barre di scorrimento orizzontale e verticale vengono mostrate
...
**Sintassi:** obj << Read Only( state=0|1 )

**Descrizione:** Se è vero (true, 1), il testo nel riquadro di script non può essere modificato.
...
**Sintassi:** obj << Reformat

**Descrizione:** Esegue la formattazione dello script per facilitarne la lettura.
...
**Descrizione:** Restituisce un riquadro di visualizzazione che contiene un riquadro di scripting modificabile.
...
**Sintassi:** obj << Set Cursor Position( position )

**Descrizione:** Imposta la posizione del cursore alla posizione indicata.
...
**Sintassi:** obj << Set Line Text( line number, text )

**Descrizione:** Imposta il testo al numero di riga specificato.
...
**Sintassi:** obj << Set Selection Width( width )

**Descrizione:** Imposta la larghezza della selezione alla larghezza fornita.
...
### Set Show Empty Scrollbars

**Sintassi:** obj << Set Show Empty Scrollbars( state=0|1 )

**Descrizione:** Se vero (1), le barre di scorrimento orizzontale e verticale vengono mostrate anche se non necessarie
...
**Sintassi:** obj << Set Show Scrollbars( state=0|1 )

**Descrizione:** Specifica se le barre di scorrimento orizzontale e verticale vengono mostrate
...
**Descrizione:** Sostituisce al testo attuale nel riquadro di script il testo specificato.
...
**Sintassi:** obj << Show Embedded Log( state=0|1 )

**Descrizione:** Abilita/disabilita il log integrato.
...
**Sintassi:** obj << Show Line Numbers( state=0|1 )

**Descrizione:** Mostra e nasconde i numeri di riga sulla sinistra del riquadro dello script
