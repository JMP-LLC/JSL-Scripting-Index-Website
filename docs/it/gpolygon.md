...
**Sintassi:** obj << Closed( state=0|1 )

**Descrizione:** Se questa opzione è attivata, il poligono avrà automaticamente un&apos;area interna anche se i punti di inizio e di fine non coincidono.
...
**Descrizione:** Imposta il colore del poligono.
...
**Descrizione:** Attiva o disattiva un poligono riempito.
...
**Descrizione:** Imposta i punti sui quali si deve estendere il poligono.
...
**Sintassi:** obj << Raised( state=0|1 )

**Descrizione:** Attiva o disattiva un poligono in rilievo.
...
**Sintassi:** obj << Smooth( state=0|1 )

**Descrizione:** Attiva o disattiva un poligono arrotondato.
