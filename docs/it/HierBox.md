...
**Sintassi:** obj << Above( "string" )

**Descrizione:** Inserisce una nuova stringa sopra la casella gerarchica chiamante.
...
**Sintassi:** obj << After( "string" )

**Descrizione:** Inserisce una nuova stringa dopo la casella gerarchica chiamante.
...
**Sintassi:** obj << Before( "string" )

**Descrizione:** Inserisce una nuova stringa prima della casella gerarchica chiamante.
...
**Sintassi:** obj << Below( "string" )

**Descrizione:** Inserisce una nuova stringa sotto la casella gerarchica chiamante.
...
**Sintassi:** obj << Change Type( "Lisca di pesce"|"Gerarchia"|"Nidificato" )

**Descrizione:** Imposta lo stile della casella gerarchica.
...
**Descrizione:** Nasconde tutti gli elementi di livello inferiore sotto la casella gerarchica specificata.
...
**Descrizione:** Rimuove la casella gerarchica.
...
**Sintassi:** obj << Direction( 0|1 )

**Descrizione:** Imposta se le stringhe nella casella gerarchica devono puntare a destra (1) o a sinistra (0).
...
**Descrizione:** Sposta la casella gerarchica chiamante in modo che sia la prima.
...
**Sintassi:** obj << Force Alternate

**Descrizione:** Sposta la casella gerarchica chiamante in modo che si alterni con la casella di pari livello.
...
**Sintassi:** obj << Force Down

**Descrizione:** Sposta in basso la casella gerarchica chiamante.
...
**Sintassi:** obj << Force Left

**Descrizione:** Sposta a sinistra la casella gerarchica chiamante.
...
**Sintassi:** obj << Force Right

**Descrizione:** Sposta a destra la casella gerarchica chiamante.
...
**Sintassi:** obj << Force Up

**Descrizione:** Sposta in alto la casella gerarchica chiamante.
...
**Descrizione:** Restituisce un riquadro di visualizzazione che contiene una gerarchia di stringhe.
...
**Sintassi:** obj << Horizontal

**Descrizione:** Ruota il testo in orizzontale con inizio a sinistra.
...
**Descrizione:** Sposta la casella gerarchica chiamante in modo che sia l&apos;ultima.
...
**Sintassi:** obj << Lean( 0|1 )

**Descrizione:** Imposta se le stringhe nella casella gerarchica devono inclinare a destra (1) o a sinistra (0).
...
**Descrizione:** Crea una nuova tabella di dati che contiene le stringhe nella casella gerarchica.
...
**Sintassi:** obj << Other Side

**Descrizione:** Sposta la casella gerarchica chiamante sull&apos;altro lato delle altre caselle.
...
**Sintassi:** obj << Override Descendant Padding( state=0|1 )

**Descrizione:** Questo è vero se tutti i discendenti adottano la stessa impostazione di spaziatura prescritta.
...
**Sintassi:** obj << Pad Current Node( state=0|1 )

**Descrizione:** Questo è vero se si applica l&apos;impostazione della spaziatura interna prescritta al nodo corrente.
...
**Sintassi:** obj << Rotate Left

**Descrizione:** Ruota il testo in verticale con inizio in basso.
...
**Sintassi:** obj << Rotate Right

**Descrizione:** Ruota il testo in verticale con inizio in alto.
...
**Sintassi:** obj << Siblings Horizontal Pad( number )

**Descrizione:** Questa è la consueta spaziatura interna tra caselle gerarchiche.
...
**Sintassi:** obj << Siblings Total Pad( number )

**Descrizione:** È la spaziatura verticale tra le caselle gerarchiche di pari livello e il rispettivo riquadro padre.
...
**Sintassi:** obj << Siblings Vertical Pad( number )

**Descrizione:** È la spaziatura interna tra le caselle gerarchiche quando ruotate di 90 gradi.
...
**Sintassi:** obj << Text Wrap Width( width )

**Descrizione:** Specifica la larghezza che ciascuna stringa può raggiungere prima di iniziare una nuova riga.
...
**Sintassi:** obj << Uneditable( state=0|1 )

**Descrizione:** Se questa opzione è attivata (1), si può fare clic con il mouse sulle stringhe per modificarle.
