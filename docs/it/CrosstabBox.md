...
**Sintassi:** obj << Format( element, Format( format, <options> ) )

**Descrizione:** Imposta il formato per l&apos;elemento CrossTabBox specificato
...
**Descrizione:** Restituisce una matrice dei valori in CrossTabBox.
...
**Descrizione:** Crea una nuova tabella di dati che contiene i valori in CrossTabBox.
