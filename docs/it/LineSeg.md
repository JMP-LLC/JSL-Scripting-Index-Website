...
**Sintassi:** obj << Arrowhead( "None"|"Start"|"End"|"Both" )

**Descrizione:** Specifica quando disegnare frecce alle estremità di un segmento di linea.
...
**Sintassi:** obj << Get Arrowhead

**Descrizione:** Il valore corrente che specifica quando disegnare frecce in un segmento di linea.
...
**Sintassi:** obj << Get Connect Missing

**Descrizione:** Ottiene la modalità di connessione con valori mancanti. Una fra "Connesso Continuo", "Connesso Sfumato", "Connesso Tratteggiato" o "Nessuna connessione".
...
**Sintassi:** 0|1 = obj << Get Log Curve

**Descrizione:** Ottiene l&apos;impostazione della curva logaritmica. Se un grafico ha un asse che utilizza una scala logaritmica, la linea curverà in modo che tutti i punti lungo la linea abbiano gli stessi valori x e y che avrebbero se l&apos;asse fosse lineare.
...
**Sintassi:** 0|1 = obj << Get Smooth

**Descrizione:** Restituisce l&apos;impostazione della curva di smoothing.
...
**Sintassi:** 0..1 = obj << Get Smoothness
...
**Sintassi:** obj << Get Unconnected Marker

**Descrizione:** Carica l&apos;indicatore da utilizzare per rappresentare i segmenti di linea con un singolo estremo.
...
**Descrizione:** Restituisce un vettore dei valori della coordinata X.
...
**Descrizione:** Restituisce un vettore dei valori della coordinata Y.
...
**Sintassi:** 0|1 = obj << Get halfpoint is unbounded line

**Descrizione:** Indica se un singolo punto con una coordinata mancante è trattato come una linea non vincolata.
...
**Descrizione:** Crea un segmento di visualizzazione dei segmenti di linee collegate. Il terzo argomento facoltativo consente l&apos;assegnazione di stati delle righe da una tabella di dati (dt) o in modo indipendente.
...
**Sintassi:** obj << Set Arrowhead( "None"|"Start"|"End"|"Both" )
...
**Sintassi:** obj << Set Connect Missing( "Connesso Continuo"|"Connesso Sfumato"|"Connesso Tratteggiato"|"Nessuna connessione" )

**Descrizione:** Imposta la modalità di connessione con valori mancanti. Una fra "Connesso Continuo", "Connesso Sfumato", "Connesso Tratteggiato" o "Nessuna connessione".
...
**Sintassi:** obj << Set Log Curve( state=0|1 )

**Descrizione:** Effettua l&apos;impostazione della curva logaritmica. Se un grafico ha un asse che utilizza una scala logaritmica, la linea curverà in modo che tutti i punti lungo la linea abbiano gli stessi valori x e y che avrebbero se l&apos;asse fosse lineare.
...
**Sintassi:** obj << Set Smooth( state=0|1 )

**Descrizione:** Imposta lo stato di una curva di smoothing.
...
**Sintassi:** obj << Set Smoothness( number )
...
**Sintassi:** obj << Set Unconnected Marker( marker )

**Descrizione:** Imposta l&apos;indicatore da utilizzare per rappresentare i segmenti di linea con un singolo estremo. Usare " " per nessuna rappresentazione.
...
**Sintassi:** obj << Set halfpoint is unbounded line( state=0|1 )

**Descrizione:** Determina se un singolo punto con una coordinata mancante deve essere trattato come una linea non vincolata.
