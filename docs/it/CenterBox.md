...
**Descrizione:** Restituisce (1) se la casella centrale è orizzontale (1) o verticale (0).
...
**Descrizione:** Imposta la casella centrale come orizzontale (1) o verticale (0).
