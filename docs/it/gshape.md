...
**Descrizione:** Imposta il colore della forma.
...
**Descrizione:** Attiva o disattiva una forma riempita.
...
**Sintassi:** obj << Oval( x1,y1,x2,y2 )

**Descrizione:** Disegna un ovale sopra il riquadro di visualizzazione.
...
**Descrizione:** Attiva o disattiva una forma in rilievo.
...
**Sintassi:** obj << Rectangle( x1,y1,x2,y2 )

**Descrizione:** Disegna un rettangolo sopra il riquadro di visualizzazione.
