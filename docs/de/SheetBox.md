...
**Beschreibung:** Gibt ein Anzeigefeld zurück, in dem andere Anzeigefelder horizontal oder vertikal angeordnet werden können.
...
**Beschreibung:** Gibt an, welches Element das SheetBox enthalten soll.
...
**Beschreibung:** Legt die Breite fest, wenn das SheetBox horizontal ist, andernfalls legt es die Höhe fest.
...
**Beschreibung:** Legt die Breite und Höhe für das SheetBox fest.
