...
**Syntax:** obj << Add(<index>,"title",contents);

obj << Add(<index>,tabPageBox)

**Beschreibung:** Fügt ein neues Register hinzu. Wenn kein index angegeben wird, wird das Register im Anschluss an die vorhandenen Register angehängt. Wenn es sich bei dem hinzuzufügenden Inhalt nicht um ein Tab Page Box handelt, wird ein neues Tab Page Box für den Inhalt hinzugefügt.
...
**Beschreibung:** Entfernt das Register an index.  Wenn kein index angegeben ist, wird das ausgewählte Register entfernt.
...
**Beschreibung:** Wenn ein Container andockbar ist, können verschiebbare untergeordnete Elemente mittels Drag & Drop neu angeordnet werden.
...
**Beschreibung:** Andockeinstellung für das Containerfeld zurückgeben.
...
**Beschreibung:** Minimale Breite der abgeschnittenen Registertitel abrufen, wenn Overflow Enabled festgelegt ist. Die Standardeinstellung 0 wendet eine Standard-Mindestbreite an.
...
**Beschreibung:** Wenn Overflow Enabled gleich 1 ist, wird der Registerliste nicht erzwungenermaßen die Breite der Registertitel zugewiesen. Wenn die Registerliste nicht breit genug ist für alle Titel, wird ein Überlaufmenü zur Auswahl neuer Register angezeigt.
...
**Beschreibung:** Gibt das gegenwärtig ausgewählte Register zurück.
...
**Beschreibung:** Aktuellen Status der Registersichtbarkeit abrufen
...
**Beschreibung:** Aktuelles Erscheinungsbild des Registers abrufen.
...
**Beschreibung:** Gibt das Skript zurück, das ausgeführt wird, wenn ein anderes Register ausgewählt wird.
...
**Beschreibung:** Gibt das Skript zurück, das ausgeführt wird, wenn ein Register über ein Skript oder das Symbol zum Schließen geschlossen wird. Das Skript gibt 1 zurück, wenn das Schließen zulässig ist, oder 0, wenn das Schließen abgebrochen wird.
...
**Beschreibung:** Gibt den Tooltip des Symbols zum Schließen des Registers zurück.
...
**Beschreibung:** Gibt die Anzahl der Register zurück.
...
**Beschreibung:** Gibt den Rand der Register zurück.
...
**Beschreibung:** Gibt das Skript zurück, das ausgeführt wird, wenn auf das Register „Neu“ geklickt wird. Das Skript ist verantwortlich für die Erstellung des neuen Registers.
...
**Beschreibung:** Gibt das Symbol des Registers „Neu“ zurück.
...
**Beschreibung:** Gibt den Tooltip des Registers „Neu“ zurück.
...
**Beschreibung:** Aktuelle Einstellung für die Titelanordnung abrufen.
...
**Beschreibung:** Gibt den Index des Registers mit dem angegebenen Titel zurück.
...
**Syntax:** obj << Insert(<index>,"title",contents);

obj << Insert(<index>,tabPageBox)

**Beschreibung:** Fügt ein neues Register ein. Wenn kein index angegeben wird, wird das neue Register im Anschluss an die vorhandenen Register angehängt. Wenn es sich bei dem hinzuzufügenden Inhalt nicht um ein Tab Page Box handelt, wird ein neues Tab Page Box für den Inhalt hinzugefügt.
...
**Beschreibung:** Tabulatorposition fromIndex an Position toIndex verschieben.
...
**Syntax:** obj << Replace(<index>,"title",contents);

obj << Replace(<index>,tabPageBox)

**Beschreibung:** Ersetzt das Register. Wenn kein index angegeben wird, wird das ausgewählte Register ersetzt. Wenn es sich bei dem hinzuzufügenden Inhalt nicht um ein Tab Page Box handelt, wird ein neues Tab Page Box für den Inhalt hinzugefügt.
...
**Beschreibung:** Minimale Breite der abgeschnittenen Registertitel festlegen, wenn Overflow Enabled festgelegt ist. Die Standardeinstellung 0 wendet eine Standard-Mindestbreite an.
...
**Beschreibung:** Wenn Overflow Enabled wahr ist, wird der Registerliste nicht erzwungenermaßen die Breite der Registertitel zugewiesen. Wenn die Registerliste nicht breit genug ist für alle Titel, wird ein Überlaufmenü zur Auswahl neuer Register angezeigt. Diese Option gilt nur, wenn für den Stil Tab festgelegt ist.
...
**Beschreibung:** Setzt den Fokus auf das Register an index.
...
**Syntax:** obj << Set Style( "Register"|"Kombination"|"Gliederung"|"Vertikale Streuung"|"Horizontale Streuung"|"Größe minimieren" )

**Beschreibung:** Ändert das Erscheinungsbild des Registers.
...
**Beschreibung:** Nachdem eine Änderung vorgenommen wurde (wenn z. B. ein neues Register ausgewählt wurde), wird das angegebene script oder die function ausgeführt.
...
**Beschreibung:** Legt das script oder die Function fest, das/die ausgeführt wird, wenn ein Register über ein Skript oder das Symbol zum Schließen geschlossen wird. Das script oder die Function gibt 1 zurück, wenn das Schließen zulässig ist, oder 0, wenn das Schließen abgebrochen wird.
...
**Beschreibung:** Legt den Tooltip des Symbols zum Schließen des Registers fest.
...
**Beschreibung:** Legt den Rand für die Register fest.  Eingegebene Parameter können für alle Seiten, horizontale und vertikale Größen oder verschiedene Werte für jede Seite übernommen werden.
...
**Beschreibung:** Legt das script oder die Function fest, das/die ausgeführt wird, wenn auf das Register „Neu“ geklickt wird. Das script oder die function ist verantwortlich für die Erstellung des neuen Registers.
...
**Beschreibung:** Legt das Symbol des Registers „Neu“ fest.
...
**Beschreibung:** Legt den Tooltip des Registers „Neu“ fest.
...
**Syntax:** obj << Set Title Location( "Automatisch"|"Oben"|"Unten"|"Links"|"Rechts" )

**Beschreibung:** Anordnung der Titel der Registerseiten festlegen. Bei der Einstellung „Automatisch“ wird die Anordnung abhängig von der Größe des Inhalts automatisch gewählt. Diese Option gilt nur, wenn für den Stil Tabbed festgelegt ist.
...
**Beschreibung:** Blendet die Register ein oder aus.
...
**Beschreibung:** Gibt ein Anzeigefeld zurück, das Seiten mit anderen Anzeigefeldern enthält.
