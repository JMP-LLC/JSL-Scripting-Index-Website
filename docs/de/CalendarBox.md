...
**Syntax:** obj << Date( number );

number = obj << Get Date

**Beschreibung:** Das aktuell ausgewählte Datum im Kalender.
...
**Syntax:** obj << Max Date( number );

number = obj << Get Max Date

**Beschreibung:** Legt das späteste Datum fest. Das Kalenderbedienelement wird auf eine Auswahl im richtigen Bereich begrenzt.
...
**Syntax:** obj << Min Date( number );

number = obj << Get Min Date

**Beschreibung:** Legt das früheste Datum fest. Das Kalenderbedienelement wird auf eine Auswahl im richtigen Bereich begrenzt.
...
**Syntax:** obj << Show Time( state=0|1 );

state = obj << Get Show Time

**Beschreibung:** Neben einem Datum auch eine Uhrzeit auswählen.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn ein Datum angeklickt wird. date ist das aktuell ausgewählte Datum.
