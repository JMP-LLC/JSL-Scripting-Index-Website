...
**Beschreibung:** Fügt dem Projekt eine Liste von Lesezeichen hinzu. Vorhandene Lesezeichen bleiben erhalten. Das Argument ist eine Liste von Lesezeichenelementen, von denen jedes Element mittels Datei(), Ordner() oder Gruppe() angegeben wird. Der Typ Gruppe() kann Dateien, Ordner und Gruppen als untergeordnete Elemente aufnehmen, wobei die gleiche Syntax rekursiv verwendet wird.
...
**Beschreibung:** Listet alle Dateien eines Projekts auf
...
**Beschreibung:** Extrahiert eine bestimmte Datei aus dem Projekt. Der JMP-Befehl Open() extrahiert keine Dateien aus dem Projekt, die nicht direkt von JMP geöffnet werden können. Ein Beispiel dafür sind Parquet-Dateien.
...
**Beschreibung:** Extrahiert alle Dateien aus dem Projekt in das temporäre Verzeichnis.
...
**Beschreibung:** Gibt die Liste der Lesezeichen im Projekt zurück. Das Format der zurückgegebenen Liste ist das gleiche wie das von Lesezeichen hinzufügen() und Lesezeichen festlegen() verwendete Format.
...
**Beschreibung:** Gibt die Fensteranordnung des Projekts zurück. Das Format ist das gleiche wie das von Layout festlegen() verwendete Format.
...
**Beschreibung:** Den Pfad des temporären Verzeichnisses des Projekts auf Festplatte abrufen
...
**Beschreibung:** Prüft, ob eine bestimmte Datei im Projekt in das temporäre Verzeichnis extrahiert wurde. Der JMP-Befehl Open() extrahiert keine Dateien aus dem Projekt, die nicht direkt von JMP geöffnet werden können. Ein Beispiel dafür sind Parquet-Dateien.
...
**Beschreibung:** Den Pfad einer gespeicherten Projektdatei auf Festplatte abrufen
...
**Beschreibung:** Legt für das Projekt fest, dass die Standard-Fensteranordnung verwendet wird.
...
**Beschreibung:** Führt ein Skript im Kontext des Projekts aus. Insbesondere werde alle vom Skript geöffneten Fenster Teil des Projekts. Das Skript greift auf JSL-Namen im Kontext des Projekts zurück, nicht auf die des einschließenden Skripts.
...
**Beschreibung:** Speichert das Projekt. Es können ein Pfad und ein Dateiname angegeben werden, um das Projekt an einem bestimmten Speicherort zu speichern. Wurde das Projekt bereits gespeichert, ist dieses Argument optional.



Nicht gespeicherte Dokumente im Projekt müssen gespeichert werden, bevor das Projekt selbst gespeichert wird.
...
**Beschreibung:** Legt die Lesezeichen für das Projekt fest. Vorhandene Lesezeichen werden entfernt. Das Argument ist eine Liste von Lesezeichenelementen, von denen jedes Element mittels Datei(), Ordner() oder Gruppe() angegeben wird. Der Typ Gruppe() kann Dateien, Ordner und Gruppen als untergeordnete Elemente aufnehmen, wobei die gleiche Syntax rekursiv verwendet wird.
...
**Beschreibung:** Legt die Fensteranordnung des Projekts fest.
...
**Beschreibung:** Blendet den Lesezeichenbereich im Projekt ein oder aus
...
**Beschreibung:** Blendet den Inhaltsbereich im Projekt ein oder aus
...
**Beschreibung:** Blendet den Log-Bereich im Projekt ein oder aus
...
**Beschreibung:** Blendet den Bereich „Zuletzt geöffnete Dateien“ im Projekt ein oder aus
...
**Beschreibung:** Blendet den Arbeitsbereich im Projekt ein oder aus
