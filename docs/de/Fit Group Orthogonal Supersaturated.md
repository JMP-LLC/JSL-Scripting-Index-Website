...
**Beschreibung:** Analysiert ein Gruppen-orthogonales übersättigtes Design. Ein Gruppen-orthogonales übersättigtes Design ist ein Design mit weniger Beobachtungen als Modellparametern, wo die Haupteffekte nicht alle gleichzeitig geschätzt werden können.
