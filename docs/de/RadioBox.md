...
**Beschreibung:** Aktiviert oder deaktiviert ein einzelnes Element in einer Gruppe runder Optionsfelder.
...
**Beschreibung:** Gibt den (bei 1 beginnenden) Index des ausgewählten runden Optionsfelds zurück.
...
**Beschreibung:** Ruft den Text des ausgewählten runden Optionsfelds ab.
...
**Beschreibung:** Gruppiert runde Optionsfelder, sodass jeweils nur ein Optionsfeld in der Gruppe ausgewählt ist.
...
**Beschreibung:** Gibt den Index einer Zeichenkette zurück, bzw. 0, wenn der Index nicht gefunden wird.
...
**Beschreibung:** Ermittelt, ob ein einzelnes Element in einer Gruppe runder Optionsfelder aktiviert oder deaktiviert ist.
...
**Beschreibung:** Gibt ein Anzeigefeld für die Anzeige einer Liste von runden Optionsfeldern zurück. Das Skript wird ausgeführt, wenn auf ein Optionsfeld geklickt wird.
...
**Beschreibung:** Legt das ausgewählte runde Optionsfeld fest.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn ein Optionsfeld angeklickt wird.
