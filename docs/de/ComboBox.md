...
**Beschreibung:** Fügt am Ende der Liste der Elemente im Kombinationsfeld eine neue Zeichenkette hinzu
...
**Beschreibung:** Gibt ein Anzeigefeld mit einer Dropdown-Liste von Textelementen zurück. Jedes Element im Kombinationsfeld kann einen optionalen Tooltipp haben, der auf die Zeichenkette für den Elementtext folgend als Zeichenkette in Klammern angegeben wird. Mit dem optionalen Argument Editable wird die Bearbeitung des Texts im Kombinationsfeld möglich.
...
**Beschreibung:** Legt fest, ob das Element an index auswählbar (1) oder nicht auswählbar (0) ist.
...
**Beschreibung:** Gibt den Index des ausgewählten Elements zurück.
...
**Beschreibung:** Gibt eine Zeichenkette des ausgewählten Elements zurück.
...
**Beschreibung:** Fügen Sie eine neue Zeichenkette am Ende der Liste oder an der von der optionalen position angezeigten Stelle ein.
...
**Beschreibung:** Gibt zurück, ob das Element an index auswählbar (1) oder nicht auswählbar (0) ist.
...
**Beschreibung:** Setzt das Kombinationsfeld auf das Element am angegebenen Index.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn ein neues Element im Kombinationsfeld ausgewählt wird.
