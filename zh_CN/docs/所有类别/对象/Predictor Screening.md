...
**语法:** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Predictor Screening(...<By( column(s) )>...)
...
**语法:** obj = Predictor Screening(...Response( column(s) )...)
...
**语法:** obj = Predictor Screening(...X( column(s) )...)
...
**语法:** obj = Predictor Screening(...Y( column(s) )...)
