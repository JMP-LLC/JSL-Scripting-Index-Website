...
**语法:** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Predictor Screening(...&lt;By( column(s) )&gt;...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Predictor Screening(...Response( column(s) )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Predictor Screening(...X( column(s) )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Predictor Screening(...Y( column(s) )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Predictor Screening(...Number Trees( number=100 )...)

**说明:** 指定 Bootstrap 森林模型中的决策树个数。 默认为“100”。
...
**语法:** obj = Predictor Screening(...Set Random Seed( number )...)
