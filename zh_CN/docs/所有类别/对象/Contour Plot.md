...
**语法:** obj = Contour Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Contour Plot(...<By( column(s) )>...)
...
**语法:** obj = Contour Plot(...X( column, column )...)
...
**语法:** obj = Contour Plot(...Y( column(s) )...)
