...
**语法:** obj = Marker Relatedness(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Marker Relatedness(...Additive Type( "二倍体方法 1"|"二倍体方法 2"|"多倍体"="二倍体方法 1" )...)
...
**语法:** obj = Marker Relatedness(...Clustering( state=0|1 )...)
...
**语法:** obj = Marker Relatedness(...Dominance Type( "二倍体方法 1"|"二倍体方法 2"|"多倍体"="二倍体方法 1" )...)
...
**语法:** obj = Marker Relatedness(...Epistasis Type( "加性 - 加性"|"显性 - 加性"|"显性 - 显性"="加性 - 加性" )...)
...
**语法:** obj = Marker Relatedness(...Imputation Value( number=0 )...)
...
**语法:** obj = Marker Relatedness(...Kinship Type( "状态一致性"|"加性"|"显性"|"上位性"="状态一致性" )...)
...
**语法:** obj = Marker Relatedness(...Missing Marker Imputation Method( "HWE 关闭"|"HWE 打开"|"随机"|"指定"="HWE 关闭" )...)
...
**语法:** obj = Marker Relatedness(...Ploidy( number=2 )...)
...
**语法:** obj = Marker Relatedness(...Principal Components( state=0|1 )...)
...
**语法:** obj = Marker Relatedness(...Set Random Seed( number=0 )...)
...
**语法:** obj = Marker Relatedness(...Unthreaded( state=0|1 )...)
