...
**语法:** obj = Normalization(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** Mean Expression Threshold ( number = 0.05 )
...
**语法:** Create New Tables for Results ( state =0|1 )
...
**语法:** Interpolated Quantiles( state =0|1 )
...
**语法:** Log Transformation( state =0|1 )
...
**语法:** Logratio Threshold ( number = 0.3 )
...
**语法:** Method( "Row Standardize" | "Wrench" )
...
**语法:** Total Prior Count ( number = 0.25 )
