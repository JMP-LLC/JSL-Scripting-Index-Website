...
**语法:** obj = Manage Limits(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Manage Limits( Process Variables( columns), Grouping( columns) )
...
**语法:** obj = Manage Limits( Process Variables( columns) )
...
**说明:** 将数据表中与落在规格限之外的观测对应的单元格着色。低于下规格限的观测对应的单元格着淡红色。高于上规格限的观测对应的单元格着淡蓝色。
...
**语法:** obj &lt;&lt; Save to Column Properties
...
**语法:** obj &lt;&lt; Save to Column Properties in Split Table( &lt; Remaining Columns ( Drop All | Keep All | Split All )&gt; )

**说明:** 将限值数据作为列属性保存在按分组变量拆分的新数据表中。
...
**语法:** obj &lt;&lt; Save to Tall Limits Table

**说明:** 创建新的高型数据表，它包含每列的所有限值数据。
...
**语法:** obj &lt;&lt; Save to Wide Limits Table

**说明:** 创建新的宽型数据表，它包含每列的所有限值数据。
