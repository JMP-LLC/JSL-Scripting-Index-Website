...
**语法:** obj = Attribute Chart(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Attribute Chart(...&lt;By( column(s) )&gt;...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Attribute Chart(...&lt;Freq( column )&gt;...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Attribute Chart(...Grouping( column(s) )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Attribute Chart(...Response( column(s) )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Attribute Chart(...&lt;Standard( column )&gt;...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定一个引用列，它包含每个分组变量（部件）水平的已知值。
...
**语法:** obj = Attribute Chart(...X( column(s) )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Attribute Chart(...Y( column(s) )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Agreement by Rater Confid Intervals( state=0|1 )

**说明:** 在效率图中显示或隐藏有关单元格一致性百分比的置信区间。 默认开启。
...
**语法:** obj &lt;&lt; Attribute Gauge Charts( state=0|1 )
...
**语法:** obj &lt;&lt; Connect Agreement Points( state=0|1 )

**说明:** 在计数量具图和效率图中显示或隐藏一条连接一组单元格中的单元格均值的线。 默认开启。
...
**语法:** obj &lt;&lt; Connect Effectiveness Points( state=0|1 )

**说明:** 在计数量具图和效率图中显示或隐藏用于连接评级员和标准之间一致性百分比值的红线。
...
**语法:** obj &lt;&lt; Effectiveness Report( state=0|1 )

**说明:** 显示或隐藏包含一致性计数、有效性、误分类和合格性的报表。 默认开启。
...
**语法:** obj &lt;&lt; Effectiveness by Rater Confid Intervals( state=0|1 )

**说明:** 在效率图中显示或隐藏有关单元格有效性百分比的置信区间。
...
**语法:** obj &lt;&lt; Show Agreement Grand Mean( state=0|1 )

**说明:** 在计数量具图中显示或隐藏达到总体一致性百分比值的线。 默认开启。
...
**语法:** obj &lt;&lt; Show Agreement Group Means( state=0|1 )

**说明:** 在计数量具图中显示或隐藏达到组内一致性百分比值的线。该选项需要不止一个分组变量。
...
**语法:** obj &lt;&lt; Show Agreement Points( state=0|1 )

**说明:** 在计数量具图和效率图中显示或隐藏一致性点。 默认开启。
...
**语法:** obj &lt;&lt; Show Effectiveness Points( state=0|1 )

**说明:** 在计数量具图和效率图中显示或隐藏有效性点。
...
**语法:** obj &lt;&lt; Calculate Escape Rate( state=0|1 )

**说明:** 显示或隐藏包含基于给定的不合格概率的逃逸率的报表。
...
**语法:** obj &lt;&lt; Change Conforming Category( state=0|1 )
...
**语法:** Attribute Chart( Probability of Nonconformance( probability ) )

**说明:** 设置不合格概率以便用于后续的逃逸率计算。
