...
**语法:** obj = Attribute Chart(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Attribute Chart(...<By( column(s) )>...)
...
**语法:** obj = Attribute Chart(...<Freq( column )>...)
...
**语法:** obj = Attribute Chart(...Grouping( column(s) )...)
...
**语法:** obj = Attribute Chart(...Response( column(s) )...)
...
**语法:** obj = Attribute Chart(...<Standard( column )>...)
...
**语法:** obj = Attribute Chart(...X( column(s) )...)
...
**语法:** obj = Attribute Chart(...Y( column(s) )...)
