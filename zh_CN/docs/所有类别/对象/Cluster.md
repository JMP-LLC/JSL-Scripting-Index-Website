...
**语法:** obj = Y(...<Attribute ID( column(s) )>...)
...
**语法:** obj = Hierarchical Cluster(...Add Spatial Measures( state=0|1 )...)
...
**语法:** obj = Hierarchical Cluster(...Hybrid Cycles( number=30 )...)
...
**语法:** obj = Hierarchical Cluster(...Hybrid Goal( number=400 )...)
...
**语法:** obj = Hierarchical Cluster(...Hybrid Initial K( number=10 )...)
...
**语法:** obj = Hierarchical Cluster(...Hybrid Log Details( state=0|1 )...)
...
**语法:** obj = Hierarchical Cluster(...Hybrid RandomPCA Dim( number=0 )...)
...
**语法:** Method( "Average"|"Centroid"|"Ward"|"Single"|"Complete"|"Fast Ward"|"Hybrid Ward" )
...
**语法:** obj = Hierarchical Cluster(...Missing value imputation( state=0|1 )...)
...
**语法:** obj = Hierarchical Cluster(...Standardize By( "未标准化"|"列"|"行"|"列和行" )...)
...
**语法:** obj = Hierarchical Cluster(...Standardize Robustly( state=0|1 )...)
...
**语法:** obj = Hierarchical Cluster(...Two Way Clustering...)
...
**语法:** obj = Hierarchical Cluster(...Use Saved Cluster Table( state=0|1 )...)
