...
**语法:** obj = Group Options(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Platform( &lt;Roles&gt;, &lt;Platform Options&gt;, Group Options(&lt;Return Group(0|1)&gt;, &lt;options&gt;))

**说明:** “组平台”为使用“依据”角色或多个 Y 角色启动时创建的平台排列报表。无法直接创建“组平台”，但是在启动可导致创建多个平台时创建。在启动时使用 Group Options 参数指定组行为的选项。
...
**语法:** obj &lt;&lt; Auto Broadcast( state=0|1 )
...
**语法:** obj &lt;&lt; Get Auto Broadcast

**说明:** 返回用于为报表中的交互式操作自动应用传播的设置。
...
**语法:** obj &lt;&lt; Get Hide Empty Platforms
...
**语法:** list = Get Platforms(&lt;Visible Only(0|1)&gt;)

**说明:** 返回组中平台的列表。若指定了“VisibleOnly”选项，则不包括隐藏的平台，并且列表将采用显示的顺序。
...
**语法:** obj &lt;&lt; Hide Empty Platforms( state=0|1 )
...
**语法:** obj &lt;&lt; Layout( "垂直列表"|"水平列表"|"行内排列"|"选项卡内排列" )
...
**语法:** obj &lt;&lt; N Across( number )

**说明:** 设置“Arrange in Rows”布局的跨平台数。
...
**语法:** Order By(&lt;mode&gt;, &lt;Descending(0|1)&gt;, &lt;Order Statistic("Count" | "Mean" | "Median" | "Mode" | "Geometric Mean" | "Min" | "Max" | "Range" | "Sum" | "Std Dev" | "Variance" | "Std Err" | "CV" | "Interquartile Range" | "Median Absolute Deviation" | "Q10%" | "Q1" | "Q3" | "Q90%")&gt;

**说明:** 设置组中平台的顺序。该顺序可基于平台计算的值、与“依据”组一起使用时的列统计量，或是在使用多个 Y 启动组时的响应统计量。默认情况下，顺序为降序且统计量为“均值”。
