...
**语法:** obj = Explore Patterns(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**说明:** 清除选定列或所有列（若未选择列）的单元格颜色。在 JSL 中，您可以指定列名列表。
...
**语法:** obj &lt;&lt; Colorize Duplicates Across Columns

**说明:** 对数据表中的单元格着色，以对应于在“各列之间的重复项”报表中找到的重复匹配项。
...
**语法:** obj &lt;&lt; Colorize Linear Relationships

**说明:** 对数据表中的单元格着色，以对应于在“变量之间的线性关系”表中找到的线性关系。
...
**语法:** obj &lt;&lt; Distribution wrt Spec Limits( state=0|1 )

**说明:** 显示或隐藏相对于期望观测（落在规格限之外）的观测表。
...
**语法:** obj &lt;&lt; Duplicates Across Columns( state=0|1 )

**说明:** 显示或隐藏一个报表，它包含跨多个列出现在相同的行中的值的序列表。
...
**语法:** obj &lt;&lt; Formatted Widths( state=0|1 )

**说明:** 显示或隐藏格式化值的总宽度和小数宽度。
...
**语法:** obj &lt;&lt; Fraction Length( state=0|1 )

**说明:** 显示或隐藏值使用多长的连续的分数。随机数显示为 15，它是限值。无理数往往具有更高的小数部分长度，具体取决于它们离分数有多近。
...
**语法:** obj = Explore Patterns(...Include Missing( state=0|1 )...)
...
**语法:** obj &lt;&lt; Leading and Trailing Digits( state=0|1 )

**说明:** 显示或隐藏每个前导数位和尾部数位（1 到 9）的计数表。
...
**语法:** obj &lt;&lt; Linear Relationships( state=0|1 )

**说明:** 显示或隐藏在指定数量的顺序行上与其他列线性相关的列报表。
...
**语法:** obj &lt;&lt; Longest Duplicated Sequences( state=0|1 )

**说明:** 显示或隐藏在同一列中出现多次的值的最长序列表。 默认开启。
...
**语法:** obj &lt;&lt; Longest Runs( state=0|1 )

**说明:** 显示或隐藏相同值的最长的长度。 默认开启。
...
**语法:** obj = Explore Patterns(...Minimum Cross Column Duplicate Run Size( number=2 )...)

**说明:** 指定要使一个序列被报告为列之间的重复序列，它需要具有的最小长度。 默认为“2”。
...
**语法:** obj = Explore Patterns(...Minimum Longest Duplicate Size( number=2 )...)

**说明:** 指定要使一个序列被报告为一列中的重复序列，它需要具有的最小长度。 默认为“2”。
...
**语法:** obj = Explore Patterns(...Minimum Rows for Linear Relationship( number=10 )...)

**说明:** 指定用于在各组行之间检测列之间的线性关系的最小行数。 默认为“10”。
...
**语法:** obj = Explore Patterns(...Minimum Run Size( number=2 )...)

**说明:** 指定要使一个序列被报告为一个长度规模，一行中需要具有的最小值个数。 默认为“2”。
...
**语法:** obj &lt;&lt; Most Duplicated Values( state=0|1 )
...
**语法:** obj &lt;&lt; Order by Runs Rarity

**说明:** 按最长的长度的稀缺度值对列列表排序。更高的稀缺度值显示在顶部。
...
**语法:** obj &lt;&lt; Order by Sequence Rarity

**说明:** 按最长的重复序列的稀缺度值对列列表排序。更高的稀缺度值显示在顶部。
...
**语法:** obj &lt;&lt; Save Duplicates Across Columns

**说明:** 将“各列之间的重复项”表保存至新数据表。
...
**语法:** obj &lt;&lt; Save Linear Relationships

**说明:** 将值之间的线性关系表保存至新数据表。
...
**语法:** obj &lt;&lt; Save Table of Duplicate Sequences

**说明:** 将所有列的最长的重复序列保存至新数据表。
...
**语法:** obj &lt;&lt; Save Table of Runs

**说明:** 将所有列的最长的长度保存至新数据表。
...
**语法:** obj &lt;&lt; Select Columns( {list of columns} or ALL )
...
**语法:** obj &lt;&lt; Spec Limit Matches( state=0|1 )

**说明:** 显示或隐藏与下规格限、上规格限或目标完全相等的值。
