...
**语法:** obj &lt;&lt; Composite Error( state=0|1 )

**说明:** 显示或隐藏模型隐含的工具变量两阶段最小二乘方程的复合误差。
...
**语法:** obj &lt;&lt; Show All Equations( state=0|1 )

**说明:** 显示或隐藏模型中仅包含常数项作为预测变量的方程。
...
**语法:** obj &lt;&lt; Variance of the Error( state=0|1 )

**说明:** 显示或隐藏模型中每个方程的误差方差。
...
**说明:** Guarda una columna con la puntuación del factor para cada variable en columnas de la tabla de datos. Las puntuaciones de factores se calculan en una columna oculta que también se agrega a la tabla de datos. El método de Bartlett se utiliza para estimar estas puntuaciones.
...
**说明:** Guarda una columna con la puntuación del factor para cada variable en columnas de la tabla de datos. Las puntuaciones de factores se calculan en una columna oculta que también se agrega a la tabla de datos. El método de regresión se utiliza para estimar estas puntuaciones.
