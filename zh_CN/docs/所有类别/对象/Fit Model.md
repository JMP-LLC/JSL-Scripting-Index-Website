...
**说明:** 显示或隐藏一个图表，它为效应的每个水平（控制水平除外）包含一个点。每个点显示该水平的最小二乘均值与控制水平的最小二乘均值之间的相对关系。图中标绘了上决策限 (UDL) 和下决策限 (LDL)。
...
**说明:** 将新列保存至数据表。新列包含条件预测单值的置信区间。置信区间包括具有随机效应的模型的随机效应估计值。该选项仅可用于 REML 分析方法。 按住 shift 键输入 alpha 水平或后缀。
...
**说明:** 将新列保存至数据表。新列包含条件预测期望值的置信区间。置信区间包括具有随机效应的模型的随机效应估计值。该选项仅可用于 REML 分析方法。 按住 shift 键输入 alpha 水平或后缀。
...
**说明:** 将新公式列保存至数据表。新列包含一个公式，它包括具有随机效应的模型的随机效应估计值。该选项仅可用于 REML 分析方法。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含使用随机效应系数的最佳线性无偏预测变量 (BLUP) 计算的条件预测值。该选项仅可用于 REML 分析方法。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含条件预测的残差。残差值包括具有随机效应的模型的随机效应估计值。该选项仅可用于 REML 分析方法。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含每个观测在估计模型中影响大小的测度。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含在效应杠杆图中绘制的 X 和 Y 值。Y 值是偏残差。X 值是效应杠杆图中收缩后的回归变量。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含外部学生化残差。这些是将残差除以排除当前行之后的标准误差估计值后得到的。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含矩阵 xInv(x`x)x` 的对角线值。这些值也称为帽子或杠杆率值。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含实际响应单值的置信区间界限。它既包含响应变异也包含估计值变异。 按住 shift 键输入 alpha 水平或后缀。
...
**说明:** 将新列保存至数据表。新列包含期望值的置信区间界限。它包含估计值的变异，但没有包含响应的变异。 按住 shift 键输入 alpha 水平或后缀。
...
**说明:** 将新列保存至数据表。新列包含拟合模型的预测值。 按住 shift 键输入后缀。
...
**说明:** 将新公式列保存至数据表。新列包含拟合模型的预测公式。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。这些列包含用于预测、置信限和预测限的公式。该选项创建的限值列包含“预测刻画器”使用的属性。 按住 shift 键输入 alpha 水平或后缀。
...
**说明:** 将新列保存至数据表。新列包含拟合模型的残差值。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含单个预测值的标准误差。它用于计算单值置信区间。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含预测值的标准误差。它用于计算均值置信区间。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含残差值的标准误差。它用于计算学生化残差。 按住 shift 键输入后缀。
...
**说明:** 将新公式列保存至数据表。新列包含作为回归变量函数的预测值标准误差公式。 按住 shift 键输入后缀。
...
**说明:** 将新列保存至数据表。新列包含学生化残差，即残差除以其标准误差。 按住 shift 键输入后缀。
