...
**语法:** obj = Fit Causal Treatment(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** Fit Model(...Run( Fit( options ) )...); obj &lt;&lt; Fit( options ); obj &lt;&lt; (Fit[number] &lt;&lt; option)
...
**说明:** 支持您修改部分参数值并重新运行分析。该选项仅适用于 IPWR 和 AIPW 模型。
...
**语法:** obj = Generalized Linear Model(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Generalized Linear Model" ), "Firth Bias-Adjusted Estimates"n( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Generalized Linear Model" ), GLM Distribution( distribution name )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Generalized Linear Model" ), Link Function( link type )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Generalized Linear Model" ), Overdispersion Tests and Intervals( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Generalized Linear Model" ), Power Link Parameter( value=1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** scrobj &lt;&lt; LSMeans Contrast( [ l1, l2, l3, ... ] ); obj &lt;&lt; ( effect &lt;&lt; {LSMeans Contrast( [ l1, l2, l3, ... ] )} )
...
**语法:** scrobj &lt;&lt; LSMeans Dunnett( state=0|1|&lt;alpha&gt;, Control Level( level ), &lt;comparison options&gt; ); obj &lt;&lt; ( effect &lt;&lt; {LSMeans Dunnett( state=0|1|&lt;alpha&gt;, Control Level( level ), &lt;comparison options&gt; )} )
...
**语法:** scrobj &lt;&lt; LSMeans Plot; obj &lt;&lt; ( effect &lt;&lt; {LSMeans Plot} )
...
**语法:** scrobj &lt;&lt; Student&apos;s t( state=0|1|&lt;alpha&gt;, &lt;comparison options&gt; ); obj &lt;&lt; ( effect &lt;&lt; {Student&apos;s t( state=0|1|&lt;alpha&gt;, &lt;comparison options&gt; )} )
...
**语法:** scrobj &lt;&lt; LSMeans Table( state=0|1 ); obj &lt;&lt; ( effect &lt;&lt; {LSMeans Table( state=0|1 )} )
...
**语法:** scrobj &lt;&lt; LSMeans Tukey HSD( state=0|1|&lt;alpha&gt;, &lt;comparison options&gt; ); obj &lt;&lt; ( effect &lt;&lt; {LSMeans Tukey HSD( state=0|1|&lt;alpha&gt;, &lt;comparison options&gt; )} )
...
**语法:** scrobj &lt;&lt; Power Analysis( Alpha(from, to, by), Sigma(from, to, by), Delta(from, to, by), Number(from, to, by), objective, &lt;Power Plot&gt;, &lt;Done&gt;); obj &lt;&lt; ( effect &lt;&lt; {Power Analysis( Alpha(from, to, by), Sigma(from, to, by), Delta(from, to, by), Number(from, to, by), objective, &lt;Power Plot&gt;, &lt;Done&gt;)} )
...
**语法:** scrobj &lt;&lt; Test Slices( state=0|1 ); obj &lt;&lt; ( response &lt;&lt; { effect1 * effect2 &lt;&lt; {Test Slices( state=0|1 )} } )
...
**说明:** Shows or hides a chart that contains a point for each level of the effect other than the control. Each point shows the least squares mean for that level in relation to the least squares mean for the control level. Upper decision limits (UDL) and lower decision limits (LDL) are plotted.
...
**语法:** scrobj &lt;&lt; Comparisons with Control( state=0|1, Control Level( level ), &lt;options&gt; ); obj &lt;&lt; Multiple Comparisons( Effect( effect ), Comparisons with Control( state=0|1, Control Level( level ), &lt;options&gt; ) )
...
**语法:** scrobj &lt;&lt; Comparisons with Overall Average( state=0|1, &lt;options&gt; ); obj &lt;&lt; Multiple Comparisons( Effect( effect ), Comparisons with Overall Average( state=0|1, &lt;options&gt; ) )
...
**语法:** scrobj &lt;&lt; Equivalence Tests( number ); obj &lt;&lt; Multiple Comparisons( Effect( effect ), Equivalence Tests( number ) )
...
**语法:** scrobj &lt;&lt; Least Squares Means Plot; obj &lt;&lt; Multiple Comparisons( Effect( effect ), Least Squares Means Plot )
...
**语法:** scrobj &lt;&lt; Slice F Test( state=0|1 ); obj &lt;&lt; Multiple Comparisons( Sliced Effect Estimates( Sliced Effect( effect1 * effect2 ), Slice Term List( effect_level ) ), Slice F Test( state=0|1 ) )
...
**语法:** scrobj &lt;&lt; Student&apos;s t( state=0|1, &lt;options&gt; ); obj &lt;&lt; Multiple Comparisons( Effect( effect ), Student&apos;s t( state=0|1, &lt;options&gt; ) )
...
**语法:** scrobj &lt;&lt; Tukey HSD( state=0|1, &lt;options&gt; ); obj &lt;&lt; Multiple Comparisons( Effect( effect ), Tukey HSD( state=0|1, &lt;options&gt; ) )
...
**语法:** obj = Fit Model(...Convergence Limit( number=0.00000001 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Maximum Iterations( number=100 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Standard Least Squares" ), Method( "EMS" | "REML" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Standard Least Squares" ), NoBounds( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Summary of Fit(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene el intervalo de confianza del valor individual de la predicción condicional. Los intervalos de confianza incluyen estimaciones de efectos aleatorios para modelos con efectos aleatorios. Esta opción solo está disponible para los métodos de análisis REML. Mantenga pulsada la tecla Mayús para introducir el nivel alfa o el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene el intervalo de confianza del valor esperado de la predicción condicional. Los intervalos de confianza incluyen estimaciones de efectos aleatorios para modelos con efectos aleatorios. Esta opción solo está disponible para los métodos de análisis REML. Mantenga pulsada la tecla Mayús para introducir el nivel alfa o el sufijo.
...
**说明:** Guarda una nueva columna de fórmulas en la tabla de datos. La columna nueva contiene una fórmula que incluye estimaciones de efectos aleatorios para modelos con efectos aleatorios. Esta opción solo está disponible para los métodos de análisis REML. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene una medida de la influencia de cada observación en la estimación del modelo. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda nuevas columnas en la tabla de datos. Las columnas nuevas contienen los valores X e Y que se representan en los gráficos de apalancamiento de los efectos. El valor Y es el residuo parcial. El valor X es el encogimiento del regresor en los gráficos de apalancamiento de los efectos. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene los residuos estudentizados externamente. Son los residuos divididos entre las estimaciones del error estándar que excluyen la fila actual. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene los valores diagonales de la matriz xInv(x`x)x`. Estos valores también se denominan valores hat o de apalancamiento. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda nuevas columnas en la tabla de datos. Las columnas nuevas contienen los límites del intervalo de confianza para una realización individual de la respuesta. Engloba la variación tanto en la respuesta como en su estimación. Mantenga pulsada la tecla Mayús para introducir el nivel alfa o el sufijo.
...
**说明:** Guarda nuevas columnas en la tabla de datos. Las columnas nuevas contienen los límites del intervalo de confianza para el valor esperado. Engloba la variación en la estimación, pero no en la respuesta. Mantenga pulsada la tecla Mayús para introducir el nivel alfa o el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene los valores predichos para el modelo ajustado. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una columna de fórmulas nueva en la tabla de datos. La columna nueva contiene la fórmula de predicción para el modelo ajustado. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda las columnas nuevas en la tabla de datos. Las columnas contienen fórmulas para las predicciones, límites de confianza y límites de predicción. Las columnas de límites que se crean con esta opción contienen propiedades que utiliza el Perfilador de predicción. Mantenga pulsada la tecla Mayús para introducir el nivel alfa o el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene los valores residuales para el modelo ajustado. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**语法:** obj &lt;&lt; Show CV( state=0|1 )

**说明:** 显示或隐藏“REML 方差分量的估计值”报表中的“变异系数”列。
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene el error estándar de un valor predicho individual. Se utiliza para calcular el intervalo de confianza individual. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene el error estándar de los valores predichos. Se utiliza para calcular el intervalo de confianza de la media. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene el error estándar de los valores residuales. Se utiliza para calcular los residuos estudentizados. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una nueva columna de fórmulas en la tabla de datos. La columna nueva contiene la fórmula del error estándar de los valores predichos como función de los regresores. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene el residuo estudentizado, que es el residuo dividido por su error estándar. Mantenga pulsada la tecla Mayús para introducir el sufijo.
...
**语法:** obj = Fit Least Squares(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Prediction Formula(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Manova(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Mixed(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** Fit Model( Y( columns ), Effects( columns ), Random Effects( columns ), Repeated Effects( columns ), Repeated Structure( type ), Personality( "Mixed Model" ) )
...
**说明:** Muestra u oculta un gráfico de los valores reales frente a los valores predichos por el modelo, mientras se tienen en cuenta los efectos aleatorios. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio. 默认开启。
...
**说明:** Muestra u oculta un gráfico de los valores reales frente a los valores predichos por el modelo, sin tener en cuenta los efectos aleatorios. Esta opción solo está disponible cuando el modelo contiene al menos un efecto fijo. 默认开启。
...
**说明:** 将整个报表中的标准误差替换为未调整的估计值和基于组间-组内的自由度。要在多个比较报表中使用组间-组内自由度，您必须在添加多重比较报表之前选择该选项。
...
**说明:** Guarda una nueva columna de fórmulas en la tabla de datos. La columna nueva contiene la fórmula de predicción de la media condicional. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio.
...
**说明:** Guarda una nueva columna en la tabla de datos. La columna nueva contiene los valores predichos para la media condicional. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio.
...
**说明:** Muestra u oculta los gráficos de residuos que evalúan el ajuste del modelo, mientras se tienen en cuenta los efectos aleatorios. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio.
...
**说明:** 将整个报表中的标准误差替换为未调整的估计值和基于约束的自由度。要在多个比较报表中使用约束自由度，您必须在添加多重比较报表之前选择该选项。
...
**语法:** obj = Fit Model(...Dispose Reports( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**说明:** Muestra u oculta las pruebas de efectos fijos. Esta opción solo está disponible cuando el modelo contiene al menos un efecto fijo. 默认开启。
...
**说明:** Genera estimaciones de las medias de mínimos cuadrados o estimaciones definidas por el usuario. Estas estimaciones permiten al usuario realizar comparaciones con la media global, comparaciones con un control o comparaciones por pares. Esta opción solo está disponible cuando el modelo contiene al menos un efecto fijo.
...
**说明:** Muestra u oculta un informe de las estimaciones de los coeficientes aleatorios. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio. 默认开启。
...
**说明:** Muestra u oculta una tabla de estimaciones de parámetros de covarianza de efectos aleatorios. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio. 默认开启。
...
**说明:** Muestra u oculta una tabla de predicciones de efectos aleatorios. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio.
...
**说明:** Muestra u oculta una tabla de estimaciones de parámetros de covarianza de efectos repetidos. Esta opción solo está disponible cuando el modelo contiene al menos un efecto repetido. 默认开启。
...
**说明:** Muestra u oculta los gráficos de residuos que evalúan el ajuste del modelo, sin tener en cuenta los efectos aleatorios. Esta opción solo está disponible cuando el modelo contiene al menos un efecto fijo.
...
**语法:** obj = Fit Model(...Results in Data Tables( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**说明:** Muestra u oculta el informe Pruebas secuenciales (tipo 1) que contiene las sumas de cuadrados a medida que se añaden efectos al modelo secuencialmente. Esta opción solo está disponible cuando el modelo contiene al menos un efecto fijo.
...
**说明:** Guarda una columna nueva en la tabla de datos. La columna nueva contiene los errores estándar de las predicciones condicionales de la media. Esta opción solo está disponible cuando el modelo contiene al menos un efecto aleatorio.
...
**语法:** obj = Fit Model(...Suppress Reports( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Nominal Logistic(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Ordinal Logistic(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Parametric Survival(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Distribution("Weibull"|"Lognormal"|"Exponential"|"Frechet"|"Loglogistic"|"All Distributions"|"SEV"|"Normal"|"LEV"|"Logistic"...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Proportional Hazards(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Response Screening(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Stepwise(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Estimate Only Variance Components(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit GLMM Platform(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** Fit Model( Y( columns ), Effects( columns ), Random Effects( columns ), Repeated Effects( columns ), Repeated Structure( type ), Personality( "Generalized Linear Mixed Model" ) )

**说明:** 拟合广义线性混合模型。当响应为非 Gaussian 时，这些模型可用于随机系数、裂区和区组设计。响应分布可以适用于连续、分类、计数和事件时间响应数据。
...
**语法:** obj = Fit Generalized(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Run( Fit( Estimation Method( method ) ) )... )

**说明:** 指定用于拟合模型的估计方法或变量选择。
...
**语法:** obj = Fit Model(...Generalized Distribution( distribution )... )

**说明:** 指定用于拟合模型的响应变量列在给定预测变量列条件下的分布。
...
**语法:** obj &lt;&lt; Validation Method( "K 折"|"保留"|"留一法"|"BIC"|"AICc"|"ERIC"|"无"|"验证列" )
...
**语法:** obj = Run(...&lt;ID( column )&gt;...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Response Screening" ), Subgroup( column(s) )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Switch( column(s) )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Response Screening" ), Cauchy Fit( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Censor Code( string )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Center Polynomials( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Partial Least Squares" ), Centering( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Nominal Logistic" ), Choose High Target( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Run(...Effects( col, col, ... )...); obj = Run(...Effects( macro( col, col, ... ) )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Standard Least Squares" ), Emphasis( "Effect Leverage" | "Effect Screening" | "Minimal Report" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Standard Least Squares" ), Estimate Only Variance Components( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Generalized Regression" ), Generalized Distribution( distribution name )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Partial Least Squares" ), Imputation Method( "Mean" | "EM" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Partial Least Squares" ), Impute Missing Data( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Informative Missing( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Partial Least Squares" ), Max Iterations( number=1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...No Intercept( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Response Screening" ), Robust Fit( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Run( &lt;options&gt; )...); obj &lt;&lt; Run( &lt;options&gt; )
...
**语法:** obj = Fit Model(...Personality( "Partial Least Squares" ), Scaling( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Set Alpha Level( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Personality( "Partial Least Squares" ), Standardize X( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Suppress Coding( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Fit Model(...Suppress Warning for Missing Effects( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
