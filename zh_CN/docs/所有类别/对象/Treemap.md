...
**语法:** obj = Treemap(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** Treemap( Categories( column ), &lt;Sizes( column )&gt;, &lt;Coloring( column )&gt; )

**说明:** “图形生成器”是为名义型或有序型变量创建矩形平铺的替代方法。平铺类别的大小与所选变量内的类别计数成比例。
...
**语法:** obj &lt;&lt; Change Color Column( column )
...
**语法:** obj &lt;&lt; Color Range( low, high )

**说明:** 设置颜色渐变范围。在默认情况下，低值为着色列的最小值，高值为着色列的最大值。
...
**语法:** obj = Treemap(...Layout( "拆分"|"方形化"|"混合" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

### Legend

**语法:** obj &lt;&lt; Legend( state=0|1 )

**说明:** 显示或隐藏图例，这些图例显示了映射至实际颜色的颜色列的值。
