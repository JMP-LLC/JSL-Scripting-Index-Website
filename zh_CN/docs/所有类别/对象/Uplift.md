...
**语法:** obj = Uplift(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Uplift(...Informative Missing( state=0|1 )...)
...
**语法:** obj = Uplift(...Ordinal Restricts Order( state=0|1 )...)
...
**语法:** obj = Uplift(...Validation Portion( fraction=0 )...)
