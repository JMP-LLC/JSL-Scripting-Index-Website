...
**语法:** obj &lt;&lt; Always allow publishing to JMP Public( state=0|1 )

**说明:** 即使配置了其他 JMP Live 连接，也始终支持菜单项发布到 JMP Public。
...
**语法:** Preferences[1] &lt;&lt; Name("Set ODBC Primary Key as Link ID") ( state = 0|1 )
...
**说明:** Si las barras o clases de datos faltantes se muestran inicialmente en gráficos de resumen. Sea cual sea el valor que aparezca, se puede cambiar para gráficos de resumen individuales haciendo clic con el botón derecho en el gráfico de resumen y seleccionado "Barra con valores faltantes" o "Clase con valores faltantes".
