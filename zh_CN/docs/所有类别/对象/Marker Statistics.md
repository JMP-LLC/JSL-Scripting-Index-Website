...
**语法:** obj = Marker Statistics(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Marker Statistics(...Marker Format( "数值"|"单字符"|"字符"|"单码核苷酸"|"核苷酸"="数值" )...)
...
**语法:** obj = Marker Statistics(...Ploidy( number=2 )...)
...
**语法:** obj = Marker Statistics(...Unthreaded( state=0|1 )...)
...
**语法:** obj = Marker Statistics(...Use Annotation Table( state=0|1 )...)
