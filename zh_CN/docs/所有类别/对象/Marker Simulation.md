...
**语法:** obj = Marker Simulation(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Cross( column(s) )

**说明:** 指定将样本分组到区组的列。随后在不同组的样本之间进行杂交。
...
**语法:** obj &lt;&lt; Predictor Formula( column(s) )
...
**语法:** obj = Marker Simulation(...Estimate Diversity( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Simulation(...Imputation Value( number=0 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Simulation(...Missing Marker Imputation Method( "HWE 关闭"|"HWE 打开"|"随机"|"指定"="HWE 关闭" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Simulation(...Number of Generations( number=1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定杂交和选择过程要经历的世代数。 默认为“1”。
...
**语法:** obj = Marker Simulation(...Number of Individuals per Cross( number=5 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定每次杂交要模拟的个体数。 默认为“5”。
...
**语法:** obj = Marker Simulation(...Number of Selected Crosses( number=0 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定每代要选择的最大族系数。 默认为“0”。
...
**语法:** obj = Marker Simulation(...Number of Selected Individuals( number=0 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定每个家系要选择的最大个体数。 默认为“0”。
...
**语法:** obj = Marker Simulation(...Ploidy( number=2 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定指示倍性水平的偶数。 默认为“2”。
...
**语法:** obj = Marker Simulation(...Select Best Individuals( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 选择满足“预测变量公式”的“规格限”列属性中指定的所有准则的最佳个体。
...
**语法:** obj = Marker Simulation(...Set Random Seed( number=0 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Show Diversity Plot( state=1 )

**说明:** 显示或隐藏遗传多样性的图。 默认开启。
...
**语法:** obj &lt;&lt; Show Evaluation Plot( state=1 )

**说明:** 显示或隐藏遗传统计量的图。 默认开启。
...
**语法:** obj = Marker Simulation(...Threshold to Make Line Plots( number=500 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定要在报表中绘制线图的最大杂交数。当总杂交数小于该阈值时绘制线图。 默认为“500”。
...
**语法:** obj = Marker Simulation(...Unthreaded( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Simulation(...Use Annotation Table( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Simulation(...Use Only Markers Found in Predictor Formula( state=0|1 )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 模拟仅在预测变量公式中找到的那些标记。
