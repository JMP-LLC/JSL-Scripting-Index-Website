...
**语法:** obj = Distance Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** Permutations ( number = 1000 )&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** Number of Permutations to Calculate PERMANOVA 默认为“1000”。
...
**语法:** Pricpal Components ( number = 2 )&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** Number of Principal Components 默认为“2”。
