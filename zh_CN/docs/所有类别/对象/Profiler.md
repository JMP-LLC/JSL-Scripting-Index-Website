...
**语法:** obj &lt;&lt; Save Constraints to New Table
...
**语法:** obj &lt;&lt; Save Constraints to Table Script
...
**语法:** obj &lt;&lt; Error StdDev( Set Error StdDev(colume name(value),...) )
...
**说明:** 显示或隐藏“角点”报表。该报表包含因子空间极端处的规格内概率表。这些概率是使用以预测值为中心的正态分布计算的，并在规格限处截断。
...
**说明:** 显示或隐藏影响比。这些比率显示每个因子（从中点到每个限值）敏感的变化是怎样影响预测值偏离其规格限的程度。
