...
**语法:** obj = Partial Least Squares(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Partial Least Squares(...Centering( state=0|1)...)
...
**语法:** obj = Partial Least Squares(...Imputation Method( "均值"|"EM" )...)
...
**语法:** obj = Partial Least Squares(...Impute Missing Data( state=0|1 )...)
...
**语法:** obj = Partial Least Squares(...Max Iterations( number=1 )...)
...
**语法:** obj = Partial Least Squares(...Scaling( state=0|1)...)
