...
**说明:** 对函数的堆叠矩阵执行非负奇异值分解 (SVD)。非负 SVD 会约束矩阵分解，使得分和载荷大于或等于零。
...
**语法:** obj &lt;&lt; ARWLS Save Baselines

**JMP添加的版本:** 19

#### ARWLS Save Corrected

**语法:** obj &lt;&lt; ARWLS Save Corrected
...
**语法:** obj &lt;&lt; Parametric Save Baselines

**JMP添加的版本:** 19

#### Parametric Save Corrected

**语法:** obj &lt;&lt; Parametric Save Corrected
...
**语法:** obj &lt;&lt; SNIP Save Baselines

**JMP添加的版本:** 19

#### SNIP Save Corrected

**语法:** obj &lt;&lt; SNIP Save Corrected
...
**语法:** obj &lt;&lt; Save Script Options( "保存脚本将保存步骤"|"保存脚本将保存状态"="保存脚本将保存步骤" )

**说明:** 指定为再现峰值查找结果而保存的脚本的类型。 默认为“保存脚本将保存步骤”。
