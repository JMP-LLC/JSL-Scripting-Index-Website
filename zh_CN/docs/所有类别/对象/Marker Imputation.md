...
**语法:** obj = Marker Imputation(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Marker Imputation(...Imputation Value( number=0 )...)
...
**语法:** obj = Marker Imputation(...Method( "LD-kNN"|"HWE 关闭"|"HWE 打开"|"随机"|"指定"="LD-kNN" )...)
...
**语法:** obj = Marker Imputation(...Nearest Markers( number=15 )...)
...
**语法:** obj = Marker Imputation(...Nearest Samples( number=15 )...)
...
**语法:** obj = Marker Imputation(...Ploidy( number=2 )...)
...
**语法:** obj = Marker Imputation(...Set Random Seed( number=0 )...)
...
**语法:** obj = Marker Imputation(...Unthreaded( state=0|1 )...)
