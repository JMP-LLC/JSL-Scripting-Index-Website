...
**说明:** Mimic a human user using JSL scripting.
...
**语法:** [xmin ymin, xmax ymax] = Bounds(boxref)

**说明:** Gets the rectangle for a given box.
...
**语法:** boxref = Button(label)

**说明:** Gets the first button box ref with the given label under Mimic box.
...
**语法:** [x y] = Center(rect | boxref)

**说明:** Calculates the center point for a given box or rectangle.
...
**语法:** pt = Disclosure(boxref | objref)

**说明:** Get position of the gray disclosure triangle for the given object or outline.
...
**语法:** geo = Frame Coords(framebox, geo)

**说明:** Converts a point or rectangle in Frame coordinates into a point or rectangle in screen space. Works best with continuous scales.
...
**语法:** rect = Grid Region(gridbox, "IdColumn", 9)

**说明:** Looks up named regions from the Data Grid.
...
**语法:** rect = List Item(listbox, item label)

**说明:** Finds the first item with the given label in a List Box Box, reveals it, and gets its bounds
...
**语法:** pt = Lrt(boxref | objref)

**说明:** Get position of the Little Red Triangle for the given object or outline.
...
**语法:** geo = Offset(geo | boxref, pt)

**说明:** Offset the given box/point/rectangle by given point.
...
**语法:** [x y] = TopLeft(rect | boxref)

**说明:** Calculates the top-left corner point for a given box or rectangle.
