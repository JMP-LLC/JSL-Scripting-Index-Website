...
**语法:** obj = Scatterplot Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Density Ellipses( state=0|1 )
...
**说明:** 设置覆盖率，对于散点图矩阵上显示的椭圆而言是 (1 - Alpha)。
...
**说明:** 标识分组变量，这些变量的水平用于创建散点图矩阵上显示的各椭圆。
...
**说明:** 锁定轴范围，以便在数据或过滤条件发生更改时它们不会随之更改。
...
**语法:** obj = Scatterplot Matrix(...Matrix Format( "下三角"|"上三角"|"正方形" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Nonpar Density( state=0|1 )
...
**说明:** 通过在散点图矩阵上轻微移动点，随机散布各点。 默认为“自动”。
...
**语法:** obj &lt;&lt; Shaded Ellipses( state=0|1 )
