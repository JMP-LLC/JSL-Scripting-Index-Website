...
**语法:** obj = Nonlinear(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Nonlinear(...<Predictor Formula( column )>...)
...
**语法:** obj = Nonlinear(...<Response( column )>...)
...
**语法:** obj = Nonlinear(...<Weight( column )>...)
