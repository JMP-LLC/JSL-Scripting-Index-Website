...
**语法:** obj = Cluster Variables(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Cluster Variables(...<By( column(s) )>...)
...
**语法:** obj = Cluster Variables(...Columns( column(s) )...)
...
**语法:** obj = Cluster Variables(...<Freq( column )>...)
...
**语法:** obj = Cluster Variables(...<Weight( column )>...)
...
**语法:** obj = Cluster Variables(...Y( column(s) )...)
