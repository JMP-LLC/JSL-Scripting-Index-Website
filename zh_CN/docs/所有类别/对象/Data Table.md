...
**语法:** obj << Group Columns( first column, number )
...
**语法:** obj << Group Scripts({ script1, script2, ...}) 
...
**语法:** sd = dt << Make SAS Data Step Window( )
...
**语法:** obj << Save( <filepath>, <file type> ) 
...
**语法:** obj << Format( "Best|Fixed Dec...", <width>, <dec>, <"Use Thousands Separator">  )
