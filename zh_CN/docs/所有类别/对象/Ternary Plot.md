...
**语法:** obj = Ternary Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Ternary Plot(...<By( column(s) )>...)
...
**语法:** obj = Ternary Plot(...Contour Formula( formula column )...)
...
**语法:** obj = Ternary Plot(...Plotting( column(s) )...)
...
**语法:** obj = Ternary Plot(...X( column(s) )...)
