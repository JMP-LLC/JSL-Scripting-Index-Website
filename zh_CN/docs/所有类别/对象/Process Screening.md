...
**语法:** obj = Process Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Process Screening(...<By( column(s) )>...)
...
**语法:** obj = Process Screening(...<Grouping( column(s) )>...)
...
**语法:** obj = Process Screening(...Process Variables( column(s) )...)
...
**语法:** obj = Process Screening(...<Subgroup( column(s) )>...)
...
**语法:** obj = Process Screening(...<Time( column )>...)
...
**语法:** obj = Process Screening(...<n Trials( column )>...)
...
**语法:** obj = Process Screening(...Control Chart Type( "Indiv and MR"|"XBar and R"|"XBar and S"|"XBar MR and R"|"XBar MR and S"|"Count"|"Nonnegative Continuous"|"Proportion" )...)
...
**语法:** obj = Process Screening(...Outlier Threshold( number=5 )...)
...
**语法:** obj = Process Screening(...Shift Lambda( number=.3 )...)
...
**语法:** obj = Process Screening(...Shift Threshold( number=3 )...)
...
**语法:** obj = Process Screening(...Subgroup Sample Size( number=5 )...)
...
**语法:** obj = Process Screening(...Use Limits Table( state=0|1, data table, <options>)...)
...
**语法:** obj = Process Screening(...Use Medians instead of Means( state=0|1 )...)
...
**语法:** obj << Chart Options as Selected( Circle Alarm Points( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( Connect Points( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( Dispersion Chart( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( Frame Size( width=500, height=170 ) ); 
...
**语法:** obj << Chart Options as Selected( Number of Plots Across( number=1 ) ); 
...
**语法:** obj << Chart Options as Selected( Remove ); 
...
**语法:** obj << Chart Options as Selected( Show Centerline( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( Show Control Limits( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( Show Markers( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( Show Spec Limits( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( Show Zones( state=0|1 ) ); 
...
**语法:** obj << Chart Options as Selected( V Axis Label( state=0|1 ) ); 
