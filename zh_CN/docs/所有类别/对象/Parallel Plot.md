...
**语法:** obj = Parallel Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** Parallel Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**语法:** Parallel Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
