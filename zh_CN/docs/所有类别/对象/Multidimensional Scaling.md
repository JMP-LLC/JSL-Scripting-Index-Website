...
**语法:** obj = Multidimensional Scaling(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** Data Format( Distance Matrix | Attribute List )
...
**语法:** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)
...
**语法:** Transformation( None | Ratio | Interval | Ordinal )
