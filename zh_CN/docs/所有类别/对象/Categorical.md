...
**语法:** obj = Categorical(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Categorical(...Aligned Responses( columns )...)
...
**语法:** obj = Categorical(...Confidence Interval Coverage( number=0.95 )...)
...
**语法:** obj = Categorical(...Count Missing Responses( state=0|1 )...)
...
**语法:** obj = Categorical(...Grouping Option( "组合"|"单独"|"二者" )...)
...
**语法:** obj = Categorical(...Include Responses Not in Data( state=0|1 )...)
...
**语法:** obj = Categorical(...Indicator Group( columns )...)
...
**语法:** obj = Categorical(...Multiple Delimited( column )...)
...
**语法:** obj = Categorical(...Multiple Response( columns )...)
...
**语法:** obj = Categorical(...Multiple Response by ID( column )...)
...
**语法:** obj = Categorical(...Order Response Levels High to Low( state=0|1 )...)
...
**语法:** obj = Categorical(...Rater Agreement( columns )...)
...
**语法:** obj = Categorical(...Repeated Measures( columns )...)
...
**语法:** obj = Categorical(...Response Frequencies( columns )...)
...
**语法:** obj = Categorical(...Responses( column )...)
...
**语法:** obj = Categorical(...Shorten Labels( state=0|1 )...)
...
**语法:** obj = Categorical(...Structured( Column * nestedColumn ... + rightColumn, sideColumn + lowerColumns...  )...)
...
**语法:** obj = Categorical(...Unique Occurrences within ID( state=0|1 )...)
