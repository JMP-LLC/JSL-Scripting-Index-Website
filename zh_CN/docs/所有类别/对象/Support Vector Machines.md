...
**语法:** obj = Support Vector Machines(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Support Vector Machines(...&lt;By( column(s) )&gt;...)
...
**语法:** obj = Support Vector Machines(...Factor( column(s) )...)
...
**语法:** obj = Support Vector Machines(...&lt;Freq( column )&gt;...)
...
**语法:** obj = Support Vector Machines(...Response( column )...)
...
**语法:** obj = Support Vector Machines(...&lt;Validation( column )&gt;...)
...
**语法:** obj = Support Vector Machines(...X( column(s) )...)
...
**语法:** obj = Support Vector Machines(...Y( column )...)
...
**语法:** Set Random Seed( number )

**说明:** 设置用于“K 折”和“保留”验证的随机化过程的随机种子。若您要重新生成分析，该选项会很有用。
...
**语法:** obj &lt;&lt; Tuning Design( state=0|1 )
...
**语法:** obj &lt;&lt; (fit[number] &lt;&lt; Confusion Matrix( state=0|1 ))

**说明:** 显示或隐藏实际响应与预测响应的交叉表矩阵。 默认开启。
...
**说明:** 对于指定的拟合，显示或隐藏训练集的图，其中 X 轴标绘预测值，Y 轴标绘实际值。若您使用了验证集和测试集，也会为它们显示图。 默认开启。
...
**说明:** 对于指定的拟合，显示或隐藏训练集的图，其中 X 轴标绘预测值，Y 轴标绘残差值。若您使用了验证集和测试集，也会为它们显示图。
...
**语法:** obj &lt;&lt; (fit[number] &lt;&lt; Publish Probability Formula)

**说明:** 将每个响应水平的概率保存为数据表中的单独一列。
...
**语法:** obj &lt;&lt; (fit[number] &lt;&lt; Response Profile Plot( state=0|1 ))

**说明:** 显示或隐藏“响应特征”图。 默认开启。
...
**语法:** obj &lt;&lt; (fit[number] &lt;&lt; Save Predicteds)
...
**语法:** obj &lt;&lt; (fit[number] &lt;&lt; Save Probabilities)
...
**语法:** obj &lt;&lt; (fit[number] &lt;&lt; Save Probability Formula)
...
**说明:** 在数据表中创建一个新列，用于标识在训练、验证和检验数据集中使用的行。
...
**语法:** obj &lt;&lt; (fit[number] &lt;&lt; Support Vector Coefficients( state=0|1 ))
