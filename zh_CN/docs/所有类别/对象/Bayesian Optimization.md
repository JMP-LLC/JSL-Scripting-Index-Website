...
**说明:** 指示是否运行自动候选集生成和批次选择。此选项相当于同时启用或禁用“生成候选集”选项和“自动选择批次”选项。
...
**说明:** 指定批次自动选择算法所需的最小 R 方量度。在“Bayes 优化”平台的启动窗口中，该选项被称为基于模型的扩充 R 方阈值。
...
**语法:** obj &lt;&lt; Nominal Correlation Type( "等相关性" )
...
**语法:** obj &lt;&lt; Ordinal Correlation Type( "等相关性"|"不等相关性" )
