...
**语法:** obj << Continuous Correlation Type( "高斯"|"Matern 3/2"|"Matern 5/2"|"指数"="Matern 5/2" )

**说明:** 默认为“Matern 5/2”。

### Copy All Model Fits Script

**语法:** obj << Copy All Model Fits Script

**说明:** 创建生成该分析的 JSL 脚本，并将其置于剪贴板上。

### Copy Startup Script

**语法:** obj << Copy Startup Script
...
**语法:** obj << Model Based Augmentation RSquare Threshold( number )

### Nominal Correlation Type

**语法:** obj << Nominal Correlation Type( "等相关性"|"Unequal Correlations"="等相关性" )

**说明:** 默认为“等相关性”。

### Ordinal Correlation Type

**语法:** obj << Ordinal Correlation Type( "等相关性"|"Unequal Correlations"|"Latent Variable"="等相关性" )

**说明:** 默认为“等相关性”。

### Save All Model Fits Script to Data Table

**语法:** obj << Save All Model Fits Script to Data Table

**说明:** 创建生成该分析的 JSL 脚本，并将其作为表属性保存至数据表中。

### Save All Model Fits Script to Journal

**语法:** obj << Save All Model Fits Script to Journal

**说明:** 创建生成该分析的 JSL 脚本，并将一个按钮添加至包含该脚本的记录中。

### Save All Model Fits Script to Report

**语法:** obj << Save All Model Fits Script to Report

**说明:** 创建生成该分析的 JSL 脚本，并在报表中显示。有助于保留打印的已完成操作记录。

### Save All Model Fits Script to Script Window

**语法:** obj << Save All Model Fits Script to Script Window

**说明:** 创建生成该分析的 JSL 脚本，并将其追加至当前的脚本文本窗口中。

### Save Startup Script to Data Table

**语法:** obj << Save Startup Script to Data Table

**说明:** 创建生成该分析的 JSL 脚本，并将其作为表属性保存至数据表中。

### Save Startup Script to Journal

**语法:** obj << Save Startup Script to Journal

**说明:** 创建生成该分析的 JSL 脚本，并将一个按钮添加至包含该脚本的记录中。

### Save Startup Script to Report

**语法:** obj << Save Startup Script to Report

**说明:** 创建生成该分析的 JSL 脚本，并在报表中显示。有助于保留打印的已完成操作记录。

### Save Startup Script to Script Window

**语法:** obj << Save Startup Script to Script Window
