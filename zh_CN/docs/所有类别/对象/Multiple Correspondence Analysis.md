...
**语法:** obj = Multiple Correspondence Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**语法:** obj = Multiple Correspondence Analysis(...<By( column(s) )>...)
...
**语法:** obj = Multiple Correspondence Analysis(...<Factor( column(s) )>...)
...
**语法:** obj = Multiple Correspondence Analysis(...<Freq( column )>...)
...
**语法:** obj = Multiple Correspondence Analysis(...Response( column(s) )...)
...
**语法:** obj = Multiple Correspondence Analysis(...<Supplementary ID( column )>...)
...
**语法:** obj = Multiple Correspondence Analysis(...<Supplementary Variable( column(s) )>...)
...
**语法:** obj = Multiple Correspondence Analysis(...<X( column(s) )>...)
...
**语法:** obj = Multiple Correspondence Analysis(...Y( column(s) )...)
...
**语法:** obj = Multiple Correspondence Analysis(...<Z( column(s) )>...)
