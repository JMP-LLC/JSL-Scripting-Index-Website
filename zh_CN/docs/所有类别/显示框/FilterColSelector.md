...
**语法:** obj &lt;&lt; Name contains( Name contains( s ) )
...
**语法:** obj &lt;&lt; Name ends with( Name ends with ( text ) )
...
**语法:** obj &lt;&lt; Name starts with( Name starts with ( text ) )
...
**语法:** obj &lt;&lt; Set Selected( index,&lt;selected&gt; )

**说明:** 将 index 处的项设置为选中状态 (1) 或取消选中状态 (0)。
