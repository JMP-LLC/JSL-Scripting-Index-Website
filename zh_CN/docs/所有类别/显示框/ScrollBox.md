...
**说明:** 若内容大于 ScrollBox 的大小，则返回在底部和右侧放置滚动条的显示框。
...
**语法:** obj &lt;&lt; Get Clip Printing( state=0|1 )

**说明:** 返回打印时用于剪切滚动框内容的当前设置。
...
**语法:** pixels = obj &lt;&lt; Get Height

**说明:** 返回滚动区域的高度。

### Get Scroll Extents

**语法:** {h pixels,v pixels} = obj &lt;&lt; Get Scroll Extents
...
**语法:** {h,v} = obj &lt;&lt; Get Scroll Position
...
**语法:** {h,v} = obj &lt;&lt; Get Scrollers

**说明:** 返回水平和垂直滚动的标志。若在给定方向禁用滚动，则 Scroll Box 在该方向上充当常规容器。
...
**语法:** obj &lt;&lt; Get Show Empty

**说明:** 返回滚动条为空时用于显示它们的当前设置。
...
**语法:** obj &lt;&lt; Set Auto Scrollable( state=0|1 )

**说明:** 根据子框的拉伸属性自动设置滚动参数。若该框在某个方向上不可拉伸，则每个方向上的滚动条为活动状态。
...
**语法:** obj &lt;&lt; Set Clip Printing( state=0|1 )

**说明:** 打印时滚动框内容剪切为适合滚动框大小，或显示整个内容。默认关闭剪切。
...
**语法:** obj &lt;&lt; Set Scroll Position( h,v )

**说明:** 设置水平和垂直滚动位置。值可以以像素为单位给出，或使用关键字“Start”和“End”给出。
...
**语法:** obj &lt;&lt; Set Scrollers( h,v )

**说明:** 设置水平和垂直滚动的标志。若在给定方向禁用滚动，则 Scroll Box 在该方向上充当常规容器。
...
**语法:** obj &lt;&lt; Set Show Empty( state=0|1 )
