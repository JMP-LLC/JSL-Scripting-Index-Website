...
**语法:** obj << Point from( state=0|1 )

**说明:** 绘制 (1) 或删除 (0) 线条起始处的箭头。
...
**语法:** obj << Point to( state=0|1 )

**说明:** 绘制 (1) 或删除 (0) 线条结尾处的箭头。
