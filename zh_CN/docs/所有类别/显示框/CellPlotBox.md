...
**语法:** obj << Color Theme( Green to Black to Red|Green to White to Red|White to Black|Blue to Gray to Red|Blue to Green to Red|Spectral|Jet|White to Blue|White to Green|White to Red )
...
**语法:** obj << Graph Type( "色图"|"点图"|"垂直线图"|"水平线图"|"水平条形图" )
...
**语法:** obj << No separator lines( state=0|1 )
