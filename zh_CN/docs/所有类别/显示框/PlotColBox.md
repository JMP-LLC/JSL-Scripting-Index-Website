...
**说明:** 返回使用 string 作为标题标签的显示框，以图形的方式表示数值。
...
**语法:** obj &lt;&lt; Set Values( matrix|list )

**说明:** 将 PlotColBox 更新为提供的值。
...
**语法:** obj &lt;&lt; Significance( list|matrix )
