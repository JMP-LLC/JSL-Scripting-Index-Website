...
**语法:** obj &lt;&lt; Add(&lt;index&gt;,"title",contents);obj &lt;&lt; Add(&lt;index&gt;,tabPageBox)

**说明:** 添加新选项卡。若未指定“index”，则该选项卡追加到当前选项卡之后。若要添加的内容不是“Tab Page Box”，则添加新的“Tab Page Box”以保留内容。
...
**说明:** 删除 index 处的选项卡。若未指定 index，则删除选定的选项卡。
...
**语法:** obj &lt;&lt; DockName( text )

### Dockable

**语法:** obj &lt;&lt; Dockable( bool )

**说明:** 若某个容器可停放，则可通过拖放重新排列可移动的子项。
...
**语法:** obj &lt;&lt; Get Min Title Width

**说明:** 在设置 Overflow Enabled 时获取截断选项卡标题的最小宽度。默认设置 0 将应用默认最小宽度。
...
**语法:** obj &lt;&lt; Get Overflow Enabled

**说明:** 当“Overflow Enabled”为 1 时，不会强制选项卡列表成为选项卡标题的宽度。若选项卡列表的宽度不足以容纳所有标题，则会显示一个溢出菜单，允许选择新选项卡。
...
**语法:** obj &lt;&lt; Get Tab Close

**说明:** 返回从脚本或通过关闭图标关闭选项卡时运行的脚本。该脚本应返回 1 以允许关闭，或返回 0 以取消关闭。
...
**语法:** "string" = obj &lt;&lt; Get Tab Close Tip
...
**语法:** all | horizontal,vertical | left,top,right,bottom = obj &lt;&lt; Get Tab Margin
...
**说明:** 返回点击“新建”选项卡时运行的脚本。该脚本负责创建新选项卡。
...
**语法:** "string" = obj &lt;&lt; Get Tab New Icon
...
**语法:** style = obj &lt;&lt; Get Title Location
...
**语法:** index = obj &lt;&lt; Index of Tab( "string" )
...
**语法:** obj &lt;&lt; Insert(&lt;index&gt;,"title",contents);obj &lt;&lt; Insert(&lt;index&gt;,tabPageBox)

**说明:** 插入新选项卡。若未指定“index”，则新选项卡追加到当前选项卡之后。若要添加的内容不是“Tab Page Box”，则添加新的“Tab Page Box”以保留内容。
...
**语法:** obj &lt;&lt; Move Tab( fromIndex, toIndex )

**说明:** 将选项卡从位置 fromIndex 移至位置 toIndex。
...
**语法:** obj &lt;&lt; Replace(&lt;index&gt;,"title",contents);obj &lt;&lt; Replace(&lt;index&gt;,tabPageBox)

**说明:** 替换选项卡。若未指定“index”，则替换选定的选项卡。若要添加的内容不是“Tab Page Box”，则添加新的“Tab Page Box”以保留内容。
...
**语法:** obj &lt;&lt; Set Min Title Width( number )

**说明:** 在设置 Overflow Enabled 时设置截断选项卡标题的最小宽度。默认设置 0 将应用默认最小宽度。
...
**语法:** obj &lt;&lt; Set Overflow Enabled( state=0|1 )

**说明:** 当“Overflow Enabled”为 true 时，不会强制选项卡列表成为选项卡标题的宽度。若选项卡列表的宽度不足以容纳所有标题，则会显示一个溢出菜单，允许选择新选项卡。该选项仅适用于样式设置为 Tab。
...
**语法:** obj &lt;&lt; Set Selected( index )

**说明:** 将焦点放置到 index 处的选项卡。
...
**语法:** obj &lt;&lt; Set Style( "选项卡"|"组合框"|"分级显示项"|"垂直散布"|"水平散布"|"最小化大小" )
...
**语法:** obj &lt;&lt; Set Tab Changed( script|Function( {this}, &lt;script&gt; ) )

**说明:** 在进行更改后（例如选择一个新的选项卡），系统将运行指定的“script”或“function”。
...
**语法:** obj &lt;&lt; Set Tab Close( script|Function )

**说明:** 设置从脚本或通过关闭图标关闭选项卡时要运行的“script”或“Function”。“script”或“Function”应返回 1 以允许关闭，或返回 0 以取消关闭。
...
**语法:** obj &lt;&lt; Set Tab Close Tip( "string" )
...
**语法:** obj &lt;&lt; Set Tab Margin( all | horizontal,vertical | left,top,right,bottom )

**说明:** 设置选项卡的边距。输入的参数可应用于各边（水平方向大小和垂直方向大小），也可以为每个边应用不同的值。
...
**语法:** obj &lt;&lt; Set Tab New( script|Function( {this}, &lt;script&gt; ) )

**说明:** 设置点击“新建”选项卡时运行“script”或“Function”。“script”或“function”负责创建新选项卡。
...
**语法:** obj &lt;&lt; Set Tab New Icon( "string" )
...
**语法:** obj &lt;&lt; Set Title Location( "自动"|"上"|"下"|"左"|"右" )

**说明:** 设置选项卡页标题的位置。设置为“自动”时，将根据内容的大小自动选择位置。该选项仅适用于样式设置为 Tabbed。
