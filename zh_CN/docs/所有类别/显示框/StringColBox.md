...
**语法:** "left"|"right"|"center" = obj &lt;&lt; Get Justify
...
**语法:** obj &lt;&lt; Set Allow Text Search( &lt;0 | 1&gt; )

**说明:** 在具有可选择的行的表框中，该命令允许具有焦点的字符串列响应键盘输入以更改选定行。
...
**语法:** obj &lt;&lt; Set Justify( "left","right","center" )
