...
**语法:** obj &lt;&lt; Append( "string" | {"string", ...} )

**说明:** 将新字符串或字符串列表追加到结尾处。
...
**语法:** "bool" = obj &lt;&lt; Get Case Sensitive

**说明:** 若添加到列表的项除大小写外均匹配，则返回真
...
**语法:** obj &lt;&lt; Item Padding( sides ); sides = obj &lt;&lt; Get Item Padding
...
**语法:** list = obj &lt;&lt; Get Items( &lt;"Column Reference"&gt;)
...
**语法:** list = obj &lt;&lt; Get Selected(&lt;"Column Reference"&gt;)
...
**语法:** indices = obj &lt;&lt; Get Selected Indices
...
**语法:** obj &lt;&lt; Insert( "string",index )

**说明:** 将指定项或项列表添加到列表框的指定 index 之后。
...
**语法:** obj &lt;&lt; Menus Enabled( state=0|1 )

**说明:** 允许或禁止右击时显示 ListBoxBox 菜单。
...
**语法:** obj &lt;&lt; Modeling Type( {"Any","Continuous","Nominal","Ordinal","Multiple Response","Unstructured Text","Vector","None","Row State"}) &gt; )

**说明:** 为列列表框设置列的接受建模类型。默认值 "Any" 允许任意列使用经典建模类型（"Continuous"、"Nominal"、"Ordinal"）。
...
**语法:** obj &lt;&lt; On Change( script )

**说明:** 当列表中的选择内容发生更改时执行脚本。
...
**语法:** obj &lt;&lt; Set Case Sensitive( "bool" )

**说明:** 确定是否在大小写方面将添加到列表框的项与现有项进行比较
...
**语法:** obj &lt;&lt; Set Data Type( "任意"|"数值型"|"字符型" )

**说明:** 设置列的类型。列列表框可接受“任意”、“字符型”或“数值型”
...
**说明:** 设置控件的指定函数。当选择一个或多个项时该函数的脚本运行。
...
**语法:** obj &lt;&lt; Set Selected( index|{index1, index2, ...}|"All",&lt;selected&gt;,&lt;Run Script(0|1)&gt; )

**说明:** 将“index”处的项设置为选定 (1) 或取消选定 (0)。默认情况下，该消息为其 ListBoxBox 运行脚本。使用 RunScript(0) 以禁止运行脚本。使用 RunScript 选项还需要指定 selected 参数，因为参数与位置有关。
...
**语法:** obj &lt;&lt; Set Size( width,height )

**说明:** 设置 ListBoxBox 的高度和宽度。
...
**语法:** obj &lt;&lt; Set Tips( Lista de consejos )
