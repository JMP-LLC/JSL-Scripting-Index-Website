...
**说明:** 在显示框树中生成数据表视图。将当前数据表更改为指定的数据表。
...
**语法:** obj &lt;&lt; Close Data Grid( state=0|1 )
...
**语法:** obj &lt;&lt; Close Side Panels( state=0|1 )
...
**语法:** obj &lt;&lt; Close summary panels( state=0|1 )
...
**语法:** obj &lt;&lt; Get Close Summary Panels
