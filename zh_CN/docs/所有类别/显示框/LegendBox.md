...
**语法:** LegendBox &lt;&lt; Get Item(Model ID, Model Index)

**说明:** 返回可以查询或更改其可见属性的图例项。
...
**语法:** obj &lt;&lt; Legend Position( list )

**说明:** 根据输入的 list 重新排列 LegendBox 内部的项。
...
**语法:** obj &lt;&lt; Orientation( vertical|horizontal )

**说明:** 设置 LegendBox 内部项的朝向。
...
**语法:** obj &lt;&lt; Revert Legend

**说明:** 将对 LegendBox 的任何更改复原。
...
**说明:** 指定图例中显示的最大项数。该设置可防止噪音图例占据图形。
...
**语法:** obj &lt;&lt; Set Wrap( number )

**说明:** 指定图例项应显示的行数；0 表示不换行（即，一个宽列）
...
**语法:** obj &lt;&lt; font( fontname, &lt;fontsize&gt;, &lt;fontstyle&gt; )
