...
**说明:** 若背景填充关闭，则返回 0；若背景填充打开，则返回 1。
...
**语法:** obj &lt;&lt; Set Style( pen style )

**说明:** 设置边框的线条样式。Pen style 可以为数字或加引号的字符串: 0（实线）、1（点线）、2（虚线）、3（点划线）、4（双点划线）
