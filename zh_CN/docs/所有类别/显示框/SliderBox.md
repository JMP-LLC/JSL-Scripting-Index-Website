...
**语法:** bool = obj &lt;&lt; Get Log Scale

**说明:** 返回滑块为对数尺度 (1) 还是线性尺度 (0)
...
**语法:** obj &lt;&lt; Set( float, &lt;index&gt;,&lt;run script(0|1)&gt; )
...
**语法:** obj &lt;&lt; Set Log Scale( 0|1 )

**说明:** 设置滑块为对数尺度 (1) 或线性尺度 (0)
