...
**语法:** "Promise" = obj << Execute Script

**说明:** 在当前页面的上下文中异步执行给定的 Javascript。返回脚本结果的承诺（作为字符串）
...
**说明:** Sets the width and height of the web browser box. The web browser box has a default Stretch setting of &apos;Window&apos; that must be changed to &apos;Off&apos; to honor the requested size.
