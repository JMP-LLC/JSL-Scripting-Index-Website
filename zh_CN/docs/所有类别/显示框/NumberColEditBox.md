...
**语法:** obj &lt;&lt; Align Decimal Separator( state=0|1 )

**说明:** 指定列中的值使用小数分隔符垂直对齐。
...
**语法:** obj &lt;&lt; Enable Semantic Formats( state=0|1 )

**说明:** 控制语义格式是否应用于列。语义格式还可以通过首选项控制。
...
**语法:** obj &lt;&lt; Get Align Decimal Separator

**说明:** 若列根据小数分隔符对齐值，则返回 1，否则返回 0。
...
**语法:** format = obj &lt;&lt; Get Conditional Format
...
**语法:** obj &lt;&lt; Get Effective Format( &lt;row&gt; )

**说明:** 返回列的有效格式，即应用任何匹配的语义格式后的格式。若给定了 row，则仅返回该行的有效格式。
...
**语法:** obj &lt;&lt; Get Enable Semantic Formats

**说明:** 返回列的“启用语义格式”设置。语义格式还可以通过首选项控制。
...
**语法:** width,&lt;decimalplaces&gt; = obj &lt;&lt; Get Format

**说明:** 返回当前格式 (width, decimalplaces)。decimalplaces > 100 表示日期/时间值。
...
**语法:** obj &lt;&lt; Hide Missing Values( state=0|1 )
...
**语法:** obj &lt;&lt; Set Conditional Format( "Correlation"|"PValue"|"Factor Pattern" )
...
**语法:** obj &lt;&lt; Set Format( "format", &lt;width, &lt;decimal places&gt;&gt;, &lt;"Use thousands separator"&gt; )
...
**语法:** obj &lt;&lt; Set Function( Function( {thisBox, which}, &lt;script&gt; ) )

**说明:** 设置控件的给定函数。提交更改时该函数的脚本运行。“which”是发生更改的单元格的行编号。
...
**语法:** obj &lt;&lt; Set Values( matrix )

**说明:** 将 NumberColBox 更新为提供的值。
