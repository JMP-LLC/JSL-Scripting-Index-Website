...
**说明:** 设置控件的指定函数。当任一滑块的值发生更改时该函数的脚本运行。
...
**语法:** obj &lt;&lt; Set Lower( float, &lt;index&gt;, &lt;run script(0|1)&gt; )
...
**语法:** obj &lt;&lt; Set Upper( float, &lt;index&gt;, &lt;run script(0|1)&gt; )
