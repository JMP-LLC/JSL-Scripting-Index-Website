...
**语法:** obj &lt;&lt; Graph Margin( sides );sides = obj &lt;&lt; Get Graph Margin

**说明:** The minimum margin around the graph area, which might be superseded by any surrounding axis, legend, or title.
...
**语法:** obj &lt;&lt; Scale Graph Margin( state=0|1 );state = obj &lt;&lt; Get Scale Graph Margin

**说明:** Specifies whether the Graph Margin properties should scale with the graph size when applied.
...
**语法:** obj &lt;&lt; Graph Spacing Transparency( color )
