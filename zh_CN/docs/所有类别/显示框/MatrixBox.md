...
**语法:** obj &lt;&lt; Column Names( strings or list of strings )
...
**说明:** 控制语义格式是否应用于矩阵。语义格式还可以通过首选项控制。
...
**语法:** obj &lt;&lt; Get Effective Format( col, &lt;row&gt; )
...
**说明:** 获取矩阵的“启用语义格式”设置。语义格式还可以通过首选项控制。
...
**语法:** obj &lt;&lt; Get Format( width, decimalplaces )
...
**语法:** obj &lt;&lt; Make Combined Data Table( &lt;Invisible(bool)&gt; )
...
**语法:** obj &lt;&lt; Open( state=0|1 )

**说明:** 显示或隐藏 MatrixBox 中的值。
...
**语法:** obj &lt;&lt; Row Names( strings or list of strings )
...
**语法:** obj &lt;&lt; Set Conditional Format( None|Correlation|PValue|Factor Pattern )
...
**语法:** obj &lt;&lt; Sort( column, ascending )

**说明:** 基于其中一列对矩阵的行排序。若为列指定 0，则删除排序。
