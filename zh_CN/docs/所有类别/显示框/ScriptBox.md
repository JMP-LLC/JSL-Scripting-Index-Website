...
**语法:** obj &lt;&lt; Get Line Text( line number )
...
**说明:** 以字符串列表的形式返回脚本窗口中的所有文本，每个字符串一行。
...
**语法:** obj &lt;&lt; Get Show Empty Scrollbars( state=0|1 )

**说明:** 返回一个布尔值，该值指示是否显示水平和垂直滚动条，即便没必要显示它们
...
**语法:** obj &lt;&lt; Get Show Scrollbars

**说明:** 返回一个含有两个元素的列表，该列表指示是否显示水平和垂直滚动条
...
**语法:** obj &lt;&lt; Read Only( state=0|1 )

**说明:** 若为真 (1)，则脚本框中的文本不能编辑。
...
**语法:** obj &lt;&lt; Set Cursor Position( position )
...
**语法:** obj &lt;&lt; Set Line Text( line number, text )
...
**语法:** obj &lt;&lt; Set Selection Width( width )
...
**语法:** obj &lt;&lt; Set Show Empty Scrollbars( state=0|1 )

**说明:** 若为真 (1)，则显示水平或垂直滚动条，即便没必要显示它们
...
**语法:** obj &lt;&lt; Set Show Scrollbars( state=0|1 )
...
**语法:** obj &lt;&lt; Show Embedded Log( state=0|1 )
...
**语法:** obj &lt;&lt; Show Line Numbers( state=0|1 )
