...
**Descripción:** Crea un segmento de gráfico circular en el origen especificado, con el radio especificado, basado en los valores especificados en el formato de matriz.
...
**Sintaxis:** obj &lt;&lt; Get Origin

**Descripción:** Obtiene el origen del gráfico circular.
...
**Sintaxis:** obj &lt;&lt; Get Radius

**Descripción:** Obtiene el radio del gráfico circular.
...
**Descripción:** Obtiene el estilo del gráfico circular, que puede ser gráfico circular, anillo o coxcomb.
...
**Sintaxis:** obj &lt;&lt; Origin( Origen X, origen Y )

**Descripción:** Establece el origen del gráfico circular.
...
**Sintaxis:** obj &lt;&lt; Radius( radio )

**Descripción:** Establece el radio del gráfico circular.
...
**Sintaxis:** Set Label Offset {Wedge Index, X Scale Coordinate (0-1), Y Scale Coordinate (0-1)}

**Descripción:** Establece la compensación de la etiqueta de valor de una porción del gráfico circular con respecto a una coordenada en el gráfico
...
**Sintaxis:** obj &lt;&lt; Style( "gráfico circular", "anillo", "coxcomb" )

**Descripción:** Establece el estilo del gráfico circular como gráfico circular, anillo o coxcomb.
