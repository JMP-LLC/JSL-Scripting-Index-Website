...
**Descripción:** Devuelve un cuadro de visualización que muestra cadenas en una columna.
...
**Sintaxis:** "left"|"right"|"center" = obj &lt;&lt; Get Justify

**Descripción:** Obtiene la justificación horizontal de la columna
...
**Sintaxis:** obj &lt;&lt; Numerical Order( &lt;0 | 1&gt; )

**Descripción:** El texto que contenga números se mostrará en orden numérico.
...
**Sintaxis:** obj &lt;&lt; Set Allow Text Search( &lt;0 | 1&gt; )

**Descripción:** En los cuadros de las tablas con filas seleccionables, este comando permite que una columna de cadena que tenga foco responda a la entrada de teclado para cambiar la fila seleccionada.
...
**Sintaxis:** obj &lt;&lt; Set Justify( "left","right","center" )

**Descripción:** Establece la justificación horizontal de la columna
