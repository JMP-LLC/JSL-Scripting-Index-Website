...
**Sintaxis:** obj &lt;&lt; Close Panel( index,&lt;previous&gt; )

**Descripción:** Cierra el panel con el índice indicado. Si el argumento previous es 1, el espacio se asignará al cuadro anterior en la lista. De lo contrario, se asignará al siguiente.
...
**Sintaxis:** obj &lt;&lt; Divider Color( color );color = obj &lt;&lt; Get Divider Color

**Descripción:** Especifica o devuelve el color de cada divisor. Si no se establece, se utiliza un color basado en el color de fondo.
...
**Sintaxis:** obj &lt;&lt; Divider Length( number );number = obj &lt;&lt; Get Divider Length

**Descripción:** Especifica o devuelve la longitud como porcentaje de cada divisor. Un valor de 0,0 genera un divisor invisible. Un valor de 1,0 genera la línea divisoria de longitud completa (predeterminada).
...
**Sintaxis:** obj &lt;&lt; Divider Thickness( number );number = obj &lt;&lt; Get Divider Thickness

**Descripción:** Especifica o devuelve el grosor de línea de cada divisor. El valor debe ser distinto de cero.
...
**Sintaxis:** {size1,...} = obj &lt;&lt; Get Sizes

**Descripción:** Devuelve las proporciones de cada uno de los paneles de Splitter Box.
...
**Sintaxis:** obj &lt;&lt; Open Panel( index,&lt;previous&gt; )

**Descripción:** Abre el panel con el índice indicado. Si el argumento previous es 1, el espacio se tomará del cuadro anterior de la lista. De lo contrario, se tomará del cuadro siguiente.
...
**Sintaxis:** obj &lt;&lt; Set Sizes( {size1,...} )

**Descripción:** Establece las proporciones de cada panel del Splitter Box.
...
**Sintaxis:** obj &lt;&lt; Size( size )

**Descripción:** Establece la proporción del último panel del Splitter Box.
...
**Sintaxis:** state=0|1 = obj &lt;&lt; get horizontal

**Descripción:** Devuelve (1) si el cuadro de lista está horizontal o (0) si está vertical.
...
**Sintaxis:** obj &lt;&lt; set horizontal( state=0|1 )

**Descripción:** Establece el cuadro de lista en horizontal (1) o vertical (0).
