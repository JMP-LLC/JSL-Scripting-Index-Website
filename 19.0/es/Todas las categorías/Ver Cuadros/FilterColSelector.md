...
**Sintaxis:** obj &lt;&lt; None( (0 | 1) )

**Descripción:** Incluye o excluye columnas con el tipo de modelización "ninguno" de la lista.
...
**Sintaxis:** obj &lt;&lt; Character( (0 | 1) )

**Descripción:** Incluye o excluye de la lista las columnas de caracteres.
...
**Sintaxis:** obj &lt;&lt; Continuous( (0 | 1) )

**Descripción:** Incluye o excluye de la lista las columnas continuas.
...
**Sintaxis:** obj &lt;&lt; Expression( (0 | 1) )

**Descripción:** Incluye o excluye columnas de expresión de la lista.
...
**Sintaxis:** list = obj &lt;&lt; Get Selected
...
**Sintaxis:** obj &lt;&lt; Match case( (0 | 1) )

**Descripción:** Determina si la búsqueda de columnas distingue o no entre mayúsculas y minúsculas.
...
**Sintaxis:** obj &lt;&lt; Multiple Response( (0 | 1) )

**Descripción:** Incluye o excluye columnas de respuesta múltiple de la lista.
...
**Sintaxis:** obj &lt;&lt; Name contains( Name contains( s ) )

**Descripción:** Lista sólo aquellas columnas cuyo nombre contiene el texto indicado.
...
**Sintaxis:** obj &lt;&lt; Name ends with( Name ends with ( text ) )

**Descripción:** Lista sólo aquellas columnas cuyo nombre acaba con el texto indicado.
...
**Sintaxis:** obj &lt;&lt; Name starts with( Name starts with ( text ) )

**Descripción:** Lista sólo aquellas columnas cuyo nombre comienza por el texto indicado.
...
**Sintaxis:** obj &lt;&lt; Nominal( (0 | 1) )

**Descripción:** Incluye o excluye de la lista las columnas nominales.
...
**Sintaxis:** obj &lt;&lt; Numeric( (0 | 1) )

**Descripción:** Incluye o excluye de la lista las columnas numéricas.
...
**Sintaxis:** obj &lt;&lt; Ordinal( (0 | 1) )

**Descripción:** Incluye o excluye de la lista las columnas ordinales.
...
**Descripción:** Restablece la lista de columnas como lista completa.
...
**Sintaxis:** obj &lt;&lt; Set Selected( index,&lt;selected&gt; )

**Descripción:** Establece que se seleccione (1) o deseleccione (0) el elemento del index.
...
**Sintaxis:** obj &lt;&lt; Sort by name

**Descripción:** Ordena la lista de columnas por nombre.
...
**Sintaxis:** obj &lt;&lt; Unstructured Text( (0 | 1) )

**Descripción:** Incluye o excluye columnas con texto sin formato de la lista.
...
**Sintaxis:** obj &lt;&lt; Vector( (0 | 1) )

**Descripción:** Incluye o excluye columnas de vectores de la lista.
