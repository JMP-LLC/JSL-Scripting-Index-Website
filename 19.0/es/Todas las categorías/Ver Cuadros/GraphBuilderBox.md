...
**Descripción:** The minimum margin around the graph area, which might be superseded by any surrounding axis, legend, or title.
...
**Descripción:** Specifies whether the Graph Margin properties should scale with the graph size when applied.
