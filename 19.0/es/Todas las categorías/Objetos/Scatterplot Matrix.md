...
**Sintaxis:** obj &lt;&lt; Density Ellipses( state=0|1 )
...
**Descripción:** Establece el nivel de cobertura, que es (1 - alfa) para las elipses que se muestran en la matriz de gráficos de dispersión.
...
**Descripción:** Establece la transparencia para las elipses que se muestran en la matriz de gráficos de dispersión.
...
**Descripción:** Identifica una variable de agrupación cuyos niveles se utilizan para crear elipses distintas que se muestran en la matriz de gráficos de dispersión.
...
**Descripción:** Protege los rangos de eje de manera que no se modifiquen como respuesta a cambios de datos o de filtrado.
...
**Sintaxis:** obj = Scatterplot Matrix(...Matrix Format( "Triangular inferior"|"Triangular superior"|"Cuadrado" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj &lt;&lt; Nonpar Density( state=0|1 )
...
**Descripción:** Esparce los puntos al desplazarlos ligeramente en la matriz de gráficos de dispersión. "Automático" de forma predeterminada.
...
**Sintaxis:** obj &lt;&lt; Shaded Ellipses( state=0|1 )
...
**Sintaxis:** obj = Scatterplot Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
