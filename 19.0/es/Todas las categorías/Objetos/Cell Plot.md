...
**Sintaxis:** obj &lt;&lt; Arrange Plots( number across )

**Descripción:** Organiza los gráficos horizontalmente. Solo está disponible cuando hay una variable X.
...
**Sintaxis:** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) )&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Descripción:** Muestra u oculta la leyenda añadida al final del gráfico.
...
**Sintaxis:** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) )&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
