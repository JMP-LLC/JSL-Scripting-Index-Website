...
**Syntaxe :** obj &lt;&lt; Arrange Plots( number across )

**Description :** Réorganise les graphiques horizontalement. Uniquement disponible lorsqu&apos;une variable X est présente.
...
**Syntaxe :** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) )&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Description :** Affiche ou masque la légende ajoutée à la fin du graphique.
...
**Syntaxe :** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) )&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
