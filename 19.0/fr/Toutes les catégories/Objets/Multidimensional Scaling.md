...
**Syntaxe :** obj &lt;&lt; "3D Plot"n( 1 )

**Description :** Affiche ou masque un graphique 3D qui requiert un minimum de trois dimensions.
...
**Syntaxe :** Data Format( Distance Matrix | Attribute List )&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Spécifie le format de la table de données, qui peut être une matrice de distance ou une liste des attributs.
...
**Description :** Reflète le graphique de l&apos;échelonnement multidimensionnel sur l&apos;axe horizontal.
...
**Description :** Reflète le graphique de l&apos;échelonnement multidimensionnel sur l&apos;axe vertical.
...
**Description :** Affiche ou masque le graphique de l&apos;échelonnement multidimensionnel. Actif par défaut.
...
**Description :** Enregistre, dans la table de données, les coordonnées dimensionnelles pour les variables de réponse.
...
**Syntaxe :** obj &lt;&lt; Save Proximity

**Description :** Enregistre la matrice de proximité dans la table de données. Uniquement disponible lorsque le format de données est Liste des attributs.
...
obj = dt << Multidimensional Scaling(
	Y(
		:Top incisors, :Bottom incisors, :Top canines, :Bottom canines,
		:Top premolars, :Bottom premolars, :Top molars, :Bottom molars
	),
...
**Syntaxe :** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Spécifie les dimensions pour l&apos;échelonnement multidimensionnel. "2" par défaut.
...
**Syntaxe :** obj &lt;&lt; Shepard Diagram( state=0|1 )

**Description :** Affiche ou masque le diagramme de Shepard, qui représente graphiquement la proximité observée par rapport à la proximité prévue. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; Show Coordinates( state=0|1 )

**Description :** Affiche ou masque les coordonnées dimensionnelles pour les variables de réponse.
...
**Syntaxe :** obj &lt;&lt; Show Proximity( state=0|1 )

**Description :** Affiche ou masque une table des valeurs de la proximité observée et prévue entre les variables de réponse.
...
**Syntaxe :** Transformation( None | Ratio | Interval | Ordinal )&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Spécifie le choix de transformation pour l&apos;analyse de l&apos;échelonnement multidimensionnel.
...
**Syntaxe :** obj &lt;&lt; Waern Links( Smallest Portion | Largest Portion, portion, visible )

**Description :** Spécifie les liens Waern pour le graphique de l&apos;échelonnement multidimensionnel (MDS). Le premier argument spécifie si les liens doivent être dessinés pour la partie la plus petite ou la plus grande. Le deuxième argument spécifie la valeur de la partie. Le troisième argument est un argument Booléen qui spécifie si les commandes du lien Waern sont visibles.
...
**Syntaxe :** obj = Multidimensional Scaling(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
