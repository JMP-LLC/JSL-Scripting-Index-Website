...
**Syntaxe :** obj &lt;&lt; Grouping( columns )

**Description :** Créez des groupes de graphiques pour les lignes avec la même valeur dans cette colonne.
...
**Syntaxe :** obj &lt;&lt; Response( columns )

**Description :** Colonnes qui auront toutes les valeurs dans chaque ligne connectées à une seule ligne.
...
**Syntaxe :** Parallel Plot( Y( columns ), Center at Zero( state=0|1 ) )&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Centre l&apos;ensemble des graphiques sur l&apos;origine.
...
**Syntaxe :** obj &lt;&lt; Reversed( columns )

**Description :** Identifie les variables Y dont les axes sont inversés.
...
**Syntaxe :** Parallel Plot( Y( columns ), Scale Uniformly( state=0|1 ) )&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Fixe une échelle uniforme pour l&apos;ensemble des graphiques.

```jsl

dt = Open( "$SAMPLE_DATA/Dogs.jmp" );
obj = dt << Parallel Plot(
...
**Syntaxe :** obj &lt;&lt; Show Reversing Checkboxes( state=0|1 )

**Description :** Affiche ou masque les cases à cocher permettant d&apos;inverser les axes pour les différentes variables Y.
...
**Syntaxe :** obj = Parallel Plot(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
