...
**Syntaxe :** obj &lt;&lt; Categories( column(s) )
...
**Syntaxe :** Treemap( Categories( column ), &lt;Sizes( column )&gt;, &lt;Coloring( column )&gt; )

**Description :** Alternative au constructeur de graphiques pour créer une mosaïque rectangulaire pour une variable nominale ou ordinale. Les catégories de mosaïque sont proportionnelles en taille aux dénombrements des catégories au sein d&apos;une variable sélectionnée.
...
**Syntaxe :** obj &lt;&lt; Change Color Column( column )

**Description :** Change la colonne utilisée pour la mise en couleur des catégories.
...
**Syntaxe :** obj &lt;&lt; Color Range( low, high )

**Description :** Définit l’étendue du gradient de couleur. Les valeurs des bornes par défaut sont : borne inférieure=min et borne supérieure=max de la colonne de coloriage.
...
**Description :** Définit le thème de couleurs utilisé pour l&apos;arborescence (tree map).
...
**Syntaxe :** obj = Treemap(...Layout( "Divisions"|"Arranger en carrés"|"Mixte" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

### Legend

**Syntaxe :** obj &lt;&lt; Legend( state=0|1 )

**Description :** Affiche ou masque une légende montrant les valeurs de la colonne couleur mappées sur les couleurs réelles.
...
**Syntaxe :** obj = Treemap(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
