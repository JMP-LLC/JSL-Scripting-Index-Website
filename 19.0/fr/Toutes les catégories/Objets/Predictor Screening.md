...
**Syntaxe :** obj = Predictor Screening(...&lt;By( column(s) )&gt;...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Predictor Screening(...Response( column(s) )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Predictor Screening(...X( column(s) )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Predictor Screening(...Y( column(s) )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Predictor Screening(...Number Trees( number=100 )...)

**Description :** Spécifie le nombre d&apos;arbres de décision dans le modèle de Forêt aléatoire. "100" par défaut.
...
**Syntaxe :** obj &lt;&lt; Save Results

**Description :** Crée une nouvelle table de données contenant le tableau de classement des prédicteurs du rapport.
...
**Syntaxe :** obj = Predictor Screening(...Set Random Seed( number )...)

**Description :** Définit la graine aléatoire pour les valeurs de démarrage utilisées dans les procédures d&apos;ajustement.
...
**Syntaxe :** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
