...
**Description :** Crée une colonne avec une seule en-tête sur une ou plusieurs colonnes enfants dans une boîte de tableaux.
...
New Window( "Example",
	col = Number Col Box( "Random Numbers",
		{Random Uniform(), Random Uniform() * 10, Random Uniform() *
		100, Random Uniform() * 1000, Random Uniform() * 10000}
	)
);
...
New Window( "Smart Shrinking",
	Table Box(
		String Col Edit Box(
			"Regular",
			{"I change my size every time you edit"}
		),
...
New Window( "Example",
	scb = String Col Box( "Associated Text",
		{"a", "b", "c", "d", "e"}
	)
);
