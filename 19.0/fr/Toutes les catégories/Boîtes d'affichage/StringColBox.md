...
**Description :** Renvoie une boîte d’affichage affichant les chaînes dans une colonne.
...
**Syntaxe :** "left"|"right"|"center" = obj &lt;&lt; Get Justify

**Description :** Obtient la justification horizontale de la colonne
...
**Syntaxe :** obj &lt;&lt; Numerical Order( &lt;0 | 1&gt; )

**Description :** Le texte contenant des nombres sera trié par ordre numérique.
...
**Syntaxe :** obj &lt;&lt; Set Allow Text Search( &lt;0 | 1&gt; )

**Description :** Dans les boîtes de tableaux avec des lignes sélectionnables, cette commande permet à une colonne de chaîne dotée d&apos;un focus de répondre à une commande clavier demandant de changer la ligne sélectionnée.
...
**Syntaxe :** obj &lt;&lt; Set Justify( "left","right","center" )

**Description :** Définit la justification horizontale de la colonne
