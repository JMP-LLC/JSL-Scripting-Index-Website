...
**Syntaxe :** obj &lt;&lt; Append( "string" | {"string", ...} )

**Description :** Ajoute la nouvelle chaîne ou liste de chaînes à la dernière position.
...
**Description :** Efface la sélection actuelle ; les éléments sont encore présents mais ne sont plus sélectionnés.
...
**Syntaxe :** "bool" = obj &lt;&lt; Get Case Sensitive

**Description :** Renvoie Vrai si les éléments ajoutés à la liste peuvent correspondre, à l&apos;exception de la casse
...
**Syntaxe :** obj &lt;&lt; Get Data Type

**Description :** renvoie le type de données d’une liste de colonnes
...
**Syntaxe :** obj &lt;&lt; Item Padding( sides );sides = obj &lt;&lt; Get Item Padding

**Description :** Le remplissage ajoute un espace entre le texte d&apos;élément de case de liste
...
**Syntaxe :** list = obj &lt;&lt; Get Items( &lt;"Column Reference"&gt;)

**Description :** Renvoie une liste de tous les éléments.
...
**Syntaxe :** obj &lt;&lt; Get Max Items

**Description :** Renvoie le nombre maximum d&apos;éléments admis dans la liste.
...
**Syntaxe :** max = obj &lt;&lt; Get Max Selected

**Description :** Renvoie le nombre maximum d&apos;éléments pouvant être sélectionnés dans la liste.
...
**Syntaxe :** obj &lt;&lt; Get Min Items

**Description :** Renvoie le nombre minimum d&apos;éléments requis pour la liste.
...
**Syntaxe :** obj &lt;&lt; Get Modeling Type

**Description :** Renvoie une liste des types de modélisation pour une zone de liste de colonne.
...
**Syntaxe :** nlines = obj &lt;&lt; Get N Lines

**Description :** Renvoie le nombre de lignes visibles dans la liste.
...
**Syntaxe :** list = obj &lt;&lt; Get Selected(&lt;"Column Reference"&gt;)

**Description :** Renvoie une liste des éléments sélectionnés.
...
**Syntaxe :** indices = obj &lt;&lt; Get Selected Indices

**Description :** Renvoie une liste de tous les indices sélectionnés.
...
**Syntaxe :** obj &lt;&lt; Insert( "string",index )

**Description :** Ajoute à la liste l’élément ou la liste d’éléments spécifiés après l’index index spécifié.
...
**Syntaxe :** obj &lt;&lt; Locate Item

**JMP Version ajoutée :** 14

### Menus Enabled

**Syntaxe :** obj &lt;&lt; Menus Enabled( state=0|1 )

**Description :** Active ou désactive l’affichage du menu Boîte de listes lorsque vous cliquez à l’aide du bouton droit.
...
**Syntaxe :** obj &lt;&lt; Modeling Type( {"Any","Continuous","Nominal","Ordinal","Multiple Response","Unstructured Text","Vector","None","Row State"}) &gt; )

**Description :** Définit les types de modélisation de colonne acceptés pour une liste de colonne. La valeur par défaut de "Any" autorisera toute colonne avec un type de modélisation classique ("Continuous", "Nominal", "Ordinal").
...
**Syntaxe :** obj &lt;&lt; On Change( script )

**Description :** Exécute le script lorsque la sélection de la liste change.
...
**Description :** Supprime tous les éléments.
...
**Syntaxe :** obj &lt;&lt; Remove Item( index )

**Description :** Supprime l’élément spécifié à l’indice index.
...
**Syntaxe :** obj &lt;&lt; Remove Selected

**Description :** Supprime les éléments sélectionnés.
...
**Syntaxe :** obj &lt;&lt; Set Case Sensitive( "bool" )

**Description :** Détermine si les éléments ajoutés à la zone de liste doivent être comparés avec les éléments existants en respectant ou non la casse
...
**Syntaxe :** obj &lt;&lt; Set Data Type( "Toutes"|"Numérique"|"Caractère" )

**Description :** permet de définir le type de colonnes qu’une liste de colonnes acceptera. Les valeurs possibles sont : Toutes, Caractère ou Numérique
...
**Syntaxe :** obj &lt;&lt; Set Function( Function( {thisBox}, &lt;script&gt; ) )

**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsqu&apos;un ou plusieurs éléments sont sélectionnés.
...
**Syntaxe :** obj &lt;&lt; Set Items( list )

**Description :** Définit la liste de tous les éléments.
...
**Syntaxe :** obj &lt;&lt; Set Max Items( number )

**Description :** Définit le nombre maximum d&apos;éléments permis pour la liste.
...
**Syntaxe :** obj &lt;&lt; Set Max Selected( max )

**Description :** Définir le nombre maximum d&apos;éléments qui peuvent être sélectionnés dans la liste.
...
**Syntaxe :** obj &lt;&lt; Set Min Items( number )

**Description :** Définit le nombre minimum d&apos;éléments requis pour la liste.
...
**Syntaxe :** obj &lt;&lt; Set N Lines( nlines )

**Description :** Définir le nombre de lignes visibles dans la liste.
...
**Syntaxe :** obj &lt;&lt; Set Selected( index|{index1, index2, ...}|"All",&lt;selected&gt;,&lt;Run Script(0|1)&gt; )

**Description :** Définit l&apos;élément à index comme élément à sélectionner (1) ou désélectionner (0). Par défaut, ce message exécute le script pour sa ListBoxBox. Utiliser RunScript(0) pour supprimer l&apos;exécution du script. Utiliser l&apos;option RunScript requiert également de spécifier l&apos;argument selected, car les arguments sont positionnels.
...
**Syntaxe :** obj &lt;&lt; Set Size( width,height )

**Description :** Définit la largeur et la hauteur de la boîte de listes.
...
//This message applies to many display box objects
New Window( "Example",
	ex = Button Box( "Hover Me", Print( "Pressed." ) )
);
...
**Syntaxe :** obj &lt;&lt; Set Tips( Liste des conseils )

**Description :** Définit les conseils relatifs aux éléments contenus dans la case de liste.
...
tree << Set Stretch( "Window", "Window" ) <<
Set Max Size( 10000, 10000 );
scroll << Set Stretch( "Window", "Window" ) <<
Set Max Size( 10000, 10000 );
Wait( 2 );
