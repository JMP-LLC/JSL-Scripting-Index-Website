...
**構文:** obj = Attribute Chart(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = Attribute Chart(...&lt;By( column(s) )&gt;...)
...
**構文:** obj = Attribute Chart(...&lt;Freq( column )&gt;...)
...
**構文:** obj = Attribute Chart(...Grouping( column(s) )...)

**説明:** 判定をグループ化する分類列を指定する(通常は部品)。
...
**構文:** obj = Attribute Chart(...Response( column(s) )...)

**説明:** 各判定者による判定結果の列を指定する。
...
**構文:** obj = Attribute Chart(...&lt;Standard( column )&gt;...)

**説明:** 基準値（参照値）が含まれている列を指定する。基準値とは，測定対象の部品(グループ変数)の真値である。
...
**構文:** obj = Attribute Chart(...X( column(s) )...)
...
**構文:** obj = Attribute Chart(...Y( column(s) )...)
...
**構文:** obj &lt;&lt; Agreement by Rater Confid Intervals( state=0|1 )

**説明:** 有効性のチャートにおいて、セルの一致性についての信頼区間の表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj &lt;&lt; Attribute Gauge Charts( state=0|1 )

**説明:** 計数値用ゲージチャートの表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj &lt;&lt; Connect Agreement Points( state=0|1 )

**説明:** 計数値用ゲージチャートと有効性グラフの両方において、セルグループ内のセル平均をつなぐ折れ線の表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj &lt;&lt; Connect Effectiveness Points( state=0|1 )

**説明:** 計数値用ゲージチャートと有効性チャートの両方において、判定者による判定と基準との一致率を示す赤い線の表示/非表示を切り替える。
...
**構文:** obj &lt;&lt; Effectiveness Report( state=0|1 )

**説明:** 一致度数・有効性・誤分類・適合性を含むレポートの表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj &lt;&lt; Effectiveness by Rater Confid Intervals( state=0|1 )

**説明:** 有効性グラフにおいて、セルごとの有効性の信頼区間の表示/非表示を切り替える。
...
**構文:** obj &lt;&lt; Show Agreement Grand Mean( state=0|1 )

**説明:** 計数値用ゲージチャートにおいて、全体の一致性を示す線の表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj &lt;&lt; Show Agreement Group Means( state=0|1 )

**説明:** 計数値用ゲージチャートにおいて、グループ内の一致率を示す線の表示/非表示を切り替える。複数のグループ変数が必要。
...
**構文:** obj &lt;&lt; Show Agreement Points( state=0|1 )

**説明:** 計数値用ゲージチャートと有効性グラフの両方において、一致性の点の表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj &lt;&lt; Show Effectiveness Points( state=0|1 )

**説明:** 計数値用ゲージチャートと有効性グラフの両方において、有効性の点の表示/非表示を切り替える。
...
**構文:** obj &lt;&lt; Calculate Escape Rate( state=0|1 )

**説明:** 指定の不適合品率に基づく流出率のレポートの表示/非表示を切り替える。
...
**構文:** obj &lt;&lt; Change Conforming Category( state=0|1 )

**説明:** 基準において適合品であることを示すデータ値を指定する。
...
**構文:** Attribute Chart( Probability of Nonconformance( probability ) )

**説明:** 流出率の計算に使用する不適合確率を設定する。
