...
**構文:** obj = Distance Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** Permutations ( number = 1000 )

**説明:** Number of Permutations to Calculate PERMANOVA デフォルトの値は"1000"。
...
**構文:** Pricpal Components ( number = 2 )

**説明:** Number of Principal Components デフォルトの値は"2"。
