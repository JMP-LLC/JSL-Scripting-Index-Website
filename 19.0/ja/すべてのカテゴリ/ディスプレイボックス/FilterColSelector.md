...
**構文:** obj &lt;&lt; Character( (0 | 1) )

**説明:** リストに文字タイプの列を含むかどうかを指定する。
...
**構文:** obj &lt;&lt; Continuous( (0 | 1) )

**説明:** リストに連続尺度の列を含むかどうかを指定する。
...
**構文:** obj &lt;&lt; Expression( (0 | 1) )

**説明:** データタイプが「式」の列をリストに含めるかどうかを指定する。
...
**構文:** obj &lt;&lt; Match case( (0 | 1) )

**説明:** 列の検索で大文字と小文字を区別するかどうかを指定する。
...
**構文:** obj &lt;&lt; Multiple Response( (0 | 1) )

**説明:** リストに多重応答の列を含むかどうかを指定する。
...
**構文:** obj &lt;&lt; Name contains( Name contains( s ) )

**説明:** 名前が指定のテキストを含む列だけをリストする。
...
**構文:** obj &lt;&lt; Name ends with( Name ends with ( text ) )

**説明:** 名前が指定のテキストで終わる列だけをリストする。
...
**構文:** obj &lt;&lt; Name starts with( Name starts with ( text ) )

**説明:** 名前が指定のテキストで始まる列だけをリストする。
...
**構文:** obj &lt;&lt; Set Selected( index,&lt;selected&gt; )

**説明:** indexの項目を選択状態(1)または非選択状態(0)に設定する。
...
**構文:** obj &lt;&lt; Unstructured Text( (0 | 1) )

**説明:** リストに非構造化テキストの列を含むかどうかを指定する。
