...
**Beschreibung:** Gibt die Einstellung für automatischen Bildlauf zurück.
...
**Beschreibung:** Gibt die aktuelle Einstellung zum Begrenzen des Inhalts des Bildlauffelds beim Drucken zurück.
...
**Beschreibung:** Gibt die Hintergrundfarbe zurück.

### Get Height

**Syntax:** pixels = obj &lt;&lt; Get Height

**Beschreibung:** Gibt die Höhe des Bildlaufbereichs zurück.

### Get Scroll Extents

**Syntax:** {h pixels,v pixels} = obj &lt;&lt; Get Scroll Extents

**Beschreibung:** Gibt die maximalen Positionen für horizontalen und vertikalen Bildlauf zurück.
...
**Beschreibung:** Gibt die aktuellen horizontalen und vertikalen Positionen des Bildlaufs zurück.
...
**Beschreibung:** Gibt die Flags für horizontalen und vertikalen Bildlauf zurück. Ist der Bildlauf in einer vorgegebenen Richtung deaktiviert, verhält sich das Scroll Box in dieser Richtung wie ein regulärer Container.
...
**Beschreibung:** Gibt die aktuelle Einstellung zum Anzeigen der Bildlaufleisten zurück, wenn diese leer sind.
...
**Beschreibung:** Gibt die Breite des Bildlaufbereichs zurück.

### Height

**Syntax:** obj &lt;&lt; Height( pixels )

**Beschreibung:** Legt die Höhe des Bildlaufbereichs fest.
...
**Beschreibung:** Bildlaufparameter basierend auf den Streckeigenschaften des untergeordneten Felds automatisch festlegen. Die Bildlaufleiste in jeder Richtung ist aktiv, wenn das Feld in der Richtung nicht streckbar ist.
...
**Beschreibung:** Legt die vorgegebene Farbe für den Hintergrund des Scroll-Felds fest.
...
**Beschreibung:** Der Inhalt des Bildlauffelds wird beim Drucken auf die Größe des Bildlauffelds begrenzt oder es wird der gesamte Inhalt angezeigt. Standardmäßig ist die Begrenzung ausgeschaltet.
...
**Beschreibung:** Legt die horizontalen und vertikalen Positionen des Bildlaufs fest. Die Werte können in Pixel oder durch die Schlüsselwörter „Start“ und „End“ angegeben werden.
...
**Beschreibung:** Legt die Flags für horizontalen und vertikalen Bildlauf fest. Ist der Bildlauf in einer vorgegebenen Richtung deaktiviert, verhält sich das Scroll Box in dieser Richtung wie ein regulärer Container.
...
**Beschreibung:** Bildaufleisten anzeigen, auch wenn sie leer sind.
...
**Beschreibung:** Legt die Breite des Bildlaufbereichs fest.
...
**Beschreibung:** Gibt ein Anzeigefeld zurück, das unten und rechts eine Bildlaufleiste anordnet, wenn der Inhalt größer als die Größe des ScrollBox ist.
