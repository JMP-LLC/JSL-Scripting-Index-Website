...
**Beschreibung:** Ruft die horizontale Ausrichtung für die Spalte ab
...
**Beschreibung:** Text mit Zahlen wird in numerischer Reihenfolge sortiert.
...
**Beschreibung:** In Tabellenfeldern mit auswählbaren Zeilen, ermöglicht dieser Befehl, dass eine Zeichenkettenspalte, die im Fokus ist, auf Tastatureingaben reagiert, damit die ausgewählte Zeile geändert werden kann.
...
**Beschreibung:** Legt die horizontale Ausrichtung für die Spalte fest
...
**Beschreibung:** Gibt ein Anzeigefeld mit Zeichenketten in einer Spalte zurück.
