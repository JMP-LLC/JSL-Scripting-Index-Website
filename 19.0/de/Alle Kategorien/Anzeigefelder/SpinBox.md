...
**Beschreibung:** Simuliert einen Klick auf die Schaltfläche und führt so das zugeordnete Skript aus.
...
**Beschreibung:** Simuliert einen Klick auf den Abwärtspfeil und führt so das zugeordnete Skript aus.
...
**Beschreibung:** Simuliert einen Klick auf den Aufwärtspfeil und führt so das zugeordnete Skript aus.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn die Schaltflächen des Drehfelds betätigt werden. [increment] ist das für das Zahlenfeld festgelegte Inkrement.
...
**Beschreibung:** Gibt ein Anzeigefeld zurück, um eine Schaltfläche mit Bedienelementen für Aufwärts und Abwärts anzuzeigen. Das Argument script wird mit einem Argument aufgerufen, das die Richtung des angeklickten Pfeils angibt (negativ ist abwärts, positiv ist aufwärts). Die Größe 1 kennzeichnet einen einzelnen Klick. Größere Werte können verwendet werden, um eine wiederholte Aktion kenntlich zu machen.
