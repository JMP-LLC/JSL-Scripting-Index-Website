...
**Beschreibung:** Gibt die Anzahl von Entscheidungsbäumen im Bootstrap-Forest-Modell an. Standardmäßig „100“.
...
**Beschreibung:** Erstellt eine neue Datentabelle, die die Prädiktorenrangliste aus dem Bericht enthält.
...
**Beschreibung:** Legt den Startwert für die Startwerte fest, die in den Anpassungen verwendet werden.
...
**Syntax:** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Predictor Screening(...&lt;By( column(s) )&gt;...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Predictor Screening(...Response( column(s) )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Predictor Screening(...X( column(s) )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Predictor Screening(...Y( column(s) )...)&lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
