...
**Sintassi:** obj = Partial Least Squares(...Centering( state=0|1)...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Partial Least Squares(...Imputation Method( "Media"|"EM" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Partial Least Squares(...Impute Missing Data( state=0|1 )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Partial Least Squares(...Max Iterations( number=1 )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Partial Least Squares(...Scaling( state=0|1)...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Partial Least Squares(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
