...
**Sintassi:** obj = Manage Limits( Process Variables( columns), Grouping( columns) )
...
**Sintassi:** obj = Manage Limits( Process Variables( columns) )

**Descrizione:** Specifica le colonne continue dei processi.
...
**Descrizione:** Colora le celle della tabella dei dati che corrispondono alle osservazioni che non rientrano nei limiti di specifica. Le celle per le osservazioni che sono al di sotto del limite di specifica inferiore sono di colore rosso chiaro. Le celle per le osservazioni che superano il limite di specifica superiore sono di colore azzurro.
...
**Sintassi:** obj &lt;&lt; Load from Limits Table

**Descrizione:** Carica i dati dei limiti da una tabella di dati.
...
**Sintassi:** obj &lt;&lt; Round Decimals

**Descrizione:** Arrotonda tutti i valori numerici a un numero di posizioni decimali specificato.
...
**Sintassi:** obj &lt;&lt; Save to Column Properties

**Descrizione:** Salva i dati dei limiti come proprietà della colonna.
...
**Sintassi:** obj &lt;&lt; Save to Column Properties in Split Table( &lt; Remaining Columns ( Drop All | Keep All | Split All )&gt; )

**Descrizione:** Salva i dati dei limiti come proprietà della colonna in una nuova tabella di dati suddivisa per le variabili di raggruppamento.
...
**Sintassi:** obj &lt;&lt; Save to Tall Limits Table

**Descrizione:** Crea una nuova tabella di dati verticale che contiene tutti i dati dei limiti per ogni colonna.
...
**Sintassi:** obj &lt;&lt; Save to Wide Limits Table

**Descrizione:** Crea una nuova tabella di dati orizzontale che contiene tutti i dati dei limiti per ogni colonna.
...
**Sintassi:** obj &lt;&lt; Show Limits All

**Descrizione:** Seleziona le caselle di controllo &apos;Mostra limiti&apos; per tutti gli elementi.
...
**Sintassi:** obj = Manage Limits(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
