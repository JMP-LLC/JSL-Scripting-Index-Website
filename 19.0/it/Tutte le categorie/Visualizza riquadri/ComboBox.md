...
**Descrizione:** Restituisce un riquadro di visualizzazione che mostra un elenco a discesa di elementi di testo. Ogni elemento nella casella combinata può avere una descrizione facoltativa che è specificata come stringa all&apos;interno di parentesi dopo la stringa di testo dell&apos;elemento. L&apos;argomento facoltativo Modificabile permette di modificare il testo della casella combinata.
...
**Sintassi:** obj &lt;&lt; Append Item( string )

**Descrizione:** Aggiunge una nuova stringa alla fine dell&apos;elenco di elementi della casella combinata
...
**Descrizione:** Imposta l&apos;elemento che si trova in index come selezionabile (1) o non selezionabile (0).
...
**Sintassi:** index = obj &lt;&lt; Get

**Descrizione:** Restituisce l&apos;indice dell&apos;elemento selezionato.
...
**Descrizione:** Restituisce una stringa dell&apos;elemento selezionato.
...
**Sintassi:** obj &lt;&lt; Insert Item( string, &lt;position&gt; )

**Descrizione:** Inserisce una nuova stringa al termine dell&apos;elenco o nel punto indicato dalla position opzionale.
...
**Descrizione:** Restituisce se l&apos;elemento che si trova in index è selezionabile (1) o non selezionabile (0).
...
**Sintassi:** obj &lt;&lt; Set( index,&lt;run script(0|1)&gt; )

**Descrizione:** Imposta una casella combinata sull&apos;elemento che si trova all&apos;indice specificato.
...
**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando viene selezionato un nuovo elemento della casella combinata.
