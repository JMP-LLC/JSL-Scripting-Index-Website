...
**Descrizione:** Restituisce un riquadro di visualizzazione che mostra un albero gerarchico. Di default può essere selezionato un singolo elemento. Se è specificata la selezione multipla, è possibile selezionare più di un elemento dell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Add Root( node )

**Descrizione:** Aggiungi un nodo principale all&apos;albero
...
**Sintassi:** obj &lt;&lt; Collapse( node )

**Descrizione:** Comprime il nodo nell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Enable Item( node, 0|1 )

**Descrizione:** Attiva o disattiva il nodo nell&apos;albero. Imposta lo stato su 1 per attivare il nodo, su 0 per disattivarlo.
...
**Sintassi:** obj &lt;&lt; Expand( node )

**Descrizione:** Espande il nodo nell&apos;albero.
...
**Sintassi:** script = obj &lt;&lt; Get Context Menu Script

**Descrizione:** Restituisce lo script, la funzione o il metodo che viene eseguito quando l&apos;utente fa clic con il pulsante destro del mouse sull&apos;albero o su un nodo dell&apos;albero.
...
**Sintassi:** script = obj &lt;&lt; Get Node Double Click Script

**Descrizione:** Restituisce lo script, la funzione o il metodo che viene eseguito quando si fa doppio clic su un nodo.
...
**Sintassi:** obj &lt;&lt; Get Node Select Script( script|Function( {thistree, thisnode}, &lt;script&gt; ) )

**Descrizione:** Restituisce lo script, la funzione o il metodo che viene eseguito quando cambia la selezione nell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Get Roots

**Descrizione:** Ottiene un elenco dei nodi principali dell&apos;albero. Se non sono presenti nodi principali, viene restituito un elenco vuoto.
...
**Descrizione:** Per un albero a selezione singola, ottiene il nodo dell&apos;albero selezionato oppure Vuoto se non è selezionato alcun nodo. Per un albero a selezione multipla, ottiene un elenco dei nodi selezionati o Vuoto se non è selezionato alcun nodo.
...
**Sintassi:** collapsed = obj &lt;&lt; Is Collapsed( node )

**Descrizione:** Restituisce vero se il nodo è compresso nell&apos;albero.
...
**Sintassi:** expanded = obj &lt;&lt; Is Expanded( node )

**Descrizione:** Restituisce vero se il nodo è espanso nell&apos;albero.
...
**Sintassi:** enabled = obj &lt;&lt; Is Item Enabled( node )

**Descrizione:** Restituisce vero se il nodo è attivato nell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Is Multiselect

**Descrizione:** Restituisce 1 se l&apos;albero è a selezione multipla. Restituisce 0 se l&apos;albero è a selezione singola.
...
**Sintassi:** obj &lt;&lt; Is Root( node )

**Descrizione:** Restituisce vero se il nodo è un nodo principale dell&apos;albero.
...
**Sintassi:** selected = obj &lt;&lt; Is Selected( node )

**Descrizione:** Restituisce vero se il nodo è selezionato nell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Make Visible( node )

**Descrizione:** Rende visibile il nodo all&apos;interno dell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Remove Root( node )

**Descrizione:** Rimuove un nodo principale dall&apos;albero
...
**Sintassi:** obj &lt;&lt; Set Context Menu Script( Function( {thistree, thisnode}, &lt;script&gt; ) )

**Descrizione:** Imposta lo script, la funzione o il metodo da eseguire quando l&apos;utente fa clic con il pulsante destro del mouse sull&apos;albero o su un nodo dell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Set Multiselect( state=0|1 )

**Descrizione:** Imposta l&apos;albero come a selezione singola (0) o a selezione multipla (1).
...
**Sintassi:** obj &lt;&lt; Set Node Double Click Script( script )

**Descrizione:** Imposta lo script, la funzione o il metodo da eseguire quando si fa doppio clic su un nodo.
...
**Sintassi:** obj &lt;&lt; Set Node Select Script( script|Function( {thistree, thisnode}, &lt;script&gt; ) )

**Descrizione:** Imposta l&apos;esecuzione dello script, della funzione o del metodo che viene eseguito quando cambia la selezione nell&apos;albero. Viene passato allo script il valore vuoto se la selezione è stata cancellata
...
**Sintassi:** obj &lt;&lt; Set Roots( roots )

**Descrizione:** Imposta l&apos;elenco dei nodi principali visualizzati nell&apos;albero.
...
**Sintassi:** obj &lt;&lt; Set Selected( node|{nodes}, &lt;0|1&gt; )

**Descrizione:** Seleziona il nodo dell&apos;albero specificato nel riquadro di visualizzazione dell&apos;albero. Se si utilizza un elenco di nodi dell&apos;albero, gli alberi a selezione multipla selezioneranno tutti i nodi dell&apos;elenco. Se si utilizza un elenco di nodi dell&apos;albero, gli alberi a selezione singola selezioneranno il primo nodo dell&apos;elenco.
...
**Descrizione:** Imposta la larghezza e l&apos;altezza del riquadro.
