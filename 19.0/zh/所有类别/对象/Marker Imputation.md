...
**语法:** obj = Marker Imputation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Imputation(...Imputation Value( number=0 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Imputation(...Method( "LD-kNN"|"HWE 关闭"|"HWE 打开"|"随机"|"指定"="LD-kNN" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定四种缺失标记插补方法中的一种。 默认为“LD-kNN”。
...
**语法:** obj = Marker Imputation(...Nearest Markers( number=15 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** Specifies the number of neighbor markers. 默认为“15”。
...
**语法:** obj = Marker Imputation(...Nearest Samples( number=15 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** Specifies the number of neighbor samples. 默认为“15”。
...
**语法:** obj = Marker Imputation(...Ploidy( number=2 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Imputation(...Set Random Seed( number=0 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Imputation(...Unthreaded( state=0|1 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
