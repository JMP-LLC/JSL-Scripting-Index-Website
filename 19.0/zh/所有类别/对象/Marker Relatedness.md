...
**语法:** obj = Marker Relatedness(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Relatedness(...Additive Type( "二倍体方法 1"|"二倍体方法 2"|"多倍体"="二倍体方法 1" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定加性基因组关系矩阵的估计方法。 默认为“二倍体方法 1”。
...
**语法:** obj = Marker Relatedness(...Clustering( state=0|1 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Relatedness(...Dominance Type( "二倍体方法 1"|"二倍体方法 2"|"多倍体"="二倍体方法 1" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定显性基因组关系矩阵的估计方法。 默认为“二倍体方法 1”。
...
**语法:** obj = Marker Relatedness(...Epistasis Type( "加性 - 加性"|"显性 - 加性"|"显性 - 显性"="加性 - 加性" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定要从标记计算的上位性基因组关系矩阵的类型。 默认为“加性 - 加性”。
...
**语法:** obj = Marker Relatedness(...Imputation Value( number=0 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Relatedness(...Kinship Type( "状态一致性"|"加性"|"显性"|"上位性"="状态一致性" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定要从标记计算的基因组关系矩阵的类型。 默认为“状态一致性”。
...
**语法:** obj &lt;&lt; Merge Kinship Table

**说明:** 将基因组关系矩阵表合并到原始数据表中。
...
**语法:** obj = Marker Relatedness(...Missing Marker Imputation Method( "HWE 关闭"|"HWE 打开"|"随机"|"指定"="HWE 关闭" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Relatedness(...Ploidy( number=2 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Relatedness(...Principal Components( state=0|1 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Save Square Kinship Table

**说明:** 将方形矩阵基因组关系保存到非堆叠格式的表中
...
**语法:** obj &lt;&lt; Save Stacked Kinship Table

**说明:** 将基因组关系矩阵的上三角部分保存到堆叠格式的表中
...
**语法:** obj = Marker Relatedness(...Set Random Seed( number=0 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj = Marker Relatedness(...Unthreaded( state=0|1 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
