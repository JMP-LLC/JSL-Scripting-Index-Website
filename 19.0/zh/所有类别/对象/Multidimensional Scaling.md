...
**语法:** obj = Multidimensional Scaling(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** Data Format( Distance Matrix | Attribute List )&lt;b&gt;启动窗口项: 是&lt;/b&gt;

**说明:** 指定数据表的格式，它可以是距离矩阵或特性列表。
...
**语法:** obj &lt;&lt; Save Proximity

**说明:** 将邻近性矩阵保存至数据表。仅当数据格式为“特性列表”时可用。
...
**语法:** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Shepard Diagram( state=0|1 )

**说明:** 显示或隐藏 Shepard 图，该图相对预测的邻近性绘制实际的邻近性。 默认开启。
...
**语法:** obj &lt;&lt; Show Coordinates( state=0|1 )
...
**语法:** obj &lt;&lt; Show Proximity( state=0|1 )

**说明:** 显示或隐藏响应变量之间的实际邻近性值和预测邻近性值的表。
...
**语法:** Transformation( None | Ratio | Interval | Ordinal )&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Waern Links( Smallest Portion | Largest Portion, portion, visible )

**说明:** 指定 MDS 图的 Waern 链接。第一个参数指定是应为最小部分还是最大部分绘制链接。第二个参数指定部分值。第三个参数是布尔值，用于指定 Waern 链接控件是否可见。
