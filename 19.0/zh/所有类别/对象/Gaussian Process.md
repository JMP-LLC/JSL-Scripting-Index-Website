...
**语法:** obj = Gaussian Process(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Block Size( number )

**说明:** 设置“快速 GASP”的每个区组中放置的观测数。
...
**语法:** obj &lt;&lt; Estimate Nugget( state=0|1 )

**说明:** 向估计过程中引入岭参数以平滑噪点，而不是使用完全插值法。
...
**语法:** obj &lt;&lt; Fast GASP( state=0|1 )

**说明:** “快速 GASP”选项允许拟合包含上千行的模型。
...
**语法:** obj &lt;&lt; Publish Variance Formula

**说明:** 生成方差公式并将其发布为“公式存储库”中的公式列脚本。
...
**语法:** obj &lt;&lt; Save Jackknife Predicted Values

**说明:** 在数据表的新列中保存 Jackknife 预测值。
...
**语法:** obj &lt;&lt; Set Correlation Function( structure=高斯 )

**说明:** 设置模型中使用的相关性结构。

高斯限定两个响应间的相关性为非零。

三次相关允许相距很远的点的相关性为零。 默认为“高斯”。
...
**语法:** obj &lt;&lt; Set Minimum Theta( number )

**说明:** 设置在拟合模型中使用的最小 Theta 值。
...
**语法:** obj &lt;&lt; Set Nugget( number )

**说明:** 将 Nugget 的大小设置为常数，该常数用作估算过程中的岭参数。
