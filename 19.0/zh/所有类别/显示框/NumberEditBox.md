...
**语法:** obj &lt;&lt; Get Exclude Maximum

**说明:** 若设置，则最大值会从有效数值范围中排除。
...
**语法:** obj &lt;&lt; Get Exclude Minimum

**说明:** 若设置，则最小值会从有效数值范围中排除。
...
**语法:** inc = obj &lt;&lt; Get Increment

**说明:** 返回用于步进控制的增量值。当编辑过程中按下向上或向下箭头键时，或者当发送 <<Increment 或 <<Decrement 消息时，将使用该值。
...
**语法:** function = obj &lt;&lt; Get Number Changed
...
**说明:** Returns the tooltip of the Number Box.
...
**说明:** 设置用于步进控制的增量值。当编辑过程中按下向上或向下箭头键时，或者当发送 <<Increment 或 <<Decrement 消息时，将使用该值。
...
**语法:** obj &lt;&lt; Set( numeric value,&lt;run script(0|1)&gt; )
...
**语法:** obj &lt;&lt; Set Exclude Maximum( state=0|1 )
...
**语法:** obj &lt;&lt; Set Exclude Minimum( state=0|1 )
...
**说明:** 设置控件的给定函数。当提交对“数字编辑框”的更改时会运行该函数的脚本。
...
**语法:** obj &lt;&lt; Set Increment( inc )

**说明:** 设置用于步进控制的增量值。当编辑过程中按下向上/向下键时，或者当发送 <<Increment 或 <<Decrement 消息时，将使用该值。
...
**语法:** obj &lt;&lt; Set Integer Only( state=0|1 )
...
**语法:** obj &lt;&lt; Set Number Changed( Function( {thisBox, value}, &lt;script&gt; ) )

**说明:** 设置每次更改数字时执行的函数。该回调在提交更改之前于编辑期间调用。若取消了编辑操作，则会生成另一个回调来提供原始值。
...
**语法:** obj &lt;&lt; Set Show Spin Box( state=0|1 )
...
**说明:** Sets the tooltip of the Number Box.
