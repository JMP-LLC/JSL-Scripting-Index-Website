...
**语法:** project &lt;&lt; Add Bookmarks( {&lt;File(path)&gt;, &lt;Folder( path, &lt;Expanded(boolean)&gt; )&gt;, &lt;Group(name, &lt;Expanded(boolean)&gt;, {contents}&gt;} )

**说明:** 将列表书签添加至项目。已保留现有书签。参数是书签项列表，每一项使用 File()、Folder() 或 Group() 指定。Group() 类型递归使用相同的语法接受文件、文件夹和组作为子项。
...
**语法:** project &lt;&lt; Extract("file")

**说明:** 从项目中提取特定文件。JMP Open() 命令不会从项目中提取不能被 JMP 直接打开的文件。例如 parquet 文件。
...
**语法:** project &lt;&lt; Extract All()

**说明:** 将项目中的所有文件提取到临时目录中。
...
**语法:** project &lt;&lt; Get Bookmarks()

**说明:** 返回项目中的书签列表。返回列表的格式与 Add Bookmarks() 和 Set Bookmarks() 使用的格式相同。
...
**语法:** project &lt;&lt; Get Layout()

**说明:** 返回项目的窗口布局。格式与 Set Layout() 使用的格式相同。
...
**语法:** project &lt;&lt; Is Extracted("file")

**说明:** 检查项目中的特定文件是否已提取到临时目录。JMP Open() 命令不会从项目中提取不能被 JMP 直接打开的文件。例如 parquet 文件。
...
**语法:** project &lt;&lt; Run Script(script)

**说明:** 运行项目上下文中的脚本。特别是该脚本打开的任何窗口将成为项目的一部分。该脚本将访问项目上下文中而非封装脚本中的 JSL 名称。
...
**语法:** project &lt;&lt; Save Project(&lt;path&gt;)

**说明:** 保存项目。可以指定路径和文件名以将项目保存至特定位置；若项目已保存，该参数是可选的。



必须保存项目中的未保存文档才能保存项目本身。
...
**语法:** project &lt;&lt; Set Bookmarks( {&lt;File(path)&gt;, &lt;Folder( path, &lt;Expanded(boolean)&gt; )&gt;, &lt;Group(name, &lt;Expanded(boolean)&gt;, {contents}&gt;} )

**说明:** 设置项目的书签。已删除现有书签。参数是书签项列表，每一项使用 File()、Folder() 或 Group() 指定。Group() 类型递归使用相同的语法接受文件、文件夹和组作为子项。
...
**语法:** project &lt;&lt; Show Bookmarks(boolean)
...
**语法:** project &lt;&lt; Show Contents(boolean)
...
**语法:** project &lt;&lt; Show Recent Files(boolean)

**说明:** 在项目中显示或隐藏“最近使用的文件”窗格。
...
**语法:** project &lt;&lt; Show Workspace(boolean)
