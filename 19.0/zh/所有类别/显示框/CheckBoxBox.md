...
**说明:** 返回一个显示框，在其中为输入的 list 中的每一项显示一个复选框。
...
**语法:** obj &lt;&lt; Enable Item( index, 0|1 )

**说明:** 将 index 处的项设置为启用状态 (1) 或禁用状态 (0)。
...
**语法:** 0|1 = obj &lt;&lt; Get( &lt;index&gt; )

**说明:** 为三状态复选框返回复选框的选中状态 (1)、未选中状态 (0) 或不确定状态 (empty())。
...
**语法:** indices = obj &lt;&lt; Get Selected Indices As Matrix

**说明:** Returns a list of all of the selected indices as a matrix
...
**语法:** obj &lt;&lt; Get Three State( &lt;Boolean&gt; )

**说明:** 创建三状态复选框。所有项均为 0、1 或 empty()。
...
**语法:** obj &lt;&lt; Set( &lt;index&gt;,&lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**说明:** 将复选框设置为选中状态 (1) 或未选中状态 (0)。使用 RunScript 选项还需要指定 Boolean 参数，因为参数与位置有关。
...
**语法:** obj &lt;&lt; Set All( &lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**说明:** 将所有复选框设置为选中状态 (1) 或未选中状态 (0)。使用 RunScript 选项还需要指定 Boolean 参数，因为参数与位置有关。
...
**语法:** obj &lt;&lt; Set Function( Function( {thisBox, index}, &lt;script&gt; ) )

**说明:** 设置控件的指定函数。当点击复选框时该函数的脚本运行。
...
**语法:** obj &lt;&lt; Set Three State( &lt;Boolean&gt; )
