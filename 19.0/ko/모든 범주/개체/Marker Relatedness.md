...
**구문:** obj = Marker Relatedness(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Relatedness(...Additive Type( "이배체 방법 1"|"이배체 방법 2"|"배수체"="이배체 방법 1" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 상가적 유전체 관계 행렬에 대한 추정 방법을 지정합니다. 기본값은 "이배체 방법 1"입니다.
...
**구문:** obj = Marker Relatedness(...Clustering( state=0|1 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 관계 행렬을 사용하여 군집화 보고서를 생성합니다.
...
**구문:** obj = Marker Relatedness(...Dominance Type( "이배체 방법 1"|"이배체 방법 2"|"배수체"="이배체 방법 1" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 우성 유전체 관계 행렬에 대한 추정 방법을 지정합니다. 기본값은 "이배체 방법 1"입니다.
...
**구문:** obj = Marker Relatedness(...Epistasis Type( "상가적 x 상가적"|"상가적 x 우성"|"우성 x 우성"="상가적 x 상가적" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 표지자에서 계산할 상위성 유전체 관계 행렬의 유형을 지정합니다. 기본값은 "상가적 x 상가적"입니다.
...
**구문:** obj = Marker Relatedness(...Imputation Value( number=0 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Relatedness(...Kinship Type( "상태별 동일성"|"상가적"|"우성"|"상위성"="상태별 동일성" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 표지자에서 계산할 유전체 관계 행렬의 유형을 지정합니다. 기본값은 "상태별 동일성"입니다.
...
**구문:** obj &lt;&lt; Merge Kinship Table

**설명:** 유전체 관계 행렬 테이블을 원래 데이터 테이블에 병합합니다.
...
**구문:** obj = Marker Relatedness(...Missing Marker Imputation Method( "HWE 해제"|"HWE 설정"|"랜덤"|"지정됨"="HWE 해제" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Relatedness(...Ploidy( number=2 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Relatedness(...Principal Components( state=0|1 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;

**설명:** 관계 행렬을 사용하여 주성분 보고서를 생성합니다.
...
**구문:** obj &lt;&lt; Save Square Kinship Table

**설명:** 유전체 관계 정방 행렬을 쌓이지 않은 형식의 테이블에 저장합니다.
...
**구문:** obj &lt;&lt; Save Stacked Kinship Table

**설명:** 유전체 관계 행렬의 상삼각 부분을 쌓인 형식의 테이블에 저장합니다.
...
**구문:** obj = Marker Relatedness(...Set Random Seed( number=0 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj = Marker Relatedness(...Unthreaded( state=0|1 )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
