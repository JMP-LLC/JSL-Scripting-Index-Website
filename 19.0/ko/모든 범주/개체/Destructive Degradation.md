...
**구문:** obj = Destructive Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;실행기 항목: 예&lt;/b&gt;
...
**구문:** obj &lt;&lt; Control( yTrans, timeTrans, distribution, path definition )

**설명:** 보고서의 경로 정의 패널에서 모형을 선택합니다. 선택한 모형은 열화 그림에도 표시됩니다.
...
**구문:** obj &lt;&lt; Model( yTrans, timeTrans, distribution, path definition )

**설명:** 모형 적합을 지정하고 적합 모형에 대한 보고서를 표시합니다.
...
**구문:** obj &lt;&lt; Shade( state=0|1 )

**설명:** 표시된 모형의 상한 및 하한을 표시하거나 숨깁니다. 또한 이 옵션은 경계 사이의 음영을 표시하거나 숨깁니다. 기본적으로 설정되어 있습니다.
...
**구문:** obj &lt;&lt; Shade Coverage( proportion )

**설명:** 음영 적용 범위를 늘리거나 줄이기 위한 비율을 지정합니다.
...
**구문:** obj &lt;&lt; Use Condition Temperature( "Celsius"|"Fahrenheit"|"Kelvin", temperature )

**설명:** 1차 운동 역학 모형에서 사용 조건(X0)의 척도 및 온도를 지정합니다.
