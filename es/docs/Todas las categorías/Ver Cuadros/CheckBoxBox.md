...
**Descripción:** Devuelve un cuadro de visualización que muestra una casilla de verificación para cada elemento de la list introducida.
...
**Sintaxis:** obj &lt;&lt; Enable Item( index, 0|1 )

**Descripción:** Establece habilitar (1) o deshabilitar (0) el elemento del index.
...
**Sintaxis:** 0|1 = obj &lt;&lt; Get( &lt;index&gt; )

**Descripción:** Devuelve si la casilla de selección se selecciona (1), deselecciona (0) o se deja indeterminada (empty()) para las casillas de selección con tres estados.
...
New Window( "Example",
	Check Box(
		{"a", "b", "c"},
		<<setfunction(/*anonymous function...*/
			Function(
...
**Descripción:** Devuelve una lista de cadenas de los elementos seleccionados.
...
**Sintaxis:** obj &lt;&lt; Get Selected Indices
...
### Get Selected Indices As Matrix

**Sintaxis:** indices = obj &lt;&lt; Get Selected Indices As Matrix

**Descripción:** Returns a list of all of the selected indices as a matrix
...
**Sintaxis:** obj &lt;&lt; Get Three State( &lt;Boolean&gt; )

**Descripción:** Crea una casilla de selección con tres estados. Todos los elementos son 0, 1 o empty().
...
**Sintaxis:** obj &lt;&lt; Set( &lt;index&gt;,&lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**Descripción:** Establece que la casilla de selección se seleccione (1) o deseleccione (0). Si se utiliza la opción RunScript, también es necesario especificar el argumento Boolean, puesto que los argumentos son posicionales.
...
**Sintaxis:** obj &lt;&lt; Set All( &lt;Boolean|empty()&gt;,&lt;Run Script(0|1)&gt; )

**Descripción:** Establece que todas las casillas de selección se seleccionen (1) o deseleccionen (0). Si se utiliza la opción RunScript, también es necesario especificar el argumento Boolean, puesto que los argumentos son posicionales.
...
**Sintaxis:** obj &lt;&lt; Set Function( Function( {thisBox, index}, &lt;script&gt; ) )

**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se hace clic en una casilla de selección.
	...
	cb = Check Box(
		...
		<<SetFunction(
			Function( {thisBox, index},
				...
				((thisBox << sib) << sib) <<
				settext( "Selected: " || Char( thisBox << Get Selected ) );
			)
		)
	),
	Text Box( "" ),
...
**Sintaxis:** obj &lt;&lt; Set Three State( &lt;Boolean&gt; )
