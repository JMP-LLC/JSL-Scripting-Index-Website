...
**Descripción:** Devuelve un cuadro de visualización etiquetado con string como título para representar los números.
...
**Sintaxis:** obj << Lower( list|matrix )
...
**Sintaxis:** obj << Set Values( matrix|list )

**Descripción:** Actualiza el PlotColBox a los valores proporcionados.
...
**Sintaxis:** obj << Significance( list|matrix )
...
**Sintaxis:** obj << Upper( list|matrix )
