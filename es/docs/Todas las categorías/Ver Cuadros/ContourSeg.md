...
**Sintaxis:** me = Contour Seg( Triangulation, [ levels ], &lt; zColor([colors], &lt;Cycle Colors|Interpolate Colors&gt;) &gt;, &lt;Fill|Fill Between|Fill Below|Fill Above&gt;, &lt; Transparency([] | t) &gt;

**Descripción:** Devuelve un segmento de visualización que representa los contornos de una triangulación. Es posible especificar colores opcionales para cada nivel como una matriz o una lista. La transparencia se puede especificar como número o como matriz.
...
**Sintaxis:** fill = obj &lt;&lt; Get Fill

**Descripción:** Devuelve la opción de relleno de los contornos.
...
**Sintaxis:** obj &lt;&lt; Set Fill( "Lines"|"Fill Above"|"Fill Between"|"Fill Below" )

**Descripción:** Establece la opción de relleno de los contornos.
