...
**Sintaxis:** LegendBox &lt;&lt; Get Item(Model ID, Model Index)

**Descripción:** Devuelve un elemento de la leyenda que puede consultarse o cuyas propiedades visibles pueden modificarse.
...
**Sintaxis:** obj &lt;&lt; Get Items

**Descripción:** Devuelve una lista de todos los elementos de la leyenda que pueden consultarse o cuyas propiedades visibles pueden modificarse.
...
**Sintaxis:** obj &lt;&lt; Legend Position( list )

**Descripción:** Reorganiza los elementos del interior del cuadro de leyenda según la list introducida.
...
**Descripción:** Muestra la ventana de leyenda para cambiar diversas configuraciones.
...
**Descripción:** Establece la dirección en que mirarán los elementos del interior del cuadro de leyenda.
...
**Sintaxis:** obj &lt;&lt; Revert Legend

**Descripción:** Revierte cualquier cambio realizado al cuadro de leyenda.
...
**Descripción:** Especifica el número máximo de elementos que mostrar en la leyenda. Este ajuste evita que haya una leyenda saturada que sobrecargue el gráfico.
...
**Sintaxis:** obj &lt;&lt; Set Title( "string" )

**Descripción:** Establece el título del cuadro de leyenda.
...
**Sintaxis:** obj &lt;&lt; Set Wrap( number )

**Descripción:** Especifica el número de línea en el que deben aparecer los elementos de la leyenda; 0 indica sin ajuste (es decir, una única columna ancha)
...
**Sintaxis:** obj &lt;&lt; Sides( top|left )

**Descripción:** Establece la posición del cuadro de leyenda.
...
**Sintaxis:** obj &lt;&lt; font( fontname, &lt;fontsize&gt;, &lt;fontstyle&gt; )

**Descripción:** Especifica la fuente que se utilizará para el texto de la leyenda.
