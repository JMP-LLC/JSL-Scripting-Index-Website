...
**Descripción:** Devuelve un cuadro de visualización que tiene un borde alrededor de los cuadros de visualización que contiene.
...
**Sintaxis:** obj &lt;&lt; Bottom( pixels )

**Descripción:** Agrega espacio entre la parte inferior del cuadro de borde y el contenido del cuadro de borde.
...
**Descripción:** Devuelve 0 si está desactivado el relleno de fondo o 1 si está activado el relleno de fondo.
...
**Sintaxis:** obj &lt;&lt; Get Style

**Descripción:** Devuelve el código numérico del estilo de línea del borde.
...
**Sintaxis:** pixels = obj &lt;&lt; GetBottom

**Descripción:** devuelve el borde inferior
...
**Sintaxis:** pixels = obj &lt;&lt; GetLeft

**Descripción:** devuelve el borde izquierdo
...
**Sintaxis:** pixels = obj &lt;&lt; GetRight

**Descripción:** devuelve el borde derecho
...
**Sintaxis:** value = obj &lt;&lt; GetSides

**Descripción:** devuelve qué lados se representan
...
**Sintaxis:** pixels = obj &lt;&lt; GetTop

**Descripción:** devuelve el borde superior
...
**Sintaxis:** obj &lt;&lt; Left( pixels )

**Descripción:** Agrega espacio entre la parte izquierda del cuadro de borde y el contenido del cuadro de borde.
...
**Sintaxis:** obj &lt;&lt; Right( pixels )

**Descripción:** Agrega espacio entre la parte derecha del cuadro de borde y el contenido del cuadro de borde.
...
**Descripción:** Habilita o deshabilita el relleno del fondo del cuadro de borde con el color de fondo.
...
**Sintaxis:** obj &lt;&lt; Set Style( pen style )

**Descripción:** Establece el estilo de línea del borde. Pen style puede ser tanto el número como la cadena entrecomillada: 0 (Sólido), 1 (Con puntos), 2 (Con guiones), 3 (GuionPunto), 4 (GuionPuntoPunto)
...
**Sintaxis:** obj &lt;&lt; Sides( value )

**Descripción:** Un entero que corresponde a la configuración del cuadro de visualización.
...
**Sintaxis:** obj &lt;&lt; Top( pixels )

**Descripción:** Agrega espacio entre la parte superior del cuadro de borde y el contenido del cuadro de borde.
