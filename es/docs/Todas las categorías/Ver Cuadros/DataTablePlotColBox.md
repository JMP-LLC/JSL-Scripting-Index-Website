...
**Descripción:** Devuelve un cuadro de visualización que muestra una columna de una tabla de datos.
...
**Descripción:** Estable un punto en lugar de una barra.
...
**Sintaxis:** "Default"|"Top"|"Bottom" = obj &lt;&lt; Get Axis Position

**Descripción:** Obtiene la posición del eje para la columna del gráfico. La opción predeterminada es que en ocasiones se muestre en la parte superior dependiendo de la escala y el título.
...
**Sintaxis:** obj &lt;&lt; Get Bar Color

**Descripción:** Coge el color de las barras del diagrama
...
**Sintaxis:** obj &lt;&lt; Get Bar Select Color

**Descripción:** Coge el color de las barras del diagrama correspondiente a una fila seleccionada
...
**Sintaxis:** data table column = obj &lt;&lt; Get Data Table Column

**Descripción:** Returns a reference to the data table column that corresponds to this table box column.
...
**Sintaxis:** list = obj &lt;&lt; Get Labels

**Descripción:** Devuelve las etiquetas para cada fila.
...
**Sintaxis:** {color if upper &lt; reference line, color if crosses reference line, color if lower &gt; reference line, alpha, line width, pen style, cap length } = obj &lt;&lt; Get primary interval line properties

### Get secondary interval line properties

**Sintaxis:** {color if upper &lt; reference line, color if crosses reference line, color if lower &gt; reference line, alpha, line width, pen style, cap length } = obj &lt;&lt; Get secondary interval line properties
...
**Sintaxis:** obj &lt;&lt; Lower( data table column )

**Descripción:** El límite inferior dibuja una curva en los puntos especificados.
...
**Sintaxis:** obj &lt;&lt; Lower2( list|matrix )
...
**Descripción:** Muestra marcadores en los límites de cada valor.
...
**Sintaxis:** obj &lt;&lt; Set Axis Position( "Default"|"Top"|"Bottom" )

**Descripción:** Establece que el eje para la columna del gráfico siempre esté en la parte superior o inferior. La opción predeterminada es que en ocasiones se muestre en la parte superior dependiendo de la escala y el título.
...
**Sintaxis:** obj &lt;&lt; Set Bar Color( color )

**Descripción:** Establece el color de las barras del diagrama
...
**Sintaxis:** obj &lt;&lt; Set Bar Select Color( color )

**Descripción:** Establece el color de las barras del diagrama correspondiente a la fila seleccionada
...
**Sintaxis:** obj &lt;&lt; Set Data Table Column( data table column )

**Descripción:** Sets the data table column that corresponds to this table box column.
...
**Sintaxis:** obj &lt;&lt; Set Labels( data table column )

**Descripción:** Establece las etiquetas para cada fila.
...
**Sintaxis:** obj &lt;&lt; Set Plot Style( "Default"|"Bar"|"Interval" )

**Descripción:** Cambia la representación visual de la columna del gráfico.
...
**Sintaxis:** obj &lt;&lt; Set Reference Line( number )
...
**Sintaxis:** obj &lt;&lt; Set Scale( minimum, maximum, &lt;format name&gt;, &lt;width&gt; | &lt;width, decimal places&gt;, &lt; "Use thousands separator"&gt; )

**Descripción:** Establece la escala minimum y maximum de PlotColBox. Los parámetros de formato especifican un formato que solo se utiliza si los dos primeros parámetros son 0 y 1.
...
**Sintaxis:** obj &lt;&lt; Set Values( &lt;list&gt; )

**Descripción:** Establece los valores de una lista.
...
**Descripción:** Establece la longitud (en píxeles) del PlotColBox.
...
**Sintaxis:** obj &lt;&lt; Set primary interval line properties( {color if upper &lt; reference line, color if crosses reference line, color if lower &gt; reference line, alpha, line width, pen style, cap length } )

### Set secondary interval line properties

**Sintaxis:** obj &lt;&lt; Set secondary interval line properties( {color if upper &lt; reference line, color if crosses reference line, color if lower &gt; reference line, alpha, line width, pen style, cap length } )

### Significance

**Sintaxis:** obj &lt;&lt; Significance( data table column )

**Descripción:** Se utiliza para redimensionar el marcador cuando la columna del gráfico está en el modo de intervalo.
...
**Sintaxis:** obj &lt;&lt; Upper( data table column )

**Descripción:** El límite superior dibuja una curva en los puntos especificados.  Primero debe especificarse un límite inferior.
...
**Sintaxis:** obj &lt;&lt; Upper2( list|matrix )
