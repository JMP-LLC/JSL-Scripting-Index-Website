...
**Sintaxis:** obj << Get Filter

### Set Row States

**Sintaxis:** obj << Set Row States( dt, rs )

**Descripción:** Establece los estados de fila para la tabla de datos especificada dentro del filtro. Las selecciones realizadas en este estado de fila no se vincularán a la tabla de datos, pero se incluirán en los informes vinculados al filtro de selección.
