...
**Sintaxis:** obj &lt;&lt; Append( "string" | {"string", ...} )

**Descripción:** Añade la nueva cadena o lista de cadenas a la última posición.
...
**Descripción:** Borra la selección actual: los elementos siguen ahí, pero ya no están seleccionados.
...
**Sintaxis:** obj &lt;&lt; Enable( 0|1 )

**Descripción:** Establece que se habilite (1) o deshabilite (0) el control.
...
**Sintaxis:** "bool" = obj &lt;&lt; Get Case Sensitive

**Descripción:** Devuelve True si los elementos añadidos a la lista coinciden, a excepción del uso de la mayúscula y la minúscula
...
**Sintaxis:** obj &lt;&lt; Get Data Type

**Descripción:** devuelve el tipo de datos de un cuadro de lista de columna
...
**Sintaxis:** obj &lt;&lt; Get Function

**Descripción:** Devuelve la función o script establecidos para el control, en caso de que los haya.
...
**Sintaxis:** obj &lt;&lt; Item Padding( sides );sides = obj &lt;&lt; Get Item Padding

**Descripción:** El espaciado interno añade espacio entre el texto de los elementos del cuadro de lista.
...
**Sintaxis:** list = obj &lt;&lt; Get Items( &lt;"Column Reference"&gt;)

**Descripción:** Devuelve una lista de todos los elementos.
...
**Sintaxis:** obj &lt;&lt; Get Max Items

**Descripción:** Devuelve el número máximo de elementos permitidos en la lista.
...
**Sintaxis:** max = obj &lt;&lt; Get Max Selected

**Descripción:** Devuelve el número máximo de elementos que se pueden seleccionar en la lista.
...
**Sintaxis:** obj &lt;&lt; Get Min Items

**Descripción:** Devuelve el número mínimo de elementos necesarios para la lista.
...
**Sintaxis:** obj &lt;&lt; Get Modeling Type

**Descripción:** Devuelve una lista de tipos de modelización para un cuadro de lista de columnas.
...
**Sintaxis:** nlines = obj &lt;&lt; Get N Lines

**Descripción:** Devuelve el número de líneas visibles de la lista.
...
**Sintaxis:** list = obj &lt;&lt; Get Selected(&lt;"Column Reference"&gt;)

**Descripción:** Devuelve una lista de los elementos seleccionados.
...
**Sintaxis:** indices = obj &lt;&lt; Get Selected Indices

**Descripción:** Devuelve una lista de todos los índices seleccionados.
...
**Sintaxis:** obj &lt;&lt; Insert( "string",index )

**Descripción:** Agrega el elemento o lista de elementos especificados al cuadro de lista después del index especificado.
...
**Sintaxis:** 0|1 = obj &lt;&lt; Is Enabled

**Descripción:** Devuelve el estado habilitado del control
...
**Sintaxis:** obj &lt;&lt; Locate Item

**JMP Versión agregada:** 14

### Menus Enabled

**Sintaxis:** obj &lt;&lt; Menus Enabled( state=0|1 )

**Descripción:** Habilita o deshabilita la posible aparición del menú de la casilla del cuadro de lista al hacer clic con el botón derecho del ratón.
...
**Sintaxis:** obj &lt;&lt; Modeling Type( {"Any","Continuous","Nominal","Ordinal","Multiple Response","Unstructured Text","Vector","None","Row State"}) &gt; )

**Descripción:** Establece los tipos de modelización de columnas aceptados para un cuadro de lista de columnas. El valor predeterminado de "Any" permitirá cualquier columna con un tipo de modelización clásico ("Continuous", "Nominal", "Ordinal").
...
**Sintaxis:** obj &lt;&lt; On Change( script )

**Descripción:** Ejecuta el script cuando cambia la selección de la lista.
...
dt = Open( "$SAMPLE_DATA/Big Class.jmp" );
New Window( "Example",
	clb = Col List Box( all, On Change( Show( clb << Get Items ) ) )
);
Wait( 1 );
...
**Descripción:** Elimina todos los elementos.
...
**Sintaxis:** obj &lt;&lt; Remove Item( index )

**Descripción:** Elimina el elemento especificado de index.
...
**Sintaxis:** obj &lt;&lt; Remove Selected

**Descripción:** Elimina los elementos seleccionados.
...
**Sintaxis:** obj &lt;&lt; Set Case Sensitive( "bool" )

**Descripción:** Determina si los elementos añadidos al cuadro de lista deben compararse con los elementos existentes en cuanto al uso de la mayúscula y minúscula o no
...
**Sintaxis:** obj &lt;&lt; Set Data Type( "Todos"|"Numérico"|"Carácter" )

**Descripción:** establece el tipo de columnas que aceptará un cuadro de lista de columnas en Todos, Carácter o Numérico
...
**Sintaxis:** obj &lt;&lt; Set Function( Function( {thisBox}, &lt;script&gt; ) )

**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se seleccionan uno o más elementos.
...
**Sintaxis:** obj &lt;&lt; Set Items( list )

**Descripción:** Establece la lista de todos los elementos.
...
**Sintaxis:** obj &lt;&lt; Set Max Items( number )

**Descripción:** Establece el número máximo de elementos permitidos en la lista.
...
**Sintaxis:** obj &lt;&lt; Set Max Selected( max )

**Descripción:** Establece el número máximo de elementos que se pueden seleccionar en la lista.
...
**Sintaxis:** obj &lt;&lt; Set Min Items( number )

**Descripción:** Establece el número mínimo de elementos que se necesitan para la lista.
...
**Sintaxis:** obj &lt;&lt; Set N Lines( nlines )

**Descripción:** Establece el número de líneas visibles en la lista.
...
**Descripción:** Establece que el script indicado se ejecute al hacer clic en el control.
...
**Sintaxis:** obj &lt;&lt; Set Selected( index|{index1, index2, ...}|"All",&lt;selected&gt;,&lt;Run Script(0|1)&gt; )

**Descripción:** Establece el elemento en index para seleccionarse (1) o deseleccionarse (0). De forma predeterminada, este mensaje ejecuta el script para su ListBoxBox. Utilice RunScript(0) para suprimir la ejecución del script. Si utiliza la opción RunScript también tiene que especificar el argumento selected, puesto que los argumentos son posicionales.
...
**Sintaxis:** obj &lt;&lt; Set Size( width,height )

**Descripción:** Establece el ancho y la altura de la casilla del cuadro de lista.
...
**Descripción:** Establece el texto a visualizar como información sobre herramienta al mover el ratón sobre el control.
...
**Sintaxis:** obj &lt;&lt; Set Tips( Lista de consejos )

**Descripción:** Establece consejos para los elementos individuales del cuadro de lista.
