...
**Descripción:** Establece el color del fondo del texto.
...
**Sintaxis:** obj << Editable( state=0|1 )

**Descripción:** Si está habilitado (1), se puede hacer clic con el ratón sobre el texto para editarlo.
...
**Descripción:** Habilita o deshabilita el texto relleno.
...
**Sintaxis:** obj << Fixed Size( state=0|1 )

**Descripción:** Si se habilita, respeta el tamaño de anotación definido por el usuario; de lo contrario, lo calcula en función del contenido de texto.
...
**Sintaxis:** obj << Font( face,<size>,<style> )

**Descripción:** Establece la fuente del texto.
...
**Descripción:** Devuelve el color del fondo.
...
**Sintaxis:** font = obj << Get Font

**Descripción:** Devuelve la fuente del texto.
...
**Sintaxis:** color = obj << Get Text Color

**Descripción:** Devuelve el color del texto.
...
**Sintaxis:** 0|1 = obj << GetEditable

**Descripción:** Devuelve un mensaje que indica si texto es editable.
...
**Sintaxis:** 0|1 = obj << GetFilled

**Descripción:** Devuelve un mensaje que indica si texto está relleno.
...
**Sintaxis:** N|NE|E|SE|S|SW|W|NW = obj << GetOctant

**Descripción:** Devuelve la ubicación en que se ha colocado el texto.
...
**Sintaxis:** 0|1 = obj << GetTagLine

**Descripción:** Devuelve (1) si la línea de etiqueta está habilitada o (0) si está deshabilitada.
...
**Sintaxis:** "string" = obj << GetText

**Descripción:** Devuelve el texto.
...
**Sintaxis:** obj << Justification( "string" )

**Descripción:** Establece la justificación del texto
...
**Sintaxis:** obj << Minimized( state=0|1 )
...
**Sintaxis:** obj << Octant( <N|NE|E|SE|S|SW|W|NW> )

**Descripción:** Establece en el cuadro de visualización la ubicación en que se diseñará el texto.
...
**Sintaxis:** obj << Tag Anchor

### Tag Line

**Sintaxis:** obj << Tag Line( state=0|1 )

**Descripción:** Agrega una línea desde la parte superior izquierda del cuadro de visualización hasta el texto
...
**Sintaxis:** obj << Text( "string" )

**Descripción:** Establece string como texto.
...
**Sintaxis:** obj << Text Box( x1,y1,x2,y2 )

**Descripción:** Coloca el texto en un cuadro de texto.
