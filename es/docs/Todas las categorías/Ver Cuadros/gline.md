...
**Descripción:** Establece el color de la línea.
...
**Sintaxis:** obj << Dashed( state=0|1 )

**Descripción:** Habilita o deshabilita una línea discontinua.
...
**Sintaxis:** obj << Line( x1,y1,x2,y2 )

**Descripción:** Dibuja una línea encima del cuadro de visualización.
...
**Sintaxis:** obj << Point from( state=0|1 )

**Descripción:** Dibuja (1) o elimina (0) una flecha al principio de la línea.
...
**Sintaxis:** obj << Point to( state=0|1 )

**Descripción:** Dibuja (1) o elimina (0) una flecha al final de la línea.
...
**Sintaxis:** obj << Thick( state=0|1 )

**Descripción:** Dibuja la línea gruesa (1) o fina (0).
