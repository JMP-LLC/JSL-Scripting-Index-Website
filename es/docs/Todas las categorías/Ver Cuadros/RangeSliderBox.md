...
**Sintaxis:** float = obj << Get Lower( <index> )
...
**Sintaxis:** string = obj << Get Lower Var
...
**Sintaxis:** float = obj << Get Upper( <index> )
...
**Sintaxis:** string = obj << Get Upper Var
...
**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando cambia el valor de cualquier control deslizante.
...
**Sintaxis:** obj << Set Lower( float, <index>, <run script(0|1)> )
...
**Sintaxis:** string = obj << Set Lower Var
...
**Sintaxis:** obj << Set Upper( float, <index>, <run script(0|1)> )
...
**Sintaxis:** string = obj << Set Upper Var
