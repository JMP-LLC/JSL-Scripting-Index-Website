...
**Descripción:** Devuelve un cuadro de visualización para el que se pueden indicar un color y tamaño arbitrarios.
...
**Descripción:** Establece el color indicado para el espaciador.
...
**Descripción:** Devuelve el color del espaciador.
...
**Sintaxis:** boolean = obj &lt;&lt; Get Fill

**Descripción:** Returns whether the background is painted or not.
...
**Descripción:** Devuelve la altura del espaciador.
...
**Sintaxis:** alpha = obj &lt;&lt; Get Transparency

**Descripción:** Returns the transparency value, 0..1.
...
**Descripción:** Devuelve el ancho del espaciador.
...
**Descripción:** Establece la altura del espaciador.
...
**Descripción:** Sets whether the background is painted or not.
...
**Sintaxis:** obj &lt;&lt; Size( width, height,&lt;min width, min height&gt;,&lt;max width, max height&gt; )

**Descripción:** Establece el ancho y altura del espaciador.
...
**Sintaxis:** obj &lt;&lt; Transparency( alpha )

**Descripción:** Sets the transparency value, 0..1.
...
**Descripción:** Establece el ancho del espaciador.
