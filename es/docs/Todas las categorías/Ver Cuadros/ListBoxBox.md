...
**Sintaxis:** obj &lt;&lt; Enable Item( index,enable )

**Descripción:** Permite habilitar (1) o deshabilitar (0) el elemento del index.
...
**Sintaxis:** index = obj &lt;&lt; Get First Visible Item

**Descripción:** Devuelve el índice del primer elemento visible.
...
**Sintaxis:** 0|1 = obj &lt;&lt; Item Enabled( index )

**Descripción:** Devuelve (1) si el elemento del index está habilitado o (0) si está deshabilitado.
...
**Sintaxis:** obj &lt;&lt; Set First Visible Item( index )

**Descripción:** Desplaza el cuadro de lista para que el elemento solicitado sea el primer elemento visible.
...
**Sintaxis:** obj &lt;&lt; Show Item( index )

**Descripción:** Desplaza el cuadro de lista para garantizar que el elemento solicitado esté visible en el cuadro de lista.
