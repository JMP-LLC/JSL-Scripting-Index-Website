...
**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se selecciona un nuevo elemento desde el cuadro emergente.
