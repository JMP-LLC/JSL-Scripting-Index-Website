...
**Descripción:** Devuelve un cuadro de visualización que contiene una matriz.
...
**Sintaxis:** obj &lt;&lt; Column Names( strings or list of strings )
...
**Descripción:** Controla si los formatos semánticos se aplican a la matriz. Los formatos semánticos también pueden controlarse a través de las preferencias.
...
**Sintaxis:** matrix = obj &lt;&lt; Get

**Descripción:** Devuelve una lista que representa la matriz.
...
**Descripción:** Devuelve 1 si las columnas alinean los valores en el separador decimal; de lo contrario, devuelve 0.
...
**Sintaxis:** obj &lt;&lt; Get Effective Format( col, &lt;row&gt; )

**Descripción:** Devuelve el formato efectivo de una columna, que es el formato tras la aplicación de cualquier formato semántico coincidente. Si se proporciona una row, devuelve el formato efectivo solo para esa fila.
...
**Descripción:** Obtiene la configuración de Habilitar formatos semánticos de la matriz. Los formatos semánticos también pueden controlarse a través de las preferencias.
...
**Sintaxis:** obj &lt;&lt; Get Format( width, decimalplaces )

**Descripción:** Devuelve la especificación de formato actual.
...
**Sintaxis:** obj &lt;&lt; Make Combined Data Table( &lt;Invisible(bool)&gt; )

**Descripción:** Crea una tabla de datos a partir de todas las matrices similares.
...
**Descripción:** Crea una nueva tabla de datos que contiene los valores del cuadro de matriz.
...
**Sintaxis:** obj &lt;&lt; Open( state=0|1 )

**Descripción:** Muestra u oculta los valores del cuadro de la matriz.
...
**Sintaxis:** obj &lt;&lt; Row Names( strings or list of strings )
...
**Sintaxis:** obj &lt;&lt; Set( matrix )

**Descripción:** Establece la matriz a partir de una lista.
...
**Sintaxis:** obj &lt;&lt; Set Conditional Format( None|Correlation|PValue|Factor Pattern )

**Descripción:** Establece el formato de datos de los valores de la matriz.
...
**Sintaxis:** obj &lt;&lt; Sort( column, ascending )

**Descripción:** Ordena las filas de la matriz en función de una de las columnas. Si se especifica 0 para la columna, se elimina la ordenación.
