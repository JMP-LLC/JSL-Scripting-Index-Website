...
**Sintaxis:** obj << Max Date( number );

number = obj << Get Max Date
...
**Sintaxis:** obj << Min Date( number );

number = obj << Get Min Date
...
**Sintaxis:** obj << Show Time( state=0|1 );

state = obj << Get Show Time
