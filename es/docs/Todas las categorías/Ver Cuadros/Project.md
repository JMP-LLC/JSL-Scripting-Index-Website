...
**Sintaxis:** project << Add Bookmarks( {<File(path)>, <Folder( path, <Expanded(boolean)> )>, <Group(name, <Expanded(boolean)>, {contents}>} )

**Descripción:** Añade una lista de marcadores al proyecto. Los marcadores existentes se conservan. El argumento es una lista de elementos de marcador, cada uno especificado mediante File(), Folder() o Group(). El tipo Group() acepta archivos, carpetas y grupos como hijos que utilizan la misma sintaxis de forma recurrente.
...
**Sintaxis:** project << Contents()

**Descripción:** Muestra todos los archivos de un proyecto.
...
**Sintaxis:** project << Extract("file")

**Descripción:** Extrae un archivo específico del proyecto. El comando JMP Open() no extrae archivos del proyecto que JMP no pueda abrir directamente. Un ejemplo son los archivos parquet.
...
**Sintaxis:** project << Extract All()

**Descripción:** Extrae todos los archivos del proyecto en el directorio temporal.
...
**Sintaxis:** project << Get Bookmarks()

**Descripción:** Devuelve la lista de marcadores del proyecto. El formato de la lista devuelta es el mismo que el que utiliza Add Bookmarks() y Set Bookmarks().
...
**Sintaxis:** project << Get Layout()

**Descripción:** Devuelve la presentación de ventanas del proyecto. El formato es el mismo que el que utiliza Set Layout().
...
**Sintaxis:** project << Get Temp Dir()

**Descripción:** Obtiene la ruta del disco al directorio temporal del proyecto.
...
**Sintaxis:** project << Is Extracted("file")

**Descripción:** Comprueba si se ha extraído un archivo específico del proyecto en el directorio temporal. El comando JMP Open() no extrae archivos del proyecto que JMP no pueda abrir directamente. Un ejemplo son los archivos parquet.
...
**Sintaxis:** project << Project File Path()

**Descripción:** Obtiene la ruta del disco de un archivo de proyecto guardado.
...
**Sintaxis:** project << Reset Layout()

**Descripción:** Configura el proyecto para que utilice la presentación de ventanas predeterminada.
...
**Sintaxis:** project << Run Script(script)

**Descripción:** Ejecuta un script en el contexto del proyecto. En particular, cualquier ventana abierta por el script formará parte del proyecto. El script accederá a nombres JSL en el contexto del proyecto, no en el del script envolvente.
...
**Sintaxis:** project << Save Project(<path>)

**Descripción:** Guarda el proyecto. Se pueden especificar una ruta y un nombre de archivo para guardar el proyecto en una ubicación específica; si el proyecto ya se ha guardado, este argumento es opcional.



Deben guardarse los documentos no guardados del proyecto antes de guardar el propio proyecto.
...
**Sintaxis:** project << Set Bookmarks( {<File(path)>, <Folder( path, <Expanded(boolean)> )>, <Group(name, <Expanded(boolean)>, {contents}>} )

**Descripción:** Establece los marcadores para el proyecto. Los marcadores existentes se eliminan. El argumento es una lista de elementos de marcador, cada uno especificado mediante File(), Folder() o Group(). El tipo Group() acepta archivos, carpetas y grupos como hijos que utilizan la misma sintaxis de forma recurrente.
...
**Sintaxis:** obj << Set Layout

**Descripción:** Establece la presentación de ventanas del proyecto.
...
**Sintaxis:** project << Show Bookmarks(boolean)

**Descripción:** Muestra u oculta el panel Marcadores en el proyecto
...
**Sintaxis:** project << Show Contents(boolean)

**Descripción:** Muestra u oculta el panel Contenido en el proyecto
...
**Sintaxis:** project << Show Log(boolean)

**Descripción:** Muestra u oculta el panel Registro en el proyecto
...
**Sintaxis:** project << Show Recent Files(boolean)

**Descripción:** Muestra u oculta el panel Archivos recientes en el proyecto
...
**Sintaxis:** project << Show Workspace(boolean)

**Descripción:** Muestra u oculta el panel Área de trabajo en el proyecto
