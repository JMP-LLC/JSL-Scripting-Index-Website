...
**Descripción:** Devuelve un cuadro de visualización que contiene un cuadro de scripts editable.
...
**Sintaxis:** obj &lt;&lt; Append Text( text )

**Descripción:** Agrega el texto indicado al final del script.
...
**Sintaxis:** obj &lt;&lt; Collapse All

**Descripción:** Contrae todas las secciones plegables del contenido del Cuadro de scripts.
...
**Sintaxis:** obj &lt;&lt; Expand All

**Descripción:** Expande todas las secciones contraídas del contenido del Cuadro de scripts.
...
**Sintaxis:** obj &lt;&lt; Get Cursor Line

**Descripción:** Devuelve la línea en la que se encuentra actualmente el cursor.
...
**Sintaxis:** obj &lt;&lt; Get Cursor Position

**Descripción:** Devuelve la posición actual del cursor.
...
**Sintaxis:** obj &lt;&lt; Get Line Count

**Descripción:** Devuelve el conteo de líneas del cuadro del script.
...
**Sintaxis:** obj &lt;&lt; Get Line Text( line number )

**Descripción:** Devuelve el texto del número de línea indicado.
...
**Sintaxis:** obj &lt;&lt; Get Lines

**Descripción:** Devuelve todo el texto de la ventana del script como lista de cadenas, una línea por cadena.
...
**Sintaxis:** obj &lt;&lt; Get Selection Width

**Descripción:** Devuelve el ancho actual de la selección.
...
**Sintaxis:** obj &lt;&lt; Get Show Empty Scrollbars( state=0|1 )

**Descripción:** Devuelve un valor booleano que indica si se muestran las barras de desplazamiento horizontal y vertical incluso si no son necesarias
...
**Sintaxis:** obj &lt;&lt; Get Show Scrollbars

**Descripción:** Devuelve una lista de dos elementos que indica si se muestran las barras de desplazamiento horizontal y vertical
...
**Sintaxis:** obj &lt;&lt; Read Only( state=0|1 )

**Descripción:** Si es verdadero (1), no puede modificarse el texto de dentro del cuadro de script.
...
**Sintaxis:** obj &lt;&lt; Reformat

**Descripción:** Da formato al script de modo que sea más fácil de leer.
...
**Sintaxis:** obj &lt;&lt; Set Cursor Position( position )

**Descripción:** Establece la posición del cursor en la posición proporcionada.
...
**Sintaxis:** obj &lt;&lt; Set Line Text( line number, text )

**Descripción:** Establece el texto en el número de línea indicado.
...
**Sintaxis:** obj &lt;&lt; Set Selection Width( width )

**Descripción:** Establece el ancho de la selección en el ancho proporcionado.
...
**Sintaxis:** obj &lt;&lt; Set Show Empty Scrollbars( state=0|1 )

**Descripción:** Si es True (1), se muestran las barras de desplazamiento horizontal o vertical incluso si no son necesarias
...
**Sintaxis:** obj &lt;&lt; Set Show Scrollbars( state=0|1 )

**Descripción:** Especifica si se muestran las barras de desplazamiento horizontal y vertical
...
**Sintaxis:** obj &lt;&lt; Set Text( text )

**Descripción:** Reemplaza el texto actual del cuadro de script por el texto indicado.
...
**Sintaxis:** obj &lt;&lt; Show Embedded Log( state=0|1 )

**Descripción:** Habilita/deshabilita el registro incrustado.
...
**Sintaxis:** obj &lt;&lt; Show Line Numbers( state=0|1 )

**Descripción:** Muestra u oculta los números de línea en la parte izquierda del cuadro del script.
