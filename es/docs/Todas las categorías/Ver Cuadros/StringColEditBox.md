...
**Descripción:** Devuelve un cuadro de visualización que muestra cadenas editables en una columna.
...
**Sintaxis:** obj &lt;&lt; Set Function( Function( {thisBox, which}, &lt;script&gt; ) )

**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se confirma un cambio. which es el número de fila de la celda que ha cambiado.
