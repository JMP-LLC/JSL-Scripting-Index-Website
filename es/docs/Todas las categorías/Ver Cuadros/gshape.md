...
**Descripción:** Establece el color de la forma.
...
**Descripción:** Habilita o deshabilita una forma rellena.
...
**Sintaxis:** obj << Oval( x1,y1,x2,y2 )

**Descripción:** Dibuja un óvalo encima del cuadro de visualización.
...
**Descripción:** Habilita o deshabilita una forma en relieve.
...
**Sintaxis:** obj << Rectangle( x1,y1,x2,y2 )

**Descripción:** Dibuja un rectángulo encima del cuadro de visualización.
