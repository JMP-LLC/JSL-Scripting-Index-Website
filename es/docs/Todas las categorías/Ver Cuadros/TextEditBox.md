...
**Descripción:** Devuelve un cuadro de visualización que contiene texto editable.
...
**Sintaxis:** obj &lt;&lt; Bullet point( state=0|1 )

**Descripción:** Dibuja un símbolo de viñeta, que precede al texto.
...
**Sintaxis:** obj &lt;&lt; Enable( state=0|1 )

**Descripción:** Establece si puede editarse el TextEditBox.
...
**Sintaxis:** obj &lt;&lt; Fixed Size( state=0|1, &lt;width&gt;, &lt;height&gt; )

**Descripción:** Si está habilitado, el TextBox no se expande si el ancho del texto es mayor que el ancho del TextBox.
...
**Sintaxis:** bullet = obj &lt;&lt; Get Bullet

**Descripción:** Devuelve un valor que indica si se dibuja un símbolo de viñeta delante del texto.
...
**Descripción:** Obtiene la función que se ejecuta después de editar el texto.
...
**Sintaxis:** 0|1 = obj &lt;&lt; Get Hidden State( state=0|1 )
...
**Sintaxis:** "string" = obj &lt;&lt; Get Hint

**Descripción:** Texto que se muestra como sugerencia cuando el cuadro de texto está vacío.
...
**Sintaxis:** justify = obj &lt;&lt; Get Justify

**Descripción:** Izquierda, centro o derecha justifican el texto.
...
**Sintaxis:** rotation = obj &lt;&lt; Get Rotation

**Descripción:** Devuelve la rotación del texto.
...
**Descripción:** Cambia el contenido de la cadena del cuadro.
...
**Sintaxis:** function = obj &lt;&lt; Get Text Changed

**Descripción:** Devuelve la función que se ejecuta cada vez que se realiza un cambio en el texto.
...
**Descripción:** Devuelve el cuadro de información sobre herramientas de Text Box.
...
**Descripción:** Devuelve el ancho del TextBox.
...
**Sintaxis:** obj &lt;&lt; Get Wrap

**Descripción:** Devuelve el punto de ajuste actual en píxeles
...
**Sintaxis:** obj &lt;&lt; Hide( state=0|1 )

**Descripción:** Muestra u oculta el texto.
...
**Sintaxis:** obj &lt;&lt; Is Enabled( state=0|1 )
...
**Sintaxis:** obj &lt;&lt; Justify Text( "Izquierda"|"Centro"|"Derecha" )
...
**Sintaxis:** obj &lt;&lt; Markup( state=0|1 )

**Descripción:** Indica que el texto puede contener marcado HTML y debe interpretarse. Las etiquetas HTML admitidas son negrita (<b></b>), cursiva (<i></i>), subrayado (<u></u>), fuente (<font face=&apos;&apos;></font>), color de fuente (<font color=&apos;&apos;></font>), tamaño de fuente (<font size=&apos;&apos;></font> y color de fondo (<background color=&apos;&apos;></background>). Para el color de fuente y el color de fondo, puede especificar el color por su nombre (azul), por el triplo hexadecimal, especificado en sintaxis HTML (#0000ff) o en formato hexadecimal (0x0000ff). Si un nombre especifica un color, el nombre utiliza la definición de JMP del color.
...
**Sintaxis:** obj &lt;&lt; Password Style( state=0|1 )

**Descripción:** Si está habilitado, el TextEditBox muestra ***** en lugar de las contraseñas.
...
**Sintaxis:** obj &lt;&lt; Preprocess Markup( state=0|1 )

**Descripción:** Indica que el texto se debe procesar previamente para sustituir las etiquetas de marcado de JMP por etiquetas HTML con el formato adecuado.
...
**Descripción:** Restaura el contenido del texto a su valor inicial.
...
**Sintaxis:** obj &lt;&lt; Rotate Text( left|right|horizontal )

**Descripción:** Rota el texto 90 grados a izquierda o derecha o lo devuelve a la horizontal.
...
**Sintaxis:** obj &lt;&lt; Set Script( script ) obj &lt;&lt; Script( script )

**Descripción:** Después de editar el texto, se ejecutará el script especificado.
...
**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se confirma el cambio del cuadro de edición de texto.
...
**Sintaxis:** obj &lt;&lt; Set Text( "string", &lt;Run Script(bool)&gt; )

**Descripción:** Cambia el contenido de la cadena del cuadro. Para el cuadro de edición de texto, un argumento opcional Run Script(bool) establece si se ejecuta el script del cuadro de edición de texto cuando se ejecuta Establecer texto. El valor predeterminado es 0 (no ejecuta el script).
...
**Sintaxis:** obj &lt;&lt; Set Text Changed( Function( {this, value}, &lt;script&gt; ) )

**Descripción:** Establece function que se ejecuta cada vez que se realiza un cambio en el texto. Esta devolución de llamada se realiza durante la edición antes de llevar a cabo el cambio. En el caso de una operación de edición cancelada, se generará una devolución de llamada adicional para proporcionar el valor original.
...
**Sintaxis:** obj &lt;&lt; Set Tip( text )

**Descripción:** Establece el cuadro de información sobre herramientas de Text Box.
...
**Descripción:** Establece el ancho del TextBox.
...
**Sintaxis:** obj &lt;&lt; Set Wrap( n )

**Descripción:** Establece el punto de ajuste, en (n) píxeles.
...
**Sintaxis:** obj &lt;&lt; SetNLines( number )

**Descripción:** Establece el número de líneas en que puede aparecer el texto.
...
**Sintaxis:** obj &lt;&lt; White Box Style( 0=ordinary text, 1=bordered white box entry field )

**Descripción:** Determina si debe aparecer como campo de entrada con el texto dentro de cuadro blanco con borde o como texto sin formato sobre el que poder hacer clic para editarlo
