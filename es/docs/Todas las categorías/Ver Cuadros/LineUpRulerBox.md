...
**Sintaxis:** list = obj << Get Widths

**Descripción:** Devuelve el ancho de las columnas para los cuadros de alineación que contienen.
...
**Sintaxis:** obj << Widths( list )

**Descripción:** Establece el ancho de las columnas para los cuadros de alineación que contienen.
