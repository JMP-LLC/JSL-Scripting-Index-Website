...
**Sintaxis:** obj << Closed( state=0|1 )

**Descripción:** Si está habilitado, el polígono tiene automáticamente un interior incluso si los puntos de inicio y final no coinciden.
...
**Descripción:** Establece el color del polígono.
...
**Descripción:** Habilita o deshabilita un polígono relleno.
...
**Descripción:** Establece los puntos a los que se ampliará el polígono.
...
**Sintaxis:** obj << Raised( state=0|1 )

**Descripción:** Habilita o deshabilita un polígono en relieve.
...
**Sintaxis:** obj << Smooth( state=0|1 )

**Descripción:** Habilita o deshabilita un polígono liso.
