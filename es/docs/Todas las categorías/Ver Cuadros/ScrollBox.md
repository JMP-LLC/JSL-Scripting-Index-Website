...
**Descripción:** Devuelve un cuadro de visualización que coloca una barra de desplazamiento en la parte inferior y a la derecha si el contenido es mayor que el tamaño del ScrollBox.
...
**Sintaxis:** obj << Get Auto Scrollable

**Descripción:** Devuelve la configuración Desplazable automáticamente.
...
**Sintaxis:** obj << Get Clip Printing( state=0|1 )

**Descripción:** Devuelve la configuración actual para cortar el contenido del cuadro con desplazamiento al imprimir.
...
**Descripción:** Devuelve el color de fondo.

### Get Height

**Sintaxis:** pixels = obj << Get Height

**Descripción:** Devuelve la altura del área de desplazamiento.

### Get Scroll Extents

**Sintaxis:** {h pixels,v pixels} = obj << Get Scroll Extents

**Descripción:** Devuelve las posiciones máximas de desplazamiento horizontal y vertical.
...
**Sintaxis:** {h,v} = obj << Get Scroll Position

**Descripción:** Devuelve las posiciones de desplazamiento horizontal y vertical actuales.
...
**Sintaxis:** {h,v} = obj << Get Scrollers

**Descripción:** Devuelve los indicadores de desplazamiento horizontal y vertical. Si el desplazamiento está desactivado en una dirección determinada, Scroll Box se comportará como un contenedor normal en esa dirección.
...
**Sintaxis:** obj << Get Show Empty

**Descripción:** Devuelve la configuración actual para mostrar las barras de desplazamiento cuando están vacías.
...
**Descripción:** Devuelve el ancho del área de desplazamiento.

### Height

**Sintaxis:** obj << Height( pixels )

**Descripción:** Establece la altura del área de desplazamiento.
...
**Sintaxis:** obj << Set Auto Scrollable( state=0|1 )

**Descripción:** Establece automáticamente parámetros de desplazamiento en función de las propiedades de extensión del cuadro hijo. La barra de desplazamiento de cada dirección estará activa si el cuadro no se puede ajustar en esa dirección.
...
**Descripción:** Establece el color indicado para el fondo del cuadro de desplazamiento.
...
**Sintaxis:** obj << Set Clip Printing( state=0|1 )

**Descripción:** El contenido del cuadro con desplazamiento se corta hasta el tamaño del cuadro con desplazamiento al imprimir, o se muestra todo el contenido. De forma predeterminada, el corte está desactivado.
...
**Sintaxis:** obj << Set Scroll Position( h,v )

**Descripción:** Establece las posiciones de desplazamiento horizontal y vertical. Los valores se pueden indicar en píxeles o mediante las palabras clave "Inicio" y "Fin".
...
**Sintaxis:** obj << Set Scrollers( h,v )

**Descripción:** Establece los indicadores para el desplazamiento horizontal y vertical. Si el desplazamiento está desactivado en una dirección en particular, Scroll Box se comportará como un contenedor normal en esa dirección.
...
**Sintaxis:** obj << Set Show Empty( state=0|1 )

**Descripción:** Muestra las barras de desplazamiento aunque estén vacías.
...
**Descripción:** Establece el ancho del área de desplazamiento.
