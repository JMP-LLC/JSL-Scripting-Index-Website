...
**Descripción:** Devuelve un cuadro de visualización que contiene una jerarquía de cadenas.
...
**Sintaxis:** obj &lt;&lt; Above( "string" )

**Descripción:** Inserta una nueva cadena encima del cuadro de jerarquía de llamada.
...
**Sintaxis:** obj &lt;&lt; After( "string" )

**Descripción:** Inserta una nueva cadena después del cuadro de jerarquía de llamada.
...
**Sintaxis:** obj &lt;&lt; Before( "string" )

**Descripción:** Inserta una nueva cadena antes del cuadro de jerarquía de llamada.
...
**Sintaxis:** obj &lt;&lt; Below( "string" )

**Descripción:** Inserta una nueva cadena debajo del cuadro de jerarquía de llamada.
...
**Sintaxis:** obj &lt;&lt; Change Type( "Espina de pez"|"Jerarquía"|"Anidado" )

**Descripción:** Establece el estilo del cuadro de jerarquía.
...
**Descripción:** Oculta todos los hijos debajo del cuadro de jerarquía indicado.
...
**Descripción:** Quita el cuadro de jerarquía.
...
**Sintaxis:** obj &lt;&lt; Direction( 0|1 )

**Descripción:** Establece si las cadenas del cuadro de jerarquía deben apuntar a la derecha (1) o a la izquierda (0).
...
**Descripción:** Mueve el cuadro de jerarquía de llamada a la posición de primer cuadro de jerarquía.
...
**Sintaxis:** obj &lt;&lt; Force Alternate

**Descripción:** Mueve el cuadro de jerarquía de llamada para que se alterne con el cuadro de jerarquía hermano.
...
**Sintaxis:** obj &lt;&lt; Force Down

**Descripción:** Mueve hacia abajo el cuadro de jerarquía de llamada.
...
**Sintaxis:** obj &lt;&lt; Force Left

**Descripción:** Mueve el cuadro de jerarquía de llamada a la izquierda.
...
**Sintaxis:** obj &lt;&lt; Force Right

**Descripción:** Mueve el cuadro de jerarquía de llamada a la derecha.
...
**Sintaxis:** obj &lt;&lt; Force Up

**Descripción:** Mueve hacia arriba el cuadro de jerarquía de llamada.
...
**Sintaxis:** obj &lt;&lt; Horizontal

**Descripción:** Rota el texto de manera que quede horizontal empezando por la izquierda.
...
**Descripción:** Mueve el cuadro de jerarquía de llamada a la posición de último cuadro de jerarquía.
...
**Sintaxis:** obj &lt;&lt; Lean( 0|1 )

**Descripción:** Establece si las cadenas del cuadro de jerarquía deben inclinarse a la derecha (1) o a la izquierda (0).
...
**Descripción:** Crea una nueva tabla de datos que contiene las cadenas del cuadro de jerarquía.
...
**Sintaxis:** obj &lt;&lt; Other Side

**Descripción:** Mueve el cuadro de jerarquía de llamada al otro lado de los demás cuadros de jerarquía.
...
### Override Descendant Padding

**Sintaxis:** obj &lt;&lt; Override Descendant Padding( state=0|1 )

**Descripción:** Es cierto si todos los descendientes adoptan la misma configuración de espaciado interno prescrita.
...
**Sintaxis:** obj &lt;&lt; Pad Current Node( state=0|1 )

**Descripción:** Es cierto si aplicamos la configuración de espaciado interno prescrita al nodo actual.
...
**Sintaxis:** obj &lt;&lt; Rotate Left

**Descripción:** Rota el texto de manera que quede vertical empezando por abajo.
...
**Sintaxis:** obj &lt;&lt; Rotate Right

**Descripción:** Rota el texto de manera que quede vertical empezando por arriba.
...
### Siblings Horizontal Pad

**Sintaxis:** obj &lt;&lt; Siblings Horizontal Pad( number )

**Descripción:** Es el espaciado interno habitual entre cuadros de jerarquía.
...
**Sintaxis:** obj &lt;&lt; Siblings Total Pad( number )

**Descripción:** Es el espaciado interno vertical entre los cuadros de jerarquía hermanos y su cuadro progenitor.
...
### Siblings Vertical Pad

**Sintaxis:** obj &lt;&lt; Siblings Vertical Pad( number )

**Descripción:** Es el espaciado interno entre cuadros de jerarquía cuando se giran 90 grados.
...
**Sintaxis:** obj &lt;&lt; Text Wrap Width( width )

**Descripción:** Especifica el ancho que puede tener cada cadena antes de que ésta empiece una nueva línea.
...
**Sintaxis:** obj &lt;&lt; Uneditable( state=0|1 )

**Descripción:** Si está habilitado (1), se puede hacer clic con el ratón sobre las cadenas para editarlas.
