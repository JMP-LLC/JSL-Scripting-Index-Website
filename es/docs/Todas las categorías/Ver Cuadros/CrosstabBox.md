...
**Sintaxis:** obj &lt;&lt; Format( element, Format( format, &lt;options&gt; ) )

**Descripción:** Establece el formato para el elemento CrossTabBox proporcionado
...
**Descripción:** Devuelve una matriz de los valores del CrossTabBox.
...
**Descripción:** Crea una nueva tabla de datos que contiene los valores de CrossTabBox.
