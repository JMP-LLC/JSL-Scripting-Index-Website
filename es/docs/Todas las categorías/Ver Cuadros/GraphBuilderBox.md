...
**Sintaxis:** Graph Builder

**Descripción:** Componente interno del Constructor de gráficos.
...
**Sintaxis:** obj &lt;&lt; Graph Margin( sides ); sides = obj &lt;&lt; Get Graph Margin

**Descripción:** Margen mínimo alrededor del área del gráfico, que se puede sustituir con cualquier eje, leyenda o título circundante.
...
### Get Scale Graph Margin

**Sintaxis:** obj &lt;&lt; Scale Graph Margin( state=0|1 ); state = obj &lt;&lt; Get Scale Graph Margin

**Descripción:** Especifica si las propiedades del margen del gráfico se deben escalar con el tamaño del gráfico cuando se aplican.
...
**Sintaxis:** obj &lt;&lt; Graph Borders( color )
...
**Sintaxis:** obj &lt;&lt; Graph Spacing( color )

**Descripción:** Establece la cantidad de espacios entre los paneles del gráfico.
...
**Descripción:** Establece el color de los espacios entre los paneles del gráfico.
...
**Sintaxis:** obj &lt;&lt; Graph Spacing Transparency( color )

**Descripción:** Establece la transparencia de los espacios entre los paneles del gráfico.
