...
**Descripción:** Sets the width and height of the web browser box. The web browser box has a default Stretch setting of &apos;Window&apos; that must be changed to &apos;Off&apos; to honor the requested size.
