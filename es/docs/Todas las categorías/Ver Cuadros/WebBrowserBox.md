...
**Sintaxis:** "Promise" = obj &lt;&lt; Execute Script

**Descripción:** Ejecuta de forma asíncrona el Javascript especificado en el contexto de la página actual. Devuelve una promesa para el resultado del script (como cadena de caracteres).
...
**Sintaxis:** "URL" = obj &lt;&lt; Get URL

**Descripción:** Devuelve la URL a la que ha ido el navegador.
...
**Sintaxis:** obj &lt;&lt; Navigate( "URL" )

**Descripción:** Va a la URL especificada.
...
**Descripción:** Establece el ancho y alto del cuadro del navegador web. El cuadro del navegador web tiene una configuración predeterminada de Ajustar en "Ventana" que se debe cambiar a "Desactivado" para respetar el tamaño solicitado.
