...
**Descripción:** Devuelve la cadena utilizada por el segmento de texto.
...
**Sintaxis:** obj &lt;&lt; Set Location

**Descripción:** Establece la ubicación del texto. Si se establece la relación, 0,0 será la parte superior izquierda y 1,1 será la parte inferior derecha. Si no se establece relación, las coordenadas estarán relacionadas con los ejes.
...
**Sintaxis:** obj &lt;&lt; Set Relative( 0|1,0|1 )

**Descripción:** Un valor de 0 significa que la coordenada x o y estará relacionada con el cuadro del marco y un valor de 1 significa que el valor x o y estará relacionado con los ejes. Cuando la relación se establezca en 0, las coordenadas x e y asignarán de 0,0 a 1,1 para el área comprendida entre la superior izquierda y la parte inferior derecha del cuadro del gráfico.
...
**Descripción:** Establece la cadena utilizada por el segmento de texto.
...
**Sintaxis:** obj &lt;&lt; Set Text Alignment( left|center|right,&lt;top|center|bottom&gt; )
