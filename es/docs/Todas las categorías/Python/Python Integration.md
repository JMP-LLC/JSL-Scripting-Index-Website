...
**Sintaxis:** result = jmp.from_arrow(&lt;library.Dataframe&gt;, requested_schema=&lt;schema&gt;, visibility=&lt;string&gt;, preserve_index=&lt;bool&gt;)

**Descripción:** Crea un objeto jmp.DataTable a partir de un DataFrame que implemente la interfaz PyArrow Capsule.
...
**Descripción:** Las tablas pequeñas se actualizan rápidamente, pero en el caso de tablas grandes, tener que actualizar la interfaz de usuario mientras se realizan cambios masivos en una columna lleva mucho tiempo. El método begin_update() detiene las actualizaciones de la interfaz gráfica de usuario (GUI) de la tabla de datos hasta que se invoque el método correspondiente end_update().
...
**Descripción:** Restablece el procesamiento de actualizaciones de la interfaz gráfica de usuario de la tabla de datos.
