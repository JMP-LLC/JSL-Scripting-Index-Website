...
**Sintaxis:** col_obj.display_width
...
**Sintaxis:** dt.new_column(  name=&apos;column_name&apos;,
...
**Sintaxis:** jmp.RowState(selected?=<boolean>, hidden?=<booleane>, labeled?=<boolean>, excluded?=<boolean>, color?=<int>, marker?=<int>)
