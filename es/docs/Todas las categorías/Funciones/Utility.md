...
**Descripción:** Registra un complemento. Un valor de Autocarga de 1 obliga al complemento a cargarse cuando se registra. Un valor de 0 hace que el complemento permanezca sin cargarse. Si no se especifica Autocarga, se utilizará la configuración del archivo addin.def si se encuentra; de lo contrario, el valor predeterminado será que el complemento se cargue.
...
**Descripción:** Genera una secuencia de números de llenado del espacio casi aleatorios con la secuencia de Sobol en hasta 21.201 dimensiones.
