...
**Sintaxis:** obj &lt;&lt; Early Stopping( state=0|1 )
...
**Sintaxis:** obj = Bootstrap Forest(...Informative Missing( state=0|1 )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj &lt;&lt; Maximum Number of Terms( number )

**Descripción:** Establece el número máximo de términos para probar cuando se ejecutan modelos múltiples.
...
**Sintaxis:** Maximum Splits Per Tree( number )

**Descripción:** Establece el número máximo de divisiones por árbol.
...
**Sintaxis:** Method( "Bootstrap Forest" )&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** Minimum Splits Per Tree( number )

**Descripción:** Establece el número mínimo de divisiones por árbol. El valor predeterminado es de 10.
...
**Sintaxis:** Number Terms( number )

**Descripción:** Establece el número términos muestreados por división. El valor predeterminado es floor(nX/4), donde “nX” es el número de columnas X.
...
**Sintaxis:** Number Trees( number )

**Descripción:** Establece el número de árboles en el bosque. El valor predeterminado es de 100.
...
**Sintaxis:** obj = Bootstrap Forest(...Ordinal Restricts Order( state=0|1 )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** Portion( fraction )

**Descripción:** Establece la porción de la población muestreada para la muestra bootstrap. El valor predeterminado es de 1.
...
**Descripción:** Guarda el R cuadrado de validación junto con el número de árbol en una nueva tabla de datos. Solo está disponible en caso de usar una columna de validación.
...
**Descripción:** Muestra una lista de árboles individuales, solo con nombres, con nombres y categorías, o con nombres, categorías y estimaciones en cada nodo.
...
**Sintaxis:** Time Limit( number )

**Descripción:** Establece el límite de tiempo para la iteración. El número es el límite en segundos para detener la adición de árboles.
...
**Descripción:** Una tabla de parámetros de sintonización con los que realizar la corrida, que admiten: Número de términos, División mínima por árbol, División máxima por árbol, Número de árboles, Bootstrap de porción, Tamaño mínimo de división

### Use Excluded Rows for Validation

**Sintaxis:** obj = Bootstrap Forest(...Use Excluded Rows for Validation( state=0|1 )...)
...
**Sintaxis:** obj = Bootstrap Forest(...Validation Portion( fraction=0 )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Bootstrap Forest(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
