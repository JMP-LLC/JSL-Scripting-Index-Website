...
**Descripción:** Muestra u oculta una tabla que contiene las coordenadas de los componentes. Esta opción solo está disponible cuando el análisis contiene una variable categórica.
