...
**Sintaxis:** obj &lt;&lt; Test Items( column(s) )
...
**Sintaxis:** obj = Item Analysis(...Model( "Logístico 2PL"|"Logístico 3PL"|"Logístico 1PL" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;

**Descripción:** Identifica el modelo empleado para el análisis de ítems.
...
**Descripción:** Cambia la presentación de las curvas características del ítem que están cerradas de forma predeterminada.
...
**Sintaxis:** obj &lt;&lt; Save Ability Formula

**Descripción:** Guarda la fórmula de capacidad en una nueva columna de la tabla de datos.
...
**Sintaxis:** obj = Item Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
