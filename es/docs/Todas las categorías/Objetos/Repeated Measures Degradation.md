...
**Sintaxis:** obj &lt;&lt; Bayesian Models

**Descripción:** Especifica modelos bayesianos.
...
**Sintaxis:** obj &lt;&lt; Control

**Descripción:** Especifica la transformación de la respuesta, la transformación del tiempo y el tipo de modelo.
...
**Sintaxis:** obj &lt;&lt; Reference Temperature

**Descripción:** Establece el valor de temperatura de referencia utilizado por los modelos adecuados.
...
**Sintaxis:** obj &lt;&lt; Reference X

**Descripción:** Establece el valor de referencia utilizado por los modelos adecuados.
...
**Sintaxis:** obj &lt;&lt; Save Posterior To Script( state=0|1 )

**Descripción:** Especifica que cuando se guarda el script del informe actual, dicho script contiene las muestras posteriores. Si ejecuta el script guardado, las muestras posteriores se cargan directamente del script en el análisis Degradación de Medidas Repetidas. Opción activada de forma predeterminada.
...
**Sintaxis:** obj = Repeated Measures Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
