...
**Sintaxis:** obj &lt;&lt; Randomized SVD Dim( number=200 )

**Descripción:** Especifica el número de dimensiones de la SVD aleatorizada al que reducir el problema extenso. "200" de forma predeterminada.
