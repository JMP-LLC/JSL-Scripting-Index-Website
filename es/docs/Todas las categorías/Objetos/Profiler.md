...
**Descripción:** Oculta o muestra la fila de perfiles de deseabilidad.
...
**Sintaxis:** obj &lt;&lt; Error StdDev( Set Error StdDev(colume name(value),...) )

**Descripción:** Establece la desviación estándar utilizada para simular el error de las respuestas.
...
**Descripción:** Bloquea el factor continuo en el valor especificado. Este bloqueo es temporal.
...
**Descripción:** Muestra u oculta las relaciones de impacto. Estas relaciones muestran cómo los cambios de sensibilidad de cada factor, desde el punto medio hasta cada límite, afectan a la distancia entre las predicciones y los límites de especificación.
