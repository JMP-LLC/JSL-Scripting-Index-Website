...
**Sintaxis:** obj = K Means Cluster(...Columns( column(s) )...)
...
**Sintaxis:** obj = K Means Cluster(...Y( column(s) )...)
...
**Sintaxis:** Columns Scaled Individually( state=0|1 )

**Descripción:** Escala cada columna de forma independiente a las demás columnas. Opción activada de forma predeterminada.
