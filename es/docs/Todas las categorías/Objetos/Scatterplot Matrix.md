...
**Sintaxis:** obj = Scatterplot Matrix(...Matrix Format( "Triangular inferior"|"Triangular superior"|"Cuadrado" )...)
...
**Sintaxis:** obj = Scatterplot Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)
