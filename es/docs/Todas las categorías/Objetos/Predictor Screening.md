...
**Sintaxis:** obj = Predictor Screening(...&lt;By( column(s) )&gt;...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Predictor Screening(...Response( column(s) )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Predictor Screening(...X( column(s) )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Predictor Screening(...Y( column(s) )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Predictor Screening(...Number Trees( number=100 )...)

**Descripción:** Especifica el número de árboles de decisión en el modelo de bosque bootstrap. "100" de forma predeterminada.
...
**Sintaxis:** obj &lt;&lt; Save Results

**Descripción:** Crea una nueva tabla de datos que contiene la tabla de clasificación de predictores del informe.
...
**Sintaxis:** obj = Predictor Screening(...Set Random Seed( number )...)

**Descripción:** Establece la semilla para los valores iniciales que se utilizan en los procedimientos de ajuste.
...
**Sintaxis:** obj = Predictor Screening(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
