...
**Descripción:** "DEFAULT"  Utiliza la versión negociada de forma predeterminada (recomendado).

\\

 "1+" Fuerza la versión TLS 1.0 o superior, en función de lo que admitan el servidor y el cliente.
...
\\
 ...
 2.0 Fuerza TLS 2.0 (no recomendado)

\\

 3.0 Fuerza TLS 3.0 (no recomendado)

\\

 "MAX" Elige automáticamente la versión compatible más alta
