...
**Sintaxis:** Parallel Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**Sintaxis:** Parallel Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
...
**Sintaxis:** obj = Parallel Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
