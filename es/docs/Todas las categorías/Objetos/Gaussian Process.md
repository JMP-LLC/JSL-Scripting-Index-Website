...
**Sintaxis:** obj &lt;&lt; Block Size( number )

**Descripción:** Establece el número de observaciones que colocar en cada bloque para GASP rápido.
...
**Sintaxis:** obj &lt;&lt; Estimate Nugget( state=0|1 )

**Descripción:** Introduce un parámetro ridge en el procedimiento de estimación. Así se efectúa un alisado sobre el ruido en lugar de realizar una interpolación perfecta.
...
**Sintaxis:** obj &lt;&lt; Fast GASP( state=0|1 )

**Descripción:** La opción GASP rápido permite ajustar modelos con miles de filas.
...
**Descripción:** Construye la fórmula de predicción y la publica como script de columna de fórmula en el almacén de fórmulas.
...
**Sintaxis:** obj &lt;&lt; Publish Variance Formula

**Descripción:** Construye la fórmula de varianza y la publica como script de columna de fórmula en el almacén de fórmulas.
...
**Sintaxis:** obj &lt;&lt; Save Jackknife Predicted Values

**Descripción:** Guarda los valores predichos de jackknife en una columna nueva de la tabla de datos.
...
**Sintaxis:** obj &lt;&lt; Save Variance Formula

**Descripción:** Guarda la fórmula de varianza en una columna nueva de la tabla de datos.
...
**Sintaxis:** obj &lt;&lt; Set Correlation Function( structure=Gaussiano )

**Descripción:** Establece la estructura de correlación utilizada en el modelo.

La estructura Gaussiana impone que la correlación entre dos respuestas sea distinta de cero.

La estructura cúbica permite correlaciones igual a cero para puntos que se encuentren lo suficientemente alejados. "Gaussiano" de forma predeterminada.
...
**Sintaxis:** obj &lt;&lt; Set Minimum Theta( number )

**Descripción:** Establece el valor theta mínimo que se utiliza en el modelo ajustado.
...
**Sintaxis:** obj &lt;&lt; Set Nugget( number )

**Descripción:** Establece el tamaño de la pepita como constante utilizada como un parámetro ridge en el procedimiento de estimación.
...
**Sintaxis:** obj = Gaussian Process(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
