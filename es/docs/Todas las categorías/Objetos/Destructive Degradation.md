...
**Sintaxis:** obj &lt;&lt; Control( yTrans, timeTrans, distribution, path definition )

**Descripción:** Selecciona un modelo en el panel Definición de la trayectoria del informe. El modelo seleccionado también se muestra en el gráfico de degradación.
...
**Sintaxis:** obj &lt;&lt; Model( yTrans, timeTrans, distribution, path definition )

**Descripción:** Especifica un ajuste del modelo y muestra un informe para el modelo ajustado.
...
**Sintaxis:** obj &lt;&lt; Shade( state=0|1 )

**Descripción:** Muestra u oculta los límites superior e inferior para el modelo mostrado. Esta opción también muestra u oculta el sombreado entre los límites. Opción activada de forma predeterminada.
...
**Sintaxis:** obj &lt;&lt; Shade Coverage( proportion )

**Descripción:** Especifica una proporción para aumentar o disminuir la cantidad de cobertura del sombreado.
...
**Sintaxis:** obj &lt;&lt; Use Condition Temperature( "Celsius"|"Fahrenheit"|"Kelvin", temperature )

**Descripción:** Especifica la escala y la temperatura para la condición de uso (X0) en modelos cinéticos de primer orden.
...
**Sintaxis:** obj = Destructive Degradation(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
