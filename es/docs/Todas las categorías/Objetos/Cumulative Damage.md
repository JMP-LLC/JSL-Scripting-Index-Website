...
**Descripción:** Ajusta todas las distribuciones disponibles.
...
**Descripción:** Obtiene los resultados disponibles como objetos JSL.
...
**Sintaxis:** obj << Model Type( Step Stress | Ramp Stress | Sinusoid Stress | Piecewise Ramp Stress )

**Descripción:** Especifica el tipo de patrón de estrés para el modelo de daño acumulativo. Esta opción debe especificar en el script de inicio.
...
**Sintaxis:** obj << Simulate

**Descripción:** Muestra u oculta el panel de configuración de la simulación.
