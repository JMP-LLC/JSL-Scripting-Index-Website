...
**Sintaxis:** obj = Naive Bayes(...&lt;By( column(s) )&gt;...)
...
**Sintaxis:** obj = Naive Bayes(...Factor( column(s) )...)

**Descripción:** Especifica las columnas predictoras categóricas o continuas.
...
**Sintaxis:** obj = Naive Bayes(...&lt;Freq( column )&gt;...)
...
**Sintaxis:** obj = Naive Bayes(...Response( column )...)

**Descripción:** Especifica la columna de respuesta categórica cuyos valores representan las clases de interés.
...
**Sintaxis:** obj = Naive Bayes(...&lt;Validation( column )&gt;...)
...
**Sintaxis:** obj = Naive Bayes(...&lt;Weight( column )&gt;...)
...
**Sintaxis:** obj = Naive Bayes(...X( column(s) )...)
...
**Sintaxis:** obj = Naive Bayes(...Y( column )...)
...
**Sintaxis:** obj = Naive Bayes(...Prior Bias( fraction=.5 )...)

**Descripción:** Establece el valor de sesgo a priori. El valor se divide por el número de niveles de respuesta y, a continuación, esta cantidad se añade a los conteos para garantizar estimaciones de razones distintas de cero. ".5" de forma predeterminada.
...
**Descripción:** Muestra u oculta la curva Característica operativa del receptor (ROC) de cada nivel de la variable de respuesta. La curva ROC es un gráfico de sensibilidad frente a (1 - especificidad). Si ha utilizado la validación, se muestra un gráfico para cada conjunto de entrenamiento, validación y prueba. Opción activada de forma predeterminada.
...
**Descripción:** Guarda una columna nueva en la tabla de datos. La columna contiene las clasificaciones predichas.
...
**Descripción:** Guarda una columna nueva en la tabla de datos. La columna nueva contiene la fórmula de predicción para las clasificaciones.
...
**Descripción:** Guarda columnas nuevas en la tabla de datos. Estas columnas contienen las fórmulas que se utilizan para clasificar cada observación.
...
**Sintaxis:** obj = Naive Bayes(...Use Excluded Rows for Validation( state=0|1 )...)
...
**Sintaxis:** obj = Naive Bayes(...Validation Portion( fraction=0 )...)

**Descripción:** Especifica la parte de los datos que se utilizará como conjunto de validación. "0" de forma predeterminada.
...
**Sintaxis:** obj = Naive Bayes(...Window View( "Visible"|"Invisible"|"Private" )...)&lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
