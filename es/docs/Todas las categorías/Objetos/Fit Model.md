...
**Descripción:** Muestra u oculta un gráfico que contiene un punto por cada nivel del efecto distinto del de control. Cada punto muestra la media de mínimos cuadrados de ese nivel en relación con la media de mínimos cuadrados del nivel de control. Se representan los límites de decisión superior (UDL) y los límites de decisión inferior (LDL).
