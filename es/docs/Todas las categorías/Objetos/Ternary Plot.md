...
**Sintaxis:** obj = Ternary Plot(...<By( column(s) )>...)
...
**Sintaxis:** obj = Ternary Plot(...Contour Formula( formula column )...)
...
**Sintaxis:** obj = Ternary Plot(...Plotting( column(s) )...)
...
**Sintaxis:** obj = Ternary Plot(...X( column(s) )...)
...
**Sintaxis:** obj = Ternary Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
