...
**Sintaxis:** obj = Survival(...Censor Code( value=1 )...)
...
**Sintaxis:** obj = Survival(...Plot Failure instead of Surivival( state=0|1 )...)
...
**Sintaxis:** obj = Survival(...Window View( "Visible"|"Invisible"|"Private" )...)
