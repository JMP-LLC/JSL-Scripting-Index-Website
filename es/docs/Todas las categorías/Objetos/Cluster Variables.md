...
**Sintaxis:** obj = Cluster Variables(...<By( column(s) )>...)
...
**Sintaxis:** obj = Cluster Variables(...Columns( column(s) )...)
...
**Sintaxis:** obj = Cluster Variables(...<Freq( column )>...)
...
**Sintaxis:** obj = Cluster Variables(...<Weight( column )>...)
...
**Sintaxis:** obj = Cluster Variables(...Y( column(s) )...)
...
**Sintaxis:** obj = Cluster Variables(...Window View( "Visible"|"Invisible"|"Private" )...)
