...
**Sintaxis:** obj = Degradation(...Censor Code( value=1 )...) &lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Degradation(...Use Pooled MSE for Nonpoolable Model( state=0 )...) &lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
...
**Sintaxis:** obj = Degradation(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Elemento de inicio: Sí&lt;/b&gt;
