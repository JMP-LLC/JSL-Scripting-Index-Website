...
**Sintaxis:** obj = Multiple Correspondence Analysis(...<By( column(s) )>...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...<Factor( column(s) )>...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...<Freq( column )>...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...Response( column(s) )...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...<Supplementary ID( column )>...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...<Supplementary Variable( column(s) )>...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...<X( column(s) )>...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...Y( column(s) )...)
...
**Sintaxis:** obj = Multiple Correspondence Analysis(...<Z( column(s) )>...)
