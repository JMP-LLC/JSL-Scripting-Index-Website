...
**Descripción:** Simula un clic en el botón, ejecutando las rellamadas que procedan. Los botones de alternancia cambian de estado antes de invocar la rellamada. Los botones de menú requieren un argumento para especificar en qué elemento se hace clic.
...
**Sintaxis:** pressed = obj << Get

**Descripción:** Devuelve 1 si se pulsa el botón de alternar, 0 si no se pulsa. Solo se aplica a los botones que tengan Style("Toggle").
...
**Sintaxis:** name = obj << Get Button Name

**Descripción:** Devuelve el nombre de botón.
...
**Sintaxis:** icon = obj << Get Icon

**Descripción:** Devuelve el icono del botón.
...
**Sintaxis:** left|right = obj << Get Icon Location

**Descripción:** Devuelve la ubicación de un icono en un cuadro de botones. El icono se puede mostrar en el lado izquierdo o derecho del texto del botón.
...
**Sintaxis:** obj << Get Menu Choice

**Descripción:** Obtiene el índice de la última selección de menú del usuario

```js

Names Default To Here( 1 );
New Window( "Example",
	b = Button Box( "Popup Menu", Print( b << Get Menu Choice ) )
);
...
**Sintaxis:** list of menu items = obj << Get Menu Items

**Descripción:** Al hacer clic en el botón se obtienen los elementos de menú del menú emergente
...
**Descripción:** Devuelve el estilo actual del botón.
...
**Sintaxis:** style = obj << Get Underline Style

**Descripción:** Devuelve el estilo de subrayado actual del botón.
...
**Sintaxis:** obj << Open Next Outline

**Descripción:** Cierra el cuadro contenedor de esquema y abre el siguiente.
...
**Sintaxis:** obj << Restore Focus After Click( state=0|1 )

**Descripción:** Establece para el botón que el foco de edición se preserve después de haber hecho clic en él. La opción predeterminada para Windows es tomar el foco; la opción predeterminada para Macintosh es preservar el foco.
...
**Sintaxis:** obj << Set( pressed, <run script(0|1)> )

**Descripción:** Establece el estado de alternancia de un botón de alternar en pulsado (1) o no pulsado (0). Solo se aplica a los botones que tengan Style("Toggle").
...
**Sintaxis:** obj << Set Button Name( name )

**Descripción:** Establece el texto indicado como nombre para el botón.
...
**Sintaxis:** obj << Set Function( Function( {thisBox}, <script> ) | Method({thisBox}, <script>) | <symbol> )

**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se pulsa el botón.
...
**Sintaxis:** obj << Set Icon( icon name|image filepath )

**Descripción:** Muestra un icono JMP o una imagen en el botón. Utilice un nombre de icono de JMP o la ruta de acceso a un archivo de imagen.
...
**Sintaxis:** obj << Set Icon Location( left,right )

**Descripción:** Establece la ubicación del icono en el lado izquierdo o derecho del texto del botón
...
**Sintaxis:** obj << Set Menu Choice( index )

**Descripción:** Establece el índice de la selección de menú de usuario
...
**Sintaxis:** obj << Set Menu Items( list of menu items )

**Descripción:** Establece los elementos de menú a utilizar para el menú emergente cuando se hace clic en el botón
...
**Sintaxis:** obj << Style( "Normal"|"Subrayado"|"Alternancia" )

**Descripción:** Establece el estilo del botón.
...
**Sintaxis:** obj << Underline Style( state=0|1 )

**Descripción:** Establece el botón para que use el estilo de dibujo subrayado en lugar del estilo de botón estándar.
...
**Sintaxis:** obj << Unhide Next Item

**Descripción:** Revela elementos ocultos en el cuadro contenedor de esquema.
