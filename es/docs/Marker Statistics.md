...
**Sintaxis:** obj = Marker Statistics(...Marker Format( "Numérico"|"Un solo carácter"|"Carácter"|"Nucleótido de código único"|"Nucleótido"="Numérico" )...)
...
**Sintaxis:** obj = Marker Statistics(...Ploidy( number=2 )...)
...
**Sintaxis:** obj = Marker Statistics(...Unthreaded( state=0|1 )...)
...
**Sintaxis:** obj = Marker Statistics(...Use Annotation Table( state=0|1 )...)
...
**Sintaxis:** obj = Marker Statistics(...Window View( "Visible"|"Invisible"|"Private" )...)
