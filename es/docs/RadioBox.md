...
**Descripción:** Habilita o deshabilita un elemento concreto de una casilla de opción
...
**Descripción:** Devuelve el índice 1 del botón de opción seleccionado.
...
**Sintaxis:** selectedText = obj << Get Selected

**Descripción:** Obtiene el texto del botón de opción seleccionado
...
**Sintaxis:** obj << Group( radiobox )

**Descripción:** Agrupa juntos los cuadros de opciones de manera que sólo se seleccione cada vez un botón de opción del grupo
...
**Sintaxis:** obj << Index Of( string )

**Descripción:** Devuelve el índice de una cadena, o 0 si no se encuentra
...
**Sintaxis:** obj << Item Enabled( index )

**Descripción:** Verifica si está habilitado o deshabilitado un elemento concreto de un cuadro de casillas de opción
...
**Descripción:** Devuelve un cuadro de visualización para mostrar una lista o botones de opción. Cuando se hace clic en un botón de opción se ejecuta el script.
...
**Descripción:** Establece el botón de opción seleccionado.
...
**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se hace clic en una casilla de opción.
