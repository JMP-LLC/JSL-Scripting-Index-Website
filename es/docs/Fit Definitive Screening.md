...
**Sintaxis:** Fit Definitive Screening( Y( column ), X( columns ) )

**Descripción:** Analiza los diseños de cribado definitivos (DSD) usando una metodología denominada Selección de modelo efectiva para DSD. Este algoritmo utiliza la estructura exclusiva del diseño para identificar efectos principales y de segundo orden.
...
**Sintaxis:** obj << Interactions Obey Strong Heredity( state=0|1 )

**JMP Versión agregada:** 14

### Make Model Callback

**Sintaxis:** obj << Make Model Callback
...
**Sintaxis:** obj << Quadratic Terms Obey Strong Heredity( state=0|1 )
...
**Sintaxis:** obj << Run Model Callback
...
**Sintaxis:** obj << Set Stage 1 p value

**JMP Versión agregada:** 15

### Set Stage 2 ratio

**Sintaxis:** obj << Set Stage 2 ratio
