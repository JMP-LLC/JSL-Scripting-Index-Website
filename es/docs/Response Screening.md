...
**Sintaxis:** obj = Response Screening(...<By( column(s) )>...)
...
**Sintaxis:** obj = Response Screening(...Cauchy( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Common X Scale( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Common Y Scale( state=0|1 )...)
...
**Descripción:** Specifies the method for comparing means or rates. You can compare each level with a control group level or compare all possible level combinations.
...
**Sintaxis:** obj = Response Screening(...Corr( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Empirical Bayes Shrinkage( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Force X Categorical( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Force X Continuous( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Force Y Categorical( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Force Y Continuous( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...<Freq( column )>...)
...
**Sintaxis:** obj = Response Screening(...<Grouping( column(s) )>...)
...
**Sintaxis:** obj = Response Screening(...Kappa( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Kruskal Wallis Test( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Max Comparison Levels( number=100 )...)
...
**Sintaxis:** obj = Response Screening(...Max Logworth( number )...)
...
**Sintaxis:** obj = Response Screening(...Missing is Category( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Negative Binomial Y( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...No Report( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Paired X and Y( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Poisson Y( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Quartiles per Group( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Response( column(s) )...)
...
**Sintaxis:** obj = Response Screening(...Robust( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...<Subgroup( column(s) )>...)
...
**Sintaxis:** obj = Response Screening(...Subgroup Twoway( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...Unthreaded( state=0|1 )...)
...
**Sintaxis:** obj = Response Screening(...<Weight( column )>...)
...
**Sintaxis:** obj = Response Screening(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**Sintaxis:** obj = Response Screening(...X( column(s) )...)
...
**Sintaxis:** obj = Response Screening(...Y( column(s) )...)
