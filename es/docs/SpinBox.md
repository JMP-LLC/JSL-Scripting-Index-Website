...
**Sintaxis:** obj << Click( <value> )

**Descripción:** Simula que se hace clic en el botón y se ejecuta cualquier script asociado.
...
**Sintaxis:** obj << Decrement( <value> )

**Descripción:** Simula un clic en la flecha hacia abajo, y ejecuta cualquier secuencia de comandos adjunta.
...
**Sintaxis:** obj << Increment( <value> )

**Descripción:** Simula un clic en la flecha hacia arriba, y ejecuta cualquier secuencia de comandos adjunta.
...
**Sintaxis:** obj << Set Function( Function( {thisBox, increment}, <script> ) )

**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se pulsan los botones del cuadro de número. [increment] es el incremento establecido para el cuadro numérico.
...
**Descripción:** Devuelve un cuadro de visualización que muestra un botón con controles hacia arriba y hacia abajo. El argumento script se invoca con un argumento que indica el sentido de la flecha en la que se haya hecho clic (negativo significa hacia abajo y positivo hacia arriba). El valor 1 significa un solo clic. Es posible usar valores mayores para indicar una acción repetida.
