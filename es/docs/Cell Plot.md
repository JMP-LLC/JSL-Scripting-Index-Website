...
**Sintaxis:** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**Sintaxis:** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
...
**Sintaxis:** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
