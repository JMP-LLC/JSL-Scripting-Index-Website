...
**Sintaxis:** obj = Marker Simulation(...Estimate Diversity( state=0|1 )...)
...
**Sintaxis:** obj = Marker Simulation(...Imputation Value( number=0 )...)
...
**Sintaxis:** obj = Marker Simulation(...Missing Marker Imputation Method( "HWE desactivado"|"HWE activado"|"Aleatorio"|"Especificado"="HWE desactivado" )...)
...
**Sintaxis:** obj = Marker Simulation(...Number of Generations( number=1 )...)
...
**Sintaxis:** obj = Marker Simulation(...Number of Individuals per Cross( number=5 )...)
...
**Sintaxis:** obj = Marker Simulation(...Number of Selected Crosses( number=0 )...)
...
**Sintaxis:** obj = Marker Simulation(...Number of Selected Individuals( number=0 )...)
...
**Sintaxis:** obj = Marker Simulation(...Ploidy( number=2 )...)
...
**Sintaxis:** obj = Marker Simulation(...Select Best Individuals( state=0|1 )...)
...
**Sintaxis:** obj = Marker Simulation(...Set Random Seed( number=0 )...)
...
**Sintaxis:** obj = Marker Simulation(...Threshold to Make Line Plots( number=500 )...)
...
**Sintaxis:** obj = Marker Simulation(...Unthreaded( state=0|1 )...)
...
**Sintaxis:** obj = Marker Simulation(...Use Annotation Table( state=0|1 )...)
...
**Sintaxis:** obj = Marker Simulation(...Use Only Markers Found in Predictor Formula( state=0|1 )...)
...
**Sintaxis:** obj = Marker Simulation(...Window View( "Visible"|"Invisible"|"Private" )...)
