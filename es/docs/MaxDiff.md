...
**Sintaxis:** obj = MaxDiff(...Convergence Criterion( number )...)
...
**Sintaxis:** obj = MaxDiff(...Firth Bias-Adjusted Estimates( state=0|1 )...)
...
**Sintaxis:** obj = MaxDiff(...Hierarchical Bayes( state=0|1 )...)
...
**Sintaxis:** obj = MaxDiff(...Number of Bayesian Iterations( number )...)
...
**Sintaxis:** obj = MaxDiff(...One Table...)
...
**Sintaxis:** obj = MaxDiff(...<Profile Effects( column )>...)
...
**Sintaxis:** obj = MaxDiff(...Remove Subject Effects...)
...
**Sintaxis:** MaxDiff( Response Best Option( column ), ... )
...
**Sintaxis:** MaxDiff( Response Value Indicates Best( value ), ... )
...
**Sintaxis:** MaxDiff( Response Value Indicates Worst( value ), ... )
...
**Sintaxis:** MaxDiff( Response Worst Option( column ), ... )
...
**Sintaxis:** obj = MaxDiff(...<Subject Effects( column )>...)
...
**Sintaxis:** obj = MaxDiff(...Window View( "Visible"|"Invisible"|"Private" )...)
