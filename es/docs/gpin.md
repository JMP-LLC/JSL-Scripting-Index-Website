...
**Sintaxis:** obj << Add Text( "string" )

**Descripción:** Agrega un bloque de texto personalizado a la etiqueta flotante anclada.
...
**Sintaxis:** obj << Click Link( "<index, integer>" )

**Descripción:** Simula una acción de clic en el vínculo asociado al texto o índice proporcionados. Si no se especifica ninguno, toma el último vínculo, que es el graphlet por lo general, si lo hay.
...
**Descripción:** Cierra la etiqueta flotante.
...
**Sintaxis:** "string" = obj << Copy

**Descripción:** Copia el contenido de la etiqueta flotante en el portapapeles. 

Si la operación está asignada a una variable, se almacena ahí el contenido de texto de la etiqueta flotante.
...
**Descripción:** Elimina la anotación de encima del cuadro de visualización.
...
**Sintaxis:** obj << Deleteable

**Descripción:** Permite eliminar "borrar" del menú contextual
...
**Descripción:** Inicia un editor visual para el contenido de la etiqueta flotante.
...
**Descripción:** Establece la fuente de la etiqueta flotante anclada
...
**Sintaxis:** obj << Get Links

**Descripción:** "Devuelve una lista de texto asociado a las entradas en las que se puede hacer clic en la etiqueta flotante. 

Las imágenes y graphlets están asociados a una cadena vacía
...
**Sintaxis:** Associative Array = obj << Get Local Context

**Descripción:** Devuelve un arreglo asociativo con los nombres y valores de las variables locales proporcionadas como parte del contexto de ejecución de la etiqueta flotante.

Consulte las definiciones prestablecidas del graphlet para obtener ejemplos de uso.
...
**Sintaxis:** obj << Launch graphlet

**Descripción:** Inicia la plataforma o visualización del graphlet en una nueva ventana.

Se puede recuperar el iniciador/contenido anterior con un comando Deshacer.

Se obtiene la misma funcionalidad haciendo clic en la miniatura del graphlet.
...
**Sintaxis:** obj << Launch in last

**Descripción:** Inicia la plataforma o visualización del graphlet en una nueva ventana o en la última ventana iniciada reemplazando su contenido.

Se puede recuperar el iniciador/contenido anterior con un comando Deshacer.

Se obtiene la misma funcionalidad pulsando Alt y haciendo clic en la miniatura del graphlet.
...
**Sintaxis:** obj << Launch in place

**Descripción:** Inicia la plataforma o visualización del graphlet en la ventana actual reemplazando su contenido.

Se puede recuperar el iniciador/contenido anterior con un comando Deshacer.

Se obtiene la misma funcionalidad pulsando Control y haciendo clic en la miniatura del graphlet.
...
**Sintaxis:** obj << Reanchor

### Replace Text

**Sintaxis:** obj << Replace Text( "string" )

**Descripción:** Reemplaza el contenido de texto de la etiqueta flotante anclada por el texto especificado.
...
**Sintaxis:** obj << Revert Text

**Descripción:** Revierte el contenido de texto de la etiqueta flotante anclada al texto original.
...
**Descripción:** Inicia una tabla de datos con un filtro de datos local que solo muestra el subconjunto de los datos asociados al elemento visual situado bajo la etiqueta flotante.
...
**Sintaxis:** obj << Tag Line( state=0|1 )
...
**Sintaxis:** obj << Use Gradient( state=0|1 )
