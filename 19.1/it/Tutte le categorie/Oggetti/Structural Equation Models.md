...
**Sintassi:** obj = Structural Equation Models(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj &lt;&lt; Composite Error( state=0|1 )

**Descrizione:** Mostra o nasconde l&apos;errore composito delle equazioni ai minimi quadrati a due stadi delle variabili strumentali implicite nel modello.
...
**Sintassi:** obj &lt;&lt; Show All Equations( state=0|1 )

**Descrizione:** Mostra o nasconde le equazioni nel modello che hanno come predittore solo la costante.
...
**Sintassi:** obj &lt;&lt; Variance of the Error( state=0|1 )

**Descrizione:** Mostra o nasconde la varianza dell&apos;errore per ogni equazione del modello.
...
**Sintassi:** obj &lt;&lt; Remove Effects

**Descrizione:** Rimuove gli effetti indiretti specifici dal report.
