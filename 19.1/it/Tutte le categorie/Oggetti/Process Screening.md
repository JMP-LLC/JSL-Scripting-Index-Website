...
**Descrizione:** Specifica il peso utilizzato nello smoother doppio-esponenziale di Holt per la rilevazione del drift. ".05", per impostazione predefinita.
...
**Descrizione:** Memorizza tutte le informazioni sullo shift in modo che possano essere salvate successivamente in una tabella di dati utilizzando l&apos;opzione Salva tabella shift. Questa opzione deve essere specificata nello script di avvio.
...
**Descrizione:** Mostra o nasconde il massimo per i tipi di grafico Conteggio e Continuo non negativo. Per impostazione predefinita l&apos;opzione è attivata.
...
**Descrizione:** Rilancia la piattaforma Screening dei processi per creare un nuovo report che contiene solo i processi selezionati dal report originale.
...
**Descrizione:** Crea una nuova tabella di dati che contiene i dati degli intervalli di shift memorizzati. Questa opzione richiede che l&apos;opzione Crea dati dettagliati di shift sia specificata nello script di avvio.
...
**Descrizione:** Mostra o nasconde la colonna Azione nella tabella di riepilogo. Questo test viene attivato quando un punto è maggiore di un limite di azione superiore o inferiore a un limite di azione inferiore. Per impostazione predefinita l&apos;opzione è attivata.
...
**Descrizione:** Mostra o nasconde la colonna Allarme nella tabella di riepilogo. Questo test viene attivato quando un punto è maggiore del limite di allarme superiore o inferiore al limite di allarme inferiore.
...
**Descrizione:** Mostra o nasconde la colonna Aumento Allarme nella tabella di riepilogo. Questa colonna conta i casi in cui il processo è in aumento e il punto precedente è superiore al limite di allarme superiore o se un processo è in diminuzione e il punto precedente è inferiore al limite di allarme inferiore.
...
**Descrizione:** Specifica se utilizzare il limite inferiore K-Sigma. Questa opzione è disponibile solo per i grafici di proporzione.
...
**Descrizione:** Specifica se utilizzare il limite superiore K-Sigma. Questa opzione è disponibile solo per i grafici di proporzione. Per impostazione predefinita l&apos;opzione è attivata.
