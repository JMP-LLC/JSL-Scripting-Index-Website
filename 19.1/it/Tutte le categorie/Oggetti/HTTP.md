...
**Descrizione:** "DEFAULT" Usa la versione negoziata di default (consigliata).

\\\\

         "1+" Forza la versione TLS 1.0 o superiore, a seconda di quella supportata sia dal server sia dal client.
...
\\
         ...
         2.0        Forza TLS 2.0 (non consigliato)

\\

         3.0        Forza TLS 3.0 (non consigliato)

\\

         "MAX" Sceglie automaticamente la versione più alta tra quelle supportate
