...
**Sintassi:** obj &lt;&lt; Arrange Plots( number across )

**Descrizione:** Dispone i diagrammi orizzontalmente. Disponibile solo quando è presente una variabile X.
...
**Sintassi:** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) ) &lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Descrizione:** Mostra/Nasconde la legenda allegata alla fine del diagramma.
...
**Sintassi:** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) ) &lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
...
**Sintassi:** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Elemento Finestra di dialogo di avvio: Sì&lt;/b&gt;
