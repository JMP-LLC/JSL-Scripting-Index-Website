...
**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando viene selezionato un nuovo elemento dal riquadro a comparsa.
