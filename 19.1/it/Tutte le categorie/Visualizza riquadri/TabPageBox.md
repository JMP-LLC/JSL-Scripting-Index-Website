...
**Descrizione:** Chiude la scheda, se possibile.
...
**Sintassi:** obj &lt;&lt; Closeable( state=0|1 )

**Descrizione:** Imposta lo stato di chiusura della scheda.
...
**Sintassi:** obj &lt;&lt; Focus Color( color ); color = obj &lt;&lt; Get Focus Color

**Descrizione:** Se è impostato il colore dello stato attivo, viene utilizzato per la barra dello stato attivo del titolo della scheda quando la scheda o un riquadro al suo interno è attivo.
...
**Sintassi:** obj &lt;&lt; Get Close

**Descrizione:** Restituisce lo script che viene eseguito quando la scheda viene chiusa da uno script o tramite l&apos;icona di chiusura. Lo script deve restituire 1 per consentire la chiusura o 0 per annullarla.
...
**Sintassi:** "string" = obj &lt;&lt; Get Close Tip
...
**Sintassi:** "bool" = obj &lt;&lt; Get Closeable

**Descrizione:** Restituisce lo stato di chiusura della scheda.
...
**Sintassi:** "string" = obj &lt;&lt; Get Icon

**Descrizione:** Restituisce l&apos;icona della scheda.
...
**Sintassi:** obj &lt;&lt; Get Moveable

**Descrizione:** Restituisce l’impostazione di spostamento del riquadro.
...
**Descrizione:** Restituisce un riferimento a un oggetto che supporta script associato al riquadro Tab Page.
...
**Descrizione:** Restituisce la descrizione della scheda
...
**Descrizione:** Restituisce il titolo di Tab Page Box.
...
**Sintassi:** obj &lt;&lt; Icon( "string" )

**Descrizione:** Imposta l&apos;icona della scheda.
...
**Descrizione:** Blocca il titolo della pagina della scheda per impedire modifiche interattive.
...
**Sintassi:** obj &lt;&lt; Moveable( state=0|1 )

**Descrizione:** I riquadri spostabili possono essere sistemati all&apos;interno di un riquadro ancorabile utilizzando drag-and-drop.
...
**Sintassi:** obj &lt;&lt; Set Close( script|Function( {this}, &lt;script&gt; ) )

**Descrizione:** Imposta l&apos;esecuzione di script o di Function quando la scheda viene chiusa da uno script o tramite l&apos;icona di chiusura. script o Function dovrebbero restituire 1 per consentire la chiusura o 0 per annullarla.
...
**Sintassi:** obj &lt;&lt; Set Close Tip( "string" )
...
**Descrizione:** Imposta l&apos;oggetto che supporta script associato al riquadro Pagina delle schede. Il riquadro Pagina delle schede presenterà un menu associato al triangolo rosso di messaggi che possono essere inviati all&apos;oggetto che supporta script. Se non viene specificato alcun argomento, l&apos;oggetto che supporta script sarà cancellato.
...
**Descrizione:** Imposta una funzione che viene eseguita quando il titolo della pagina della scheda viene cambiato.
...
**Sintassi:** obj &lt;&lt; Tip( "string" )

**Descrizione:** Imposta la descrizione della scheda.
...
**Sintassi:** obj &lt;&lt; Title( "string", &lt;Run Script(0 | 1)&gt; )

**Descrizione:** Imposta il titolo di Tab Page Box.
