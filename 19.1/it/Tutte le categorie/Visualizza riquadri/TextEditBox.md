...
**Descrizione:** Restituisce un riquadro di visualizzazione che contiene testo modificabile.
...
**Sintassi:** obj &lt;&lt; Bullet point( state=0|1 )

**Descrizione:** Inserisce un carattere punto elenco che precede il testo.
...
**Sintassi:** obj &lt;&lt; Enable( state=0|1 )

**Descrizione:** Imposta se la TextEditBox può essere modificata.
...
**Sintassi:** obj &lt;&lt; Fixed Size( state=0|1, &lt;width&gt;, &lt;height&gt; )

**Descrizione:** Se questa opzione è attivata, la TextBox non si espande se la larghezza del testo è maggiore della larghezza della TextBox.
...
**Sintassi:** bullet = obj &lt;&lt; Get Bullet

**Descrizione:** Restituisce un valore che indica se prima del testo viene inserito un carattere punto di elenco.
...
**Descrizione:** Ottiene la funzione che viene eseguita dopo le modifiche al testo.
...
**Sintassi:** 0|1 = obj &lt;&lt; Get Hidden State( state=0|1 )
...
**Sintassi:** "string" = obj &lt;&lt; Get Hint

**Descrizione:** Il testo visualizzato mostra un suggerimento quando la casella di testo è vuota.
...
**Sintassi:** justify = obj &lt;&lt; Get Justify

**Descrizione:** Allinea il testo a sinistra, al centro o a destra.
...
**Sintassi:** rotation = obj &lt;&lt; Get Rotation

**Descrizione:** Restituisce la rotazione del testo.
...
**Descrizione:** Restituisce la stringa contenuta nel riquadro.
...
**Sintassi:** function = obj &lt;&lt; Get Text Changed

**Descrizione:** Restituisce la funzione eseguita ogni volta che si effettua una modifica al testo.
...
**Sintassi:** "string" = obj &lt;&lt; Get Tip

**Descrizione:** Restituisce la descrizione comando di Text Box.
...
**Descrizione:** Restituisce la larghezza della TextBox.
...
**Sintassi:** obj &lt;&lt; Get Wrap

**Descrizione:** Restituisce il punto corrente per andare a capo, in pixel.
...
**Sintassi:** obj &lt;&lt; Hide( state=0|1 )

**Descrizione:** Mostra/Nasconde il testo.
...
**Sintassi:** obj &lt;&lt; Is Enabled( state=0|1 )
...
**Sintassi:** obj &lt;&lt; Justify Text( "Sinistra"|"Centro"|"Destra" )
...
**Sintassi:** obj &lt;&lt; Markup( state=0|1 )

**Descrizione:** Indica che il testo potrebbe contenere markup HTML e deve essere interpretato. I tag HTML supportati sono grassetto (<b></b>), corsivo (<i></i>), sottolineato(<u></u>), tipo di carattere(<font face=&apos;&apos;></font>), colore carattere(<font color=&apos;&apos;></font>), dimensione carattere(<font size=&apos;&apos;></font> e colore di sfondo(<background color=&apos;&apos;></background>). Per il colore del carattere e il colore di sfondo è possibile specificare il colore in base al nome (blu), alla tripletta esadecimale, specificata nella sintassi HTML (#0000ff) o al formato esadecimale (0x0000ff). Se un nome specifica un colore, il nome usa la definizione di JMP del colore.
...
**Sintassi:** obj &lt;&lt; Password Style( state=0|1 )

**Descrizione:** Se questa opzione è attivata, nella TextEditBox compare \*\*\*\*\* invece della password.
...
**Sintassi:** obj &lt;&lt; Preprocess Markup( state=0|1 )

**Descrizione:** Indica che il testo deve essere pre-elaborato per sostituire i tag di markup JMP con tag HTML correttamente formattati.
...
**Descrizione:** Ripristina il contenuto del testo al suo valore iniziale.
...
**Sintassi:** obj &lt;&lt; Rotate Text( left|right|horizontal )

**Descrizione:** Ruota il testo di 90 gradi a sinistra o a destra, oppure lo riporta in orizzontale.
...
**Sintassi:** obj &lt;&lt; Set Script( script ) obj &lt;&lt; Script( script )

**Descrizione:** Dopo le modifiche al testo sarà eseguito lo script specificato.
...
**Descrizione:** Imposta la funzione specificata per il controllo. Lo script della funzione viene eseguito quando si apporta una modifica alla casella di modifica del testo.
...
**Sintassi:** obj &lt;&lt; Set Text( "string", &lt;Run Script(bool)&gt; )

**Descrizione:** Modifica il contenuto di stringhe del riquadro. Per la casella di modifica del testo, un argomento Run Script(bool) facoltativo imposta se lo script della casella deve essere eseguito quando viene eseguito Imposta testo. Il valore predefinito è 0 (lo script non viene eseguito).
...
**Sintassi:** obj &lt;&lt; Set Text Changed( Function( {this, value}, &lt;script&gt; ) )

**Descrizione:** Imposta la function che viene eseguita ogni volta che si apporta una modifica al testo. Questo callback viene chiamato durante la modifica prima che sia completata. Nel caso di annullamento di un&apos;operazione di modifica, viene generato un altro callback in modo da fornire il valore originale.
...
**Sintassi:** obj &lt;&lt; Set Tip( text )

**Descrizione:** Imposta la descrizione comando di Text Box.
...
**Descrizione:** Imposta la larghezza della TextBox.
...
**Sintassi:** obj &lt;&lt; Set Wrap( n )

**Descrizione:** Imposta il punto per andare a capo, in pixel (n).
...
**Sintassi:** obj &lt;&lt; SetNLines( number )

**Descrizione:** Imposta il numero di righe che possono costituire il testo.
...
**Sintassi:** obj &lt;&lt; White Box Style( 0=ordinary text, 1=bordered white box entry field )

**Descrizione:** Determina se deve apparire come un campo di immissione con il testo all&apos;interno di un riquadro bianco con bordo o semplicemente come testo normale sul quale si può fare clic per modificarlo.
