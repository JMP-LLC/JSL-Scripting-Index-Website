...
**Beschreibung:** Führt das vorgegebene Javascript asynchron im Kontext der aktuellen Seite aus. Gibt eine Zusage für das Skriptergebnis zurück (als Zeichenkette)
...
**Beschreibung:** Gibt die URL zurück, die der Browser aufgerufen hat.
...
**Beschreibung:** Geht zur angegebenen URL.
...
**Beschreibung:** Legt die Breite und Höhe des Felds für den Webbrowser fest. Das Webbrowserfeld hat für „Strecken“ die Standardeinstellung „Fenster“, die in „Aus“ geändert werden muss, um die gewünschte Größe zu erhalten.
