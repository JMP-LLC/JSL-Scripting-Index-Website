...
**Beschreibung:** Verringert den Wert um die aktuelle Einstellung.
...
**Beschreibung:** Gibt die gegenwärtig im Bearbeitungsfeld eingegebene Zahl zurück.
...
**Beschreibung:** Wenn festgelegt, wird der Maximalwert aus dem Bereich gültiger Zahlen ausgeschlossen.
...
**Beschreibung:** Wenn festgelegt, wird der Minimalwert aus dem Bereich gültiger Zahlen ausgeschlossen.
...
**Beschreibung:** Gibt das Format der anzuzeigenden Zahl zurück.
...
**Beschreibung:** Gibt das Inkrement für die Schrittsteuerung zurück. Dieser Wert wird verwendet, wenn während der Bearbeitung die Aufwärts- oder Abwärts-Pfeiltasten gedrückt oder die <<Increment- bzw. <<Decrement-Meldungen gesendet werden.
...
**Beschreibung:** Wenn festgelegt, sind nur ganzzahlige Werte zugelassen.
...
**Beschreibung:** Gibt den Maximalwert zurück. Ein fehlender Wert gibt an, dass es keinen Maximalwert gibt.
...
**Beschreibung:** Gibt den Minimalwert zurück. Ein fehlender Wert gibt an, dass es keinen Minimalwert gibt.
...
**Beschreibung:** Gibt die Funktion zurück, die bei jeder Änderung an der Zahl ausgeführt wird.
...
**Beschreibung:** Gibt die Einstellung für das Spin Box zurück.
...
**Beschreibung:** Returns the tooltip of the Number Box.
...
**Beschreibung:** Gibt zurück, welche Zeichenbreite das Bearbeitungsfeld für Zahlen hat.
...
**Beschreibung:** Legt das Inkrement für die Schrittsteuerung fest. Dieser Wert wird verwendet, wenn während der Bearbeitung die Aufwärts- oder Abwärts-Pfeiltasten gedrückt oder die <<Increment- bzw. <<Decrement-Meldungen gesendet werden.
...
**Beschreibung:** Legt für den Inhalt des Bearbeitungsfelds die übergebene Zahl fest.
...
**Beschreibung:** Legt das Format der anzuzeigenden Zahl fest.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn die Änderung am Bearbeitungsfeld für Zahlen festgeschrieben wird.
...
**Beschreibung:** Legt das Inkrement für die Schrittsteuerung fest. Dieser Wert wird verwendet, wenn während der Bearbeitung die Aufwärts-/Abwärts-Pfeiltasten gedrückt oder die <<Increment- bzw. <<Decrement-Meldungen gesendet werden.
...
**Beschreibung:** Legt den Maximalwert fest. Ein fehlender Wert gibt an, dass es keinen Maximalwert gibt.
...
**Beschreibung:** Legt den Minimalwert fest. Ein fehlender Wert gibt an, dass es keinen Minimalwert gibt.
...
**Beschreibung:** Legt die Funktion fest, die bei jeder Änderung an der Zahl ausgeführt wird. Dieser Rückruf wird während der Bearbeitung aufgerufen, bevor die Änderung festgeschrieben wird. Bei einem abgebrochenen Bearbeitungsvorgang wird ein zusätzlicher Rückruf generiert, um den ursprünglichen Wert bereitzustellen.
...
**Beschreibung:** Zeigt ein Spin Box an, um den Wert zu erhöhen.
...
**Beschreibung:** Sets the tooltip of the Number Box.
...
**Beschreibung:** Legt fest, dass das Bearbeitungsfeld für Zahlen n Zeichen breit ist.
