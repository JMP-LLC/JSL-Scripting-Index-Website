...
**Beschreibung:** Gibt an, dass die Werte in der Spalte anhand des Dezimaltrennzeichens vertikal ausgerichtet werden.
...
**Beschreibung:** Legt fest, ob semantische Formate auf die Spalte angewendet werden. Semantische Formate können auch über die Voreinstellungen festgelegt werden.
...
**Beschreibung:** Gibt 1 zurück, wenn die Spalte Werte am Dezimaltrennzeichen ausrichtet, ansonsten 0.
...
**Beschreibung:** Gibt das bedingte Format zurück.
...
**Beschreibung:** Gibt das geltende Format der Spalte zurück, dabei handelt es sich um das Format nach Anwenden eines übereinstimmenden semantischen Formats. Wird row vorgegeben, wird das geltende Format für genau die Zeile zurückgegeben.
...
**Beschreibung:** Gibt die Einstellung „Semantische Formate aktivieren“ für die Spalte zurück. Semantische Formate können auch über die Voreinstellungen festgelegt werden.
...
**Beschreibung:** Gibt das aktuelle Format zurück (width, decimalplaces). decimalplaces > 100 gibt Datums-/Uhrzeitwerte an.
...
**Beschreibung:** Wenn auf 1 gesetzt, werden fehlende Werte nicht angezeigt
...
**Beschreibung:** Legt das bedingte Format fest.
...
**Beschreibung:** Legt das Format der anzuzeigenden Zahlen fest.
...
**Beschreibung:** Legt die vorgegebene Funktion für das Bedienelement fest. Das Skript der Funktion wird ausgeführt, wenn eine Änderung festgeschrieben wird. which ist die Zeilennummer der geänderten Zelle.
...
**Beschreibung:** Aktualisiert NumberColBox mit den angegebenen Werten.
...
**Beschreibung:** Gibt ein Anzeigefeld mit bearbeitbaren Zahlen in einer Spalte zurück.
