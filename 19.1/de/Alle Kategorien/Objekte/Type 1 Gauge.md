...
**Syntax:** obj = Type 1 Gauge(...Percent of Tolerance( number=20 )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;

**Beschreibung:** Ändert den Prozentwert der Teiltoleranz für den Vergleich gegen die Messungsvariation. Standardmäßig „20“.
...
**Beschreibung:** Für jede Spalte mit Messdaten werden die Metadaten für MSA Typ 1 als Spalteneigenschaft MSA-Metadaten innerhalb der Spalte der ursprünglichen Datentabelle gespeichert.
...
**Beschreibung:** Erstellt eine neue Datentabelle, die die Metadaten für MSA Typ 1 für jede Spalte mit Messdaten enthält. Die Tabelle hat ein langes Format und enthält eine Zeile für jede Messvariable.
...
**Syntax:** obj = Type 1 Gauge(...Set Alpha Level( number=.05 )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;

**Beschreibung:** Gibt das Alpha-Niveau an, das im Test der systematischen Abweichung verwendet wird. Standardmäßig „.05“.
...
**Syntax:** obj = Type 1 Gauge(...Sigma Multiplier( number=6 )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Gibt die Optionen für den Bericht „Analyse MSA Typ 1“ für jede Zielgröße der Messung an.
...
**Syntax:** obj = Type 1 Gauge(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Type 1 Gauge(...&lt;By( column(s) )&gt;...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Type 1 Gauge(...&lt;Freq( column )&gt;...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Type 1 Gauge(...Measurement( column(s) )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Type 1 Gauge(...Y( column(s) )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Analysiert Messsysteme mit der Methode MSA Typ 1, um die Wiederholbarkeit und die systematische Abweichung eines Messprozesses an einem Referenzteil auszuwerten.
...
**Beschreibung:** Richtet die im Bericht „Zusammenfassung und Prozessfähigkeitskenngrößen“ angezeigten statistischen Kenngrößen benutzerspezifisch ein.
...
**Beschreibung:** Zeigt einen Test der systematischen Abweichung des Mittelwerts der beobachteten Messwerte und den Referenzstandardwert im Bericht „Analyse MSA Typ 1“ an oder blendet ihn aus.
...
**Beschreibung:** Zeigt ein Histogramm der Messdaten im Bericht „Analyse MSA Typ 1“ an oder blendet es aus.
...
**Beschreibung:** Zeigt das Verlaufsdiagramm der Messdaten im Bericht „Analyse MSA Typ 1“ an oder blendet es aus. Dieses Diagramm zeigt die Variation der Messungen in Bezug auf den Referenzwert und den Prozentwert des Toleranzbereichs. Standardmäßig ein.
...
**Beschreibung:** Zeigt die Tabelle „Zusammenfassung und Prozessfähigkeitskenngrößen“ für MSA Typ 1 an oder blendet sie aus. Standardmäßig ein.
...
**Beschreibung:** Zeigt rechts vom Histogrammrahmen im Bericht „Analyse MSA Typ 1“ eine Zählachse an oder blendet sie aus.
...
**Beschreibung:** Zeigt die Referenzlinie im Histogramm im Bericht „Analyse MSA Typ 1“ an oder blendet sie aus. Standardmäßig ein.
...
**Beschreibung:** Zeit die Mittelwertgerade im Verlaufsdiagramm im Bericht „Analyse MSA Typ 1“ an oder blendet sie aus.
...
**Beschreibung:** Zeigt Linien für den Anteil der Toleranz im Verlaufsdiagramm im Bericht „Analyse MSA Typ 1“ an oder blendet sie aus. Standardmäßig ein.
...
**Beschreibung:** Zeigt die Referenzlinie im Verlaufsdiagramm im Bericht „Analyse MSA Typ 1“ an oder blendet sie aus. Standardmäßig ein.
