...
**Beschreibung:** Ordnet die Diagramme horizontal an. Nur verfügbar, wenn eine X-Variable vorhanden ist.
...
**Syntax:** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) ) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Beschreibung:** Zeigt die Legende am Ende des Diagramms an oder blendet sie aus.
...
**Syntax:** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) ) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
...
**Syntax:** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Element im Startfenster: Ja&lt;/b&gt;
