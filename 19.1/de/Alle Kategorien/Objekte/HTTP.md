...
**Beschreibung:** "DEFAULT"  Die standardmäßig ausgehandelte Version verwenden (empfehlenswert).

\\

         "1+"     TLS-Version 1.0 oder höher erzwingen, abhängig davon, was von Server und Client unterstützt wird.

\\

         1.0        TLS 1.0 erzwingen

\\

         1.1        TLS 1.1 erzwingen

\\

         1.2        TLS 1.2 erzwingen

\\

         1.3        TLS 1.3 erzwingen

\\

         2.0        TLS 2.0 erzwingen (nicht empfehlenswert)

\\

         3.0        TLS 3.0 erzwingen (nicht empfehlenswert)

\\

         "MAX"    Automatisch die höchste unterstützte Version wählen
