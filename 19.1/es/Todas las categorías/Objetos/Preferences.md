...
**Sintaxis:** obj &lt;&lt; Always allow publishing to JMP Public( state=0|1 )

**Descripción:** Habilite siempre la opción del menú para publicar en JMP Public, aunque haya conexiones de JMP Live configuradas.
...
**Sintaxis:** Preferences[1] &lt;&lt; Name("Set ODBC Primary Key as Link ID") ( state = 0|1 )
...
**Sintaxis:** obj &lt;&lt; Show SAS Log( "Nunca"|"Siempre"|"En caso de error" )
