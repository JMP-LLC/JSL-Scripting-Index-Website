...
#### Anidado dentro de factores individuales
...
#### Respuesta múltiple (estructurada)
...
#### Respuesta múltiple con grupos anidados
...
#### Tres respuestas en función de dos factores individuales (estructurados)
...
#### Una respuesta en función de dos factores anidados
...
#### Modelo de efectos anidados y luego cruzados, gráfico de desviación estándar
...
#### Modelo de efectos anidados y luego cruzados, gráfico de rangos
...
#### Modelo de efectos anidados, gráfico de desviación estándar
...
#### Modelo de efectos anidados, gráfico de rangos
...
#### Modelo de efectos cruzados con interacción de dos factores, gráfico de desviación estándar
...
#### Modelo de efectos cruzados con interacción de dos factores, gráfico de rangos
...
#### Modelo de efectos cruzados y luego anidados, gráfico de desviación estándar
...
#### Modelo de efectos cruzados y luego anidados, gráfico de rangos
...
#### Modelo de efectos cruzados, gráfico de desviación estándar
...
#### Modelo de efectos cruzados, gráfico de rangos
...
#### Modelo de efectos principales, gráfico de desviación estándar
...
#### Modelo de efectos principales, gráfico de rangos
...
**Descripción:** Ajusta los sesgos técnicos y mejora la idoneidad para el análisis posterior.
...
#### Cribar datos continuos no negativos para la supervisión medioambiental
...
#### Cribar muchos procesos con columna de agrupación
...
#### Cribar muchos procesos con métricas de gráficos de control individuales y de rango móvil
...
#### Cribar muchos procesos con métricas de gráficos de control X-Barra y R
...
#### Cribar muchos procesos con métricas de gráficos de control X-Barra y S
...
#### Cribar proceso con un gráfico de 3 factores (X-Barra, MR y R)
...
#### Cribar proceso con un gráfico de 3 factores (X-Barra, MR y S)
...
#### Cribar proceso con un gráfico de proporción
...
#### Cribar procesos con detección de desplazamiento
...
#### Cribar procesos con gráfico de portería de capacidad
...
#### Cribar procesos con gráfico de potencial del proceso
...
#### Cribar procesos con gráfico de rendimiento del proceso
...
#### Cribar procesos con límites de especificación en una tabla independiente
...
#### Cribar procesos de conteo con gráfico de alarmas para la supervisión ambiental
...
#### Cribar procesos para mostrar gráficos de control para procesos seleccionados
...
#### Análisis de ruta con variables latentes
...
#### Análisis factorial confirmatorio de orden superior
...
#### Modelo de curva de crecimiento latente cuadrático
...
#### Modelo de curva de crecimiento latente lineal
...
#### Regresión lineal múltiple con SEM
...
#### Regresión lineal simple con SEM
...
#### Decidir más adelante sobre el modelo
...
#### Modelo de efectos anidados y luego cruzados
...
#### Modelo de efectos cruzados y luego anidados
...
**Descripción:** Recupera el objeto para manipular el filtro de columna activo para la tabla.
...
**Descripción:** Obtiene una vista de filtro por nombre u obtiene una de las vistas de filtro especiales utilizando <<Temporal o <<Sin filtrar. Si no existe una vista de filtro con el nombre dado, devuelve Empty().
...
**Descripción:** Guarda la tabla de datos en cualquier formato compatible. Los formatos compatibles incluyen .jmp, .xls, .xlsx, .txt, .csv, .tsv, .xpt, .v8xpt, .stx, .sqlite, .db, .sqlite3 y .db3. Algunos formatos solo son compatibles con Windows. Consulte Uso de JMP para obtener más detalles.
...
**Descripción:** Muestra u oculta los iconos de filtro en las columnas de la vista de filtro actual.
...
**Descripción:** Muestra u oculta los gráficos de encabezados en la visualización de la tabla de datos.
...
**Descripción:** Muestra u oculta los grupos de columnas en la visualización de la tabla de datos.
...
**Descripción:** Muestra u oculta los estadísticos de encabezados en la visualización de la tabla de datos.
...
**Descripción:** Muestra u oculta las etiquetas de columnas en la visualización de la tabla de datos.
