...
**Descripción:** Muestra u oculta el error compuesto de las ecuaciones de mínimos cuadrados en dos etapas de la variable instrumental implícita en el modelo.
...
**Descripción:** Muestra u oculta las ecuaciones del modelo que solo tienen la constante como predictor.
...
**Descripción:** Muestra u oculta la varianza del error de cada ecuación del modelo.
...
**Sintaxis:** obj &lt;&lt; Remove Effects

**Descripción:** Quita efectos indirectos específicos del informe.
