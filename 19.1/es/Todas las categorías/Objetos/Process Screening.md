...
**Descripción:** Especifica el peso que se utiliza en el método de alisado exponencial doble de Holt para la detección de derivados. ".05" de forma predeterminada.
...
**Descripción:** Guarda todos los datos de los desplazamientos de modo que se puedan guardar más tarde en una tabla de datos con la opción Guardar tabla de desplazamientos. Esta opción se debe especificar en el script de inicio.
...
**Descripción:** Muestra u oculta el valor máximo para los tipos de gráfico Conteo y Continuo no negativo. Opción activada de forma predeterminada.
...
**Descripción:** Reinicia la plataforma de cribado del proceso para crear un nuevo informe que solo contenga los procesos seleccionados del informe original.
...
**Descripción:** Crea una nueva tabla de datos que contiene los datos guardados de discontinuidad de los desplazamientos. Esta opción requiere que se especifique la opción Generar información detallada de los desplazamientos en el script de inicio.
...
**Descripción:** Muestra u oculta la columna Acción en la tabla resumen. Esta prueba se activa cuando un punto es mayor que un límite superior de acción o menor que un límite inferior de acción. Opción activada de forma predeterminada.
...
**Descripción:** Muestra u oculta la columna Alerta en la tabla resumen. Esta prueba se activa cuando un punto es mayor que el límite superior de la alerta o menor que el límite inferior de la alerta.
...
**Descripción:** Muestra u oculta la columna Alerta en aumento en la tabla de resumen. Esta columna cuenta dónde está aumentando el proceso y el punto anterior está por encima del límite de alerta superior, o si un proceso está disminuyendo y el punto anterior está por debajo del límite de alerta inferior.
...
**Descripción:** Especifica si se debe utilizar el límite inferior K-Sigma. Esta opción solo está disponible para gráficos de proporción.
...
**Descripción:** Especifica si se debe utilizar el límite superior K-Sigma. Esta opción solo está disponible para gráficos de proporción. Opción activada de forma predeterminada.
