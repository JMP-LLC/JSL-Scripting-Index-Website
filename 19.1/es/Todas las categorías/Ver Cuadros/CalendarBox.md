...
**Sintaxis:** obj &lt;&lt; Date( number ); number = obj &lt;&lt; Get Date

**Descripción:** La fecha seleccionada actualmente en el calendario.
...
**Sintaxis:** obj &lt;&lt; Max Date( number ); number = obj &lt;&lt; Get Max Date

**Descripción:** Establece la fecha máxima. El control de calendario se limitará a las selecciones realizadas dentro del rango correcto.
...
**Sintaxis:** obj &lt;&lt; Min Date( number ); number = obj &lt;&lt; Get Min Date

**Descripción:** Establece la fecha mínima. El control de calendario se limitará a las selecciones realizadas dentro del rango correcto.
...
**Sintaxis:** obj &lt;&lt; Show Time( state=0|1 ); state = obj &lt;&lt; Get Show Time

**Descripción:** Seleccione una hora además de una fecha.
...
**Sintaxis:** obj &lt;&lt; Set Function( Function( {thisBox, date}, &lt;script&gt; ) )

**Descripción:** Establece la función especificada para el control. El script de la función se ejecuta cuando se hace clic en una fecha. date es la fecha seleccionada actualmente.
