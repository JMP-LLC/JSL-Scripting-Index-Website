...
**语法:** obj = Matched Pairs(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Paired Response( column(s) )
...
**语法:** obj &lt;&lt; Bland Altman Analysis( state=0|1 )

**说明:** 显示或隐藏 Bland-Altman 分析。该分析是用于比较同一变量的两个测量值的方法比较技术。
...
**语法:** obj &lt;&lt; Bland Altman Percent Analysis( state=0|1 )

**说明:** 显示或隐藏 Bland-Altman 百分比分析。
...
**语法:** obj &lt;&lt; Dif Statistics( state=0|1 )
...
**说明:** 更改分析中所用的 Alpha 水平，这会影响报表和图上的置信区间。
...
**语法:** obj &lt;&lt; Percent Dif Statistics( state=0|1 )
...
**语法:** obj &lt;&lt; Plot Dif By Mean( state=0|1 )

**说明:** 显示或隐藏“配对均值-配对差值”图。 默认开启。
...
**语法:** obj &lt;&lt; Plot Dif By Row( state=0|1 )
...
**语法:** obj &lt;&lt; Plot Percent Dif by Mean( state=0|1 )
...
**语法:** obj &lt;&lt; Plot Percent Dif by Row( state=0|1 )
...
**语法:** obj &lt;&lt; Reference Frame( state=0|1 )

**说明:** 显示或隐藏“均值-差值”图中的参考系。 默认开启。
...
**语法:** obj &lt;&lt; Sign Test( state=0|1 )

**说明:** 显示或隐藏符号检验。这是配对 t 检验的非参数版本。
...
**语法:** obj &lt;&lt; Wilcoxon Signed Rank( state=0|1 )

**说明:** 显示或隐藏 Wilcoxon 符号秩检验。这是配对 t 检验的非参数版本。
