...
**语法:** obj = Repeated Measures Degradation(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Save Posterior To Script( state=0|1 )

**说明:** 指定为当前报表保存脚本时，脚本包含后验样本。若您运行保存的脚本，后验样本将直接从脚本加载到“重复测量退化”分析中。 默认开启。
