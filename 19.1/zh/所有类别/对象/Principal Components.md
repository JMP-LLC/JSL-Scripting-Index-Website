...
**说明:** 显示或隐藏包含成分坐标的表。仅当分析中存在分类变量时该选项才可用。
...
**说明:** Muestra u oculta el informe Análisis de valores atípicos, que le permite detectar valores atípicos en los datos a través de estadísticos de contribución y T².
