...
**语法:** obj = Parallel Plot(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Response( columns )

**说明:** 将包含与单个线连接的每行中所有值的列。
...
**语法:** Parallel Plot( Y( columns ), Center at Zero( state=0|1 ) ) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** Parallel Plot( Y( columns ), Scale Uniformly( state=0|1 ) ) &lt;b&gt;启动窗口项: 是&lt;/b&gt;
...
**语法:** obj &lt;&lt; Show Reversing Checkboxes( state=0|1 )

**说明:** 显示或隐藏针对不同的 Y 变量反转坐标轴的复选框。
