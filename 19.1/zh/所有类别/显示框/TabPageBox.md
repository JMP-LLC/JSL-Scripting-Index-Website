...
**语法:** obj &lt;&lt; Focus Color( color ); color = obj &lt;&lt; Get Focus Color

**说明:** 若设置了焦点颜色，则当选项卡或其中的框具有焦点时，它将用于选项卡标题中的焦点栏。
...
**语法:** obj &lt;&lt; Moveable( state=0|1 )

**说明:** 可移动框可以通过拖放操作在可停放框内重新排列。
...
**语法:** obj &lt;&lt; Set Close( script|Function( {this}, &lt;script&gt; ) )
...
**说明:** 设置与"选项卡页框"关联的可脚本化对象。"选项卡页框"将显示红色小三角菜单形式的消息，它们可发送至可脚本化对象。若未提供参数，将清除可脚本化对象。
...
**语法:** obj &lt;&lt; Title( "string", &lt;Run Script(0 | 1)&gt; )

**说明:** 设置 Tab Page Box 的标题。
