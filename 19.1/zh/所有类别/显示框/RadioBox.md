...
**说明:** 返回显示框以显示列表或单选按钮。点击单选按钮后会运行脚本。
...
**语法:** selectedText = obj &lt;&lt; Get Selected
...
**语法:** obj &lt;&lt; Group( radiobox )

**说明:** 将单选框组合在一起，以便一次只选择组中的一个单选按钮。
...
**语法:** obj &lt;&lt; Index Of( string )

**说明:** 返回字符串的索引。若没找到，则返回 0。
...
**语法:** obj &lt;&lt; Item Enabled( index )

**说明:** 选中以确定单选框中的单个项是启用还是禁用
...
**说明:** 设置控件的指定函数。当点击单选按钮框时该函数的脚本运行。
