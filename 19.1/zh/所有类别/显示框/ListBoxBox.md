...
**语法:** obj &lt;&lt; Enable Item( index,enable )

**说明:** 允许将 index 处的项设置为启用状态 (1) 或禁用状态 (0)。
...
**语法:** index = obj &lt;&lt; Get First Visible Item
...
**语法:** 0|1 = obj &lt;&lt; Item Enabled( index )

**说明:** 返回 index 处的项是启用状态 (1) 还是禁用状态 (0)。
...
**语法:** obj &lt;&lt; Set First Visible Item( index )

**说明:** 滚动列表框以便请求的项是第一个可见项。
...
**语法:** obj &lt;&lt; Show Item( index )

**说明:** 滚动列表框以确保请求的项在列表框中可见。
