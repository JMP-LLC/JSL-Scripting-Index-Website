...
**说明:** 返回一个显示框，其中显示文本项的下拉列表。组合框中的每一项都可以具有可选的工具提示，提示内容通过项文本字符串后面括号内的字符串指定。可选的 Editable 参数允许编辑组合文本。
...
**语法:** obj &lt;&lt; Append Item( string )

**说明:** 将新字符串添加到组合框项列表的结尾
...
**语法:** obj &lt;&lt; Insert Item( string, &lt;position&gt; )

**说明:** 在列表末尾或在可选 position 指示的位置插入新的字符串。
...
**说明:** 返回 index 处的项是可选的 (1) 还是不可选的 (0)。
...
**语法:** obj &lt;&lt; Set( index,&lt;run script(0|1)&gt; )
...
**说明:** 设置控件的指定函数。当选择新的组合框项时该函数的脚本运行。
