...
**语法:** obj &lt;&lt; Date( number ); number = obj &lt;&lt; Get Date
...
**语法:** obj &lt;&lt; Max Date( number ); number = obj &lt;&lt; Get Max Date

**说明:** 设置最大日期。日历控件将限制在正确范围内的选择。
...
**语法:** obj &lt;&lt; Min Date( number ); number = obj &lt;&lt; Get Min Date

**说明:** 设置最小日期。日历控件将限制在正确范围内的选择。
...
**语法:** obj &lt;&lt; Show Time( state=0|1 ); state = obj &lt;&lt; Get Show Time
...
**语法:** obj &lt;&lt; Set Function( Function( {thisBox, date}, &lt;script&gt; ) )

**说明:** 设置控件的指定函数。当点击日期时该函数的脚本运行。“date”是当前选择的日期。
