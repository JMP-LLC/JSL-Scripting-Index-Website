...
**语法:** obj &lt;&lt; Editable( state=0|1 )

**说明:** 若启用 (1)，则可用鼠标点击文本进行编辑。
...
**语法:** obj &lt;&lt; Fixed Size( state=0|1 )

**说明:** 若启用，接受用户定义的注解大小，否则，基于文本内容计算它。
...
**语法:** N|NE|E|SE|S|SW|W|NW = obj &lt;&lt; GetOctant
...
**语法:** 0|1 = obj &lt;&lt; GetTagLine

**说明:** 返回标签线是启用状态 (1) 还是禁用状态 (0)。
...
**语法:** obj &lt;&lt; Octant( &lt;N|NE|E|SE|S|SW|W|NW&gt; )
