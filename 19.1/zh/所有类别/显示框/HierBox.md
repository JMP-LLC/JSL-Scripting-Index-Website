...
**语法:** obj &lt;&lt; Before( "string" )

**说明:** 在调用 HierBox 的前面插入新字符串。
...
**语法:** obj &lt;&lt; Change Type( "鱼骨图"|"层次结构"|"嵌套" )
...
**语法:** obj &lt;&lt; Direction( 0|1 )

**说明:** 设置 HierBox 中的字符串应向右 (1) 还是向左 (0)。
...
**说明:** 移动调用 HierBox 使其成为第一个 HierBox。
...
**语法:** obj &lt;&lt; Force Alternate

**说明:** 移动调用 HierBox 使其与平级 HierBox 交错。
...
**说明:** 移动调用 HierBox 使其成为最后一个 HierBox。
...
**说明:** 设置 HierBox 中的字符串应向右 (1) 还是向左 (0) 倾斜。
...
**说明:** 将调用 HierBox 移至其他 HierBox 的另一侧。
...
**语法:** obj &lt;&lt; Override Descendant Padding( state=0|1 )

**说明:** 若所有后代都采用规定的相同填充设置，则为真。
...
**语法:** obj &lt;&lt; Pad Current Node( state=0|1 )

**说明:** 若我们对当前节点应用规定的填充设置，则为真。
...
**语法:** obj &lt;&lt; Siblings Horizontal Pad( number )

**说明:** 这是 Hierbox 之间的常见填充。
...
**语法:** obj &lt;&lt; Siblings Total Pad( number )

**说明:** 这是平级 Hierbox 和它们的父级框之间的垂直填充。
...
**语法:** obj &lt;&lt; Siblings Vertical Pad( number )

**说明:** 这是旋转 90 度时 HierBox 之间的填充。
...
**语法:** obj &lt;&lt; Uneditable( state=0|1 )

**说明:** 若启用 (1)，则可用鼠标点击字符串进行编辑。
