...
**说明:** 返回一个显示框以显示层次树。默认情况下，可以选择单个项。若指定多选，则可以选择树中的多个项。
...
**语法:** obj &lt;&lt; Enable Item( node, 0|1 )

**说明:** 启用或禁用树中的节点。状态设置为 1 可启用节点。状态设置为 0 可禁用节点。
...
**语法:** script = obj &lt;&lt; Get Context Menu Script

**说明:** 返回当用户右击树或树节点时运行的脚本、函数或方法。
...
**语法:** script = obj &lt;&lt; Get Node Double Click Script

**说明:** 返回当双击节点时运行的脚本、函数或方法。
...
**语法:** obj &lt;&lt; Get Node Select Script( script|Function( {thistree, thisnode}, &lt;script&gt; ) )

**说明:** 返回当树中的选择发生更改时运行的脚本、函数或方法。
...
**说明:** 对于单选树，获取选定的树节点，若没有选定的节点，则为空。对于多选树，获取选定节点的列表，若没有选定的节点，则为空。
...
**语法:** collapsed = obj &lt;&lt; Is Collapsed( node )

**说明:** 若树中该节点处于折叠状态，则返回真。
...
**语法:** expanded = obj &lt;&lt; Is Expanded( node )

**说明:** 若树中该节点处于展开状态，则返回真。
...
**语法:** enabled = obj &lt;&lt; Is Item Enabled( node )
...
**语法:** obj &lt;&lt; Is Multiselect

**说明:** 若为多选树，则返回 1。若为单选树，则返回 0。
...
**语法:** selected = obj &lt;&lt; Is Selected( node )

**说明:** 若树中该节点处于选中状态，则返回真。
...
**语法:** obj &lt;&lt; Set Context Menu Script( Function( {thistree, thisnode}, &lt;script&gt; ) )

**说明:** 设置当用户右击树或树节点时要运行的脚本、函数或方法。
...
**语法:** obj &lt;&lt; Set Multiselect( state=0|1 )
...
**语法:** obj &lt;&lt; Set Node Double Click Script( script )

**说明:** 设置当双击节点时要运行的脚本、函数或方法。
...
**语法:** obj &lt;&lt; Set Node Select Script( script|Function( {thistree, thisnode}, &lt;script&gt; ) )

**说明:** 设置当树中的选择发生更改时要运行的脚本、函数或方法。若清除选择，则将空传递给脚本
...
**语法:** obj &lt;&lt; Set Selected( node|{nodes}, &lt;0|1&gt; )

**说明:** 选择树显示框中的给定树节点。若使用树节点列表，多选树将选择列表中的所有节点。若使用树节点列表，单选树将选择列表中的第一个节点。
