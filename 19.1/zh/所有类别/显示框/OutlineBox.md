...
**语法:** obj &lt;&lt; Add All Open Files( &lt;Menu(0,1)&gt; )

**说明:** 打开菜单以向 OutlineBox 中添加所有打开的文件。
...
**说明:** OutlineBox 的键值对，它为 TableBox 的“制作合并数据表”命令添加一列

**JMP添加的版本:** 16

### Add Directory of Files

**语法:** obj &lt;&lt; Add Directory of Files

**说明:** 打开菜单以向 OutlineBox 中添加文件目录。
...
**语法:** obj &lt;&lt; Add File Reference

**说明:** 打开菜单以向 OutlineBox 中添加文件引用。
...
**语法:** obj &lt;&lt; Add Open Files( &lt;Menu(0,1)&gt; )
...
**语法:** obj &lt;&lt; Add Outline Item

**说明:** 打开菜单以向 OutlineBox 中添加分级显示项。
...
**语法:** obj &lt;&lt; Add Script Button

**说明:** 打开菜单以向 OutlineBox 中添加脚本按钮。
...
**语法:** obj &lt;&lt; Add Text Item

**说明:** 打开菜单以向 OutlineBox 中添加文本。
...
**语法:** obj &lt;&lt; Add URL Reference

**说明:** 打开菜单以向 OutlineBox 中添加 URL。
...
**语法:** obj &lt;&lt; Add Window Reference

**说明:** 打开菜单以向 OutlineBox 中添加窗口引用。
...
**语法:** obj &lt;&lt; Close All Below

**说明:** 关闭该分级显示框和该节点下方的所有子分级显示框。
...
**语法:** obj &lt;&lt; Close All Like This

**说明:** 关闭该分级显示框和显示树中具有相同原始标题或帮助键的所有分级显示框。
...
**语法:** obj &lt;&lt; Close Where No Outlines
...
**说明:** 查找按钮脚本中的所有文件链接以编辑它们。

**JMP添加的版本:** 16

### Get Allow Title Wrapping

**语法:** 0|1 = obj &lt;&lt; Get Allow Title Wrapping( state=0|1 )
...
**语法:** obj &lt;&lt; Get Close Orientation

**说明:** 返回分级显示框垂直折叠以节省水平空间的设置。
...
**语法:** obj &lt;&lt; Get Image Export Display

**说明:** 获取保存图像时禁止分级显示项文本的选项
...
**语法:** 0|1|-1 = obj &lt;&lt; Get Menu Item State( index )

**说明:** 获取弹出式菜单中 index 菜单项的状态。状态可以是正常 (0)、选中 (1) 或禁用 (-1)
...
**语法:** scriptable object = obj &lt;&lt; Get Scriptable Object

**说明:** 返回与分级显示框关联的可脚本化对象的引用。
...
**语法:** obj &lt;&lt; Title Background Color( color ); color = obj &lt;&lt; Get Title Background Color

**说明:** 若背景颜色已设置，在绘制标题内容之前将使用背景颜色填满分级显示项标题。若背景颜色设置为“无”，包含框的背景和内容将显现。
...
**语法:** obj &lt;&lt; Title Border( sides ); sides = obj &lt;&lt; Get Title Border

**说明:** 标题边框是绕分级显示项标题外部绘制的实线。若提供了单个值，则将它应用于所有边。若指定了两个值，则将它们应用于水平和垂直边框。标题边框相对于标题的方向。闭合的分级显示项垂直旋转边框和内容。
...
**语法:** obj &lt;&lt; Title Border Color( color ); color = obj &lt;&lt; Get Title Border Color

**说明:** 用于覆盖分级显示项标题边框默认颜色的可选颜色。
...
**语法:** obj &lt;&lt; Title Padding( sides ); sides = obj &lt;&lt; Get Title Padding

**说明:** 标题填充在标题内容和标题边框之间添加空间。若提供了单个值，则将它应用于所有边。若指定了两个值，则将它们应用于水平和垂直填充。标题填充相对于标题的方向。闭合的分级显示项垂直旋转填充和内容。
...
**语法:** obj &lt;&lt; Title Text Color( color ); color = obj &lt;&lt; Get Title Text Color

**说明:** 将使用给定颜色（若已设置）绘制分级显示项标题文本。若未设置属性，则标题将继承包含框的文本颜色。
...
**语法:** obj &lt;&lt; GetHorizontal

**说明:** 若分级显示框的子级水平排布，则返回 1；否则返回 0。
...
**语法:** obj &lt;&lt; Image Export Display( "正常"|"仅文本"|"无" )

**说明:** 保存图像时禁止分级显示项文本的选项
...
**说明:** 若分级显示框是记录的一部分，则取消锁定记录以允许进一步修改。可以通过右击空白区来锁定记录。

**JMP添加的版本:** 16

### Lock Title

**语法:** obj &lt;&lt; Lock Title( state=0|1 )

**说明:** 锁定分级显示项标题以防止交互式更改。
...
**语法:** obj &lt;&lt; Open All Below

**说明:** 打开该分级显示框和该节点下方的所有子分级显示框。
...
**语法:** obj &lt;&lt; Open All Like This

**说明:** 打开该分级显示框和显示树中具有相同原始标题或帮助键的所有分级显示框。
...
**语法:** obj &lt;&lt; Set Allow Title Wrapping( 0|1 )
...
**语法:** obj &lt;&lt; Set Menu Item State( index, 0|1|-1 )

**说明:** 将 index 处的弹出式菜单项设置为正常 (0)、已选中 (1) 或已禁用 (-1)
...
**语法:** obj &lt;&lt; Set Menu Script( {"string",script,"string",script, ...} )
...
**语法:** obj &lt;&lt; Set Scriptable Object( &lt;scriptable object&gt; )

**说明:** 设置与分级显示框关联的可脚本化对象。分级显示框将显示红色小三角菜单形式的消息，它们可发送至可脚本化对象。若未提供参数，将清除可脚本化对象。
...
**语法:** obj &lt;&lt; Set Submenu( index, submenu count )
...
**语法:** obj &lt;&lt; Set Title( "string", &lt;Run Script(0 | 1)&gt; )
...
**语法:** obj &lt;&lt; Set Title Changed

**说明:** 设置分级显示项标题更改时运行的脚本。
...
**语法:** obj &lt;&lt; SetHorizontal( state=0|1 )
