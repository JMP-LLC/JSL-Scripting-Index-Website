...
**Syntaxe :** obj &lt;&lt; Composite Error( state=0|1 )

**Description :** Affiche ou masque l&apos;erreur composite des équations de variables instrumentales impliquées par le modèle avec moindres carrés en deux étapes
...
**Syntaxe :** obj &lt;&lt; Show All Equations( state=0|1 )

**Description :** Affiche ou masque les équations du modèle dont le seul régresseur est la constante.
...
**Syntaxe :** obj &lt;&lt; Variance of the Error( state=0|1 )

**Description :** Affiche ou masque la variance de l&apos;erreur pour chaque équation du modèle.
...
**Syntaxe :** obj &lt;&lt; Remove Effects

**Description :** Supprime des effets indirects spécifiques du rapport.
