...
**Description :** Réalise une décomposition en valeurs singulières (SVD) non négative sur la matrice empilée de fonctions. Une SVD non négative contraint la décomposition de matrice de manière à ce que les scores et les loadings soient supérieurs ou égaux à zéro.
...
**Syntaxe :** obj &lt;&lt; ARWLS Save Baselines

**JMP Version ajoutée :** 19

#### ARWLS Save Corrected

**Syntaxe :** obj &lt;&lt; ARWLS Save Corrected
...
**Syntaxe :** obj &lt;&lt; Custom Save Corrected
...
**Syntaxe :** obj &lt;&lt; Parametric Save Baselines

**JMP Version ajoutée :** 19

#### Parametric Save Corrected

**Syntaxe :** obj &lt;&lt; Parametric Save Corrected
...
**Syntaxe :** obj &lt;&lt; SNIP Save Baselines

**JMP Version ajoutée :** 19

#### SNIP Save Corrected

**Syntaxe :** obj &lt;&lt; SNIP Save Corrected
...
**Syntaxe :** obj &lt;&lt; Save Script Options( "Enregistrer le script enregistre les étapes"|"Enregistrer le script enregistrer l&apos;état"="Enregistrer le script enregistre les étapes" )

**Description :** Spécifie le type de script enregistré pour reproduire les résultats de détection du pic. "Enregistrer le script enregistre les étapes" par défaut.
