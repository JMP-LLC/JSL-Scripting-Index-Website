...
**Syntaxe :** obj = Type 1 Gauge(...&lt;By( column(s) )&gt;...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Type 1 Gauge(...&lt;Freq( column )&gt;...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Type 1 Gauge(...Measurement( column(s) )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj = Type 1 Gauge(...Y( column(s) )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** Type 1 Gauge( Y( column ) )

**Description :** Analyse les systèmes de mesure à l&apos;aide de la méthode de système de mesure de type 1 afin d&apos;évaluer la répétabilité et le biais d&apos;un processus de mesure sur une pièce de référence.
...
**Syntaxe :** obj = Type 1 Gauge(...Percent of Tolerance( number=20 )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Modifie le pourcentage de la tolérance de pièce utilisée pour comparer à la variation de la mesure. "20" par défaut.
...
**Syntaxe :** obj &lt;&lt; Save Type 1 Gauge Metadata as Column Properties

**Description :** Pour chaque colonne de données de mesure, enregistre les métadonnées du système de mesure de type 1 en tant que propriété de colonne Métadonnées MSA dans la colonne de la table de données d&apos;origine.
...
**Syntaxe :** obj &lt;&lt; Save Type 1 Gauge Metadata to Table

**Description :** Crée une nouvelle table de données qui contient les métadonnées du système de mesure de type 1 pour chaque colonne des données de mesure. La table utilise un format en lignes et contient une ligne pour chaque variable de mesure.
...
**Syntaxe :** obj = Type 1 Gauge(...Set Alpha Level( number=.05 )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;

**Description :** Spécifie le niveau alpha utilisé dans le test de biais. ".05" par défaut.
...
**Syntaxe :** obj = Type 1 Gauge(...Sigma Multiplier( number=6 )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj &lt;&lt; Type 1 Gauge Analysis

**Description :** Spécifie les options du rapport Analyse du système de mesure de type 1 pour chaque réponse de la mesure.
...
**Syntaxe :** obj = Type 1 Gauge(...Window View( "Visible"|"Invisible"|"Private" )...) &lt;b&gt;Élément lanceur : Oui&lt;/b&gt;
...
**Syntaxe :** obj &lt;&lt; Customize Summary and Capability Statistics(statistic1( state=0|1 ), statistic2( state=0|1 ), ..., statisticN( state=0|1 )

**Description :** Personnalise les statistiques de résumé affichées dans le rapport Résumé et statistiques de capabilité.
...
**Syntaxe :** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Bias Test( state=0|1 ))

**Description :** Affiche ou masque un test de biais de la moyenne des mesures observées et de la valeur standard de référence dans le rapport Analyse du système de mesure de type 1.
...
**Syntaxe :** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Histogram( state=0|1 ))

**Description :** Affiche ou masque un histogramme des données de mesure dans le rapport Analyse du système de mesure de type 1.
...
**Syntaxe :** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( state=0|1 ))

**Description :** Affiche ou masque la carte de suivi des données de mesure dans le rapport Analyse du système de mesure de type 1. Ce diagramme affiche la variation des mesures par rapport à la valeur de référence et au pourcentage de la plage de tolérance. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Summary and Capability Statistics( state=0|1 ))

**Description :** Affiche ou masque le résumé du système de mesure de type 1 et la table des statistiques de capabilité. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Histogram(1, Show Count Axis( state=0|1 )))

**Description :** Affiche ou masque un axe de dénombrement sur la droite du cadre de l&apos;histogramme dans le rapport Analyse du système de mesure de type 1.
...
**Syntaxe :** obj &lt;&lt; (Type 1 Gauge Analysis[number] &lt;&lt; Histogram(1, Show Reference( state=0|1 )))

**Description :** Affiche ou masque la ligne de référence sur l&apos;histogramme dans le rapport Analyse du système de mesure de type 1. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( 1, Show Mean( state=0|1 )))

**Description :** Affiche ou masque la ligne de la moyenne sur la carte de suivi dans le rapport Analyse du système de mesure de type 1.
...
**Syntaxe :** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( 1, Show Portion of Tolerance( state=0|1 )))

**Description :** Affiche ou masque la proportion des lignes de tolérance sur la carte de suivi dans le rapport Analyse du système de mesure de type 1. Actif par défaut.
...
**Syntaxe :** obj &lt;&lt; ( Type 1 Gauge Analysis[number] &lt;&lt; Run Chart( 1, Show Reference( state=0|1 )))

**Description :** Affiche ou masque la ligne de référence sur la carte de suivi dans le rapport Analyse du système de mesure de type 1. Actif par défaut.
