...
**Description :** Renvoie une boîte d’affichage avec un curseur de contrôle d&apos;étendue allant de minValue à maxValue. Lorsque les positions des deux curseurs changent, leurs valeurs sont placées dans  et dans , et le script est exécuté.lowVariablehighVariable
...
**Syntaxe :** float = obj &lt;&lt; Get Lower( &lt;index&gt; )
...
**Syntaxe :** string = obj &lt;&lt; Get Lower Var
...
**Syntaxe :** float = obj &lt;&lt; Get Upper( &lt;index&gt; )
...
**Syntaxe :** string = obj &lt;&lt; Get Upper Var
...
**Description :** Définit la fonction donnée pour le contrôle. Le script de la fonction s&apos;exécute lorsque la valeur d&apos;un des curseurs change.
...
**Syntaxe :** obj &lt;&lt; Set Lower( float, &lt;index&gt;, &lt;run script(0|1)&gt; )
...
**Syntaxe :** string = obj &lt;&lt; Set Lower Var
...
**Syntaxe :** obj &lt;&lt; Set Upper( float, &lt;index&gt;, &lt;run script(0|1)&gt; )
...
**Syntaxe :** string = obj &lt;&lt; Set Upper Var
