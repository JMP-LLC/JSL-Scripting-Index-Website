...
**Syntaxe :** project &lt;&lt; Add Bookmarks( {&lt;File(path)&gt;, &lt;Folder( path, &lt;Expanded(boolean)&gt; )&gt;, &lt;Group(name, &lt;Expanded(boolean)&gt;, {contents}&gt;} )

**Description :** Ajoute les signets d&apos;une liste au projet. Les signets existants sont conservés. L&apos;argument est une liste d&apos;éléments de signets, chacun étant spécifié à l&apos;aide de File(), Folder() ou Group(). Le type Group() accepte les Fichiers, Dossiers et Groupes en tant qu&apos;enfants utilisant la même syntaxe de manière récursive.
...
**Syntaxe :** project &lt;&lt; Contents()

**Description :** Répertorie tous les fichiers dans un projet
...
**Syntaxe :** project &lt;&lt; Extract("file")

**Description :** Extrait un fichier spécifique du projet. La commande JMP Open() n&apos;extrait pas du projet les fichiers qui ne peuvent pas être directement ouverts par JMP, comme les fichiers parquet.
...
**Syntaxe :** project &lt;&lt; Extract All()

**Description :** Extrait tous les fichiers du projet dans le répertoire temporaire.
...
**Syntaxe :** project &lt;&lt; Get Bookmarks()

**Description :** Renvoie la liste des signets dans le projet. Le format de la liste renvoyée est le même que celui utilisé par Add Bookmarks() et Set Bookmarks().
...
**Syntaxe :** project &lt;&lt; Get Layout()

**Description :** Renvoie la mise en page de la fenêtre du projet. Le format est le même que celui utilisé par Set Layout().
...
**Syntaxe :** project &lt;&lt; Get Temp Dir()

**Description :** Obtenez le chemin d&apos;accès sur le disque du répertoire temporaire du projet.
...
**Syntaxe :** project &lt;&lt; Is Extracted("file")

**Description :** Vérifie si un fichier spécifique dans le projet a été extrait dans le répertoire temporaire. La commande JMP Open() n&apos;extrait pas du projet les fichiers qui ne peuvent pas être directement ouverts par JMP, comme les fichiers parquet.
...
**Syntaxe :** project &lt;&lt; Project File Path()

**Description :** Obtenir le chemin d&apos;accès sur le disque d&apos;un fichier de projet enregistré
...
**Syntaxe :** project &lt;&lt; Reset Layout()

**Description :** Définit le projet de sorte à utiliser la mise en page par défaut de la fenêtre.
...
**Syntaxe :** project &lt;&lt; Run Script(script)

**Description :** Exécute un script dans le contexte du projet. En particulier, toutes les fenêtres ouvertes par le script seront incluses dans le projet. Le script accèdera aux noms JSL dans le contexte du projet, non dans celui du script englobant.
...
**Syntaxe :** project &lt;&lt; Save Project(&lt;path&gt;)

**Description :** Enregistre le projet. Un chemin d&apos;accès et un nom de fichier peuvent être spécifiés afin d&apos;enregistrer le projet à un emplacement spécifique ; si le projet a déjà été enregistré, cet argument est facultatif.



Tous les documents du projet doivent être enregistrés avant de pouvoir enregistrer le projet.
...
**Syntaxe :** project &lt;&lt; Set Bookmarks( {&lt;File(path)&gt;, &lt;Folder( path, &lt;Expanded(boolean)&gt; )&gt;, &lt;Group(name, &lt;Expanded(boolean)&gt;, {contents}&gt;} )

**Description :** Définit les signets du projet. Les signets existants sont supprimés. L&apos;argument est une liste d&apos;éléments de signets, chacun étant spécifié à l&apos;aide de File(), Folder() ou Group(). Le type Group() accepte les Fichiers, Dossiers et Groupes en tant qu&apos;enfants utilisant la même syntaxe de manière récursive.
...
**Syntaxe :** obj &lt;&lt; Set Layout

**Description :** Définit la mise en page de la fenêtre du projet.
...
**Syntaxe :** project &lt;&lt; Show Bookmarks(boolean)

**Description :** Affiche ou masque le volet Signets dans le projet
...
**Syntaxe :** project &lt;&lt; Show Contents(boolean)

**Description :** Affiche ou masque le volet Contenus dans le projet
...
**Syntaxe :** project &lt;&lt; Show Log(boolean)

**Description :** Affiche ou masque le volet Log dans le projet
...
**Syntaxe :** project &lt;&lt; Show Recent Files(boolean)

**Description :** Affiche ou masque le volet Fichiers récents dans le projet
...
**Syntaxe :** project &lt;&lt; Show Workspace(boolean)

**Description :** Affiche ou masque le volet Espace de travail dans le projet
