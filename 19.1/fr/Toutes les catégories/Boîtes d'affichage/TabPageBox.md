...
**Description :** Ferme l&apos;onglet, s&apos;il peut l&apos;être.
...
**Syntaxe :** obj &lt;&lt; Closeable( state=0|1 )

**Description :** Définit l&apos;état de fermeture de l&apos;onglet.
...
**Syntaxe :** obj &lt;&lt; Focus Color( color ); color = obj &lt;&lt; Get Focus Color

**Description :** Si la couleur de focus est définie, elle est utilisée pour la barre de focus sur le titre de l&apos;onglet lorsque l&apos;onglet ou une boîte de l&apos;onglet a un focus.
...
**Syntaxe :** obj &lt;&lt; Get Close

**Description :** Renvoie le script qui est exécuté lorsque l&apos;onglet est fermé par un script ou à l&apos;aide de l&apos;icône de fermeture. Le script doit renvoyer 1 pour autoriser la fermeture ou 0 pour l&apos;annuler.
...
**Syntaxe :** "string" = obj &lt;&lt; Get Close Tip
...
**Syntaxe :** "bool" = obj &lt;&lt; Get Closeable

**Description :** Renvoie l&apos;état de fermeture de l&apos;onglet.
...
**Syntaxe :** "string" = obj &lt;&lt; Get Icon

**Description :** Renvoie l&apos;icône de l&apos;onglet.
...
**Syntaxe :** obj &lt;&lt; Get Moveable

**Description :** Renvoie le paramètre amovible de la zone.

### Get Scriptable Object

**Syntaxe :** scriptable object = obj &lt;&lt; Get Scriptable Object

**Description :** Renvoie une référence à l’objet scriptable associé à la zone de page de l&apos;onglet.
...
**Description :** Renvoie l&apos;info-bulle de l&apos;onglet
...
**Description :** Renvoie le titre de la zone Tab Page Box.
...
**Syntaxe :** obj &lt;&lt; Icon( "string" )

**Description :** Définit l&apos;icône de l&apos;onglet.
...
**Description :** Verrouiller le titre de page de l&apos;onglet pour empêcher des modifications interactives.
...
**Syntaxe :** obj &lt;&lt; Moveable( state=0|1 )

**Description :** Les zones amovibles peuvent être réorganisées à l&apos;intérieur d&apos;une zone ancrable avec l&apos;option glisser-déposer.
...
**Syntaxe :** obj &lt;&lt; Set Close( script|Function( {this}, &lt;script&gt; ) )

**Description :** Définir le script ou la Function à exécuter lorsque l&apos;onglet est fermé depuis un script ou à l&apos;aide de l&apos;icône de fermeture. Le script ou la Function doit renvoyer 1 pour permettre la fermeture ou 0 pour l&apos;annuler.
...
**Syntaxe :** obj &lt;&lt; Set Close Tip( "string" )
...
**Description :** Définit l’objet scriptable associé à la zone de page de l&apos;onglet. La zone de page de l&apos;onglet affichera un menu triangle rouge avec les messages qui peuvent être envoyés à l&apos;objet scriptable. Si aucun argument n&apos;est fourni, l&apos;objet scriptable sera annulé.
...
**Description :** Définir une fonction qui s&apos;exécute lorsque le titre de page de l&apos;onglet est modifié.
...
**Syntaxe :** obj &lt;&lt; Tip( "string" )

**Description :** Définit l&apos;info-bulle de l&apos;onglet.
...
**Syntaxe :** obj &lt;&lt; Title( "string", &lt;Run Script(0 | 1)&gt; )

**Description :** Définit le titre de la zone Tab Page Box.
