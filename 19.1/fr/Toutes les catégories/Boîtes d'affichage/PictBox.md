...
**Description :** Renvoie une boîte d’affichage contenant une image.
...
**Description :** Retourne l&apos;image à la verticale et à l&apos;horizontale.
...
**Description :** Retourne l&apos;image à l&apos;horizontale.
...
**Description :** Retourne l&apos;image à la verticale.
...
**Description :** Obtenir l’image contenue dans la boîte.
...
**Description :** Fait pivoter l&apos;image de 90 degrés dans le sens contraire des aiguilles d&apos;une montre.
...
**Description :** Fait pivoter l&apos;image de 90 degrés dans le sens des aiguilles d&apos;une montre.
...
**Syntaxe :** obj &lt;&lt; Set Image( image )

**Description :** Définir l’image contenue dans la boîte.
