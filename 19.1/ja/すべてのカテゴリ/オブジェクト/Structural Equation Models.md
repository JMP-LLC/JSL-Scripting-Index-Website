...
**構文:** obj &lt;&lt; Composite Error( state=0|1 )

**説明:** モデル誘導操作変数2段階最小2乗法(MIIV-2LS)を用いた回帰式における合成誤差の表示/非表示を切り替える。
...
**構文:** obj &lt;&lt; Show All Equations( state=0|1 )

**説明:** 方程式の表示において、説明変数が定数だけのモデルの表示/非表示を切り替える。
...
**構文:** obj &lt;&lt; Variance of the Error( state=0|1 )

**説明:** モデルの各回帰式における誤差分散の表示/非表示を切り替える。
...
**構文:** obj &lt;&lt; Remove Effects

**説明:** レポートから特定の間接効果を削除する。
