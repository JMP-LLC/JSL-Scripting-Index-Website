...
**構文:** obj = Cell Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj &lt;&lt; Arrange Plots( number across )

**説明:** 横に並べるプロットの個数を変更する。X変数がある場合のみ使用可能。
...
**構文:** Cell Plot( Y( columns ), Center at Zero( state=0|1 ) )
...
**構文:** Cell Plot( Y( columns ), Scale Uniformly( state=0|1 ) )
