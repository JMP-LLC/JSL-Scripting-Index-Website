...
**構文:** &lt;&lt;Select Fit( Training | Validation | Test | Summary | Clear All, Clear | Dominant | Best(&lt;number&gt;), | Largest(name,&lt;number&gt;) | Smallest(name,&lt;number&gt;) | Where(expression) )
...
**構文:** obj &lt;&lt; Show Scripts( state=0|1 )

**説明:** For each platform called, shows options added to launch script.
...
**説明:** 学習・検証・テストの3つに分割するのではなく、学習・検証の2つに分割する。
