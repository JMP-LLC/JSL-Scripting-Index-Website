...
**構文:** obj = Scatterplot Matrix(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj &lt;&lt; Density Ellipses( state=0|1 )
...
**説明:** 楕円の確率を設定する。散布図行列上に表示された楕円の場合は(1 - アルファ)。
...
**説明:** 散布図上に水準ごとの楕円を表示させるためのグループ変数を指定する。
...
**説明:** 軸の範囲を固定する。データやフィルターの変更によって軸の範囲が変更されないようにする。
...
**構文:** obj = Scatterplot Matrix(...Matrix Format( "下三角"|"上三角"|"正方形" )...)
...
**構文:** obj &lt;&lt; Nonpar Density( state=0|1 )
...
**説明:** 散布図行列上で点を少し移動させ重なりをずらす。 デフォルトの値は"自動"。
...
**構文:** obj &lt;&lt; Shaded Ellipses( state=0|1 )
