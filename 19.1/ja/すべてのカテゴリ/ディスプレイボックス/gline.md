...
**構文:** obj &lt;&lt; Point from( state=0|1 )

**説明:** 線の始点に矢印を描画する(1)。または矢印を削除する(0)。
...
**構文:** obj &lt;&lt; Point to( state=0|1 )

**説明:** 線の終点に矢印を描画する(1)。または矢印を削除する(0)。
...
**構文:** obj &lt;&lt; Thick( state=0|1 )

**説明:** 太い線(1)または細い線(0)を描画する。
