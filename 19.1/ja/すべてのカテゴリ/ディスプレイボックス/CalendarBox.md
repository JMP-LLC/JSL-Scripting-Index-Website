...
**構文:** obj &lt;&lt; Date( number ); number = obj &lt;&lt; Get Date

**説明:** カレンダーで現在選択されている日付。
...
**構文:** obj &lt;&lt; Max Date( number ); number = obj &lt;&lt; Get Max Date

**説明:** カレンダーコントロールで選択可能な範囲の最後の日付を設定する。
...
**構文:** obj &lt;&lt; Min Date( number ); number = obj &lt;&lt; Get Min Date

**説明:** カレンダーコントロールで選択可能な範囲の最初の日付を設定する。
...
**構文:** obj &lt;&lt; Show Time( state=0|1 ); state = obj &lt;&lt; Get Show Time
...
**構文:** obj &lt;&lt; Set Function( Function( {thisBox, date}, &lt;script&gt; ) )

**説明:** コントロールに関数を設定する。関数のスクリプトは、日付がクリックされたときに実行される。dateは現在選択されている日付。
