...
**構文:** obj &lt;&lt; Align Decimal Separator( state=0|1 )

**説明:** 列の値が、小数点を縦に揃えて配置されるように指定する。
...
**構文:** obj &lt;&lt; Enable Semantic Formats( state=0|1 )

**説明:** セマンティック表示形式を列に適用するかどうかを制御する。セマンティック表示形式は環境設定で制御することも可能。
...
**構文:** obj &lt;&lt; Get Align Decimal Separator

**説明:** 小数点を揃えて列を表示している場合は1、そうでない場合は0を戻す。
...
**構文:** format = obj &lt;&lt; Get Conditional Format
...
**構文:** obj &lt;&lt; Get Effective Format( &lt;row&gt; )

**説明:** 列に設定されている形式、マッチしたセマンティック表示形式を適用した後の形式を戻す。rowが指定された場合、その行に設定されている形式を戻す。
...
**構文:** obj &lt;&lt; Get Enable Semantic Formats

**説明:** 列のEnable Semantic Formatsの設定を戻す。セマンティック表示形式は環境設定で制御することも可能。
...
**構文:** width,&lt;decimalplaces&gt; = obj &lt;&lt; Get Format

**説明:** 現在の形式(width、decimalplaces)を戻す。日付/時間の値の場合、decimalplacesは100より大きな値となる。
...
**構文:** obj &lt;&lt; Hide Missing Values( state=0|1 )

**説明:** 1に設定すると、欠測値が表示されなくなる。
...
**構文:** obj &lt;&lt; Set Conditional Format( "Correlation"|"PValue"|"Factor Pattern" )
...
**構文:** obj &lt;&lt; Set Values( matrix )

**説明:** NumberColBoxを与えられた値で更新する。
