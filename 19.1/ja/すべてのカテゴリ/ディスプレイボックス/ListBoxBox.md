...
**構文:** obj &lt;&lt; Enable Item( index,enable )

**説明:** indexの項目を選択可能(1)または不可0)に設定する。
...
**構文:** index = obj &lt;&lt; Get First Visible Item

**説明:** 表示されている先頭の項目のインデックスを戻す。
...
**構文:** 0|1 = obj &lt;&lt; Item Enabled( index )

**説明:** indexの項目が選択可能なら1、不可なら0を戻す。
...
**構文:** obj &lt;&lt; Set First Visible Item( index )

**説明:** 指定した項目が先頭に表示されるように、リストボックスをスクロールする。
...
**構文:** obj &lt;&lt; Show Item( index )

**説明:** 指定した項目が表示されるように、リストボックスをスクロールする。
