...
**構文:** obj = Ternary Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = Ternary Plot(...<By( column(s) )>...)
...
**構文:** obj = Ternary Plot(...Contour Formula( formula column )...)

**説明:** 応答曲面の等高線を作成する、計算式を持つ列。
...
**構文:** obj = Ternary Plot(...Plotting( column(s) )...)
...
**構文:** obj = Ternary Plot(...X( column(s) )...)
...
**構文:** obj << 3D Graph( state=0|1 )

**説明:** 4つ以上のX変数を使った3次元グラフを表示する。
...
**構文:** obj << Contour Fill( "線のみ"|"上を塗りつぶす"|"下を塗りつぶす" )
...
**構文:** obj << Contour Value( [c1, c2, c3, c4, c5] )
...
**説明:** 三角図上の点の表示/非表示を切り替える。 デフォルトではオン。
