...
**構文:** obj &lt;&lt; Continuous Correlation Type( "Gauss"|"Matern 3/2"|"Matern 5/2"|"指数"="Matern 5/2" )

**説明:** デフォルトの値は"Matern 5/2"。

### Copy All Model Fits Script

**構文:** obj &lt;&lt; Copy All Model Fits Script

**説明:** この分析を再現するJSLスクリプトを生成し、クリップボードにコピーする。

### Copy Startup Script

**構文:** obj &lt;&lt; Copy Startup Script
...
**構文:** obj &lt;&lt; Model Based Augmentation RSquare Threshold( number )

### Nominal Correlation Type

**構文:** obj &lt;&lt; Nominal Correlation Type( "均一相関構造"|"Unequal Correlations"="均一相関構造" )

**説明:** デフォルトの値は"均一相関構造"。

### Ordinal Correlation Type

**構文:** obj &lt;&lt; Ordinal Correlation Type( "均一相関構造"|"Unequal Correlations"|"Latent Variable"="均一相関構造" )

**説明:** デフォルトの値は"均一相関構造"。

### Save All Model Fits Script to Data Table

**構文:** obj &lt;&lt; Save All Model Fits Script to Data Table

**説明:** この分析を再現するJSLスクリプトを生成し、データテーブルのテーブルプロパティとして保存する。

### Save All Model Fits Script to Journal

**構文:** obj &lt;&lt; Save All Model Fits Script to Journal

**説明:** この分析を再現するJSLスクリプトを生成し、ジャーナルにそのスクリプトのボタンを追加する。

### Save All Model Fits Script to Report

**構文:** obj &lt;&lt; Save All Model Fits Script to Report

**説明:** この分析を再現するJSLスクリプトを生成し、レポートウィンドウに表示する。分析手順の記録を結果と一緒に残せる。

### Save All Model Fits Script to Script Window

**構文:** obj &lt;&lt; Save All Model Fits Script to Script Window

**説明:** この分析を再現するJSLスクリプトを生成し、現在のスクリプトウィンドウに表示する。

### Save Startup Script to Data Table

**構文:** obj &lt;&lt; Save Startup Script to Data Table

**説明:** この分析を再現するJSLスクリプトを生成し、データテーブルのテーブルプロパティとして保存する。

### Save Startup Script to Journal

**構文:** obj &lt;&lt; Save Startup Script to Journal

**説明:** この分析を再現するJSLスクリプトを生成し、ジャーナルにそのスクリプトのボタンを追加する。

### Save Startup Script to Report

**構文:** obj &lt;&lt; Save Startup Script to Report

**説明:** この分析を再現するJSLスクリプトを生成し、レポートウィンドウに表示する。分析手順の記録を結果と一緒に残せる。

### Save Startup Script to Script Window

**構文:** obj &lt;&lt; Save Startup Script to Script Window
