...
**説明:** このオプションをオンにすると、候補集合のデータが生成され、その候補集合から追加実験のバッチが自動的に選択される。オフにすると、この自動選択が行われない。このオプションをオン(もしくはオフ)にすることは、Generate Candidate Setおよび Autoselect Batchオプションを両方ともオン(もしくはオフ)にすることと同じである。
...
**構文:** obj &lt;&lt; Nominal Correlation Type( "均一相関構造" )
...
**構文:** obj &lt;&lt; Ordinal Correlation Type( "均一相関構造"|"不均一相関構造" )
...
**説明:** 現在のバッチに選択されている点について、その選択を取り消す。
...
**説明:** 現在のバッチに選択されている点を、現在の設定に従ってデータテーブルに書き出す。
