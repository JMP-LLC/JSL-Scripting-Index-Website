...
**構文:** obj = Cluster Variables(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = Cluster Variables(...&lt;By( column(s) )&gt;...)
...
**構文:** obj = Cluster Variables(...Columns( column(s) )...)

**説明:** クラスター分析の対象とする変数を指定する。
...
**構文:** obj = Cluster Variables(...&lt;Freq( column )&gt;...)
...
**構文:** obj = Cluster Variables(...&lt;Weight( column )&gt;...)
...
**構文:** obj = Cluster Variables(...Y( column(s) )...)
