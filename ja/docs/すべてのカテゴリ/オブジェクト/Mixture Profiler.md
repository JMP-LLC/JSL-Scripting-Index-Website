...
**構文:** obj = Mixture Profiler(...Prediction Formula( column(s) )...)
...
**構文:** obj = Mixture Profiler(...Y( column(s) )...)
...
**構文:** obj = Mixture Profiler(...Number of Grid Points( number )...)

**説明:** 3つの軸に対するグリッド点の個数を指定する。ここで指定されたグリッドの粒度で、等高線は計算される、
