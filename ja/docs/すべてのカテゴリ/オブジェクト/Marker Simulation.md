...
**構文:** obj = Marker Simulation(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj &lt;&lt; Cross( column(s) )

**説明:** サンプルをグループ化する列を指定する。異なるグループのサンプル間で交配が行われる。
...
**構文:** obj &lt;&lt; Predictor Formula( column(s) )

**説明:** 応答や特性の予測式を含む列を指定する。
...
**構文:** obj = Marker Simulation(...Estimate Diversity( state=0|1 )...)

**説明:** シミュレートした個体について、多様性指標も計算する。
...
**構文:** obj = Marker Simulation(...Imputation Value( number=0 )...)
...
**構文:** obj = Marker Simulation(...Missing Marker Imputation Method( "HWE オフ"|"HWE オン"|"ランダム"|"指定値"="HWE オフ" )...)
...
**構文:** obj = Marker Simulation(...Number of Generations( number=1 )...)

**説明:** 世代数を指定する。シミュレーションにて、交配や選択を行う世代数を指定する。 デフォルトの値は"1"。
...
**構文:** obj = Marker Simulation(...Number of Individuals per Cross( number=5 )...)

**説明:** 1回の交配のシミュレーションにて、サンプリングされる個体数を指定する。 デフォルトの値は"5"。
...
**構文:** obj = Marker Simulation(...Number of Selected Crosses( number=0 )...)

**説明:** 1世代において、サンプリングされる家族の最大数を指定する。 デフォルトの値は"0"。
...
**構文:** obj = Marker Simulation(...Number of Selected Individuals( number=0 )...)

**説明:** 1つの家族から選択（サンプリング）される個体の最大数を指定する。 デフォルトの値は"0"。
...
**構文:** obj = Marker Simulation(...Ploidy( number=2 )...)

**説明:** 倍数性における倍数を指定する。この数値は、正の偶数でなければいけない。 デフォルトの値は"2"。
...
**構文:** obj &lt;&lt; Save Simulated Table

**説明:** シミュレーションされた遺伝子型を新しいデータテーブルに保存する。
...
**構文:** obj = Marker Simulation(...Select Best Individuals( state=0|1 )...)

**説明:** 予測式の「仕様限界」列プロパティで指定されたすべての基準を満たしている最良の個体を選択する。
...
**構文:** obj = Marker Simulation(...Set Random Seed( number=0 )...)
...
**構文:** obj &lt;&lt; Show Diversity Plot( state=1 )

**説明:** 遺伝的多様度のプロットの表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj &lt;&lt; Show Evaluation Plot( state=1 )

**説明:** 遺伝に関する統計量のプロットの表示/非表示を切り替える。 デフォルトではオン。
...
**構文:** obj = Marker Simulation(...Threshold to Make Line Plots( number=500 )...)

**説明:** レポートに折れ線グラフを描画する際の最大交配数を指定する。交配数の合計がこの閾値より少ない場合に折れ線グラフが描かれる。 デフォルトの値は"500"。
...
**構文:** obj = Marker Simulation(...Unthreaded( state=0|1 )...)
...
**構文:** obj = Marker Simulation(...Use Annotation Table( state=0|1 )...)

**説明:** 注釈(アノテーション)のデータテーブルを用いる。「注釈のデータテーブル」とは、グループや位置の情報を含むデータのことである。
...
**構文:** obj = Marker Simulation(...Use Only Markers Found in Predictor Formula( state=0|1 )...)

**説明:** 予測式で使われているマーカーだけをシミュレーションします。
