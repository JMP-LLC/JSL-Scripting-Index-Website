...
**構文:** obj = Bubble Plot(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = Bubble Plot(...X( column )...)

**説明:** プロットでバブルのx座標として使用する列。
...
**構文:** obj = Bubble Plot(...Y( column )...)

**説明:** プロットでバブルのy座標として使用する列。
