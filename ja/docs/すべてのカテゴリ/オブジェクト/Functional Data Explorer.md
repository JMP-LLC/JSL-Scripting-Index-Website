...
**説明:** 関数データに対して非負値特異値分解(nonnegative SVD)を実行する。非負値特異値分解では、求められた主成分スコアと主成分負荷量は、すべてゼロ以上になる制約を課す。
...
**構文:** obj &lt;&lt; ARWLS Save Baselines

**JMP追加されたバージョン:** 19

#### ARWLS Save Corrected

**構文:** obj &lt;&lt; ARWLS Save Corrected
...
**構文:** obj &lt;&lt; Parametric Save Baselines

**JMP追加されたバージョン:** 19

#### Parametric Save Corrected

**構文:** obj &lt;&lt; Parametric Save Corrected
...
**構文:** obj &lt;&lt; SNIP Save Baselines

**JMP追加されたバージョン:** 19

#### SNIP Save Corrected

**構文:** obj &lt;&lt; SNIP Save Corrected
...
**構文:** obj &lt;&lt; Save Script Options( "ステップを保存したスクリプトを保存"|"状態を保存したスクリプトを保存"="ステップを保存したスクリプトを保存" )

**説明:** ピーク検出の分析結果を再現するために保存するスクリプトの種類を指定する。 デフォルトの値は"ステップを保存したスクリプトを保存"。
