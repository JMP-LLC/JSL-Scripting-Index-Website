...
**構文:** obj << Model Type( Step Stress | Ramp Stress | Sinusoid Stress | Piecewise Ramp Stress )

**説明:** 累積損傷モデルのストレスパターンを指定する。このオプションは起動スクリプトで指定しなければならない。
