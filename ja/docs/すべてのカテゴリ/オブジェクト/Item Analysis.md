...
**構文:** obj = Item Analysis(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = Item Analysis(...Model( "ロジスティック2PL"|"ロジスティック3PL"|"ロジスティック1PL" )...)

**説明:** 項目分析に使用するモデルを指定する。
...
**説明:** 項目特性曲線のレイアウトを変更する。項目特性曲線のアウトラインはデフォルトは閉じられている。
...
**構文:** obj << Save Ability Formula

**説明:** 能力の計算式を、データテーブルの新しい列に保存する。
