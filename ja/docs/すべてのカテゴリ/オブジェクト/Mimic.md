...
**説明:** Mimic a human user using JSL scripting.
...
**構文:** [xmin ymin, xmax ymax] = Bounds(boxref)

**説明:** Gets the rectangle for a given box.
...
**構文:** boxref = Button(label)

**説明:** Gets the first button box ref with the given label under Mimic box.
...
**構文:** [x y] = Center(rect | boxref)

**説明:** Calculates the center point for a given box or rectangle.
...
**構文:** pt = Disclosure(boxref | objref)

**説明:** Get position of the gray disclosure triangle for the given object or outline.
...
**構文:** geo = Frame Coords(framebox, geo)

**説明:** Converts a point or rectangle in Frame coordinates into a point or rectangle in screen space. Works best with continuous scales.
...
**構文:** rect = Grid Region(gridbox, "IdColumn", 9)

**説明:** Looks up named regions from the Data Grid.
...
**構文:** rect = List Item(listbox, item label)

**説明:** Finds the first item with the given label in a List Box Box, reveals it, and gets its bounds
...
**構文:** pt = Lrt(boxref | objref)

**説明:** Get position of the Little Red Triangle for the given object or outline.
...
**構文:** geo = Offset(geo | boxref, pt)

**説明:** Offset the given box/point/rectangle by given point.
...
**構文:** [x y] = TopLeft(rect | boxref)

**説明:** Calculates the top-left corner point for a given box or rectangle.
