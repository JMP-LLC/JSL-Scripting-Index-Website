...
**構文:** obj = Manage Limits(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = Manage Limits( Process Variables( columns), Grouping( columns) )
...
**構文:** obj = Manage Limits( Process Variables( columns) )
...
**説明:** データテーブルにおいて、仕様限界の範囲外にある観測値のセルに色をつける。下側仕様限界を下回る観測値のセルは淡い赤、上側仕様限界を上回る観測値のセルは淡い青で表示される。
...
**構文:** obj << Load from Limits Table

**説明:** データテーブルから限界に関する情報をロードする。
...
**構文:** obj << Round Decimals

**説明:** すべての数値を、指定した小数点以下桁数に丸める。
...
**構文:** obj << Save to Column Properties

**説明:** 限界の情報を列のプロパティとして保存する。
...
**構文:** obj << Save to Column Properties in Split Table(  < Remaining Columns ( Drop All | Keep All | Split All )> )

**説明:** 指定された限界(仕様限界や許容限界など)を新しいデータテーブルに保存する。その際、グループ変数別に列を分割し、指定された限界をその列の列プロパティとして保存する。
...
**構文:** obj << Save to Tall Limits Table

**説明:** 限界に関するすべての情報を、縦長のデータテーブルに保存する。
...
**構文:** obj << Save to Wide Limits Table

**説明:** 限界に関するすべての情報を、横長のデータテーブルに保存する
...
**構文:** obj << Show Limits All

**説明:** すべての項目の[限界の表示]チェックボックスをオンにする。
