...
**構文:** obj = MaxDiff(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = MaxDiff(...<Profile Effects( column )>...)
...
**構文:** MaxDiff( Response Best Option( column ), ... )

**説明:** 「応答データ」において、調査参加者が「最良」と評価したプロファイルのプロファイルIDを含んだ列を指定する。
...
**構文:** MaxDiff( Response Worst Option( column ), ... )

**説明:** 「応答データ」において、調査参加者が「最悪」と評価したプロファイルのプロファイルIDを含んだ列を指定する。
...
**構文:** obj = MaxDiff(...<Subject Effects( column )>...)
...
**構文:** obj << All Levels Comparison Report( state=0|1 )

**説明:** 1因子のMaxDiffモデルにおいて、全水準を比較する。
...
**構文:** obj = MaxDiff(...Convergence Criterion( number )...)
...
**構文:** obj = MaxDiff(...Firth Bias-Adjusted Estimates( state=0|1 )...)
...
**構文:** obj = MaxDiff(...Hierarchical Bayes( state=0|1 )...)
...
**構文:** obj = MaxDiff(...Number of Bayesian Iterations( number )...)
...
**構文:** obj = MaxDiff(...Remove Subject Effects...)
...
**構文:** MaxDiff( Response Value Indicates Best( value ), ... )

**説明:** 調査参加者が「最良」と評価したプロファイルのプロファイルIDのデータ値を指定する。
...
**構文:** MaxDiff( Response Value Indicates Worst( value ), ... )
