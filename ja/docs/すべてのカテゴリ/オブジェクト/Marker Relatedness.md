...
**構文:** obj = Marker Relatedness(...Window View( "Visible"|"Invisible"|"Private" )...)
...
**構文:** obj = Marker Relatedness(...Additive Type( "二倍体法1"|"二倍体法2"|"多倍体"="二倍体法1" )...)

**説明:** 相加的なゲノム関係行列を求めるのに、どの計算方法を用いるかを指定する。 デフォルトの値は"二倍体法1"。
...
**構文:** obj = Marker Relatedness(...Clustering( state=0|1 )...)

**説明:** ゲノム関係行列に対してクラスター分析を行う。
...
**構文:** obj = Marker Relatedness(...Dominance Type( "二倍体法1"|"二倍体法2"|"多倍体"="二倍体法1" )...)

**説明:** 顕性的(優性的)なゲノム関係行列を求めるのに、どの計算方法を用いるかを指定する。 デフォルトの値は"二倍体法1"。
...
**構文:** obj = Marker Relatedness(...Epistasis Type( "相加性×相加性"|"顕性×相加性"|"顕性×顕性"="相加性×相加性" )...)

**説明:** エピスタシス的なゲノム関係行列を求めるのに、どの計算方法を用いるかを指定する。 デフォルトの値は"相加性×相加性"。
...
**構文:** obj = Marker Relatedness(...Imputation Value( number=0 )...)
...
**構文:** obj = Marker Relatedness(...Kinship Type( "同一状態 (IBS)"|"相加性"|"顕性"|"エピスタシス"="同一状態 (IBS)" )...)

**説明:** どの計算方法でゲノム関係行列を求めるかを指定する。 デフォルトの値は"同一状態 (IBS)"。
...
**構文:** obj &lt;&lt; Merge Kinship Table

**説明:** ゲノム関係行列を、元のデータテーブルに結合する。
...
**構文:** obj = Marker Relatedness(...Missing Marker Imputation Method( "HWE オフ"|"HWE オン"|"ランダム"|"指定値"="HWE オフ" )...)
...
**構文:** obj = Marker Relatedness(...Ploidy( number=2 )...)
...
**構文:** obj = Marker Relatedness(...Principal Components( state=0|1 )...)

**説明:** ゲノム関係行列に対して主成分分析を行う。
...
**構文:** obj &lt;&lt; Save Square Kinship Table

**説明:** ゲノム関係行列を、正方行列の形式でデータテーブルに保存する。
...
**構文:** obj &lt;&lt; Save Stacked Kinship Table

**説明:** ゲノム関係行列の上三角部分を、積み重ねた形式でデータテーブルに保存する。
...
**構文:** obj = Marker Relatedness(...Set Random Seed( number=0 )...)
...
**構文:** obj = Marker Relatedness(...Unthreaded( state=0|1 )...)
