...
**構文:** float = obj << Get Lower( <index> )

**説明:** スライダで現在設定されている値を浮動小数点数で戻す。
...
**構文:** string = obj << Get Lower Var

**説明:** スライダの値が入る変数の名前を戻す。
...
**構文:** obj << Rescale Slider( min,max )

**説明:** スライダの最小値と最大値を設定する。
...
**説明:** コントロールに関数を設定する。関数のスクリプトは、いずれかのスライダの値が変化したときに実行される。
...
**構文:** obj << Set Lower( float, <index>, <run script(0|1)> )

**説明:** スライダの値を浮動小数点数で設定する。
...
**構文:** string = obj << Set Lower Var

**説明:** スライダの値が入る変数の名前を設定する。
...
**構文:** obj << Set Upper( float, <index>, <run script(0|1)> )
