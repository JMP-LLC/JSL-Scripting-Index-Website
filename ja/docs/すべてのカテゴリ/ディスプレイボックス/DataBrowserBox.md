...
**説明:** ディスプレイボックスツリーの中にデータテーブルビューを作成する。現在のデータテーブルも指定されたデータテーブルに変更する。
...
**構文:** obj &lt;&lt; Close Data Grid( state=0|1 )

**説明:** データテーブルのグリッドを閉じる、または開く。
...
**構文:** obj &lt;&lt; Close Side Panels( state=0|1 )
...
**構文:** obj &lt;&lt; Close summary panels( state=0|1 )
...
**構文:** obj &lt;&lt; Get Close Data Grid

**説明:** データテーブルのグリッドが閉じた状態かどうかを戻す。
...
**構文:** obj &lt;&lt; Get Close Side Panels

**説明:** データテーブルのサイドパネルが閉じた状態かどうかを戻す。
...
**構文:** obj &lt;&lt; Get Close Summary Panels

**説明:** データテーブルの要約パネルが閉じた状態かどうかを戻す。
...
**構文:** obj &lt;&lt; Set Data Table( dt )

**説明:** このディスプレイボックスのデータテーブルを設定する。
...
**説明:** データテーブルの表示でヘッダグラフの表示/非表示を切り替える。
