...
**説明:** 中に含まれたディスプレイボックスを整列させるディスプレイボックスを戻す。
...
**構文:** pixels = obj &lt;&lt; Get Spacing( number )

**説明:** ディスプレイボックス間の距離(ピクセル数)を取得する。
...
**構文:** obj &lt;&lt; Spacing( pixels )

**説明:** ディスプレイボックス間の距離をピクセル数で設定する。
...
**構文:** obj &lt;&lt; Wrap When Printing

**説明:** 並んだレポートを、印刷時に必要に応じて改行する。
