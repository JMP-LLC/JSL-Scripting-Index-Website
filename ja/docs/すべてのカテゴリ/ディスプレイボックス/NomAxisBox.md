...
**構文:** obj << Lower Frame( state=0|1 )

**説明:** 下のフレームを軸上に表示する機能を有効または無効にする。
...
**構文:** obj << Rotated Tick Labels( state=0|1 )

**説明:** 目盛りラベルの向きを横 (1)または縦 (0)に変更する。
