...
**構文:** obj &lt;&lt; Graph Margin( sides );sides = obj &lt;&lt; Get Graph Margin

**説明:** The minimum margin around the graph area, which might be superseded by any surrounding axis, legend, or title.
...
**構文:** obj &lt;&lt; Scale Graph Margin( state=0|1 );state = obj &lt;&lt; Get Scale Graph Margin

**説明:** Specifies whether the Graph Margin properties should scale with the graph size when applied.
...
**構文:** obj &lt;&lt; Graph Spacing( color )

**説明:** グラフパネル間のスペース幅を設定する。
...
**構文:** obj &lt;&lt; Graph Spacing Transparency( color )

**説明:** グラフパネル間のスペースの透明度を設定する。
