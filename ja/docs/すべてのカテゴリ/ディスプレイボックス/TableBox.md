...
**構文:** obj << Heading Underline Color( color );
...
**構文:** obj << Row Height Scale( number );
...
**構文:** obj << Row Vertical Alignment( "上"|"中央"|"ベースライン"|"下" );

"上"|"中央"|"ベースライン"|"下" = obj << Get Row Vertical Alignment
