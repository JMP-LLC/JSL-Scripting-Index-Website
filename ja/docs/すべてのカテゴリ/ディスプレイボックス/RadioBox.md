...
**説明:** ラジオボタンのディスプレイボックスを戻す。ラジオボタンがクリックされると、スクリプトが実行される。
...
**構文:** selectedText = obj &lt;&lt; Get Selected

**説明:** 選択されたラジオボタンのテキストを取得する。
...
**構文:** obj &lt;&lt; Group( radiobox )

**説明:** ラジオボタンをグループ化する。グループ化されたラジオボタンでは、そのなかで1つしか1度に選択されない。
...
**構文:** obj &lt;&lt; Index Of( string )

**説明:** 該当する文字列の通し番号を戻す。見つからない場合は0を戻す。
...
**構文:** obj &lt;&lt; Item Enabled( index )

**説明:** ラジオボックスの個々の項目が有効または無効のどちらであるかを判断する
...
**説明:** コントロールに関数を設定する。関数のスクリプトは、Radio Boxがクリックされたときに実行される。
