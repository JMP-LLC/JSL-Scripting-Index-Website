...
**構文:** obj &lt;&lt; Closed( state=0|1 )

**説明:** 有効にした場合、多角形の始点と終点が離れていても自動的に閉じる。
...
**構文:** obj &lt;&lt; Raised( state=0|1 )

**説明:** 多角形の影つきを有効または無効にする。
...
**構文:** obj &lt;&lt; Smooth( state=0|1 )

**説明:** 多角形の輪郭の平滑化を有効または無効にする。
