...
**説明:** データテーブルの列を表示するディスプレイボックスを戻す。
...
**構文:** data table column = obj << Get Data Table Column

**説明:** Returns a reference to the data table column that corresponds to this table box column.
...
**構文:** obj << Lower( data table column )
...
**構文:** obj << Set Data Table Column( data table column )

**説明:** Sets the data table column that corresponds to this table box column.
...
**構文:** obj << Set Labels( data table column )
...
**構文:** obj << Significance( data table column )
...
**構文:** obj << Upper( data table column )
