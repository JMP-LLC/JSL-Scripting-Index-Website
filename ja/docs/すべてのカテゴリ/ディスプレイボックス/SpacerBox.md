...
**説明:** 任意のサイズと色を指定できるディスプレイボックスを戻す。
...
**構文:** boolean = obj &lt;&lt; Get Fill

**説明:** Returns whether the background is painted or not.
...
**構文:** alpha = obj &lt;&lt; Get Transparency

**説明:** Returns the transparency value, 0..1.
...
**説明:** Sets whether the background is painted or not.
...
**構文:** obj &lt;&lt; Size( width, height,&lt;min width, min height&gt;,&lt;max width, max height&gt; )
...
**構文:** obj &lt;&lt; Transparency( alpha )

**説明:** Sets the transparency value, 0..1.
