...
**構文:** LegendBox &lt;&lt; Get Item(Model ID, Model Index)

**説明:** 照会できる凡例項目、または表示属性を変更できる凡例項目を戻す。
...
**説明:** 照会できる凡例項目、または表示属性を変更できる凡例項目のリストを戻す。
...
**構文:** obj &lt;&lt; Legend Position( list )

**説明:** 凡例ボックス内の項目をlistの指定に従って並べ替える。
...
**構文:** obj &lt;&lt; Orientation( vertical|horizontal )

**説明:** 凡例ボックス内の項目の向きを設定する。
...
**構文:** obj &lt;&lt; Revert Legend

**説明:** 凡例ボックスに加えられた変更を元に戻す。
...
**説明:** 凡例に表示する項目の最大数を指定する。この設定により、多数の凡例が表示されグラフが巨大になることを防げる。
...
**構文:** obj &lt;&lt; Set Wrap( number )

**説明:** 凡例を何行で表示するかを指定する。0は折り返しなし(横に長い列)
...
**構文:** obj &lt;&lt; font( fontname, &lt;fontsize&gt;, &lt;fontstyle&gt; )
