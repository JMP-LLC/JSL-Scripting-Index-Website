...
**構文:** "left"|"right"|"center" = obj &lt;&lt; Get Justify
...
**構文:** obj &lt;&lt; Numerical Order( &lt;0 | 1&gt; )

**説明:** 数値を含むテキストは、数値の順序で並べ替えられる。
...
**構文:** obj &lt;&lt; Set Allow Text Search( &lt;0 | 1&gt; )

**説明:** このコマンドにより、行を選択できるTable Boxにおいて、選択されている文字列の列の値がキーボードで入力した文字で始まる行が選択されるようになる。
...
**構文:** obj &lt;&lt; Set Justify( "left","right","center" )
