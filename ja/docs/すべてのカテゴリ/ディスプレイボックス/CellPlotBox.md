...
**構文:** obj &lt;&lt; Color Theme( Green to Black to Red|Green to White to Red|White to Black|Blue to Gray to Red|Blue to Green to Red|Spectral|Jet|White to Blue|White to Green|White to Red )

**説明:** セルプロットの表示に使うカラーテーマを指定する。
...
**構文:** obj &lt;&lt; Graph Type( "カラーマップ"|"ドットプロット"|"縦線プロット"|"横線プロット"|"横棒プロット" )

**説明:** セルプロットのグラフの種類を指定する。
...
**構文:** obj &lt;&lt; No separator lines( state=0|1 )

**説明:** セルプロットで各列の周囲を描く線を削除する。
...
**説明:** 行の編集ウィンドウが開き、選択されている最初の行が表示される。
