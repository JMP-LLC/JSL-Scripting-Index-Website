...
**構文:** bool = obj &lt;&lt; Get Log Scale

**説明:** スライダのスケールが対数の場合は1、線形の場合は0を戻す。
...
**構文:** obj &lt;&lt; Set( float, &lt;index&gt;,&lt;run script(0|1)&gt; )
...
**説明:** コントロールに関数を設定する。関数のスクリプトは、スライダが変化したときに実行される。
...
**構文:** obj &lt;&lt; Set Log Scale( 0|1 )

**説明:** スライダを対数(1)または線形(0)に設定する。
