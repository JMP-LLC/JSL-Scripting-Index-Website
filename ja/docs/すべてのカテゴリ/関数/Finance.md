...
**構文:** x = Internal Rate of Return( values, <guess=0.1> );
...
**構文:** x = Modified Internal Rate of Return( values, finance_rate, reinvest_rate );
...
**構文:** x = Net Present Value( rate, values );
